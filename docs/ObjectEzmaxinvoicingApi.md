...
public class Example {
  public static void main(String[] args) {
    ...
    String eFilterActive = "All"; // String | Specify which results we want to display. Active is the default value.
...
| **eFilterActive** | **String**| Specify which results we want to display. Active is the default value. | [optional] [enum: All, Active, Inactive] |
