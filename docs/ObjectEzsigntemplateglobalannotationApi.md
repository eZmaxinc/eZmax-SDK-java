...
import com.ezmax.api.ObjectEzsigntemplateglobalannotationApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectEzsigntemplateglobalannotationApi apiInstance = new ObjectEzsigntemplateglobalannotationApi(defaultClient);
    Integer pkiEzsigntemplateglobalannotationID = 56; // Integer | The unique ID of the Ezsigntemplateglobalannotation
    try {
