...
import com.ezmax.api.ObjectFontApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectFontApi apiInstance = new ObjectFontApi(defaultClient);
    String sSelector = "All"; // String | The type of Fonts to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Fonts to return | [enum: All, Ezsignannotation, Ezsignformfield, Ezsignsignature] |
