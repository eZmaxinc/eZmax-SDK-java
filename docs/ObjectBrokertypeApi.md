...
import com.ezmax.api.ObjectBrokertypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectBrokertypeApi apiInstance = new ObjectBrokertypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Brokertypes to return
    ...
    try {
      ...
      System.err.println("Exception when calling ObjectBrokertypeApi#brokertypeGetAutocompleteV2");
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Brokertypes to return | [enum: All] |
