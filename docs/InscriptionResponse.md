...
|**iInscriptionSellerdeclaration** | **Integer** | The sellerdeclaration of the Inscription |  |
...
|**bInscriptionIssolicitation** | **Boolean** | Whether if it&#39;s an issolicitation |  |
|**bInscriptionSalebyowner** | **Boolean** | Whether if it&#39;s an salebyowner |  |
|**bInscriptionSoldwithoutlegalwarranty** | **Boolean** | Whether if it&#39;s an soldwithoutlegalwarranty |  |
|**iInscriptionConstructionyear** | **Integer** | The constructionyear of the Inscription |  |
