...
import com.ezmax.api.ObjectCreditcardtypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectCreditcardtypeApi apiInstance = new ObjectCreditcardtypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Creditcardtypes to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Creditcardtypes to return | [enum: All] |
