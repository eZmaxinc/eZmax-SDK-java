...
import com.ezmax.api.ObjectLeadsourceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectLeadsourceApi apiInstance = new ObjectLeadsourceApi(defaultClient);
    String sSelector = "All"; // String | The type of Leadsources to return
    ...
    try {
      ...
      System.err.println("Exception when calling ObjectLeadsourceApi#leadsourceGetAutocompleteV2");
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Leadsources to return | [enum: All] |
