...
import com.ezmax.api.ObjectUserlogintypeApi;
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Userlogintypes to return | [enum: All, Ezsignfoldertype, EzsignfoldertypeReassign, Ezsigntemplatepublic] |
