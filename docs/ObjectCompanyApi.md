...
import com.ezmax.api.ObjectCompanyApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectCompanyApi apiInstance = new ObjectCompanyApi(defaultClient);
    String sSelector = "All"; // String | The type of Companys to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Companys to return | [enum: All] |
