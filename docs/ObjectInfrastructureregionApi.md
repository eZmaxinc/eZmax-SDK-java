...
import com.ezmax.api.ObjectInfrastructureregionApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectInfrastructureregionApi apiInstance = new ObjectInfrastructureregionApi(defaultClient);
    String sSelector = "AWS"; // String | The type of Infrastructureregions  to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Infrastructureregions  to return | [enum: AWS, Programmer] |
