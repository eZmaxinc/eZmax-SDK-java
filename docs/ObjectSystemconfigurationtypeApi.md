...
import com.ezmax.api.ObjectSystemconfigurationtypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectSystemconfigurationtypeApi apiInstance = new ObjectSystemconfigurationtypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Systemconfigurationtype to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Systemconfigurationtype to return | [enum: All] |
