...
import com.ezmax.api.ObjectProvinceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectProvinceApi apiInstance = new ObjectProvinceApi(defaultClient);
    String sSelector = "All"; // String | The type of Provinces to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Provinces to return | [enum: All] |
