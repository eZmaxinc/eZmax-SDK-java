...
|**fkiFinancialinstitutionID** | **Integer** | The unique ID of the Financialinstitution |  |
|**sFinancialinstitutionNameX** | **String** | The name of the Financialinstitution in the language of the requester |  [optional] |
|**fkiBuyercontractID** | **Integer** | The unique ID of the Buyercontract |  |
|**sBuyercontractContract** | **String** | The number of the Buyercontract |  [optional] |
|**fkiMortgagesupplierID** | **Integer** | The unique ID of the Mortgagesupplier |  |
...
|**bInscriptionnotauthenticatedMortgageisreferenced** | **Boolean** | Whether if it&#39;s an mortgageisreferenced |  |
|**bInscriptionnotauthenticatedHomeowner** | **Boolean** | Whether if it&#39;s an homeowner |  |
