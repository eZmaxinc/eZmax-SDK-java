...
import com.ezmax.api.ObjectEmailtypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectEmailtypeApi apiInstance = new ObjectEmailtypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Emailtypes to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Emailtypes to return | [enum: All] |
