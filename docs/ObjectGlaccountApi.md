...
import com.ezmax.api.ObjectGlaccountApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectGlaccountApi apiInstance = new ObjectGlaccountApi(defaultClient);
    String sSelector = "All"; // String | The type of Glaccounts to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Glaccounts to return | [enum: All, Supply] |
