...
import com.ezmax.api.ObjectOtherincometypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectOtherincometypeApi apiInstance = new ObjectOtherincometypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Otherincometypes to return
    ...
    try {
      ...
      System.err.println("Exception when calling ObjectOtherincometypeApi#otherincometypeGetAutocompleteV2");
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Otherincometypes to return | [enum: All] |
