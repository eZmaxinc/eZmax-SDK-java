...
|**bEzsigndocumentSendtoged** | **Boolean** | Whether the Ezsigndocument was copied to EDM |  [optional] |
...
|**iEzsigndocumentSteptotal** | **Integer** | The total number of steps |  |
|**iEzsigndocumentStepcurrent** | **Integer** | The current step |  |
