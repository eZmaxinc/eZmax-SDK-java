...
import com.ezmax.api.ObjectEzmaxmaillinglistApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectEzmaxmaillinglistApi apiInstance = new ObjectEzmaxmaillinglistApi(defaultClient);
    String eOrderBy = "pkiEzmaxmaillinglistID_ASC"; // String | Specify how you want the results to be sorted
...
|------------- | ------------- | ------------- | -------------|
| **eOrderBy** | **String**| Specify how you want the results to be sorted | [optional] [enum: pkiEzmaxmaillinglistID_ASC, pkiEzmaxmaillinglistID_DESC, sEzmaxmaillinglistNameX_ASC, sEzmaxmaillinglistNameX_DESC, sEzmaxmaillinglistDescriptionX_ASC, sEzmaxmaillinglistDescriptionX_DESC] |
