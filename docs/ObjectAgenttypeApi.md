...
import com.ezmax.api.ObjectAgenttypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectAgenttypeApi apiInstance = new ObjectAgenttypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Agenttypes to return
    ...
    try {
      ...
      System.err.println("Exception when calling ObjectAgenttypeApi#agenttypeGetAutocompleteV2");
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Agenttypes to return | [enum: All] |
