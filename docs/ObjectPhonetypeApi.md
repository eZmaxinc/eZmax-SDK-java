...
import com.ezmax.api.ObjectPhonetypeApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectPhonetypeApi apiInstance = new ObjectPhonetypeApi(defaultClient);
    String sSelector = "All"; // String | The type of Phonetypes to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Phonetypes to return | [enum: All] |
