...
import com.ezmax.api.ObjectLanguageApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectLanguageApi apiInstance = new ObjectLanguageApi(defaultClient);
    String sSelector = "All"; // String | The type of Languages to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Languages to return | [enum: All] |
