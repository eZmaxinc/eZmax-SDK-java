...
import com.ezmax.api.ObjectTimezoneApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectTimezoneApi apiInstance = new ObjectTimezoneApi(defaultClient);
    String sSelector = "All"; // String | The type of Timezones to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Timezones to return | [enum: All, Active] |
