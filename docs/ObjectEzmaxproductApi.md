...
import com.ezmax.api.ObjectEzmaxproductApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ObjectEzmaxproductApi apiInstance = new ObjectEzmaxproductApi(defaultClient);
    String sSelector = "All"; // String | The type of Ezmaxproducts to return
...
|------------- | ------------- | ------------- | -------------|
| **sSelector** | **String**| The type of Ezmaxproducts to return | [enum: All, Entitydefault, Entityother] |
