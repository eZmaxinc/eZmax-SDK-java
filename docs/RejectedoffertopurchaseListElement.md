...
|------------ | ------------- | ------------- | -------------|
|**pkiRejectedoffertopurchaseID** | **Integer** | The unique ID of the Rejectedoffertopurchase |  |
...
|**bRejectedoffertopurchaseIsactive** | **Boolean** | Whether the rejectedoffertopurchase is active or not |  |
...
|**bRejectedoffertopurchaseLinkedtoinscription** | **Boolean** | Indicate if the Rejectedoffertopurchase is linked to an inscription |  |
