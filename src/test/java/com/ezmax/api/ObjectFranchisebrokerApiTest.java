...
public class ObjectFranchisebrokerApiTest {
     ...
     */
    @Test
    public void franchisebrokerGetAutocompleteV2Test() throws ApiException {
        String sSelector = null;
        String eFilterActive = null;
        String sQuery = null;
        HeaderAcceptLanguage acceptLanguage = null;
        FranchisebrokerGetAutocompleteV2Response response = api.franchisebrokerGetAutocompleteV2(sSelector, eFilterActive, sQuery, acceptLanguage);
