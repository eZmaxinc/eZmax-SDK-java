...
public class DiscussionmembershipResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiDiscussionmembershipID", "fkiDiscussionID", "fkiUserID", "fkiUsergroupID", "fkiModulesectionID", "sDiscussionmembershipDescription", "dtDiscussionmembershipJoined"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiDiscussionmembershipID", "fkiDiscussionID", "sDiscussionmembershipDescription", "dtDiscussionmembershipJoined"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiscussionmembershipResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DiscussionmembershipResponse is not found in the empty JSON string", DiscussionmembershipResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiscussionmembershipResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DiscussionmembershipResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sDiscussionmembershipDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sDiscussionmembershipDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sDiscussionmembershipDescription").toString()));
      }
      if (!jsonObj.get("dtDiscussionmembershipJoined").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtDiscussionmembershipJoined` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtDiscussionmembershipJoined").toString()));
      }
  }
