...
public class MultilingualNotificationsubsectionName {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sNotificationsubsectionName1", "sNotificationsubsectionName2"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultilingualNotificationsubsectionName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MultilingualNotificationsubsectionName is not found in the empty JSON string", MultilingualNotificationsubsectionName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultilingualNotificationsubsectionName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MultilingualNotificationsubsectionName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sNotificationsubsectionName1") != null && !jsonObj.get("sNotificationsubsectionName1").isJsonNull()) && !jsonObj.get("sNotificationsubsectionName1").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sNotificationsubsectionName1` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sNotificationsubsectionName1").toString()));
      }
      if ((jsonObj.get("sNotificationsubsectionName2") != null && !jsonObj.get("sNotificationsubsectionName2").isJsonNull()) && !jsonObj.get("sNotificationsubsectionName2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sNotificationsubsectionName2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sNotificationsubsectionName2").toString()));
      }
  }
