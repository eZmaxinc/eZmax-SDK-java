...
public class EzsignbulksendCreateEzsignbulksendtransmissionV1Request {
  ...
  * @throws IOException if the JSON Element is invalid with respect to EzsignbulksendCreateEzsignbulksendtransmissionV1Request
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksendCreateEzsignbulksendtransmissionV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksendCreateEzsignbulksendtransmissionV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignbulksendCreateEzsignbulksendtransmissionV1Request` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
