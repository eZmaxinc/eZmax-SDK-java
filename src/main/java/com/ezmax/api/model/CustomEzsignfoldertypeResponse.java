...
public class CustomEzsignfoldertypeResponse {
  ...
  public CustomEzsignfoldertypeResponse eEzsignfoldertypeDocumentmerge(@javax.annotation.Nullable FieldEEzsignfoldertypeDocumentmerge eEzsignfoldertypeDocumentmerge) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfoldertypeID, customEzsignfoldertypeResponse.pkiEzsignfoldertypeID) &&
        ...
        Objects.equals(this.eEzsignfoldertypeDocumentmerge, customEzsignfoldertypeResponse.eEzsignfoldertypeDocumentmerge);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignfoldertypeID", "fkiFontIDAnnotation", "fkiFontIDFormfield", "fkiFontIDSignature", "sEzsignfoldertypeNameX", "bEzsignfoldertypeSendproofezsignsigner", "bEzsignfoldertypeAllowdownloadattachmentezsignsigner", "bEzsignfoldertypeAllowdownloadproofezsignsigner", "bEzsignfoldertypeAutomaticsignature", "bEzsignfoldertypeDelegate", "bEzsignfoldertypeDiscussion", "bEzsignfoldertypeReassignezsignsigner", "bEzsignfoldertypeReassignuser", "bEzsignfoldertypeReassigngroup", "iEzsignfoldertypeDeadlinedays", "iEzsignfoldertypeFontsizeannotation", "iEzsignfoldertypeFontsizeformfield", "eEzsignfoldertypeDocumentmerge"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzsignfoldertypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzsignfoldertypeResponse is not found in the empty JSON string", CustomEzsignfoldertypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignfoldertypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzsignfoldertypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
