...
public class TextstylestaticRequest {
  ...
  public boolean equals(Object o) {
    ...
    TextstylestaticRequest textstylestaticRequest = (TextstylestaticRequest) o;
    return Objects.equals(this.fkiFontID, textstylestaticRequest.fkiFontID) &&
        Objects.equals(this.bTextstylestaticBold, textstylestaticRequest.bTextstylestaticBold) &&
        Objects.equals(this.bTextstylestaticUnderline, textstylestaticRequest.bTextstylestaticUnderline) &&
        Objects.equals(this.bTextstylestaticItalic, textstylestaticRequest.bTextstylestaticItalic) &&
        Objects.equals(this.bTextstylestaticStrikethrough, textstylestaticRequest.bTextstylestaticStrikethrough) &&
        Objects.equals(this.iTextstylestaticFontcolor, textstylestaticRequest.iTextstylestaticFontcolor) &&
        Objects.equals(this.iTextstylestaticSize, textstylestaticRequest.iTextstylestaticSize);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextstylestaticRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextstylestaticRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TextstylestaticRequest is not found in the empty JSON string", TextstylestaticRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextstylestaticRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TextstylestaticRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @return An instance of TextstylestaticRequest
   * @throws IOException if the JSON string is invalid with respect to TextstylestaticRequest
   */
  public static TextstylestaticRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextstylestaticRequest.class);
  }

  /**
   * Convert an instance of TextstylestaticRequest to an JSON string
   *
   * @return JSON string
   */
