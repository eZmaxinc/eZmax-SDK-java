...
public class WebhookEzsignEzsignsignerConnect {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objEzsignfolder, webhookEzsignEzsignsignerConnect.objEzsignfolder) &&
        ...
        Objects.equals(this.objWebhook, webhookEzsignEzsignsignerConnect.objWebhook) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebhookEzsignEzsignsignerConnect
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebhookEzsignEzsignsignerConnect.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebhookEzsignEzsignsignerConnect.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookEzsignEzsignsignerConnect` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
