...
public class ApikeyGetListV1ResponseMPayload {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aObjApikey, apikeyGetListV1ResponseMPayload.aObjApikey) &&
        Objects.equals(this.iRowReturned, apikeyGetListV1ResponseMPayload.iRowReturned) &&
        Objects.equals(this.iRowFiltered, apikeyGetListV1ResponseMPayload.iRowFiltered);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aObjApikey, iRowReturned, iRowFiltered);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApikeyGetListV1ResponseMPayload
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApikeyGetListV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApikeyGetListV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApikeyGetListV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
