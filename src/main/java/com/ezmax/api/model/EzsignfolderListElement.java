...
public class EzsignfolderListElement {
  ...
  **/
  ...
  static {
    ...
    openapiRequiredFields.add("dtDueDate");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EzsignfolderListElement
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EzsignfolderListElement.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EzsignfolderListElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignfolderListElement` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
