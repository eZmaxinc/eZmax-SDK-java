...
public class CommonReportcolumn {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommonReportcolumn
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommonReportcolumn.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CommonReportcolumn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommonReportcolumn` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      CommonReportcellstyle.validateJsonObject(jsonObj.getAsJsonObject("objReportcellstyleDefault"));
  }
