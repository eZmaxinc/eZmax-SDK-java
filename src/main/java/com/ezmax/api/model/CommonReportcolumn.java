...
public class CommonReportcolumn {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("objReportcellstyleDefault", "iReportcolumnWidth", "eReportcolumnType"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("objReportcellstyleDefault", "iReportcolumnWidth", "eReportcolumnType"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonReportcolumn.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonReportcolumn is not found in the empty JSON string", CommonReportcolumn.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonReportcolumn.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonReportcolumn` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
