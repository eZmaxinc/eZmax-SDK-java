...
public class UserstagedListElement {
  ...
  public UserstagedListElement pkiUserstagedID(@javax.annotation.Nonnull Integer pkiUserstagedID) {
  ...
  public UserstagedListElement sEmailAddress(@javax.annotation.Nonnull String sEmailAddress) {
  ...
  public UserstagedListElement sUserstagedFirstname(@javax.annotation.Nonnull String sUserstagedFirstname) {
  ...
  public UserstagedListElement sUserstagedLastname(@javax.annotation.Nonnull String sUserstagedLastname) {
  ...
  public UserstagedListElement sUserstagedExternalid(@javax.annotation.Nonnull String sUserstagedExternalid) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiUserstagedID", "sEmailAddress", "sUserstagedFirstname", "sUserstagedLastname", "sUserstagedExternalid"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiUserstagedID", "sEmailAddress", "sUserstagedFirstname", "sUserstagedLastname", "sUserstagedExternalid"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserstagedListElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserstagedListElement is not found in the empty JSON string", UserstagedListElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserstagedListElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserstagedListElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
