...
public class CustomEzsignfoldersignerassociationActionableElementResponse {
  ...
  **/
  ...
  public CustomEzsignfoldersignerassociationActionableElementResponse objUsergroup(UsergroupResponseCompound objUsergroup) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfoldersignerassociationID, customEzsignfoldersignerassociationActionableElementResponse.pkiEzsignfoldersignerassociationID) &&
        ...
        Objects.equals(this.objUsergroup, customEzsignfoldersignerassociationActionableElementResponse.objUsergroup) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignfoldersignerassociationID, fkiEzsignfolderID, bEzsignfoldersignerassociationDelayedsend, bEzsignfoldersignerassociationReceivecopy, tEzsignfoldersignerassociationMessage, objEzsignsignergroup, objUser, objUsergroup, objEzsignsigner, bEzsignfoldersignerassociationHasactionableelementsCurrent, bEzsignfoldersignerassociationHasactionableelementsFuture);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomEzsignfoldersignerassociationActionableElementResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomEzsignfoldersignerassociationActionableElementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignfoldersignerassociationActionableElementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomEzsignfoldersignerassociationActionableElementResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
