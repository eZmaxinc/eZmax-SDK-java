  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultilingualBrandingDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in MultilingualBrandingDescription is not found in the empty JSON string", MultilingualBrandingDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultilingualBrandingDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MultilingualBrandingDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sBrandingDescription1") != null && !jsonObj.get("sBrandingDescription1").isJsonNull()) && !jsonObj.get("sBrandingDescription1").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sBrandingDescription1` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sBrandingDescription1").toString()));
      }
      if ((jsonObj.get("sBrandingDescription2") != null && !jsonObj.get("sBrandingDescription2").isJsonNull()) && !jsonObj.get("sBrandingDescription2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sBrandingDescription2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sBrandingDescription2").toString()));
      }
  }
