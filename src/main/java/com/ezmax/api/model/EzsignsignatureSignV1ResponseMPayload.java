...
public class EzsignsignatureSignV1ResponseMPayload {
  ...
  public EzsignsignatureSignV1ResponseMPayload objCreditcardtransaction(@javax.annotation.Nullable CustomCreditcardtransactionResponse objCreditcardtransaction) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dtEzsignsignatureDateInFolderTimezone, ezsignsignatureSignV1ResponseMPayload.dtEzsignsignatureDateInFolderTimezone) &&
        ...
        Objects.equals(this.objCreditcardtransaction, ezsignsignatureSignV1ResponseMPayload.objCreditcardtransaction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dtEzsignsignatureDateInFolderTimezone, objTimezone, objCreditcardtransaction);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("dtEzsignsignatureDateInFolderTimezone", "objTimezone", "objCreditcardtransaction"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("dtEzsignsignatureDateInFolderTimezone"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignatureSignV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignatureSignV1ResponseMPayload is not found in the empty JSON string", EzsignsignatureSignV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignatureSignV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignatureSignV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
