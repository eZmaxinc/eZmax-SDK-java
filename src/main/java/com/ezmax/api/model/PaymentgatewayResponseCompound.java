...
public class PaymentgatewayResponseCompound {
  ...
  public PaymentgatewayResponseCompound pkiPaymentgatewayID(@javax.annotation.Nonnull Integer pkiPaymentgatewayID) {
  ...
  public PaymentgatewayResponseCompound fkiCreditcardmerchantID(@javax.annotation.Nullable Integer fkiCreditcardmerchantID) {
  ...
  public PaymentgatewayResponseCompound sCreditcardmerchantDescription(@javax.annotation.Nullable String sCreditcardmerchantDescription) {
  ...
  public PaymentgatewayResponseCompound ePaymentgatewayProcessor(@javax.annotation.Nonnull FieldEPaymentgatewayProcessor ePaymentgatewayProcessor) {
  ...
  public PaymentgatewayResponseCompound objPaymentgatewayDescription(@javax.annotation.Nonnull MultilingualPaymentgatewayDescription objPaymentgatewayDescription) {
  ...
  public PaymentgatewayResponseCompound objCreditcardmerchant(@javax.annotation.Nullable CreditcardmerchantResponseCompound objCreditcardmerchant) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiPaymentgatewayID, paymentgatewayResponseCompound.pkiPaymentgatewayID) &&
        Objects.equals(this.fkiCreditcardmerchantID, paymentgatewayResponseCompound.fkiCreditcardmerchantID) &&
        Objects.equals(this.sCreditcardmerchantDescription, paymentgatewayResponseCompound.sCreditcardmerchantDescription) &&
        Objects.equals(this.ePaymentgatewayProcessor, paymentgatewayResponseCompound.ePaymentgatewayProcessor) &&
        Objects.equals(this.objPaymentgatewayDescription, paymentgatewayResponseCompound.objPaymentgatewayDescription) &&
        Objects.equals(this.objCreditcardmerchant, paymentgatewayResponseCompound.objCreditcardmerchant);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiPaymentgatewayID", "fkiCreditcardmerchantID", "sCreditcardmerchantDescription", "ePaymentgatewayProcessor", "objPaymentgatewayDescription", "objCreditcardmerchant"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiPaymentgatewayID", "ePaymentgatewayProcessor", "objPaymentgatewayDescription"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymentgatewayResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymentgatewayResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaymentgatewayResponseCompound is not found in the empty JSON string", PaymentgatewayResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymentgatewayResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PaymentgatewayResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymentgatewayResponseCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymentgatewayResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymentgatewayResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymentgatewayResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymentgatewayResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymentgatewayResponseCompound>() {
           @Override
           public void write(JsonWriter out, PaymentgatewayResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymentgatewayResponseCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymentgatewayResponseCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymentgatewayResponseCompound
   * @throws IOException if the JSON string is invalid with respect to PaymentgatewayResponseCompound
   */
  public static PaymentgatewayResponseCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymentgatewayResponseCompound.class);
  }

  /**
   * Convert an instance of PaymentgatewayResponseCompound to an JSON string
   *
   * @return JSON string
   */
