...
public class EzsigntemplateAutocompleteElementResponse {
  ...
  public EzsigntemplateAutocompleteElementResponse eEzsignfoldertypePrivacylevel(@javax.annotation.Nonnull FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel) {
  ...
  public EzsigntemplateAutocompleteElementResponse sEzsigntemplateDescription(@javax.annotation.Nonnull String sEzsigntemplateDescription) {
  ...
  public EzsigntemplateAutocompleteElementResponse pkiEzsigntemplateID(@javax.annotation.Nonnull Integer pkiEzsigntemplateID) {
  ...
  public EzsigntemplateAutocompleteElementResponse bEzsigntemplateIsactive(@javax.annotation.Nonnull Boolean bEzsigntemplateIsactive) {
  ...
  public void setbEzsigntemplateIsactive(@javax.annotation.Nonnull Boolean bEzsigntemplateIsactive) {
    this.bEzsigntemplateIsactive = bEzsigntemplateIsactive;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eEzsignfoldertypePrivacylevel", "sEzsigntemplateDescription", "pkiEzsigntemplateID", "bEzsigntemplateIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eEzsignfoldertypePrivacylevel", "sEzsigntemplateDescription", "pkiEzsigntemplateID", "bEzsigntemplateIsactive"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplateAutocompleteElementResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateAutocompleteElementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplateAutocompleteElementResponse is not found in the empty JSON string", EzsigntemplateAutocompleteElementResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateAutocompleteElementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateAutocompleteElementResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
