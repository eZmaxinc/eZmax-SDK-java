...
public class AttachmentlogResponseCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiAttachmentID", "fkiUserID", "dtAttachmentlogDatetime", "eAttachmentlogType", "sAttachmentlogDetail"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiAttachmentID", "fkiUserID", "dtAttachmentlogDatetime", "eAttachmentlogType"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachmentlogResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AttachmentlogResponseCompound is not found in the empty JSON string", AttachmentlogResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachmentlogResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AttachmentlogResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("dtAttachmentlogDatetime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtAttachmentlogDatetime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtAttachmentlogDatetime").toString()));
      }
      ...
      if ((jsonObj.get("sAttachmentlogDetail") != null && !jsonObj.get("sAttachmentlogDetail").isJsonNull()) && !jsonObj.get("sAttachmentlogDetail").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sAttachmentlogDetail` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sAttachmentlogDetail").toString()));
      }
  }
