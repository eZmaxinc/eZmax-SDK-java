...
public class EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload {
  ...
  public EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload aEEzsignsignatureType(Set<FieldEEzsignsignatureType> aEEzsignsignatureType) {
  ...
  **/
  ...
  public EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload aObjEzsignfolder(List<CustomEzsignfolderEzsignsignaturesAutomaticResponse> aObjEzsignfolder) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload is not found in the empty JSON string", EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
