...
public class EzsignsignaturepaymentdetailRequestCompound {
  ...
  public EzsignsignaturepaymentdetailRequestCompound fkiGlaccountcontainerID(@javax.annotation.Nullable Integer fkiGlaccountcontainerID) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignaturepaymentdetailRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignsignaturepaymentdetailRequestCompound is not found in the empty JSON string", EzsignsignaturepaymentdetailRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignaturepaymentdetailRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignsignaturepaymentdetailRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
