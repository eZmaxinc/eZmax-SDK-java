...
public class DiscussionmembershipResponseCompound {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiscussionmembershipResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiscussionmembershipResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DiscussionmembershipResponseCompound is not found in the empty JSON string", DiscussionmembershipResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiscussionmembershipResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DiscussionmembershipResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DiscussionmembershipResponseCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscussionmembershipResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscussionmembershipResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscussionmembershipResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscussionmembershipResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscussionmembershipResponseCompound>() {
           @Override
           public void write(JsonWriter out, DiscussionmembershipResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiscussionmembershipResponseCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiscussionmembershipResponseCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiscussionmembershipResponseCompound
   * @throws IOException if the JSON string is invalid with respect to DiscussionmembershipResponseCompound
   */
  public static DiscussionmembershipResponseCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscussionmembershipResponseCompound.class);
  }

  /**
   * Convert an instance of DiscussionmembershipResponseCompound to an JSON string
   *
   * @return JSON string
   */
