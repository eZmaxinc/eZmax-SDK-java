...
public class UserRequestV2 {
  ...
  public UserRequestV2 pkiUserID(@javax.annotation.Nullable Integer pkiUserID) {
  ...
  public UserRequestV2 fkiAgentID(@javax.annotation.Nullable Integer fkiAgentID) {
  ...
  public UserRequestV2 fkiBrokerID(@javax.annotation.Nullable Integer fkiBrokerID) {
  ...
  public UserRequestV2 fkiAssistantID(@javax.annotation.Nullable Integer fkiAssistantID) {
  ...
  public UserRequestV2 fkiEmployeeID(@javax.annotation.Nullable Integer fkiEmployeeID) {
  ...
  public UserRequestV2 fkiCompanyIDDefault(@javax.annotation.Nonnull Integer fkiCompanyIDDefault) {
  ...
  public UserRequestV2 fkiDepartmentIDDefault(@javax.annotation.Nonnull Integer fkiDepartmentIDDefault) {
  ...
  public UserRequestV2 fkiTimezoneID(@javax.annotation.Nonnull Integer fkiTimezoneID) {
  ...
  public UserRequestV2 fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public UserRequestV2 objEmail(@javax.annotation.Nonnull EmailRequestCompound objEmail) {
  ...
  public UserRequestV2 fkiBillingentityinternalID(@javax.annotation.Nonnull Integer fkiBillingentityinternalID) {
  ...
  public UserRequestV2 objPhoneHome(@javax.annotation.Nullable PhoneRequestCompoundV2 objPhoneHome) {
  ...
  public void setObjPhoneHome(@javax.annotation.Nullable PhoneRequestCompoundV2 objPhoneHome) {
    this.objPhoneHome = objPhoneHome;
  }


  public UserRequestV2 objPhoneSMS(@javax.annotation.Nullable PhoneRequestCompoundV2 objPhoneSMS) {
  ...
  public void setObjPhoneSMS(@javax.annotation.Nullable PhoneRequestCompoundV2 objPhoneSMS) {
    this.objPhoneSMS = objPhoneSMS;
  }


  public UserRequestV2 fkiSecretquestionID(@javax.annotation.Nullable Integer fkiSecretquestionID) {
  ...
  public UserRequestV2 sUserSecretresponse(@javax.annotation.Nullable String sUserSecretresponse) {
  ...
  public UserRequestV2 fkiModuleIDForm(@javax.annotation.Nullable Integer fkiModuleIDForm) {
  ...
  public UserRequestV2 eUserType(@javax.annotation.Nonnull FieldEUserType eUserType) {
  ...
  public UserRequestV2 eUserLogintype(@javax.annotation.Nonnull FieldEUserLogintype eUserLogintype) {
  ...
  public UserRequestV2 sUserFirstname(@javax.annotation.Nonnull String sUserFirstname) {
  ...
  public UserRequestV2 sUserLastname(@javax.annotation.Nonnull String sUserLastname) {
  ...
  public UserRequestV2 sUserLoginname(@javax.annotation.Nonnull String sUserLoginname) {
  ...
  public UserRequestV2 sUserJobtitle(@javax.annotation.Nullable String sUserJobtitle) {
  ...
  public UserRequestV2 eUserEzsignaccess(@javax.annotation.Nonnull FieldEUserEzsignaccess eUserEzsignaccess) {
  ...
  public UserRequestV2 bUserIsactive(@javax.annotation.Nonnull Boolean bUserIsactive) {
  ...
  public UserRequestV2 bUserValidatebyadministration(@javax.annotation.Nullable Boolean bUserValidatebyadministration) {
  ...
  public UserRequestV2 bUserValidatebydirector(@javax.annotation.Nullable Boolean bUserValidatebydirector) {
  ...
  public UserRequestV2 bUserAttachmentautoverified(@javax.annotation.Nullable Boolean bUserAttachmentautoverified) {
  ...
  public UserRequestV2 bUserChangepassword(@javax.annotation.Nullable Boolean bUserChangepassword) {
  ...
  public UserRequestV2 bUserEzsigntemplaterolegrouping(@javax.annotation.Nullable Boolean bUserEzsigntemplaterolegrouping) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUserID, userRequestV2.pkiUserID) &&
        ...
        Objects.equals(this.bUserEzsigntemplaterolegrouping, userRequestV2.bUserEzsigntemplaterolegrouping);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserRequestV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserRequestV2 is not found in the empty JSON string", UserRequestV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserRequestV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserRequestV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sUserSecretresponse") != null && !jsonObj.get("sUserSecretresponse").isJsonNull()) && !jsonObj.get("sUserSecretresponse").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserSecretresponse` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserSecretresponse").toString()));
      }
