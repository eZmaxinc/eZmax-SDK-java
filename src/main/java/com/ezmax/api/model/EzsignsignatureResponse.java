...
public class EzsignsignatureResponse {
  ...
  public EzsignsignatureResponse fkiPaymentgatewayID(@javax.annotation.Nullable Integer fkiPaymentgatewayID) {
  ...
  public EzsignsignatureResponse dEzsignsignatureCreditcardamount(@javax.annotation.Nullable String dEzsignsignatureCreditcardamount) {
  ...
  public EzsignsignatureResponse sEzsignsignatureCreditcardamountdescription(@javax.annotation.Nullable String sEzsignsignatureCreditcardamountdescription) {
  ...
  public EzsignsignatureResponse bEzsignsignatureCreditcardcustomamount(@javax.annotation.Nullable Boolean bEzsignsignatureCreditcardcustomamount) {
  ...
  public EzsignsignatureResponse eEzsignsignatureSignaturepad(@javax.annotation.Nullable FieldEEzsignsignatureSignaturepad eEzsignsignatureSignaturepad) {
  ...
  public EzsignsignatureResponse eEzsignsignatureSignaturepadrequired(@javax.annotation.Nullable FieldEEzsignsignatureSignaturepadrequired eEzsignsignatureSignaturepadrequired) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignsignatureID, ezsignsignatureResponse.pkiEzsignsignatureID) &&
        ...
        Objects.equals(this.fkiPaymentgatewayID, ezsignsignatureResponse.fkiPaymentgatewayID) &&
        Objects.equals(this.sCurrencyDescriptionX, ezsignsignatureResponse.sCurrencyDescriptionX) &&
        Objects.equals(this.dEzsignsignatureCreditcardamount, ezsignsignatureResponse.dEzsignsignatureCreditcardamount) &&
        Objects.equals(this.sEzsignsignatureCreditcardamountdescription, ezsignsignatureResponse.sEzsignsignatureCreditcardamountdescription) &&
        Objects.equals(this.bEzsignsignatureCreditcardcustomamount, ezsignsignatureResponse.bEzsignsignatureCreditcardcustomamount) &&
        ...
        Objects.equals(this.eEzsignsignatureSignaturepad, ezsignsignatureResponse.eEzsignsignatureSignaturepad) &&
        Objects.equals(this.eEzsignsignatureSignaturepadrequired, ezsignsignatureResponse.eEzsignsignatureSignaturepadrequired) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignatureResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignatureResponse is not found in the empty JSON string", EzsignsignatureResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignatureResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignatureResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
