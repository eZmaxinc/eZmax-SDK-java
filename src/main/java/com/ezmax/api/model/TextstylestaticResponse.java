...
public class TextstylestaticResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiTextstylestaticID, textstylestaticResponse.pkiTextstylestaticID) &&
        ...
        Objects.equals(this.bTextstylestaticStrikethrough, textstylestaticResponse.bTextstylestaticStrikethrough) &&
        Objects.equals(this.iTextstylestaticFontcolor, textstylestaticResponse.iTextstylestaticFontcolor) &&
        Objects.equals(this.iTextstylestaticSize, textstylestaticResponse.iTextstylestaticSize);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextstylestaticResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TextstylestaticResponse is not found in the empty JSON string", TextstylestaticResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextstylestaticResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TextstylestaticResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
