...
public class UsergroupexternalAutocompleteElementResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUsergroupexternalID, usergroupexternalAutocompleteElementResponse.pkiUsergroupexternalID) &&
        Objects.equals(this.sUsergroupexternalName, usergroupexternalAutocompleteElementResponse.sUsergroupexternalName) &&
        Objects.equals(this.bUsergroupexternalIsactive, usergroupexternalAutocompleteElementResponse.bUsergroupexternalIsactive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiUsergroupexternalID, sUsergroupexternalName, bUsergroupexternalIsactive);
  }
  ...
  public String toString() {
    ...
    sb.append("    bUsergroupexternalIsactive: ").append(toIndentedString(bUsergroupexternalIsactive)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiUsergroupexternalID", "sUsergroupexternalName", "bUsergroupexternalIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiUsergroupexternalID", "sUsergroupexternalName", "bUsergroupexternalIsactive"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsergroupexternalAutocompleteElementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UsergroupexternalAutocompleteElementResponse is not found in the empty JSON string", UsergroupexternalAutocompleteElementResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsergroupexternalAutocompleteElementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UsergroupexternalAutocompleteElementResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UsergroupexternalAutocompleteElementResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UsergroupexternalAutocompleteElementResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UsergroupexternalAutocompleteElementResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UsergroupexternalAutocompleteElementResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UsergroupexternalAutocompleteElementResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UsergroupexternalAutocompleteElementResponse>() {
           @Override
           public void write(JsonWriter out, UsergroupexternalAutocompleteElementResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UsergroupexternalAutocompleteElementResponse read(JsonReader in) throws IOException {
