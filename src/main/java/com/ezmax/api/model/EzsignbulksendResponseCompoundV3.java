...
public class EzsignbulksendResponseCompoundV3 {
  ...
  public EzsignbulksendResponseCompoundV3() {
  }

  public EzsignbulksendResponseCompoundV3 pkiEzsignbulksendID(@javax.annotation.Nonnull Integer pkiEzsignbulksendID) {
  ...
  public EzsignbulksendResponseCompoundV3 fkiEzsignfoldertypeID(@javax.annotation.Nonnull Integer fkiEzsignfoldertypeID) {
  ...
  public EzsignbulksendResponseCompoundV3 fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public EzsignbulksendResponseCompoundV3 sLanguageNameX(@javax.annotation.Nonnull String sLanguageNameX) {
  ...
  public EzsignbulksendResponseCompoundV3 eEzsignbulksendEzsignformfieldorder(@javax.annotation.Nonnull FieldEEzsignbulksendEzsignformfieldorder eEzsignbulksendEzsignformfieldorder) {
  ...
  public EzsignbulksendResponseCompoundV3 eEzsignfoldertypePrivacylevel(@javax.annotation.Nonnull FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel) {
  ...
  public EzsignbulksendResponseCompoundV3 sEzsignfoldertypeNameX(@javax.annotation.Nonnull String sEzsignfoldertypeNameX) {
  ...
  public EzsignbulksendResponseCompoundV3 sEzsignbulksendDescription(@javax.annotation.Nonnull String sEzsignbulksendDescription) {
  ...
  public EzsignbulksendResponseCompoundV3 tEzsignbulksendNote(@javax.annotation.Nonnull String tEzsignbulksendNote) {
  ...
  public EzsignbulksendResponseCompoundV3 bEzsignbulksendNeedvalidation(@javax.annotation.Nonnull Boolean bEzsignbulksendNeedvalidation) {
  ...
  public EzsignbulksendResponseCompoundV3 bEzsignbulksendIsactive(@javax.annotation.Nonnull Boolean bEzsignbulksendIsactive) {
  ...
  public EzsignbulksendResponseCompoundV3 objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  public EzsignbulksendResponseCompoundV3 aObjEzsignbulksenddocumentmapping(@javax.annotation.Nonnull List<EzsignbulksenddocumentmappingResponseCompound> aObjEzsignbulksenddocumentmapping) {
    this.aObjEzsignbulksenddocumentmapping = aObjEzsignbulksenddocumentmapping;
    return this;
  }

  public EzsignbulksendResponseCompoundV3 addAObjEzsignbulksenddocumentmappingItem(EzsignbulksenddocumentmappingResponseCompound aObjEzsignbulksenddocumentmappingItem) {
  ...
  public EzsignbulksendResponseCompoundV3 aObjEzsignbulksendsignermapping(@javax.annotation.Nonnull List<EzsignbulksendsignermappingResponse> aObjEzsignbulksendsignermapping) {
    this.aObjEzsignbulksendsignermapping = aObjEzsignbulksendsignermapping;
    return this;
  }

  public EzsignbulksendResponseCompoundV3 addAObjEzsignbulksendsignermappingItem(EzsignbulksendsignermappingResponse aObjEzsignbulksendsignermappingItem) {
  ...
  public boolean equals(Object o) {
    ...
    EzsignbulksendResponseCompoundV3 ezsignbulksendResponseCompoundV3 = (EzsignbulksendResponseCompoundV3) o;
    return Objects.equals(this.pkiEzsignbulksendID, ezsignbulksendResponseCompoundV3.pkiEzsignbulksendID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsignbulksendResponseCompoundV3.fkiEzsignfoldertypeID) &&
        Objects.equals(this.fkiLanguageID, ezsignbulksendResponseCompoundV3.fkiLanguageID) &&
        Objects.equals(this.sLanguageNameX, ezsignbulksendResponseCompoundV3.sLanguageNameX) &&
        Objects.equals(this.eEzsignbulksendEzsignformfieldorder, ezsignbulksendResponseCompoundV3.eEzsignbulksendEzsignformfieldorder) &&
        Objects.equals(this.eEzsignfoldertypePrivacylevel, ezsignbulksendResponseCompoundV3.eEzsignfoldertypePrivacylevel) &&
        Objects.equals(this.sEzsignfoldertypeNameX, ezsignbulksendResponseCompoundV3.sEzsignfoldertypeNameX) &&
        Objects.equals(this.sEzsignbulksendDescription, ezsignbulksendResponseCompoundV3.sEzsignbulksendDescription) &&
        Objects.equals(this.tEzsignbulksendNote, ezsignbulksendResponseCompoundV3.tEzsignbulksendNote) &&
        Objects.equals(this.bEzsignbulksendNeedvalidation, ezsignbulksendResponseCompoundV3.bEzsignbulksendNeedvalidation) &&
        Objects.equals(this.bEzsignbulksendIsactive, ezsignbulksendResponseCompoundV3.bEzsignbulksendIsactive) &&
        Objects.equals(this.objAudit, ezsignbulksendResponseCompoundV3.objAudit) &&
        Objects.equals(this.aObjEzsignbulksenddocumentmapping, ezsignbulksendResponseCompoundV3.aObjEzsignbulksenddocumentmapping) &&
        Objects.equals(this.aObjEzsignbulksendsignermapping, ezsignbulksendResponseCompoundV3.aObjEzsignbulksendsignermapping);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignbulksendResponseCompoundV3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksendResponseCompoundV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsignbulksendResponseCompoundV3 is not found in the empty JSON string", EzsignbulksendResponseCompoundV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksendResponseCompoundV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignbulksendResponseCompoundV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignbulksendResponseCompoundV3.openapiRequiredFields) {
      ...
      if (!jsonObj.get("a_objEzsignbulksenddocumentmapping").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objEzsignbulksenddocumentmapping` to be an array in the JSON string but got `%s`", jsonObj.get("a_objEzsignbulksenddocumentmapping").toString()));
      }
      ...
      if (!jsonObj.get("a_objEzsignbulksendsignermapping").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objEzsignbulksendsignermapping` to be an array in the JSON string but got `%s`", jsonObj.get("a_objEzsignbulksendsignermapping").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignbulksendResponseCompoundV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignbulksendResponseCompoundV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignbulksendResponseCompoundV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignbulksendResponseCompoundV3.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignbulksendResponseCompoundV3>() {
           @Override
           public void write(JsonWriter out, EzsignbulksendResponseCompoundV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignbulksendResponseCompoundV3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsignbulksendResponseCompoundV3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignbulksendResponseCompoundV3
   * @throws IOException if the JSON string is invalid with respect to EzsignbulksendResponseCompoundV3
   */
  public static EzsignbulksendResponseCompoundV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignbulksendResponseCompoundV3.class);
  }

  /**
   * Convert an instance of EzsignbulksendResponseCompoundV3 to an JSON string
   *
   * @return JSON string
   */
