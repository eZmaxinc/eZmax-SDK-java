...
public class EzsignsignatureRequestCompoundV2 {
  ...
  public EzsignsignatureRequestCompoundV2 fkiPaymentgatewayID(@javax.annotation.Nullable Integer fkiPaymentgatewayID) {
  ...
  public EzsignsignatureRequestCompoundV2 eEzsignsignatureSignaturepad(@javax.annotation.Nullable FieldEEzsignsignatureSignaturepad eEzsignsignatureSignaturepad) {
  ...
  public EzsignsignatureRequestCompoundV2 eEzsignsignatureSignaturepadrequired(@javax.annotation.Nullable FieldEEzsignsignatureSignaturepadrequired eEzsignsignatureSignaturepadrequired) {
  ...
  public EzsignsignatureRequestCompoundV2 sEzsignsignatureCreditcardamountdescription(@javax.annotation.Nullable String sEzsignsignatureCreditcardamountdescription) {
  ...
  public EzsignsignatureRequestCompoundV2 dEzsignsignatureCreditcardamount(@javax.annotation.Nullable String dEzsignsignatureCreditcardamount) {
  ...
  public EzsignsignatureRequestCompoundV2 bEzsignsignatureCreditcardcustomamount(@javax.annotation.Nullable Boolean bEzsignsignatureCreditcardcustomamount) {
  ...
  public EzsignsignatureRequestCompoundV2 aObjEzsignsignaturepaymentdetail(@javax.annotation.Nullable List<EzsignsignaturepaymentdetailRequestCompound> aObjEzsignsignaturepaymentdetail) {
    this.aObjEzsignsignaturepaymentdetail = aObjEzsignsignaturepaymentdetail;
    return this;
  }

  public EzsignsignatureRequestCompoundV2 addAObjEzsignsignaturepaymentdetailItem(EzsignsignaturepaymentdetailRequestCompound aObjEzsignsignaturepaymentdetailItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignsignatureID, ezsignsignatureRequestCompoundV2.pkiEzsignsignatureID) &&
        ...
        Objects.equals(this.fkiPaymentgatewayID, ezsignsignatureRequestCompoundV2.fkiPaymentgatewayID) &&
        ...
        Objects.equals(this.eEzsignsignatureSignaturepad, ezsignsignatureRequestCompoundV2.eEzsignsignatureSignaturepad) &&
        Objects.equals(this.eEzsignsignatureSignaturepadrequired, ezsignsignatureRequestCompoundV2.eEzsignsignatureSignaturepadrequired) &&
        ...
        Objects.equals(this.sEzsignsignatureCreditcardamountdescription, ezsignsignatureRequestCompoundV2.sEzsignsignatureCreditcardamountdescription) &&
        Objects.equals(this.dEzsignsignatureCreditcardamount, ezsignsignatureRequestCompoundV2.dEzsignsignatureCreditcardamount) &&
        Objects.equals(this.bEzsignsignatureCreditcardcustomamount, ezsignsignatureRequestCompoundV2.bEzsignsignatureCreditcardcustomamount) &&
        ...
        Objects.equals(this.aObjEzsignsignaturepaymentdetail, ezsignsignatureRequestCompoundV2.aObjEzsignsignaturepaymentdetail);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignatureRequestCompoundV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignatureRequestCompoundV2 is not found in the empty JSON string", EzsignsignatureRequestCompoundV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignatureRequestCompoundV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignatureRequestCompoundV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
