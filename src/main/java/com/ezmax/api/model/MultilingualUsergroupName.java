...
public class MultilingualUsergroupName {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sUsergroupName1", "sUsergroupName2"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MultilingualUsergroupName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MultilingualUsergroupName is not found in the empty JSON string", MultilingualUsergroupName.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultilingualUsergroupName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MultilingualUsergroupName` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sUsergroupName1") != null && !jsonObj.get("sUsergroupName1").isJsonNull()) && !jsonObj.get("sUsergroupName1").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUsergroupName1` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUsergroupName1").toString()));
      }
      if ((jsonObj.get("sUsergroupName2") != null && !jsonObj.get("sUsergroupName2").isJsonNull()) && !jsonObj.get("sUsergroupName2").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUsergroupName2` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUsergroupName2").toString()));
      }
  }
