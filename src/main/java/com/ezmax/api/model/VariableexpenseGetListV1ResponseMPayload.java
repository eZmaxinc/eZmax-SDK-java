...
public class VariableexpenseGetListV1ResponseMPayload {
  ...
  public VariableexpenseGetListV1ResponseMPayload iRowReturned(@javax.annotation.Nonnull Integer iRowReturned) {
  ...
  public VariableexpenseGetListV1ResponseMPayload iRowFiltered(@javax.annotation.Nonnull Integer iRowFiltered) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objVariableexpense"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objVariableexpense"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableexpenseGetListV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariableexpenseGetListV1ResponseMPayload is not found in the empty JSON string", VariableexpenseGetListV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariableexpenseGetListV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VariableexpenseGetListV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
