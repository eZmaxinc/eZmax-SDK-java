...
public class GlobalEzmaxclientVersionV1Response {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sEzmaxclientVersion", "sEzmaxclientOslatestversion"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sEzmaxclientVersion", "sEzmaxclientOslatestversion"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GlobalEzmaxclientVersionV1Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GlobalEzmaxclientVersionV1Response is not found in the empty JSON string", GlobalEzmaxclientVersionV1Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GlobalEzmaxclientVersionV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GlobalEzmaxclientVersionV1Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sEzmaxclientVersion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzmaxclientVersion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzmaxclientVersion").toString()));
      }
      if (!jsonObj.get("sEzmaxclientOslatestversion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzmaxclientOslatestversion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzmaxclientOslatestversion").toString()));
      }
  }
