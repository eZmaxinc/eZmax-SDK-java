...
public class EzsigntemplateglobalsignerResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplateglobalsignerID, ezsigntemplateglobalsignerResponse.pkiEzsigntemplateglobalsignerID) &&
        Objects.equals(this.fkiEzsigntemplateglobalID, ezsigntemplateglobalsignerResponse.fkiEzsigntemplateglobalID) &&
        Objects.equals(this.sEzsigntemplateglobalsignerDescription, ezsigntemplateglobalsignerResponse.sEzsigntemplateglobalsignerDescription);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplateglobalsignerID", "fkiEzsigntemplateglobalID", "sEzsigntemplateglobalsignerDescription"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplateglobalsignerID", "fkiEzsigntemplateglobalID", "sEzsigntemplateglobalsignerDescription"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplateglobalsignerResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateglobalsignerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplateglobalsignerResponse is not found in the empty JSON string", EzsigntemplateglobalsignerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateglobalsignerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateglobalsignerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sEzsigntemplateglobalsignerDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsigntemplateglobalsignerDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateglobalsignerDescription").toString()));
      }
  }
   ...
   * @return An instance of EzsigntemplateglobalsignerResponse
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplateglobalsignerResponse
   */
  public static EzsigntemplateglobalsignerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplateglobalsignerResponse.class);
  }

  /**
   * Convert an instance of EzsigntemplateglobalsignerResponse to an JSON string
   *
   * @return JSON string
   */
