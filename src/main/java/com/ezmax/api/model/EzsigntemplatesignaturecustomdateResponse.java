...
public class EzsigntemplatesignaturecustomdateResponse {
  ...
  public EzsigntemplatesignaturecustomdateResponse() {
  }

  public EzsigntemplatesignaturecustomdateResponse pkiEzsigntemplatesignaturecustomdateID(@javax.annotation.Nonnull Integer pkiEzsigntemplatesignaturecustomdateID) {
  ...
  @Deprecated
  public EzsigntemplatesignaturecustomdateResponse iEzsigntemplatesignaturecustomdateX(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateX) {
  ...
  @Deprecated
  public EzsigntemplatesignaturecustomdateResponse iEzsigntemplatesignaturecustomdateY(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateY) {
  ...
  public EzsigntemplatesignaturecustomdateResponse iEzsigntemplatesignaturecustomdateOffsetx(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateOffsetx) {
  ...
  public EzsigntemplatesignaturecustomdateResponse iEzsigntemplatesignaturecustomdateOffsety(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateOffsety) {
  ...
  public EzsigntemplatesignaturecustomdateResponse sEzsigntemplatesignaturecustomdateFormat(@javax.annotation.Nonnull String sEzsigntemplatesignaturecustomdateFormat) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplatesignaturecustomdateID, ezsigntemplatesignaturecustomdateResponse.pkiEzsigntemplatesignaturecustomdateID) &&
        Objects.equals(this.iEzsigntemplatesignaturecustomdateX, ezsigntemplatesignaturecustomdateResponse.iEzsigntemplatesignaturecustomdateX) &&
        Objects.equals(this.iEzsigntemplatesignaturecustomdateY, ezsigntemplatesignaturecustomdateResponse.iEzsigntemplatesignaturecustomdateY) &&
        Objects.equals(this.iEzsigntemplatesignaturecustomdateOffsetx, ezsigntemplatesignaturecustomdateResponse.iEzsigntemplatesignaturecustomdateOffsetx) &&
        Objects.equals(this.iEzsigntemplatesignaturecustomdateOffsety, ezsigntemplatesignaturecustomdateResponse.iEzsigntemplatesignaturecustomdateOffsety) &&
        Objects.equals(this.sEzsigntemplatesignaturecustomdateFormat, ezsigntemplatesignaturecustomdateResponse.sEzsigntemplatesignaturecustomdateFormat);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatesignaturecustomdateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatesignaturecustomdateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatesignaturecustomdateResponse is not found in the empty JSON string", EzsigntemplatesignaturecustomdateResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatesignaturecustomdateResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatesignaturecustomdateResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplatesignaturecustomdateResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatesignaturecustomdateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatesignaturecustomdateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatesignaturecustomdateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatesignaturecustomdateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatesignaturecustomdateResponse>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatesignaturecustomdateResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplatesignaturecustomdateResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplatesignaturecustomdateResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplatesignaturecustomdateResponse
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplatesignaturecustomdateResponse
   */
  public static EzsigntemplatesignaturecustomdateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplatesignaturecustomdateResponse.class);
  }

  /**
   * Convert an instance of EzsigntemplatesignaturecustomdateResponse to an JSON string
   *
   * @return JSON string
   */
