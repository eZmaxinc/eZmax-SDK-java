...
public class WebhookEzsignFolderSent {
  ...
  public WebhookEzsignFolderSent() {
  }

  public WebhookEzsignFolderSent objWebhook(@javax.annotation.Nonnull CustomWebhookResponse objWebhook) {
  ...
  public WebhookEzsignFolderSent aObjAttempt(@javax.annotation.Nonnull List<AttemptResponseCompound> aObjAttempt) {
    this.aObjAttempt = aObjAttempt;
    return this;
  }

  public WebhookEzsignFolderSent addAObjAttemptItem(AttemptResponseCompound aObjAttemptItem) {
  ...
  public WebhookEzsignFolderSent objEzsignfolder(@javax.annotation.Nonnull EzsignfolderResponse objEzsignfolder) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookEzsignFolderSent webhookEzsignFolderSent = (WebhookEzsignFolderSent) o;
    return Objects.equals(this.objWebhook, webhookEzsignFolderSent.objWebhook) &&
        Objects.equals(this.aObjAttempt, webhookEzsignFolderSent.aObjAttempt) &&
        Objects.equals(this.objEzsignfolder, webhookEzsignFolderSent.objEzsignfolder);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEzsignFolderSent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookEzsignFolderSent is not found in the empty JSON string", WebhookEzsignFolderSent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookEzsignFolderSent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookEzsignFolderSent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookEzsignFolderSent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookEzsignFolderSent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookEzsignFolderSent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookEzsignFolderSent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookEzsignFolderSent.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookEzsignFolderSent>() {
           @Override
           public void write(JsonWriter out, WebhookEzsignFolderSent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookEzsignFolderSent read(JsonReader in) throws IOException {
