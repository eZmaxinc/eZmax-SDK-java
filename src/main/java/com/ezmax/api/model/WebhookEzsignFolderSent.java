...
public class WebhookEzsignFolderSent {
  ...
  public WebhookEzsignFolderSent objWebhook(CustomWebhookResponse objWebhook) {
  ...
  public WebhookEzsignFolderSent aObjAttempt(List<AttemptResponseCompound> aObjAttempt) {
  ...
  public WebhookEzsignFolderSent objEzsignfolder(EzsignfolderResponse objEzsignfolder) {
