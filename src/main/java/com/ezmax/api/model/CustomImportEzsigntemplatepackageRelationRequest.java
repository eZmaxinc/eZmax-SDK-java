...
public class CustomImportEzsigntemplatepackageRelationRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomImportEzsigntemplatepackageRelationRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomImportEzsigntemplatepackageRelationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomImportEzsigntemplatepackageRelationRequest is not found in the empty JSON string", CustomImportEzsigntemplatepackageRelationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomImportEzsigntemplatepackageRelationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomImportEzsigntemplatepackageRelationRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
