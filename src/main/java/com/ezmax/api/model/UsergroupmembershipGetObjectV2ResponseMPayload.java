...
public class UsergroupmembershipGetObjectV2ResponseMPayload {
  ...
  public UsergroupmembershipGetObjectV2ResponseMPayload objUsergroupmembership(UsergroupmembershipResponseCompound objUsergroupmembership) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsergroupmembershipGetObjectV2ResponseMPayload
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsergroupmembershipGetObjectV2ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UsergroupmembershipGetObjectV2ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsergroupmembershipGetObjectV2ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      UsergroupmembershipResponseCompound.validateJsonObject(jsonObj.getAsJsonObject("objUsergroupmembership"));
  }
