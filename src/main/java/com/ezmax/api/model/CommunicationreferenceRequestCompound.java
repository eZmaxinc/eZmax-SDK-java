...
public class CommunicationreferenceRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiCommunicationreferenceID", "fkiBuyercontractID", "fkiEzsignfolderID", "fkiInscriptionID", "fkiInscriptiontempID", "fkiInvoiceID", "fkiOtherincomeID", "fkiElectronicfundstransferID", "fkiRejectedoffertopurchaseID"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationreferenceRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommunicationreferenceRequestCompound is not found in the empty JSON string", CommunicationreferenceRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommunicationreferenceRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommunicationreferenceRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
