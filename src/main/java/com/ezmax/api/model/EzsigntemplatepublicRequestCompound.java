...
public class EzsigntemplatepublicRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatepublicID", "fkiEzsignfoldertypeID", "fkiUserlogintypeID", "fkiEzsigntemplateID", "fkiEzsigntemplatepackageID", "sEzsigntemplatepublicDescription", "bEzsigntemplatepublicIsactive", "tEzsigntemplatepublicNote", "eEzsigntemplatepublicLimittype", "iEzsigntemplatepublicLimit"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiEzsignfoldertypeID", "fkiUserlogintypeID", "sEzsigntemplatepublicDescription", "bEzsigntemplatepublicIsactive", "tEzsigntemplatepublicNote", "eEzsigntemplatepublicLimittype", "iEzsigntemplatepublicLimit"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatepublicRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatepublicRequestCompound is not found in the empty JSON string", EzsigntemplatepublicRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatepublicRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatepublicRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
