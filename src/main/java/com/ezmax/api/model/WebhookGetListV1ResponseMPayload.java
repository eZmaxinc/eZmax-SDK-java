...
public class WebhookGetListV1ResponseMPayload {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objWebhook"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objWebhook"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookGetListV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookGetListV1ResponseMPayload is not found in the empty JSON string", WebhookGetListV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookGetListV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookGetListV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookGetListV1ResponseMPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookGetListV1ResponseMPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookGetListV1ResponseMPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookGetListV1ResponseMPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookGetListV1ResponseMPayload>() {
           @Override
           public void write(JsonWriter out, WebhookGetListV1ResponseMPayload value) throws IOException {
  ...
  /**
   * Create an instance of WebhookGetListV1ResponseMPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookGetListV1ResponseMPayload
   * @throws IOException if the JSON string is invalid with respect to WebhookGetListV1ResponseMPayload
   */
  public static WebhookGetListV1ResponseMPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookGetListV1ResponseMPayload.class);
  }

  /**
   * Convert an instance of WebhookGetListV1ResponseMPayload to an JSON string
   *
   * @return JSON string
   */
