...
public class ClonehistoryListElement {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiClonehistoryID", "fkiUserIDCloning", "fkiUserIDCloned", "dtClonehistoryFirsthit", "dtClonehistoryLasthit", "sUserLoginnameCloning", "sUserFirstnameCloning", "sUserLastnameCloning", "sUserLoginnameCloned", "sUserFirstnameCloned", "sUserLastnameCloned"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiClonehistoryID", "fkiUserIDCloning", "fkiUserIDCloned", "dtClonehistoryFirsthit", "sUserLoginnameCloning", "sUserFirstnameCloning", "sUserLastnameCloning", "sUserLoginnameCloned", "sUserFirstnameCloned", "sUserLastnameCloned"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClonehistoryListElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ClonehistoryListElement is not found in the empty JSON string", ClonehistoryListElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ClonehistoryListElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ClonehistoryListElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("dtClonehistoryFirsthit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtClonehistoryFirsthit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtClonehistoryFirsthit").toString()));
      }
      if ((jsonObj.get("dtClonehistoryLasthit") != null && !jsonObj.get("dtClonehistoryLasthit").isJsonNull()) && !jsonObj.get("dtClonehistoryLasthit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtClonehistoryLasthit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtClonehistoryLasthit").toString()));
      }
      if (!jsonObj.get("sUserLoginnameCloning").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserLoginnameCloning` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserLoginnameCloning").toString()));
      }
      if (!jsonObj.get("sUserFirstnameCloning").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserFirstnameCloning` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserFirstnameCloning").toString()));
      }
      if (!jsonObj.get("sUserLastnameCloning").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserLastnameCloning` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserLastnameCloning").toString()));
      }
      if (!jsonObj.get("sUserLoginnameCloned").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserLoginnameCloned` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserLoginnameCloned").toString()));
      }
      if (!jsonObj.get("sUserFirstnameCloned").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserFirstnameCloned` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserFirstnameCloned").toString()));
      }
      if (!jsonObj.get("sUserLastnameCloned").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserLastnameCloned` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserLastnameCloned").toString()));
      }
  }
