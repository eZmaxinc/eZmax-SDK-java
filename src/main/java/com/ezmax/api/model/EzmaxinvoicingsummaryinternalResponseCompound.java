  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzmaxinvoicingsummaryinternalResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzmaxinvoicingsummaryinternalResponseCompound is not found in the empty JSON string", EzmaxinvoicingsummaryinternalResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzmaxinvoicingsummaryinternalResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzmaxinvoicingsummaryinternalResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("a_objEzmaxinvoicingsummaryinternaldetail").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objEzmaxinvoicingsummaryinternaldetail` to be an array in the JSON string but got `%s`", jsonObj.get("a_objEzmaxinvoicingsummaryinternaldetail").toString()));
      }
