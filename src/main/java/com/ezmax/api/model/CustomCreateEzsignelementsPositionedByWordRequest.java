  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomCreateEzsignelementsPositionedByWordRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomCreateEzsignelementsPositionedByWordRequest is not found in the empty JSON string", CustomCreateEzsignelementsPositionedByWordRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomCreateEzsignelementsPositionedByWordRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomCreateEzsignelementsPositionedByWordRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sCreateezsignelementspositionedbywordPattern").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sCreateezsignelementspositionedbywordPattern` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCreateezsignelementspositionedbywordPattern").toString()));
      }
      if (!jsonObj.get("eCreateezsignelementspositionedbywordOccurance").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `eCreateezsignelementspositionedbywordOccurance` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eCreateezsignelementspositionedbywordOccurance").toString()));
      }
