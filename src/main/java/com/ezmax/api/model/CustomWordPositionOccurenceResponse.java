...
public class CustomWordPositionOccurenceResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iPage", "iX", "iY"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomWordPositionOccurenceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomWordPositionOccurenceResponse is not found in the empty JSON string", CustomWordPositionOccurenceResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomWordPositionOccurenceResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomWordPositionOccurenceResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
