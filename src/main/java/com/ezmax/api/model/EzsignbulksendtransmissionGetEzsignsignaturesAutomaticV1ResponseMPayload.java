...
public class EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload {
  ...
  public EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload aEEzsignsignatureType(@javax.annotation.Nonnull Set<FieldEEzsignsignatureType> aEEzsignsignatureType) {
  ...
  public EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload aObjEzsignfolder(@javax.annotation.Nonnull List<CustomEzsignfolderEzsignsignaturesAutomaticResponse> aObjEzsignfolder) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload is not found in the empty JSON string", EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
