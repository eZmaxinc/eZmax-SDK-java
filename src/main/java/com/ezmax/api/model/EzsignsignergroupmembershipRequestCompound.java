...
public class EzsignsignergroupmembershipRequestCompound {
  ...
  public EzsignsignergroupmembershipRequestCompound pkiEzsignsignergroupmembershipID(@javax.annotation.Nullable Integer pkiEzsignsignergroupmembershipID) {
  ...
  public EzsignsignergroupmembershipRequestCompound fkiEzsignsignergroupID(@javax.annotation.Nonnull Integer fkiEzsignsignergroupID) {
  ...
  public EzsignsignergroupmembershipRequestCompound fkiEzsignsignerID(@javax.annotation.Nullable Integer fkiEzsignsignerID) {
  ...
  public EzsignsignergroupmembershipRequestCompound fkiUserID(@javax.annotation.Nullable Integer fkiUserID) {
  ...
  public EzsignsignergroupmembershipRequestCompound fkiUsergroupID(@javax.annotation.Nullable Integer fkiUsergroupID) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignergroupmembershipRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignergroupmembershipRequestCompound is not found in the empty JSON string", EzsignsignergroupmembershipRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignergroupmembershipRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignergroupmembershipRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
