...
public class CustomContactNameResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sContactFirstname", "sContactLastname", "sContactCompany"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomContactNameResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomContactNameResponse is not found in the empty JSON string", CustomContactNameResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomContactNameResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomContactNameResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
