...
public class BrandingResponseCompoundV3 {
  ...
  public BrandingResponseCompoundV3 fkiDomainID(@javax.annotation.Nullable Integer fkiDomainID) {
  ...
  public BrandingResponseCompoundV3 sDomainName(@javax.annotation.Nullable String sDomainName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiBrandingID, brandingResponseCompoundV3.pkiBrandingID) &&
        Objects.equals(this.fkiDomainID, brandingResponseCompoundV3.fkiDomainID) &&
        Objects.equals(this.sDomainName, brandingResponseCompoundV3.sDomainName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiBrandingID, fkiDomainID, sDomainName, fkiEmailID, objBrandingDescription, sBrandingDescriptionX, sBrandingName, sEmailAddress, eBrandingLogo, eBrandingAlignlogo, iBrandingColor, bBrandingIsactive, sBrandingLogourl, sBrandingLogoemailurl, sBrandingLogointerfaceurl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiBrandingID", "fkiDomainID", "sDomainName", "fkiEmailID", "objBrandingDescription", "sBrandingDescriptionX", "sBrandingName", "sEmailAddress", "eBrandingLogo", "eBrandingAlignlogo", "iBrandingColor", "bBrandingIsactive", "sBrandingLogourl", "sBrandingLogoemailurl", "sBrandingLogointerfaceurl"));
