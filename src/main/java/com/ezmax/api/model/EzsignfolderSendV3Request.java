...
public class EzsignfolderSendV3Request {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("tEzsignfolderMessage", "eEzsignfolderMessageorder", "dtEzsignfolderDelayedsenddate", "a_fkiEzsignfoldersignerassociationID"));
