  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignerRequestCompoundContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsignsignerRequestCompoundContact is not found in the empty JSON string", EzsignsignerRequestCompoundContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignerRequestCompoundContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignerRequestCompoundContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sPhoneExtension") != null && !jsonObj.get("sPhoneExtension").isJsonNull()) && !jsonObj.get("sPhoneExtension").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sPhoneExtension` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sPhoneExtension").toString()));
      }
      if ((jsonObj.get("sPhoneE164Cell") != null && !jsonObj.get("sPhoneE164Cell").isJsonNull()) && !jsonObj.get("sPhoneE164Cell").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sPhoneE164Cell` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sPhoneE164Cell").toString()));
      }
      if ((jsonObj.get("sPhoneNumber") != null && !jsonObj.get("sPhoneNumber").isJsonNull()) && !jsonObj.get("sPhoneNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sPhoneNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sPhoneNumber").toString()));
      }
      if ((jsonObj.get("sPhoneNumberCell") != null && !jsonObj.get("sPhoneNumberCell").isJsonNull()) && !jsonObj.get("sPhoneNumberCell").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sPhoneNumberCell` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sPhoneNumberCell").toString()));
      }
  }
