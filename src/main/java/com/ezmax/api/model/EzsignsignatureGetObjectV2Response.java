...
public class EzsignsignatureGetObjectV2Response {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objDebugPayload, ezsignsignatureGetObjectV2Response.objDebugPayload) &&
        Objects.equals(this.objDebug, ezsignsignatureGetObjectV2Response.objDebug) &&
        Objects.equals(this.mPayload, ezsignsignatureGetObjectV2Response.mPayload);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EzsignsignatureGetObjectV2Response
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignatureGetObjectV2Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignatureGetObjectV2Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignsignatureGetObjectV2Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      EzsignsignatureGetObjectV2ResponseMPayload.validateJsonElement(jsonObj.get("mPayload"));
  }
