...
public class DiscussionmessageResponse {
  ...
  public DiscussionmessageResponse pkiDiscussionmessageID(@javax.annotation.Nonnull Integer pkiDiscussionmessageID) {
  ...
  public DiscussionmessageResponse fkiDiscussionID(@javax.annotation.Nonnull Integer fkiDiscussionID) {
  ...
  public DiscussionmessageResponse fkiDiscussionmembershipID(@javax.annotation.Nullable Integer fkiDiscussionmembershipID) {
  ...
  public DiscussionmessageResponse fkiDiscussionmembershipIDActionrequired(@javax.annotation.Nullable Integer fkiDiscussionmembershipIDActionrequired) {
  ...
  public DiscussionmessageResponse eDiscussionmessageStatus(@javax.annotation.Nonnull FieldEDiscussionmessageStatus eDiscussionmessageStatus) {
  ...
  public DiscussionmessageResponse tDiscussionmessageContent(@javax.annotation.Nonnull String tDiscussionmessageContent) {
  ...
  public DiscussionmessageResponse sDiscussionmessageCreatorname(@javax.annotation.Nonnull String sDiscussionmessageCreatorname) {
  ...
  public DiscussionmessageResponse sDiscussionmessageActionrequiredname(@javax.annotation.Nullable String sDiscussionmessageActionrequiredname) {
  ...
  public DiscussionmessageResponse objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiDiscussionmessageID, discussionmessageResponse.pkiDiscussionmessageID) &&
        Objects.equals(this.fkiDiscussionID, discussionmessageResponse.fkiDiscussionID) &&
        Objects.equals(this.fkiDiscussionmembershipID, discussionmessageResponse.fkiDiscussionmembershipID) &&
        Objects.equals(this.fkiDiscussionmembershipIDActionrequired, discussionmessageResponse.fkiDiscussionmembershipIDActionrequired) &&
        Objects.equals(this.eDiscussionmessageStatus, discussionmessageResponse.eDiscussionmessageStatus) &&
        Objects.equals(this.tDiscussionmessageContent, discussionmessageResponse.tDiscussionmessageContent) &&
        Objects.equals(this.sDiscussionmessageCreatorname, discussionmessageResponse.sDiscussionmessageCreatorname) &&
        Objects.equals(this.sDiscussionmessageActionrequiredname, discussionmessageResponse.sDiscussionmessageActionrequiredname) &&
        Objects.equals(this.objAudit, discussionmessageResponse.objAudit);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiscussionmessageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiscussionmessageResponse is not found in the empty JSON string", DiscussionmessageResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiscussionmessageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DiscussionmessageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscussionmessageResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscussionmessageResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscussionmessageResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscussionmessageResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscussionmessageResponse>() {
           @Override
           public void write(JsonWriter out, DiscussionmessageResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiscussionmessageResponse read(JsonReader in) throws IOException {
