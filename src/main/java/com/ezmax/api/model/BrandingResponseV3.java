...
public class BrandingResponseV3 {
  ...
  public BrandingResponseV3 fkiDomainID(@javax.annotation.Nullable Integer fkiDomainID) {
  ...
  public BrandingResponseV3 sDomainName(@javax.annotation.Nullable String sDomainName) {
  ...
  public void setsDomainName(@javax.annotation.Nullable String sDomainName) {
    this.sDomainName = sDomainName;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiBrandingID, brandingResponseV3.pkiBrandingID) &&
        Objects.equals(this.fkiDomainID, brandingResponseV3.fkiDomainID) &&
        Objects.equals(this.sDomainName, brandingResponseV3.sDomainName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiBrandingID, fkiDomainID, sDomainName, fkiEmailID, objBrandingDescription, sBrandingDescriptionX, sBrandingName, sEmailAddress, eBrandingLogo, eBrandingAlignlogo, iBrandingColor, bBrandingIsactive);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiBrandingID", "fkiDomainID", "sDomainName", "fkiEmailID", "objBrandingDescription", "sBrandingDescriptionX", "sBrandingName", "sEmailAddress", "eBrandingLogo", "eBrandingAlignlogo", "iBrandingColor", "bBrandingIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiBrandingID", "objBrandingDescription", "sBrandingDescriptionX", "eBrandingLogo", "eBrandingAlignlogo", "iBrandingColor", "bBrandingIsactive"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BrandingResponseV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BrandingResponseV3 is not found in the empty JSON string", BrandingResponseV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BrandingResponseV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BrandingResponseV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
