...
public class EzsignfoldertypeResponse {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendattachmentreceivecopy(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendattachmentreceivecopy) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfoldertypeID, ezsignfoldertypeResponse.pkiEzsignfoldertypeID) &&
        ...
        Objects.equals(this.bEzsignfoldertypeSendattachmentreceivecopy, ezsignfoldertypeResponse.bEzsignfoldertypeSendattachmentreceivecopy) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignfoldertypeResponse is not found in the empty JSON string", EzsignfoldertypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignfoldertypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
