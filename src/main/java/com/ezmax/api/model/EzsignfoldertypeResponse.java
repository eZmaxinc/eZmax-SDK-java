...
public class EzsignfoldertypeResponse {
  ...
  public EzsignfoldertypeResponse pkiEzsignfoldertypeID(@javax.annotation.Nonnull Integer pkiEzsignfoldertypeID) {
  ...
  public EzsignfoldertypeResponse objEzsignfoldertypeName(@javax.annotation.Nonnull MultilingualEzsignfoldertypeName objEzsignfoldertypeName) {
  ...
  public EzsignfoldertypeResponse fkiBrandingID(@javax.annotation.Nonnull Integer fkiBrandingID) {
  ...
  public EzsignfoldertypeResponse fkiBillingentityinternalID(@javax.annotation.Nullable Integer fkiBillingentityinternalID) {
  ...
  public EzsignfoldertypeResponse fkiUsergroupID(@javax.annotation.Nullable Integer fkiUsergroupID) {
  ...
  public EzsignfoldertypeResponse fkiUsergroupIDRestricted(@javax.annotation.Nullable Integer fkiUsergroupIDRestricted) {
  ...
  public EzsignfoldertypeResponse fkiEzsigntsarequirementID(@javax.annotation.Nullable Integer fkiEzsigntsarequirementID) {
  ...
  public EzsignfoldertypeResponse sBrandingDescriptionX(@javax.annotation.Nonnull String sBrandingDescriptionX) {
  ...
  public EzsignfoldertypeResponse sBillingentityinternalDescriptionX(@javax.annotation.Nullable String sBillingentityinternalDescriptionX) {
  ...
  public EzsignfoldertypeResponse sEzsigntsarequirementDescriptionX(@javax.annotation.Nullable String sEzsigntsarequirementDescriptionX) {
  ...
  public EzsignfoldertypeResponse sEmailAddressSigned(@javax.annotation.Nullable String sEmailAddressSigned) {
  ...
  public EzsignfoldertypeResponse sEmailAddressSummary(@javax.annotation.Nullable String sEmailAddressSummary) {
  ...
  public EzsignfoldertypeResponse sUsergroupNameX(@javax.annotation.Nullable String sUsergroupNameX) {
  ...
  public EzsignfoldertypeResponse sUsergroupNameXRestricted(@javax.annotation.Nullable String sUsergroupNameXRestricted) {
  ...
  public EzsignfoldertypeResponse eEzsignfoldertypePrivacylevel(@javax.annotation.Nonnull FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel) {
  ...
  public EzsignfoldertypeResponse eEzsignfoldertypeSendreminderfrequency(@javax.annotation.Nullable FieldEEzsignfoldertypeSendreminderfrequency eEzsignfoldertypeSendreminderfrequency) {
  ...
  public EzsignfoldertypeResponse iEzsignfoldertypeArchivaldays(@javax.annotation.Nonnull Integer iEzsignfoldertypeArchivaldays) {
  ...
  public EzsignfoldertypeResponse eEzsignfoldertypeDisposal(@javax.annotation.Nonnull FieldEEzsignfoldertypeDisposal eEzsignfoldertypeDisposal) {
  ...
  public EzsignfoldertypeResponse eEzsignfoldertypeCompletion(@javax.annotation.Nonnull FieldEEzsignfoldertypeCompletion eEzsignfoldertypeCompletion) {
  ...
  public EzsignfoldertypeResponse iEzsignfoldertypeDisposaldays(@javax.annotation.Nullable Integer iEzsignfoldertypeDisposaldays) {
  ...
  public EzsignfoldertypeResponse iEzsignfoldertypeDeadlinedays(@javax.annotation.Nonnull Integer iEzsignfoldertypeDeadlinedays) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeAutomaticsignature(@javax.annotation.Nullable Boolean bEzsignfoldertypeAutomaticsignature) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeDelegate(@javax.annotation.Nullable Boolean bEzsignfoldertypeDelegate) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeDiscussion(@javax.annotation.Nullable Boolean bEzsignfoldertypeDiscussion) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeReassignezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeReassignezsignsigner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeReassignuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeReassignuser) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeReassigngroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeReassigngroup) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtoezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtoezsignsigner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtouser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtouser) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendattachmentezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendattachmentezsignsigner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendproofezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofezsignsigner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendattachmentuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendattachmentuser) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendproofuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofuser) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendproofemail(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofemail) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeAllowdownloadattachmentezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeAllowdownloadattachmentezsignsigner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeAllowdownloadproofezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeAllowdownloadproofezsignsigner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendproofreceivealldocument(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofreceivealldocument) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtodocumentowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsignedtodocumentowner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtofolderowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsignedtofolderowner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtofullgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtofullgroup) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtolimitedgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtolimitedgroup) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsignedtocolleague(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsignedtocolleague) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsummarytodocumentowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsummarytodocumentowner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsummarytofolderowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsummarytofolderowner) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsummarytofullgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsummarytofullgroup) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsummarytolimitedgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsummarytolimitedgroup) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeSendsummarytocolleague(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsummarytocolleague) {
  ...
  public EzsignfoldertypeResponse bEzsignfoldertypeIsactive(@javax.annotation.Nonnull Boolean bEzsignfoldertypeIsactive) {
  ...
  public EzsignfoldertypeResponse aObjUserlogintype(@javax.annotation.Nonnull List<UserlogintypeResponse> aObjUserlogintype) {
    this.aObjUserlogintype = aObjUserlogintype;
    return this;
  }

  public EzsignfoldertypeResponse addAObjUserlogintypeItem(UserlogintypeResponse aObjUserlogintypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfoldertypeID, ezsignfoldertypeResponse.pkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertypeName, ezsignfoldertypeResponse.objEzsignfoldertypeName) &&
        Objects.equals(this.fkiBrandingID, ezsignfoldertypeResponse.fkiBrandingID) &&
        Objects.equals(this.fkiBillingentityinternalID, ezsignfoldertypeResponse.fkiBillingentityinternalID) &&
        Objects.equals(this.fkiUsergroupID, ezsignfoldertypeResponse.fkiUsergroupID) &&
        Objects.equals(this.fkiUsergroupIDRestricted, ezsignfoldertypeResponse.fkiUsergroupIDRestricted) &&
        Objects.equals(this.fkiEzsigntsarequirementID, ezsignfoldertypeResponse.fkiEzsigntsarequirementID) &&
        Objects.equals(this.sBrandingDescriptionX, ezsignfoldertypeResponse.sBrandingDescriptionX) &&
        Objects.equals(this.sBillingentityinternalDescriptionX, ezsignfoldertypeResponse.sBillingentityinternalDescriptionX) &&
        Objects.equals(this.sEzsigntsarequirementDescriptionX, ezsignfoldertypeResponse.sEzsigntsarequirementDescriptionX) &&
        Objects.equals(this.sEmailAddressSigned, ezsignfoldertypeResponse.sEmailAddressSigned) &&
        Objects.equals(this.sEmailAddressSummary, ezsignfoldertypeResponse.sEmailAddressSummary) &&
        Objects.equals(this.sUsergroupNameX, ezsignfoldertypeResponse.sUsergroupNameX) &&
        Objects.equals(this.sUsergroupNameXRestricted, ezsignfoldertypeResponse.sUsergroupNameXRestricted) &&
        Objects.equals(this.eEzsignfoldertypePrivacylevel, ezsignfoldertypeResponse.eEzsignfoldertypePrivacylevel) &&
        Objects.equals(this.eEzsignfoldertypeSendreminderfrequency, ezsignfoldertypeResponse.eEzsignfoldertypeSendreminderfrequency) &&
        Objects.equals(this.iEzsignfoldertypeArchivaldays, ezsignfoldertypeResponse.iEzsignfoldertypeArchivaldays) &&
        Objects.equals(this.eEzsignfoldertypeDisposal, ezsignfoldertypeResponse.eEzsignfoldertypeDisposal) &&
        Objects.equals(this.eEzsignfoldertypeCompletion, ezsignfoldertypeResponse.eEzsignfoldertypeCompletion) &&
        Objects.equals(this.iEzsignfoldertypeDisposaldays, ezsignfoldertypeResponse.iEzsignfoldertypeDisposaldays) &&
        Objects.equals(this.iEzsignfoldertypeDeadlinedays, ezsignfoldertypeResponse.iEzsignfoldertypeDeadlinedays) &&
        Objects.equals(this.bEzsignfoldertypeAutomaticsignature, ezsignfoldertypeResponse.bEzsignfoldertypeAutomaticsignature) &&
        Objects.equals(this.bEzsignfoldertypeDelegate, ezsignfoldertypeResponse.bEzsignfoldertypeDelegate) &&
        Objects.equals(this.bEzsignfoldertypeDiscussion, ezsignfoldertypeResponse.bEzsignfoldertypeDiscussion) &&
        Objects.equals(this.bEzsignfoldertypeReassignezsignsigner, ezsignfoldertypeResponse.bEzsignfoldertypeReassignezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeReassignuser, ezsignfoldertypeResponse.bEzsignfoldertypeReassignuser) &&
        Objects.equals(this.bEzsignfoldertypeReassigngroup, ezsignfoldertypeResponse.bEzsignfoldertypeReassigngroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtoezsignsigner, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtoezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtouser, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtouser) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentezsignsigner, ezsignfoldertypeResponse.bEzsignfoldertypeSendattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofezsignsigner, ezsignfoldertypeResponse.bEzsignfoldertypeSendproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentuser, ezsignfoldertypeResponse.bEzsignfoldertypeSendattachmentuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofuser, ezsignfoldertypeResponse.bEzsignfoldertypeSendproofuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofemail, ezsignfoldertypeResponse.bEzsignfoldertypeSendproofemail) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadattachmentezsignsigner, ezsignfoldertypeResponse.bEzsignfoldertypeAllowdownloadattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadproofezsignsigner, ezsignfoldertypeResponse.bEzsignfoldertypeAllowdownloadproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofreceivealldocument, ezsignfoldertypeResponse.bEzsignfoldertypeSendproofreceivealldocument) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtodocumentowner, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofolderowner, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofullgroup, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtolimitedgroup, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtocolleague, ezsignfoldertypeResponse.bEzsignfoldertypeSendsignedtocolleague) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytodocumentowner, ezsignfoldertypeResponse.bEzsignfoldertypeSendsummarytodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofolderowner, ezsignfoldertypeResponse.bEzsignfoldertypeSendsummarytofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofullgroup, ezsignfoldertypeResponse.bEzsignfoldertypeSendsummarytofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytolimitedgroup, ezsignfoldertypeResponse.bEzsignfoldertypeSendsummarytolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytocolleague, ezsignfoldertypeResponse.bEzsignfoldertypeSendsummarytocolleague) &&
        Objects.equals(this.bEzsignfoldertypeIsactive, ezsignfoldertypeResponse.bEzsignfoldertypeIsactive) &&
        Objects.equals(this.aObjUserlogintype, ezsignfoldertypeResponse.aObjUserlogintype);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignfoldertypeID, objEzsignfoldertypeName, fkiBrandingID, fkiBillingentityinternalID, fkiUsergroupID, fkiUsergroupIDRestricted, fkiEzsigntsarequirementID, sBrandingDescriptionX, sBillingentityinternalDescriptionX, sEzsigntsarequirementDescriptionX, sEmailAddressSigned, sEmailAddressSummary, sUsergroupNameX, sUsergroupNameXRestricted, eEzsignfoldertypePrivacylevel, eEzsignfoldertypeSendreminderfrequency, iEzsignfoldertypeArchivaldays, eEzsignfoldertypeDisposal, eEzsignfoldertypeCompletion, iEzsignfoldertypeDisposaldays, iEzsignfoldertypeDeadlinedays, bEzsignfoldertypeAutomaticsignature, bEzsignfoldertypeDelegate, bEzsignfoldertypeDiscussion, bEzsignfoldertypeReassignezsignsigner, bEzsignfoldertypeReassignuser, bEzsignfoldertypeReassigngroup, bEzsignfoldertypeSendsignedtoezsignsigner, bEzsignfoldertypeSendsignedtouser, bEzsignfoldertypeSendattachmentezsignsigner, bEzsignfoldertypeSendproofezsignsigner, bEzsignfoldertypeSendattachmentuser, bEzsignfoldertypeSendproofuser, bEzsignfoldertypeSendproofemail, bEzsignfoldertypeAllowdownloadattachmentezsignsigner, bEzsignfoldertypeAllowdownloadproofezsignsigner, bEzsignfoldertypeSendproofreceivealldocument, bEzsignfoldertypeSendsignedtodocumentowner, bEzsignfoldertypeSendsignedtofolderowner, bEzsignfoldertypeSendsignedtofullgroup, bEzsignfoldertypeSendsignedtolimitedgroup, bEzsignfoldertypeSendsignedtocolleague, bEzsignfoldertypeSendsummarytodocumentowner, bEzsignfoldertypeSendsummarytofolderowner, bEzsignfoldertypeSendsummarytofullgroup, bEzsignfoldertypeSendsummarytolimitedgroup, bEzsignfoldertypeSendsummarytocolleague, bEzsignfoldertypeIsactive, aObjUserlogintype);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignfoldertypeResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignfoldertypeResponse is not found in the empty JSON string", EzsignfoldertypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfoldertypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignfoldertypeResponse.openapiRequiredFields) {
      ...
      if ((jsonObj.get("sUsergroupNameXRestricted") != null && !jsonObj.get("sUsergroupNameXRestricted").isJsonNull()) && !jsonObj.get("sUsergroupNameXRestricted").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUsergroupNameXRestricted` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUsergroupNameXRestricted").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignfoldertypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignfoldertypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignfoldertypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignfoldertypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignfoldertypeResponse>() {
           @Override
           public void write(JsonWriter out, EzsignfoldertypeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignfoldertypeResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsignfoldertypeResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignfoldertypeResponse
   * @throws IOException if the JSON string is invalid with respect to EzsignfoldertypeResponse
   */
  public static EzsignfoldertypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignfoldertypeResponse.class);
  }

  /**
   * Convert an instance of EzsignfoldertypeResponse to an JSON string
   *
   * @return JSON string
   */
