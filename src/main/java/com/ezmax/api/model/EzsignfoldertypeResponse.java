  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsignfoldertypeResponse is not found in the empty JSON string", EzsignfoldertypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfoldertypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sUsergroupNameXRestricted") != null && !jsonObj.get("sUsergroupNameXRestricted").isJsonNull()) && !jsonObj.get("sUsergroupNameXRestricted").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sUsergroupNameXRestricted` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUsergroupNameXRestricted").toString()));
      }
