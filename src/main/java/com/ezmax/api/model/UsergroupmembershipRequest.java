...
public class UsergroupmembershipRequest {
  ...
  public UsergroupmembershipRequest pkiUsergroupmembershipID(Integer pkiUsergroupmembershipID) {
  ...
  **/
  ...
  public UsergroupmembershipRequest fkiUsergroupID(Integer fkiUsergroupID) {
  ...
  **/
  ...
  public UsergroupmembershipRequest fkiUserID(Integer fkiUserID) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsergroupmembershipRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsergroupmembershipRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UsergroupmembershipRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsergroupmembershipRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
