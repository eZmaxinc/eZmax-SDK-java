...
public class NotificationtestResponse {
  ...
  public NotificationtestResponse pkiNotificationtestID(@javax.annotation.Nonnull Integer pkiNotificationtestID) {
  ...
  public NotificationtestResponse objNotificationtestName(@javax.annotation.Nonnull MultilingualNotificationtestName objNotificationtestName) {
  ...
  public NotificationtestResponse fkiNotificationsubsectionID(@javax.annotation.Nonnull Integer fkiNotificationsubsectionID) {
  ...
  public NotificationtestResponse sNotificationtestFunction(@javax.annotation.Nonnull String sNotificationtestFunction) {
  ...
  public NotificationtestResponse sNotificationtestNameX(@javax.annotation.Nonnull String sNotificationtestNameX) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiNotificationtestID", "objNotificationtestName", "fkiNotificationsubsectionID", "sNotificationtestFunction", "sNotificationtestNameX"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiNotificationtestID", "objNotificationtestName", "fkiNotificationsubsectionID", "sNotificationtestFunction", "sNotificationtestNameX"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NotificationtestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in NotificationtestResponse is not found in the empty JSON string", NotificationtestResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotificationtestResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `NotificationtestResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
