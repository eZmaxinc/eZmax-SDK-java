...
public class UserResponse {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      EmailResponseCompound.validateJsonObject(jsonObj.getAsJsonObject("objEmail"));
      ...
      if (jsonObj.get("objPhoneHome") != null && !jsonObj.get("objPhoneHome").isJsonNull()) {
        PhoneResponseCompound.validateJsonObject(jsonObj.getAsJsonObject("objPhoneHome"));
      }
