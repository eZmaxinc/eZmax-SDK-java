...
public class ContactResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiContactID", "fkiLanguageID", "fkiContacttitleID", "fkiContactinformationsID", "dtContactBirthdate", "eContactType", "sContactFirstname", "sContactLastname", "sContactCompany", "sContactOccupation", "tContactNote", "bContactIsactive", "objContactinformations"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiContactID", "fkiLanguageID", "fkiContacttitleID", "fkiContactinformationsID", "eContactType", "sContactFirstname", "sContactLastname", "bContactIsactive", "objContactinformations"));
  }
