...
public class EzsignfoldertypeRequestCompoundV2 {
  ...
  private List<Integer> aFkiUsergroupIDAll;
  ...
  private List<Integer> aFkiUsergroupIDRestricted;
  ...
  private List<Integer> aFkiUsergroupIDTemplate;
  ...
  public EzsignfoldertypeRequestCompoundV2() {
  }

  public EzsignfoldertypeRequestCompoundV2 pkiEzsignfoldertypeID(Integer pkiEzsignfoldertypeID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 objEzsignfoldertypeName(MultilingualEzsignfoldertypeName objEzsignfoldertypeName) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 fkiBrandingID(Integer fkiBrandingID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 fkiBillingentityinternalID(Integer fkiBillingentityinternalID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 fkiEzsigntsarequirementID(Integer fkiEzsigntsarequirementID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 aFkiUserlogintypeID(List<Integer> aFkiUserlogintypeID) {
    this.aFkiUserlogintypeID = aFkiUserlogintypeID;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV2 addAFkiUserlogintypeIDItem(Integer aFkiUserlogintypeIDItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 aFkiUsergroupIDAll(List<Integer> aFkiUsergroupIDAll) {
    this.aFkiUsergroupIDAll = aFkiUsergroupIDAll;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV2 addAFkiUsergroupIDAllItem(Integer aFkiUsergroupIDAllItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 aFkiUsergroupIDRestricted(List<Integer> aFkiUsergroupIDRestricted) {
    this.aFkiUsergroupIDRestricted = aFkiUsergroupIDRestricted;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV2 addAFkiUsergroupIDRestrictedItem(Integer aFkiUsergroupIDRestrictedItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 aFkiUsergroupIDTemplate(List<Integer> aFkiUsergroupIDTemplate) {
    this.aFkiUsergroupIDTemplate = aFkiUsergroupIDTemplate;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV2 addAFkiUsergroupIDTemplateItem(Integer aFkiUsergroupIDTemplateItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 sEmailAddressSigned(String sEmailAddressSigned) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 sEmailAddressSummary(String sEmailAddressSummary) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 eEzsignfoldertypePrivacylevel(FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 eEzsignfoldertypeSendreminderfrequency(FieldEEzsignfoldertypeSendreminderfrequency eEzsignfoldertypeSendreminderfrequency) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 iEzsignfoldertypeArchivaldays(Integer iEzsignfoldertypeArchivaldays) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 eEzsignfoldertypeDisposal(FieldEEzsignfoldertypeDisposal eEzsignfoldertypeDisposal) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 eEzsignfoldertypeCompletion(FieldEEzsignfoldertypeCompletion eEzsignfoldertypeCompletion) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 iEzsignfoldertypeDisposaldays(Integer iEzsignfoldertypeDisposaldays) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 iEzsignfoldertypeDeadlinedays(Integer iEzsignfoldertypeDeadlinedays) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeDelegate(Boolean bEzsignfoldertypeDelegate) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeDiscussion(Boolean bEzsignfoldertypeDiscussion) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeReassignezsignsigner(Boolean bEzsignfoldertypeReassignezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeReassignuser(Boolean bEzsignfoldertypeReassignuser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtoezsignsigner(Boolean bEzsignfoldertypeSendsignedtoezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtouser(Boolean bEzsignfoldertypeSendsignedtouser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendattachmentezsignsigner(Boolean bEzsignfoldertypeSendattachmentezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendproofezsignsigner(Boolean bEzsignfoldertypeSendproofezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendattachmentuser(Boolean bEzsignfoldertypeSendattachmentuser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendproofuser(Boolean bEzsignfoldertypeSendproofuser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendproofemail(Boolean bEzsignfoldertypeSendproofemail) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeAllowdownloadattachmentezsignsigner(Boolean bEzsignfoldertypeAllowdownloadattachmentezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeAllowdownloadproofezsignsigner(Boolean bEzsignfoldertypeAllowdownloadproofezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendproofreceivealldocument(Boolean bEzsignfoldertypeSendproofreceivealldocument) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtodocumentowner(Boolean bEzsignfoldertypeSendsignedtodocumentowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtofolderowner(Boolean bEzsignfoldertypeSendsignedtofolderowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtofullgroup(Boolean bEzsignfoldertypeSendsignedtofullgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtolimitedgroup(Boolean bEzsignfoldertypeSendsignedtolimitedgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsignedtocolleague(Boolean bEzsignfoldertypeSendsignedtocolleague) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsummarytodocumentowner(Boolean bEzsignfoldertypeSendsummarytodocumentowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsummarytofolderowner(Boolean bEzsignfoldertypeSendsummarytofolderowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsummarytofullgroup(Boolean bEzsignfoldertypeSendsummarytofullgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsummarytolimitedgroup(Boolean bEzsignfoldertypeSendsummarytolimitedgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeSendsummarytocolleague(Boolean bEzsignfoldertypeSendsummarytocolleague) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 bEzsignfoldertypeIsactive(Boolean bEzsignfoldertypeIsactive) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 aFkiUserIDSigned(List<Integer> aFkiUserIDSigned) {
    this.aFkiUserIDSigned = aFkiUserIDSigned;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV2 addAFkiUserIDSignedItem(Integer aFkiUserIDSignedItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestCompoundV2 aFkiUserIDSummary(List<Integer> aFkiUserIDSummary) {
    this.aFkiUserIDSummary = aFkiUserIDSummary;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV2 addAFkiUserIDSummaryItem(Integer aFkiUserIDSummaryItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EzsignfoldertypeRequestCompoundV2 ezsignfoldertypeRequestCompoundV2 = (EzsignfoldertypeRequestCompoundV2) o;
    return Objects.equals(this.pkiEzsignfoldertypeID, ezsignfoldertypeRequestCompoundV2.pkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertypeName, ezsignfoldertypeRequestCompoundV2.objEzsignfoldertypeName) &&
        Objects.equals(this.fkiBrandingID, ezsignfoldertypeRequestCompoundV2.fkiBrandingID) &&
        Objects.equals(this.fkiBillingentityinternalID, ezsignfoldertypeRequestCompoundV2.fkiBillingentityinternalID) &&
        Objects.equals(this.fkiEzsigntsarequirementID, ezsignfoldertypeRequestCompoundV2.fkiEzsigntsarequirementID) &&
        Objects.equals(this.aFkiUserlogintypeID, ezsignfoldertypeRequestCompoundV2.aFkiUserlogintypeID) &&
        Objects.equals(this.aFkiUsergroupIDAll, ezsignfoldertypeRequestCompoundV2.aFkiUsergroupIDAll) &&
        Objects.equals(this.aFkiUsergroupIDRestricted, ezsignfoldertypeRequestCompoundV2.aFkiUsergroupIDRestricted) &&
        Objects.equals(this.aFkiUsergroupIDTemplate, ezsignfoldertypeRequestCompoundV2.aFkiUsergroupIDTemplate) &&
        Objects.equals(this.sEmailAddressSigned, ezsignfoldertypeRequestCompoundV2.sEmailAddressSigned) &&
        Objects.equals(this.sEmailAddressSummary, ezsignfoldertypeRequestCompoundV2.sEmailAddressSummary) &&
        Objects.equals(this.eEzsignfoldertypePrivacylevel, ezsignfoldertypeRequestCompoundV2.eEzsignfoldertypePrivacylevel) &&
        Objects.equals(this.eEzsignfoldertypeSendreminderfrequency, ezsignfoldertypeRequestCompoundV2.eEzsignfoldertypeSendreminderfrequency) &&
        Objects.equals(this.iEzsignfoldertypeArchivaldays, ezsignfoldertypeRequestCompoundV2.iEzsignfoldertypeArchivaldays) &&
        Objects.equals(this.eEzsignfoldertypeDisposal, ezsignfoldertypeRequestCompoundV2.eEzsignfoldertypeDisposal) &&
        Objects.equals(this.eEzsignfoldertypeCompletion, ezsignfoldertypeRequestCompoundV2.eEzsignfoldertypeCompletion) &&
        Objects.equals(this.iEzsignfoldertypeDisposaldays, ezsignfoldertypeRequestCompoundV2.iEzsignfoldertypeDisposaldays) &&
        Objects.equals(this.iEzsignfoldertypeDeadlinedays, ezsignfoldertypeRequestCompoundV2.iEzsignfoldertypeDeadlinedays) &&
        Objects.equals(this.bEzsignfoldertypeDelegate, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeDelegate) &&
        Objects.equals(this.bEzsignfoldertypeDiscussion, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeDiscussion) &&
        Objects.equals(this.bEzsignfoldertypeReassignezsignsigner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeReassignezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeReassignuser, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeReassignuser) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtoezsignsigner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtoezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtouser, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtouser) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentezsignsigner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofezsignsigner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentuser, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendattachmentuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofuser, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendproofuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofemail, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendproofemail) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadattachmentezsignsigner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeAllowdownloadattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadproofezsignsigner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeAllowdownloadproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofreceivealldocument, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendproofreceivealldocument) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtodocumentowner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofolderowner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofullgroup, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtolimitedgroup, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtocolleague, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsignedtocolleague) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytodocumentowner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsummarytodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofolderowner, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsummarytofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofullgroup, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsummarytofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytolimitedgroup, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsummarytolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytocolleague, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeSendsummarytocolleague) &&
        Objects.equals(this.bEzsignfoldertypeIsactive, ezsignfoldertypeRequestCompoundV2.bEzsignfoldertypeIsactive) &&
        Objects.equals(this.aFkiUserIDSigned, ezsignfoldertypeRequestCompoundV2.aFkiUserIDSigned) &&
        Objects.equals(this.aFkiUserIDSummary, ezsignfoldertypeRequestCompoundV2.aFkiUserIDSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignfoldertypeID, objEzsignfoldertypeName, fkiBrandingID, fkiBillingentityinternalID, fkiEzsigntsarequirementID, aFkiUserlogintypeID, aFkiUsergroupIDAll, aFkiUsergroupIDRestricted, aFkiUsergroupIDTemplate, sEmailAddressSigned, sEmailAddressSummary, eEzsignfoldertypePrivacylevel, eEzsignfoldertypeSendreminderfrequency, iEzsignfoldertypeArchivaldays, eEzsignfoldertypeDisposal, eEzsignfoldertypeCompletion, iEzsignfoldertypeDisposaldays, iEzsignfoldertypeDeadlinedays, bEzsignfoldertypeDelegate, bEzsignfoldertypeDiscussion, bEzsignfoldertypeReassignezsignsigner, bEzsignfoldertypeReassignuser, bEzsignfoldertypeSendsignedtoezsignsigner, bEzsignfoldertypeSendsignedtouser, bEzsignfoldertypeSendattachmentezsignsigner, bEzsignfoldertypeSendproofezsignsigner, bEzsignfoldertypeSendattachmentuser, bEzsignfoldertypeSendproofuser, bEzsignfoldertypeSendproofemail, bEzsignfoldertypeAllowdownloadattachmentezsignsigner, bEzsignfoldertypeAllowdownloadproofezsignsigner, bEzsignfoldertypeSendproofreceivealldocument, bEzsignfoldertypeSendsignedtodocumentowner, bEzsignfoldertypeSendsignedtofolderowner, bEzsignfoldertypeSendsignedtofullgroup, bEzsignfoldertypeSendsignedtolimitedgroup, bEzsignfoldertypeSendsignedtocolleague, bEzsignfoldertypeSendsummarytodocumentowner, bEzsignfoldertypeSendsummarytofolderowner, bEzsignfoldertypeSendsummarytofullgroup, bEzsignfoldertypeSendsummarytolimitedgroup, bEzsignfoldertypeSendsummarytocolleague, bEzsignfoldertypeIsactive, aFkiUserIDSigned, aFkiUserIDSummary);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EzsignfoldertypeRequestCompoundV2
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeRequestCompoundV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignfoldertypeRequestCompoundV2 is not found in the empty JSON string", EzsignfoldertypeRequestCompoundV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeRequestCompoundV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignfoldertypeRequestCompoundV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignfoldertypeRequestCompoundV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignfoldertypeRequestCompoundV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignfoldertypeRequestCompoundV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignfoldertypeRequestCompoundV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignfoldertypeRequestCompoundV2.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignfoldertypeRequestCompoundV2>() {
           @Override
           public void write(JsonWriter out, EzsignfoldertypeRequestCompoundV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignfoldertypeRequestCompoundV2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EzsignfoldertypeRequestCompoundV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EzsignfoldertypeRequestCompoundV2
  * @throws IOException if the JSON string is invalid with respect to EzsignfoldertypeRequestCompoundV2
  */
  public static EzsignfoldertypeRequestCompoundV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignfoldertypeRequestCompoundV2.class);
  }

 /**
  * Convert an instance of EzsignfoldertypeRequestCompoundV2 to an JSON string
  *
  * @return JSON string
  */
