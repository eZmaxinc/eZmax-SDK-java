...
public class WebsocketResponseGetWebsocketIDV1 {
  ...
  * @throws IOException if the JSON Object is invalid with respect to WebsocketResponseGetWebsocketIDV1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WebsocketResponseGetWebsocketIDV1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WebsocketResponseGetWebsocketIDV1.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebsocketResponseGetWebsocketIDV1` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      WebsocketResponseGetWebsocketIDV1MPayload.validateJsonObject(jsonObj.getAsJsonObject("mPayload"));
  }
