...
public class CommonResponseErrorCreditcardValidation {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sErrorMessage", "eErrorCode", "a_sErrorMessagedetail", "objCreditcardtransactionresponse"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sErrorMessage", "eErrorCode"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonResponseErrorCreditcardValidation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonResponseErrorCreditcardValidation is not found in the empty JSON string", CommonResponseErrorCreditcardValidation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonResponseErrorCreditcardValidation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonResponseErrorCreditcardValidation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
