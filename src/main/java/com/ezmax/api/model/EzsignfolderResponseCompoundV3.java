...
public class EzsignfolderResponseCompoundV3 {
  ...
  public EzsignfolderResponseCompoundV3 dtEzsignfolderArchive(@javax.annotation.Nullable String dtEzsignfolderArchive) {
  ...
  public EzsignfolderResponseCompoundV3 dtEzsignfolderDispose(@javax.annotation.Nullable String dtEzsignfolderDispose) {
  ...
  public EzsignfolderResponseCompoundV3 eEzsignfolderMessageorder(@javax.annotation.Nullable FieldEEzsignfolderMessageorder eEzsignfolderMessageorder) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfolderID, ezsignfolderResponseCompoundV3.pkiEzsignfolderID) &&
        ...
        Objects.equals(this.eEzsignfolderMessageorder, ezsignfolderResponseCompoundV3.eEzsignfolderMessageorder) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfolderResponseCompoundV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignfolderResponseCompoundV3 is not found in the empty JSON string", EzsignfolderResponseCompoundV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfolderResponseCompoundV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfolderResponseCompoundV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
