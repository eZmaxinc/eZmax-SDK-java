...
public class CommonResponseObjDebugPayload {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iVersionMin", "iVersionMax", "a_RequiredPermission", "bVersionDeprecated", "dtResponseDate"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iVersionMin", "iVersionMax", "a_RequiredPermission", "bVersionDeprecated", "dtResponseDate"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonResponseObjDebugPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonResponseObjDebugPayload is not found in the empty JSON string", CommonResponseObjDebugPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonResponseObjDebugPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonResponseObjDebugPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
