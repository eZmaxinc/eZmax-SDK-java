...
public class ColleagueResponseCompoundV2 {
  ...
  public ColleagueResponseCompoundV2 pkiColleagueID(@javax.annotation.Nonnull Integer pkiColleagueID) {
  ...
  public ColleagueResponseCompoundV2 fkiUserID(@javax.annotation.Nonnull Integer fkiUserID) {
  ...
  public ColleagueResponseCompoundV2 fkiUserIDColleague(@javax.annotation.Nonnull Integer fkiUserIDColleague) {
  ...
  public ColleagueResponseCompoundV2 bColleagueEzsignemail(@javax.annotation.Nonnull Boolean bColleagueEzsignemail) {
  ...
  public ColleagueResponseCompoundV2 bColleagueFinancial(@javax.annotation.Nonnull Boolean bColleagueFinancial) {
  ...
  public ColleagueResponseCompoundV2 bColleagueUsecloneemail(@javax.annotation.Nonnull Boolean bColleagueUsecloneemail) {
  ...
  public ColleagueResponseCompoundV2 bColleagueAttachment(@javax.annotation.Nonnull Boolean bColleagueAttachment) {
  ...
  public ColleagueResponseCompoundV2 bColleagueCanafe(@javax.annotation.Nonnull Boolean bColleagueCanafe) {
  ...
  public ColleagueResponseCompoundV2 bColleaguePermission(@javax.annotation.Nonnull Boolean bColleaguePermission) {
  ...
  public ColleagueResponseCompoundV2 bColleagueRealestatecompleted(@javax.annotation.Nonnull Boolean bColleagueRealestatecompleted) {
  ...
  public ColleagueResponseCompoundV2 dtColleagueFrom(@javax.annotation.Nullable String dtColleagueFrom) {
  ...
  public ColleagueResponseCompoundV2 dtColleagueTo(@javax.annotation.Nullable String dtColleagueTo) {
  ...
  public ColleagueResponseCompoundV2 eColleagueEzsign(@javax.annotation.Nonnull FieldEColleagueEzsign eColleagueEzsign) {
  ...
  public ColleagueResponseCompoundV2 eColleagueRealestateinprogress(@javax.annotation.Nonnull FieldEColleagueRealestateinprogess eColleagueRealestateinprogress) {
  ...
  public ColleagueResponseCompoundV2 objUserName(@javax.annotation.Nonnull CustomUserNameResponse objUserName) {
  ...
  public ColleagueResponseCompoundV2 objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiColleagueID", "fkiUserID", "fkiUserIDColleague", "bColleagueEzsignemail", "bColleagueFinancial", "bColleagueUsecloneemail", "bColleagueAttachment", "bColleagueCanafe", "bColleaguePermission", "bColleagueRealestatecompleted", "dtColleagueFrom", "dtColleagueTo", "eColleagueEzsign", "eColleagueRealestateinprogress", "objUserName", "objAudit"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiColleagueID", "fkiUserID", "fkiUserIDColleague", "bColleagueEzsignemail", "bColleagueFinancial", "bColleagueUsecloneemail", "bColleagueAttachment", "bColleagueCanafe", "bColleaguePermission", "bColleagueRealestatecompleted", "eColleagueEzsign", "eColleagueRealestateinprogress", "objUserName", "objAudit"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColleagueResponseCompoundV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColleagueResponseCompoundV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ColleagueResponseCompoundV2 is not found in the empty JSON string", ColleagueResponseCompoundV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColleagueResponseCompoundV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ColleagueResponseCompoundV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ColleagueResponseCompoundV2.openapiRequiredFields) {
      ...
      if ((jsonObj.get("dtColleagueFrom") != null && !jsonObj.get("dtColleagueFrom").isJsonNull()) && !jsonObj.get("dtColleagueFrom").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtColleagueFrom` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtColleagueFrom").toString()));
      }
      if ((jsonObj.get("dtColleagueTo") != null && !jsonObj.get("dtColleagueTo").isJsonNull()) && !jsonObj.get("dtColleagueTo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtColleagueTo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtColleagueTo").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColleagueResponseCompoundV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColleagueResponseCompoundV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColleagueResponseCompoundV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColleagueResponseCompoundV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ColleagueResponseCompoundV2>() {
           @Override
           public void write(JsonWriter out, ColleagueResponseCompoundV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ColleagueResponseCompoundV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ColleagueResponseCompoundV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ColleagueResponseCompoundV2
   * @throws IOException if the JSON string is invalid with respect to ColleagueResponseCompoundV2
   */
  public static ColleagueResponseCompoundV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ColleagueResponseCompoundV2.class);
  }

  /**
   * Convert an instance of ColleagueResponseCompoundV2 to an JSON string
   *
   * @return JSON string
   */
