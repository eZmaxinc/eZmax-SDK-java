...
public class EzsignsignerResponseCompoundContact {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiContactID", "sContactFirstname", "sContactLastname", "fkiLanguageID", "sEmailAddress", "sPhoneE164", "sPhoneExtension", "sPhoneE164Cell"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiContactID", "sContactFirstname", "sContactLastname", "fkiLanguageID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignerResponseCompoundContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignerResponseCompoundContact is not found in the empty JSON string", EzsignsignerResponseCompoundContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignerResponseCompoundContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignerResponseCompoundContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
