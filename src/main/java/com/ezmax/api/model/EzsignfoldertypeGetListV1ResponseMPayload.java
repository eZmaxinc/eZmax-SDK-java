...
public class EzsignfoldertypeGetListV1ResponseMPayload {
  ...
  public EzsignfoldertypeGetListV1ResponseMPayload iRowReturned(@javax.annotation.Nonnull Integer iRowReturned) {
  ...
  public EzsignfoldertypeGetListV1ResponseMPayload iRowFiltered(@javax.annotation.Nonnull Integer iRowFiltered) {
  ...
  public EzsignfoldertypeGetListV1ResponseMPayload aObjEzsignfoldertype(@javax.annotation.Nonnull List<EzsignfoldertypeListElement> aObjEzsignfoldertype) {
  ...
  public void setaObjEzsignfoldertype(@javax.annotation.Nonnull List<EzsignfoldertypeListElement> aObjEzsignfoldertype) {
    this.aObjEzsignfoldertype = aObjEzsignfoldertype;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objEzsignfoldertype"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objEzsignfoldertype"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeGetListV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignfoldertypeGetListV1ResponseMPayload is not found in the empty JSON string", EzsignfoldertypeGetListV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeGetListV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfoldertypeGetListV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignfoldertypeGetListV1ResponseMPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignfoldertypeGetListV1ResponseMPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignfoldertypeGetListV1ResponseMPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignfoldertypeGetListV1ResponseMPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignfoldertypeGetListV1ResponseMPayload>() {
           @Override
           public void write(JsonWriter out, EzsignfoldertypeGetListV1ResponseMPayload value) throws IOException {
  ...
  /**
   * Create an instance of EzsignfoldertypeGetListV1ResponseMPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignfoldertypeGetListV1ResponseMPayload
   * @throws IOException if the JSON string is invalid with respect to EzsignfoldertypeGetListV1ResponseMPayload
   */
  public static EzsignfoldertypeGetListV1ResponseMPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignfoldertypeGetListV1ResponseMPayload.class);
  }

  /**
   * Convert an instance of EzsignfoldertypeGetListV1ResponseMPayload to an JSON string
   *
   * @return JSON string
   */
