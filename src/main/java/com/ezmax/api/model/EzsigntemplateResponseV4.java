...
public class EzsigntemplateResponseV4 {
  ...
  public EzsigntemplateResponseV4() {
  }

  public EzsigntemplateResponseV4 pkiEzsigntemplateID(@javax.annotation.Nonnull Integer pkiEzsigntemplateID) {
  ...
  public EzsigntemplateResponseV4 fkiEzsigntemplatedocumentID(@javax.annotation.Nullable Integer fkiEzsigntemplatedocumentID) {
  ...
  public EzsigntemplateResponseV4 fkiEzsignfoldertypeID(@javax.annotation.Nullable Integer fkiEzsignfoldertypeID) {
  ...
  public EzsigntemplateResponseV4 objEzsignfoldertype(@javax.annotation.Nullable CustomEzsignfoldertypeTemplateResponse objEzsignfoldertype) {
  ...
  public EzsigntemplateResponseV4 fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public EzsigntemplateResponseV4 fkiEzdoctemplatedocumentID(@javax.annotation.Nullable Integer fkiEzdoctemplatedocumentID) {
  ...
  public EzsigntemplateResponseV4 sEzdoctemplatedocumentNameX(@javax.annotation.Nullable String sEzdoctemplatedocumentNameX) {
  ...
  public EzsigntemplateResponseV4 sLanguageNameX(@javax.annotation.Nonnull String sLanguageNameX) {
  ...
  public EzsigntemplateResponseV4 sEzsigntemplateDescription(@javax.annotation.Nonnull String sEzsigntemplateDescription) {
  ...
  public EzsigntemplateResponseV4 sEzsigntemplateExternaldescription(@javax.annotation.Nullable String sEzsigntemplateExternaldescription) {
  ...
  public EzsigntemplateResponseV4 tEzsigntemplateComment(@javax.annotation.Nullable String tEzsigntemplateComment) {
  ...
  public EzsigntemplateResponseV4 eEzsigntemplateRecognition(@javax.annotation.Nullable FieldEEzsigntemplateRecognition eEzsigntemplateRecognition) {
  ...
  public EzsigntemplateResponseV4 sEzsigntemplateFilenameregexp(@javax.annotation.Nullable String sEzsigntemplateFilenameregexp) {
  ...
  public EzsigntemplateResponseV4 bEzsigntemplateAdminonly(@javax.annotation.Nonnull Boolean bEzsigntemplateAdminonly) {
  ...
  public EzsigntemplateResponseV4 sEzsignfoldertypeNameX(@javax.annotation.Nullable String sEzsignfoldertypeNameX) {
  ...
  public EzsigntemplateResponseV4 objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  public EzsigntemplateResponseV4 bEzsigntemplateEditallowed(@javax.annotation.Nonnull Boolean bEzsigntemplateEditallowed) {
  ...
  public EzsigntemplateResponseV4 eEzsigntemplateType(@javax.annotation.Nullable FieldEEzsigntemplateType eEzsigntemplateType) {
  ...
  public boolean equals(Object o) {
    ...
    EzsigntemplateResponseV4 ezsigntemplateResponseV4 = (EzsigntemplateResponseV4) o;
    return Objects.equals(this.pkiEzsigntemplateID, ezsigntemplateResponseV4.pkiEzsigntemplateID) &&
        Objects.equals(this.fkiEzsigntemplatedocumentID, ezsigntemplateResponseV4.fkiEzsigntemplatedocumentID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsigntemplateResponseV4.fkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertype, ezsigntemplateResponseV4.objEzsignfoldertype) &&
        Objects.equals(this.fkiLanguageID, ezsigntemplateResponseV4.fkiLanguageID) &&
        Objects.equals(this.fkiEzdoctemplatedocumentID, ezsigntemplateResponseV4.fkiEzdoctemplatedocumentID) &&
        Objects.equals(this.sEzdoctemplatedocumentNameX, ezsigntemplateResponseV4.sEzdoctemplatedocumentNameX) &&
        Objects.equals(this.sLanguageNameX, ezsigntemplateResponseV4.sLanguageNameX) &&
        Objects.equals(this.sEzsigntemplateDescription, ezsigntemplateResponseV4.sEzsigntemplateDescription) &&
        Objects.equals(this.sEzsigntemplateExternaldescription, ezsigntemplateResponseV4.sEzsigntemplateExternaldescription) &&
        Objects.equals(this.tEzsigntemplateComment, ezsigntemplateResponseV4.tEzsigntemplateComment) &&
        Objects.equals(this.eEzsigntemplateRecognition, ezsigntemplateResponseV4.eEzsigntemplateRecognition) &&
        Objects.equals(this.sEzsigntemplateFilenameregexp, ezsigntemplateResponseV4.sEzsigntemplateFilenameregexp) &&
        Objects.equals(this.bEzsigntemplateAdminonly, ezsigntemplateResponseV4.bEzsigntemplateAdminonly) &&
        Objects.equals(this.sEzsignfoldertypeNameX, ezsigntemplateResponseV4.sEzsignfoldertypeNameX) &&
        Objects.equals(this.objAudit, ezsigntemplateResponseV4.objAudit) &&
        Objects.equals(this.bEzsigntemplateEditallowed, ezsigntemplateResponseV4.bEzsigntemplateEditallowed) &&
        Objects.equals(this.eEzsigntemplateType, ezsigntemplateResponseV4.eEzsigntemplateType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplateResponseV4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateResponseV4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplateResponseV4 is not found in the empty JSON string", EzsigntemplateResponseV4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateResponseV4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateResponseV4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplateResponseV4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplateResponseV4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplateResponseV4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplateResponseV4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplateResponseV4.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplateResponseV4>() {
           @Override
           public void write(JsonWriter out, EzsigntemplateResponseV4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplateResponseV4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplateResponseV4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplateResponseV4
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplateResponseV4
   */
  public static EzsigntemplateResponseV4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplateResponseV4.class);
  }

  /**
   * Convert an instance of EzsigntemplateResponseV4 to an JSON string
   *
   * @return JSON string
   */
