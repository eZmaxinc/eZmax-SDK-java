...
public class EzsignbulksendResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignbulksendID, ezsignbulksendResponse.pkiEzsignbulksendID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsignbulksendResponse.fkiEzsignfoldertypeID) &&
        Objects.equals(this.fkiLanguageID, ezsignbulksendResponse.fkiLanguageID) &&
        Objects.equals(this.sLanguageNameX, ezsignbulksendResponse.sLanguageNameX) &&
        Objects.equals(this.eEzsignfoldertypePrivacylevel, ezsignbulksendResponse.eEzsignfoldertypePrivacylevel) &&
        Objects.equals(this.sEzsignfoldertypeNameX, ezsignbulksendResponse.sEzsignfoldertypeNameX) &&
        Objects.equals(this.sEzsignbulksendDescription, ezsignbulksendResponse.sEzsignbulksendDescription) &&
        Objects.equals(this.tEzsignbulksendNote, ezsignbulksendResponse.tEzsignbulksendNote) &&
        Objects.equals(this.bEzsignbulksendNeedvalidation, ezsignbulksendResponse.bEzsignbulksendNeedvalidation) &&
        Objects.equals(this.bEzsignbulksendIsactive, ezsignbulksendResponse.bEzsignbulksendIsactive) &&
        Objects.equals(this.objAudit, ezsignbulksendResponse.objAudit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignbulksendID, fkiEzsignfoldertypeID, fkiLanguageID, sLanguageNameX, eEzsignfoldertypePrivacylevel, sEzsignfoldertypeNameX, sEzsignbulksendDescription, tEzsignbulksendNote, bEzsignbulksendNeedvalidation, bEzsignbulksendIsactive, objAudit);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignbulksendID", "fkiEzsignfoldertypeID", "fkiLanguageID", "sLanguageNameX", "eEzsignfoldertypePrivacylevel", "sEzsignfoldertypeNameX", "sEzsignbulksendDescription", "tEzsignbulksendNote", "bEzsignbulksendNeedvalidation", "bEzsignbulksendIsactive", "objAudit"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignbulksendID", "fkiEzsignfoldertypeID", "fkiLanguageID", "sLanguageNameX", "eEzsignfoldertypePrivacylevel", "sEzsignfoldertypeNameX", "sEzsignbulksendDescription", "tEzsignbulksendNote", "bEzsignbulksendNeedvalidation", "bEzsignbulksendIsactive", "objAudit"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignbulksendResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksendResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsignbulksendResponse is not found in the empty JSON string", EzsignbulksendResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksendResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignbulksendResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @return An instance of EzsignbulksendResponse
   * @throws IOException if the JSON string is invalid with respect to EzsignbulksendResponse
   */
  public static EzsignbulksendResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignbulksendResponse.class);
  }

  /**
   * Convert an instance of EzsignbulksendResponse to an JSON string
   *
   * @return JSON string
   */
