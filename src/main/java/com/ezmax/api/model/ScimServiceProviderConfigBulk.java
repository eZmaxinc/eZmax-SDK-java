...
public class ScimServiceProviderConfigBulk {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("supported", "maxOperations", "maxPayloadSize"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("supported", "maxOperations", "maxPayloadSize"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScimServiceProviderConfigBulk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ScimServiceProviderConfigBulk is not found in the empty JSON string", ScimServiceProviderConfigBulk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScimServiceProviderConfigBulk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ScimServiceProviderConfigBulk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
