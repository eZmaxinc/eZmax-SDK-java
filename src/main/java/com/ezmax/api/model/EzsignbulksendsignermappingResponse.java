...
public class EzsignbulksendsignermappingResponse {
  ...
  public EzsignbulksendsignermappingResponse bEzsignbulksendsignermappingReceivecopy(@javax.annotation.Nullable Boolean bEzsignbulksendsignermappingReceivecopy) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignbulksendsignermappingID, ezsignbulksendsignermappingResponse.pkiEzsignbulksendsignermappingID) &&
        Objects.equals(this.fkiEzsignbulksendID, ezsignbulksendsignermappingResponse.fkiEzsignbulksendID) &&
        Objects.equals(this.fkiUserID, ezsignbulksendsignermappingResponse.fkiUserID) &&
        Objects.equals(this.bEzsignbulksendsignermappingReceivecopy, ezsignbulksendsignermappingResponse.bEzsignbulksendsignermappingReceivecopy) &&
        Objects.equals(this.sEzsignbulksendsignermappingDescription, ezsignbulksendsignermappingResponse.sEzsignbulksendsignermappingDescription);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignbulksendsignermappingResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksendsignermappingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignbulksendsignermappingResponse is not found in the empty JSON string", EzsignbulksendsignermappingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksendsignermappingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignbulksendsignermappingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @return An instance of EzsignbulksendsignermappingResponse
   * @throws IOException if the JSON string is invalid with respect to EzsignbulksendsignermappingResponse
   */
  public static EzsignbulksendsignermappingResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignbulksendsignermappingResponse.class);
  }

  /**
   * Convert an instance of EzsignbulksendsignermappingResponse to an JSON string
   *
   * @return JSON string
   */
