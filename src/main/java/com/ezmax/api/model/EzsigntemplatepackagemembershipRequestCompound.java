...
public class EzsigntemplatepackagemembershipRequestCompound {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatepackagemembershipRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatepackagemembershipRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatepackagemembershipRequestCompound is not found in the empty JSON string", EzsigntemplatepackagemembershipRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatepackagemembershipRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatepackagemembershipRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplatepackagemembershipRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatepackagemembershipRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatepackagemembershipRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatepackagemembershipRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatepackagemembershipRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatepackagemembershipRequestCompound>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatepackagemembershipRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplatepackagemembershipRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplatepackagemembershipRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplatepackagemembershipRequestCompound
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplatepackagemembershipRequestCompound
   */
  public static EzsigntemplatepackagemembershipRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplatepackagemembershipRequestCompound.class);
  }

  /**
   * Convert an instance of EzsigntemplatepackagemembershipRequestCompound to an JSON string
   *
   * @return JSON string
   */
