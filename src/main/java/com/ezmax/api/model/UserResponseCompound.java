  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserResponseCompound is not found in the empty JSON string", UserResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sTimezoneName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sTimezoneName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sTimezoneName").toString()));
      }
      ...
      if ((jsonObj.get("sUserJobtitle") != null && !jsonObj.get("sUserJobtitle").isJsonNull()) && !jsonObj.get("sUserJobtitle").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sUserJobtitle` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserJobtitle").toString()));
      }
      ...
      if ((jsonObj.get("dtUserLastlogondate") != null && !jsonObj.get("dtUserLastlogondate").isJsonNull()) && !jsonObj.get("dtUserLastlogondate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtUserLastlogondate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtUserLastlogondate").toString()));
      }
      if ((jsonObj.get("dtUserPasswordchanged") != null && !jsonObj.get("dtUserPasswordchanged").isJsonNull()) && !jsonObj.get("dtUserPasswordchanged").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtUserPasswordchanged` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtUserPasswordchanged").toString()));
      }
