...
public class UserResponseCompound {
  ...
  public UserResponseCompound pkiUserID(@javax.annotation.Nonnull Integer pkiUserID) {
  ...
  public UserResponseCompound fkiAgentID(@javax.annotation.Nullable Integer fkiAgentID) {
  ...
  public UserResponseCompound fkiBrokerID(@javax.annotation.Nullable Integer fkiBrokerID) {
  ...
  public UserResponseCompound fkiAssistantID(@javax.annotation.Nullable Integer fkiAssistantID) {
  ...
  public UserResponseCompound fkiEmployeeID(@javax.annotation.Nullable Integer fkiEmployeeID) {
  ...
  public UserResponseCompound fkiEzmaxpartnerID(@javax.annotation.Nullable Integer fkiEzmaxpartnerID) {
  ...
  public UserResponseCompound fkiCompanyIDDefault(@javax.annotation.Nonnull Integer fkiCompanyIDDefault) {
  ...
  public UserResponseCompound sCompanyNameX(@javax.annotation.Nonnull String sCompanyNameX) {
  ...
  public UserResponseCompound fkiDepartmentIDDefault(@javax.annotation.Nonnull Integer fkiDepartmentIDDefault) {
  ...
  public UserResponseCompound sDepartmentNameX(@javax.annotation.Nonnull String sDepartmentNameX) {
  ...
  public UserResponseCompound fkiTimezoneID(@javax.annotation.Nonnull Integer fkiTimezoneID) {
  ...
  public UserResponseCompound sTimezoneName(@javax.annotation.Nonnull String sTimezoneName) {
  ...
  public UserResponseCompound fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public UserResponseCompound sLanguageNameX(@javax.annotation.Nonnull String sLanguageNameX) {
  ...
  public UserResponseCompound objEmail(@javax.annotation.Nonnull EmailResponseCompound objEmail) {
  ...
  public UserResponseCompound fkiBillingentityinternalID(@javax.annotation.Nonnull Integer fkiBillingentityinternalID) {
  ...
  public UserResponseCompound sBillingentityinternalDescriptionX(@javax.annotation.Nonnull String sBillingentityinternalDescriptionX) {
  ...
  public UserResponseCompound objPhoneHome(@javax.annotation.Nullable PhoneResponseCompound objPhoneHome) {
  ...
  public UserResponseCompound objPhoneSMS(@javax.annotation.Nullable PhoneResponseCompound objPhoneSMS) {
  ...
  public UserResponseCompound fkiSecretquestionID(@javax.annotation.Nullable Integer fkiSecretquestionID) {
  ...
  public UserResponseCompound fkiModuleIDForm(@javax.annotation.Nullable Integer fkiModuleIDForm) {
  ...
  public UserResponseCompound sModuleNameX(@javax.annotation.Nullable String sModuleNameX) {
  ...
  public UserResponseCompound eUserOrigin(@javax.annotation.Nonnull FieldEUserOrigin eUserOrigin) {
  ...
  public UserResponseCompound eUserType(@javax.annotation.Nonnull FieldEUserType eUserType) {
  ...
  public UserResponseCompound eUserLogintype(@javax.annotation.Nonnull FieldEUserLogintype eUserLogintype) {
  ...
  public UserResponseCompound sUserFirstname(@javax.annotation.Nonnull String sUserFirstname) {
  ...
  public UserResponseCompound sUserLastname(@javax.annotation.Nonnull String sUserLastname) {
  ...
  public UserResponseCompound sUserLoginname(@javax.annotation.Nonnull String sUserLoginname) {
  ...
  public UserResponseCompound sUserJobtitle(@javax.annotation.Nullable String sUserJobtitle) {
  ...
  public UserResponseCompound eUserEzsignaccess(@javax.annotation.Nonnull FieldEUserEzsignaccess eUserEzsignaccess) {
  ...
  public UserResponseCompound dtUserLastlogondate(@javax.annotation.Nullable String dtUserLastlogondate) {
  ...
  public UserResponseCompound dtUserPasswordchanged(@javax.annotation.Nullable String dtUserPasswordchanged) {
  ...
  public UserResponseCompound dtUserEzsignprepaidexpiration(@javax.annotation.Nullable String dtUserEzsignprepaidexpiration) {
  ...
  public UserResponseCompound bUserIsactive(@javax.annotation.Nonnull Boolean bUserIsactive) {
  ...
  public UserResponseCompound bUserSuspended(@javax.annotation.Nullable Boolean bUserSuspended) {
  ...
  public UserResponseCompound bUserValidatebyadministration(@javax.annotation.Nullable Boolean bUserValidatebyadministration) {
  ...
  public UserResponseCompound bUserValidatebydirector(@javax.annotation.Nullable Boolean bUserValidatebydirector) {
  ...
  public UserResponseCompound bUserAttachmentautoverified(@javax.annotation.Nullable Boolean bUserAttachmentautoverified) {
  ...
  public UserResponseCompound bUserChangepassword(@javax.annotation.Nonnull Boolean bUserChangepassword) {
  ...
  public UserResponseCompound bUserEzsigntemplaterolegrouping(@javax.annotation.Nullable Boolean bUserEzsigntemplaterolegrouping) {
  ...
  public UserResponseCompound objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUserID, userResponseCompound.pkiUserID) &&
        Objects.equals(this.fkiAgentID, userResponseCompound.fkiAgentID) &&
        Objects.equals(this.fkiBrokerID, userResponseCompound.fkiBrokerID) &&
        Objects.equals(this.fkiAssistantID, userResponseCompound.fkiAssistantID) &&
        Objects.equals(this.fkiEmployeeID, userResponseCompound.fkiEmployeeID) &&
        Objects.equals(this.fkiEzmaxpartnerID, userResponseCompound.fkiEzmaxpartnerID) &&
        Objects.equals(this.fkiCompanyIDDefault, userResponseCompound.fkiCompanyIDDefault) &&
        Objects.equals(this.sCompanyNameX, userResponseCompound.sCompanyNameX) &&
        Objects.equals(this.fkiDepartmentIDDefault, userResponseCompound.fkiDepartmentIDDefault) &&
        Objects.equals(this.sDepartmentNameX, userResponseCompound.sDepartmentNameX) &&
        Objects.equals(this.fkiTimezoneID, userResponseCompound.fkiTimezoneID) &&
        Objects.equals(this.sTimezoneName, userResponseCompound.sTimezoneName) &&
        Objects.equals(this.fkiLanguageID, userResponseCompound.fkiLanguageID) &&
        Objects.equals(this.sLanguageNameX, userResponseCompound.sLanguageNameX) &&
        Objects.equals(this.objEmail, userResponseCompound.objEmail) &&
        Objects.equals(this.fkiBillingentityinternalID, userResponseCompound.fkiBillingentityinternalID) &&
        Objects.equals(this.sBillingentityinternalDescriptionX, userResponseCompound.sBillingentityinternalDescriptionX) &&
        Objects.equals(this.objPhoneHome, userResponseCompound.objPhoneHome) &&
        Objects.equals(this.objPhoneSMS, userResponseCompound.objPhoneSMS) &&
        Objects.equals(this.fkiSecretquestionID, userResponseCompound.fkiSecretquestionID) &&
        Objects.equals(this.fkiModuleIDForm, userResponseCompound.fkiModuleIDForm) &&
        Objects.equals(this.sModuleNameX, userResponseCompound.sModuleNameX) &&
        Objects.equals(this.eUserOrigin, userResponseCompound.eUserOrigin) &&
        Objects.equals(this.eUserType, userResponseCompound.eUserType) &&
        Objects.equals(this.eUserLogintype, userResponseCompound.eUserLogintype) &&
        ...
        Objects.equals(this.sUserJobtitle, userResponseCompound.sUserJobtitle) &&
        Objects.equals(this.eUserEzsignaccess, userResponseCompound.eUserEzsignaccess) &&
        Objects.equals(this.dtUserLastlogondate, userResponseCompound.dtUserLastlogondate) &&
        Objects.equals(this.dtUserPasswordchanged, userResponseCompound.dtUserPasswordchanged) &&
        Objects.equals(this.dtUserEzsignprepaidexpiration, userResponseCompound.dtUserEzsignprepaidexpiration) &&
        Objects.equals(this.bUserIsactive, userResponseCompound.bUserIsactive) &&
        Objects.equals(this.bUserSuspended, userResponseCompound.bUserSuspended) &&
        Objects.equals(this.bUserValidatebyadministration, userResponseCompound.bUserValidatebyadministration) &&
        Objects.equals(this.bUserValidatebydirector, userResponseCompound.bUserValidatebydirector) &&
        Objects.equals(this.bUserAttachmentautoverified, userResponseCompound.bUserAttachmentautoverified) &&
        Objects.equals(this.bUserChangepassword, userResponseCompound.bUserChangepassword) &&
        Objects.equals(this.bUserEzsigntemplaterolegrouping, userResponseCompound.bUserEzsigntemplaterolegrouping) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserResponseCompound is not found in the empty JSON string", UserResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sTimezoneName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sTimezoneName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sTimezoneName").toString()));
      }
      ...
      if ((jsonObj.get("dtUserLastlogondate") != null && !jsonObj.get("dtUserLastlogondate").isJsonNull()) && !jsonObj.get("dtUserLastlogondate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtUserLastlogondate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtUserLastlogondate").toString()));
      }
      if ((jsonObj.get("dtUserPasswordchanged") != null && !jsonObj.get("dtUserPasswordchanged").isJsonNull()) && !jsonObj.get("dtUserPasswordchanged").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtUserPasswordchanged` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtUserPasswordchanged").toString()));
      }
