...
public class WebhookCreateObjectV2Response {
  ...
  public WebhookCreateObjectV2Response objDebugPayload(@javax.annotation.Nonnull CommonResponseObjDebugPayload objDebugPayload) {
  ...
  public WebhookCreateObjectV2Response objDebug(@javax.annotation.Nullable CommonResponseObjDebug objDebug) {
  ...
  public WebhookCreateObjectV2Response mPayload(@javax.annotation.Nonnull WebhookCreateObjectV2ResponseMPayload mPayload) {
  ...
  public void setmPayload(@javax.annotation.Nonnull WebhookCreateObjectV2ResponseMPayload mPayload) {
    this.mPayload = mPayload;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookCreateObjectV2Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookCreateObjectV2Response is not found in the empty JSON string", WebhookCreateObjectV2Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookCreateObjectV2Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookCreateObjectV2Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
