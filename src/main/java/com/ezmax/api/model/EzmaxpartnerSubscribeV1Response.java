...
public class EzmaxpartnerSubscribeV1Response {
  ...
  public void setsExternalID(@javax.annotation.Nonnull String sExternalID) {
    this.sExternalID = sExternalID;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sExternalID);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sExternalID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sExternalID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("sExternalID").isJsonPrimitive()) {
