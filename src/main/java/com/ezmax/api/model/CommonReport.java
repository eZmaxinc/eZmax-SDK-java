...
public class CommonReport {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("a_objReportsection", "bReportPaginate", "sReportTitle"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("a_objReportsection"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CommonReport is not found in the empty JSON string", CommonReport.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonReport.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonReport` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("a_objReportsection").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objReportsection` to be an array in the JSON string but got `%s`", jsonObj.get("a_objReportsection").toString()));
      }
      ...
      if ((jsonObj.get("sReportTitle") != null && !jsonObj.get("sReportTitle").isJsonNull()) && !jsonObj.get("sReportTitle").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sReportTitle` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sReportTitle").toString()));
      }
  }
