...
public class PermissionRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiPermissionID", "fkiUserID", "fkiApikeyID", "fkiUsergroupID", "fkiCompanyID", "fkiModulesectionID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiModulesectionID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PermissionRequestCompound is not found in the empty JSON string", PermissionRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PermissionRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PermissionRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
