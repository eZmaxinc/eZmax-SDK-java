  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigndocumentlogResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsigndocumentlogResponseCompound is not found in the empty JSON string", EzsigndocumentlogResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigndocumentlogResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigndocumentlogResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("dtEzsigndocumentlogDatetime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtEzsigndocumentlogDatetime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzsigndocumentlogDatetime").toString()));
      }
      ...
      if (!jsonObj.get("sEzsigndocumentlogDetail").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentlogDetail` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentlogDetail").toString()));
      }
      if (!jsonObj.get("sEzsigndocumentlogLastname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentlogLastname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentlogLastname").toString()));
      }
      if (!jsonObj.get("sEzsigndocumentlogFirstname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentlogFirstname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentlogFirstname").toString()));
      }
      if (!jsonObj.get("sEzsigndocumentlogIP").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentlogIP` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentlogIP").toString()));
      }
  }
