...
public class ColleagueRequestCompoundV2 {
  ...
  public boolean equals(Object o) {
    ...
    ColleagueRequestCompoundV2 colleagueRequestCompoundV2 = (ColleagueRequestCompoundV2) o;
    return Objects.equals(this.pkiColleagueID, colleagueRequestCompoundV2.pkiColleagueID) &&
        Objects.equals(this.fkiUserID, colleagueRequestCompoundV2.fkiUserID) &&
        Objects.equals(this.fkiUserIDColleague, colleagueRequestCompoundV2.fkiUserIDColleague) &&
        Objects.equals(this.bColleagueEzsignemail, colleagueRequestCompoundV2.bColleagueEzsignemail) &&
        Objects.equals(this.bColleagueFinancial, colleagueRequestCompoundV2.bColleagueFinancial) &&
        Objects.equals(this.bColleagueUsecloneemail, colleagueRequestCompoundV2.bColleagueUsecloneemail) &&
        Objects.equals(this.bColleagueAttachment, colleagueRequestCompoundV2.bColleagueAttachment) &&
        Objects.equals(this.bColleagueCanafe, colleagueRequestCompoundV2.bColleagueCanafe) &&
        Objects.equals(this.bColleaguePermission, colleagueRequestCompoundV2.bColleaguePermission) &&
        Objects.equals(this.bColleagueRealestatecompleted, colleagueRequestCompoundV2.bColleagueRealestatecompleted) &&
        Objects.equals(this.dtColleagueFrom, colleagueRequestCompoundV2.dtColleagueFrom) &&
        Objects.equals(this.dtColleagueTo, colleagueRequestCompoundV2.dtColleagueTo) &&
        Objects.equals(this.eColleagueEzsign, colleagueRequestCompoundV2.eColleagueEzsign) &&
        Objects.equals(this.eColleagueRealestateinprogress, colleagueRequestCompoundV2.eColleagueRealestateinprogress);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiUserID", "fkiUserIDColleague", "bColleagueEzsignemail", "bColleagueFinancial", "bColleagueUsecloneemail", "bColleagueAttachment", "bColleagueCanafe", "bColleaguePermission", "bColleagueRealestatecompleted", "eColleagueEzsign", "eColleagueRealestateinprogress"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColleagueRequestCompoundV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColleagueRequestCompoundV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ColleagueRequestCompoundV2 is not found in the empty JSON string", ColleagueRequestCompoundV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColleagueRequestCompoundV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ColleagueRequestCompoundV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ColleagueRequestCompoundV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColleagueRequestCompoundV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColleagueRequestCompoundV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColleagueRequestCompoundV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColleagueRequestCompoundV2.class));

       return (TypeAdapter<T>) new TypeAdapter<ColleagueRequestCompoundV2>() {
           @Override
           public void write(JsonWriter out, ColleagueRequestCompoundV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ColleagueRequestCompoundV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ColleagueRequestCompoundV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ColleagueRequestCompoundV2
   * @throws IOException if the JSON string is invalid with respect to ColleagueRequestCompoundV2
   */
  public static ColleagueRequestCompoundV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ColleagueRequestCompoundV2.class);
  }

  /**
   * Convert an instance of ColleagueRequestCompoundV2 to an JSON string
   *
   * @return JSON string
   */
