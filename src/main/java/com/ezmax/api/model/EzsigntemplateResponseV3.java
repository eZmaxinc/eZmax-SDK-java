...
public class EzsigntemplateResponseV3 {
  ...
  public EzsigntemplateResponseV3() {
  }

  public EzsigntemplateResponseV3 pkiEzsigntemplateID(@javax.annotation.Nonnull Integer pkiEzsigntemplateID) {
  ...
  public EzsigntemplateResponseV3 fkiEzsigntemplatedocumentID(@javax.annotation.Nullable Integer fkiEzsigntemplatedocumentID) {
  ...
  public EzsigntemplateResponseV3 fkiEzsignfoldertypeID(@javax.annotation.Nullable Integer fkiEzsignfoldertypeID) {
  ...
  public EzsigntemplateResponseV3 objEzsignfoldertype(@javax.annotation.Nullable CustomEzsignfoldertypeTemplateResponse objEzsignfoldertype) {
  ...
  public EzsigntemplateResponseV3 fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public EzsigntemplateResponseV3 fkiEzdoctemplatedocumentID(@javax.annotation.Nullable Integer fkiEzdoctemplatedocumentID) {
  ...
  public EzsigntemplateResponseV3 sEzdoctemplatedocumentNameX(@javax.annotation.Nullable String sEzdoctemplatedocumentNameX) {
  ...
  public EzsigntemplateResponseV3 sLanguageNameX(@javax.annotation.Nonnull String sLanguageNameX) {
  ...
  public EzsigntemplateResponseV3 sEzsigntemplateDescription(@javax.annotation.Nonnull String sEzsigntemplateDescription) {
  ...
  public EzsigntemplateResponseV3 sEzsigntemplateExternaldescription(@javax.annotation.Nullable String sEzsigntemplateExternaldescription) {
  ...
  public EzsigntemplateResponseV3 tEzsigntemplateComment(@javax.annotation.Nullable String tEzsigntemplateComment) {
  ...
  public EzsigntemplateResponseV3 eEzsigntemplateRecognition(@javax.annotation.Nullable FieldEEzsigntemplateRecognition eEzsigntemplateRecognition) {
  ...
  public EzsigntemplateResponseV3 sEzsigntemplateFilenameregexp(@javax.annotation.Nullable String sEzsigntemplateFilenameregexp) {
  ...
  public EzsigntemplateResponseV3 bEzsigntemplateAdminonly(@javax.annotation.Nonnull Boolean bEzsigntemplateAdminonly) {
  ...
  public EzsigntemplateResponseV3 sEzsignfoldertypeNameX(@javax.annotation.Nullable String sEzsignfoldertypeNameX) {
  ...
  public EzsigntemplateResponseV3 objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  public EzsigntemplateResponseV3 bEzsigntemplateEditallowed(@javax.annotation.Nonnull Boolean bEzsigntemplateEditallowed) {
  ...
  public EzsigntemplateResponseV3 eEzsigntemplateType(@javax.annotation.Nullable FieldEEzsigntemplateType eEzsigntemplateType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplateID, ezsigntemplateResponseV3.pkiEzsigntemplateID) &&
        Objects.equals(this.fkiEzsigntemplatedocumentID, ezsigntemplateResponseV3.fkiEzsigntemplatedocumentID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsigntemplateResponseV3.fkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertype, ezsigntemplateResponseV3.objEzsignfoldertype) &&
        Objects.equals(this.fkiLanguageID, ezsigntemplateResponseV3.fkiLanguageID) &&
        Objects.equals(this.fkiEzdoctemplatedocumentID, ezsigntemplateResponseV3.fkiEzdoctemplatedocumentID) &&
        Objects.equals(this.sEzdoctemplatedocumentNameX, ezsigntemplateResponseV3.sEzdoctemplatedocumentNameX) &&
        Objects.equals(this.sLanguageNameX, ezsigntemplateResponseV3.sLanguageNameX) &&
        Objects.equals(this.sEzsigntemplateDescription, ezsigntemplateResponseV3.sEzsigntemplateDescription) &&
        Objects.equals(this.sEzsigntemplateExternaldescription, ezsigntemplateResponseV3.sEzsigntemplateExternaldescription) &&
        Objects.equals(this.tEzsigntemplateComment, ezsigntemplateResponseV3.tEzsigntemplateComment) &&
        Objects.equals(this.eEzsigntemplateRecognition, ezsigntemplateResponseV3.eEzsigntemplateRecognition) &&
        Objects.equals(this.sEzsigntemplateFilenameregexp, ezsigntemplateResponseV3.sEzsigntemplateFilenameregexp) &&
        Objects.equals(this.bEzsigntemplateAdminonly, ezsigntemplateResponseV3.bEzsigntemplateAdminonly) &&
        Objects.equals(this.sEzsignfoldertypeNameX, ezsigntemplateResponseV3.sEzsignfoldertypeNameX) &&
        Objects.equals(this.objAudit, ezsigntemplateResponseV3.objAudit) &&
        Objects.equals(this.bEzsigntemplateEditallowed, ezsigntemplateResponseV3.bEzsigntemplateEditallowed) &&
        Objects.equals(this.eEzsigntemplateType, ezsigntemplateResponseV3.eEzsigntemplateType);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplateID", "fkiLanguageID", "sLanguageNameX", "sEzsigntemplateDescription", "bEzsigntemplateAdminonly", "objAudit", "bEzsigntemplateEditallowed"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplateResponseV3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateResponseV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplateResponseV3 is not found in the empty JSON string", EzsigntemplateResponseV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateResponseV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateResponseV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplateResponseV3.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplateResponseV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplateResponseV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplateResponseV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplateResponseV3.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplateResponseV3>() {
           @Override
           public void write(JsonWriter out, EzsigntemplateResponseV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplateResponseV3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplateResponseV3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplateResponseV3
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplateResponseV3
   */
  public static EzsigntemplateResponseV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplateResponseV3.class);
  }

  /**
   * Convert an instance of EzsigntemplateResponseV3 to an JSON string
   *
   * @return JSON string
   */
