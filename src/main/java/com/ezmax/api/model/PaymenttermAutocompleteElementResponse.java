...
public class PaymenttermAutocompleteElementResponse {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Net 30 days", required = true, value = "The description of the Paymentterm in the language of the requester")
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymenttermAutocompleteElementResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymenttermAutocompleteElementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymenttermAutocompleteElementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymenttermAutocompleteElementResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
