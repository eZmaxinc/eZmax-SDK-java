...
public class CustomerResponse {
  ...
  public CustomerResponse sCustomerNote(@javax.annotation.Nullable String sCustomerNote) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiCustomerID, customerResponse.pkiCustomerID) &&
        ...
        Objects.equals(this.sCustomerNote, customerResponse.sCustomerNote) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomerResponse is not found in the empty JSON string", CustomerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
