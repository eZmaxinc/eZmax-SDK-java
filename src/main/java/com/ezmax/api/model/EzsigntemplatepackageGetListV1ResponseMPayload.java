...
public class EzsigntemplatepackageGetListV1ResponseMPayload {
  ...
  public void setaObjEzsigntemplatepackage(@javax.annotation.Nonnull List<EzsigntemplatepackageListElement> aObjEzsigntemplatepackage) {
    this.aObjEzsigntemplatepackage = aObjEzsigntemplatepackage;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objEzsigntemplatepackage"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iRowReturned", "iRowFiltered", "a_objEzsigntemplatepackage"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatepackageGetListV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatepackageGetListV1ResponseMPayload is not found in the empty JSON string", EzsigntemplatepackageGetListV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatepackageGetListV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatepackageGetListV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
