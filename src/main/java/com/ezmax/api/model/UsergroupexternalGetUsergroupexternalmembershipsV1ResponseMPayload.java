...
public class UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("a_objUsergroupexternalmembership"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("a_objUsergroupexternalmembership"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload is not found in the empty JSON string", UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("a_objUsergroupexternalmembership") != null) {
        if (!jsonObj.get("a_objUsergroupexternalmembership").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `a_objUsergroupexternalmembership` to be an array in the JSON string but got `%s`", jsonObj.get("a_objUsergroupexternalmembership").toString()));
        }
