...
public class SupplyResponseCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiSupplyID", "fkiGlaccountID", "fkiGlaccountcontainerID", "fkiVariableexpenseID", "sSupplyCode", "objSupplyDescription", "dSupplyUnitprice", "bSupplyIsactive", "bSupplyVariableprice", "sGlaccountDescriptionX", "sGlaccountcontainerLongdescriptionX", "sVariableexpenseDescriptionX"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiSupplyID", "fkiVariableexpenseID", "sSupplyCode", "objSupplyDescription", "dSupplyUnitprice", "bSupplyIsactive", "bSupplyVariableprice"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SupplyResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SupplyResponseCompound is not found in the empty JSON string", SupplyResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SupplyResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SupplyResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
