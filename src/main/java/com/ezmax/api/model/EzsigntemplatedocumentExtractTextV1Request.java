...
public class EzsigntemplatedocumentExtractTextV1Request {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.iPage, ezsigntemplatedocumentExtractTextV1Request.iPage) &&
        Objects.equals(this.eSection, ezsigntemplatedocumentExtractTextV1Request.eSection) &&
        Objects.equals(this.iX, ezsigntemplatedocumentExtractTextV1Request.iX) &&
        Objects.equals(this.iY, ezsigntemplatedocumentExtractTextV1Request.iY) &&
        Objects.equals(this.iWidth, ezsigntemplatedocumentExtractTextV1Request.iWidth) &&
        Objects.equals(this.iHeight, ezsigntemplatedocumentExtractTextV1Request.iHeight);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iPage", "eSection", "iX", "iY", "iWidth", "iHeight"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iPage"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatedocumentExtractTextV1Request
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatedocumentExtractTextV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatedocumentExtractTextV1Request is not found in the empty JSON string", EzsigntemplatedocumentExtractTextV1Request.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatedocumentExtractTextV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatedocumentExtractTextV1Request` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplatedocumentExtractTextV1Request.openapiRequiredFields) {
      ...
      if ((jsonObj.get("eSection") != null && !jsonObj.get("eSection").isJsonNull()) && !jsonObj.get("eSection").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eSection` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eSection").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatedocumentExtractTextV1Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatedocumentExtractTextV1Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatedocumentExtractTextV1Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatedocumentExtractTextV1Request.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatedocumentExtractTextV1Request>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatedocumentExtractTextV1Request value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplatedocumentExtractTextV1Request read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplatedocumentExtractTextV1Request given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplatedocumentExtractTextV1Request
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplatedocumentExtractTextV1Request
   */
  public static EzsigntemplatedocumentExtractTextV1Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplatedocumentExtractTextV1Request.class);
  }

  /**
   * Convert an instance of EzsigntemplatedocumentExtractTextV1Request to an JSON string
   *
   * @return JSON string
   */
