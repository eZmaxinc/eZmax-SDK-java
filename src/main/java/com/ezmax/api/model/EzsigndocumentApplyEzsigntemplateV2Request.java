...
public class EzsigndocumentApplyEzsigntemplateV2Request {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiEzsigntemplateID", "a_sEzsigntemplatesigner", "a_pkiEzsignfoldersignerassociationID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiEzsigntemplateID", "a_sEzsigntemplatesigner", "a_pkiEzsignfoldersignerassociationID"));
  }
