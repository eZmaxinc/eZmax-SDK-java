...
public class CustomEzsignformfieldgroupRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignformfieldgroupID", "sEzsignformfieldgroupLabel", "a_objEzsignformfield"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("a_objEzsignformfield"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzsignformfieldgroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzsignformfieldgroupRequest is not found in the empty JSON string", CustomEzsignformfieldgroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignformfieldgroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzsignformfieldgroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
