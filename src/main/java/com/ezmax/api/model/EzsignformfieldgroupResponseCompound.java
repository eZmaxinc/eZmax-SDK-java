...
public class EzsignformfieldgroupResponseCompound {
  ...
  public EzsignformfieldgroupResponseCompound dtEzsignformfieldgroupCompleted(@javax.annotation.Nullable String dtEzsignformfieldgroupCompleted) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignformfieldgroupID, ezsignformfieldgroupResponseCompound.pkiEzsignformfieldgroupID) &&
        Objects.equals(this.fkiEzsigndocumentID, ezsignformfieldgroupResponseCompound.fkiEzsigndocumentID) &&
        Objects.equals(this.eEzsignformfieldgroupType, ezsignformfieldgroupResponseCompound.eEzsignformfieldgroupType) &&
        Objects.equals(this.eEzsignformfieldgroupSignerrequirement, ezsignformfieldgroupResponseCompound.eEzsignformfieldgroupSignerrequirement) &&
        Objects.equals(this.sEzsignformfieldgroupLabel, ezsignformfieldgroupResponseCompound.sEzsignformfieldgroupLabel) &&
        Objects.equals(this.iEzsignformfieldgroupStep, ezsignformfieldgroupResponseCompound.iEzsignformfieldgroupStep) &&
        Objects.equals(this.sEzsignformfieldgroupDefaultvalue, ezsignformfieldgroupResponseCompound.sEzsignformfieldgroupDefaultvalue) &&
        Objects.equals(this.iEzsignformfieldgroupFilledmin, ezsignformfieldgroupResponseCompound.iEzsignformfieldgroupFilledmin) &&
        Objects.equals(this.iEzsignformfieldgroupFilledmax, ezsignformfieldgroupResponseCompound.iEzsignformfieldgroupFilledmax) &&
        ...
        Objects.equals(this.sEzsignformfieldgroupTextvalidationcustommessage, ezsignformfieldgroupResponseCompound.sEzsignformfieldgroupTextvalidationcustommessage) &&
        ...
        Objects.equals(this.dtEzsignformfieldgroupCompleted, ezsignformfieldgroupResponseCompound.dtEzsignformfieldgroupCompleted) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignformfieldgroupID, fkiEzsigndocumentID, eEzsignformfieldgroupType, eEzsignformfieldgroupSignerrequirement, sEzsignformfieldgroupLabel, iEzsignformfieldgroupStep, sEzsignformfieldgroupDefaultvalue, iEzsignformfieldgroupFilledmin, iEzsignformfieldgroupFilledmax, bEzsignformfieldgroupReadonly, iEzsignformfieldgroupMaxlength, bEzsignformfieldgroupEncrypted, eEzsignformfieldgroupTextvalidation, sEzsignformfieldgroupRegexp, sEzsignformfieldgroupTextvalidationcustommessage, tEzsignformfieldgroupTooltip, eEzsignformfieldgroupTooltipposition, dtEzsignformfieldgroupCompleted, aObjEzsignformfield, aObjDropdownElement, aObjEzsignformfieldgroupsigner);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignformfieldgroupID", "fkiEzsigndocumentID", "eEzsignformfieldgroupType", "eEzsignformfieldgroupSignerrequirement", "sEzsignformfieldgroupLabel", "iEzsignformfieldgroupStep", "sEzsignformfieldgroupDefaultvalue", "iEzsignformfieldgroupFilledmin", "iEzsignformfieldgroupFilledmax", "bEzsignformfieldgroupReadonly", "iEzsignformfieldgroupMaxlength", "bEzsignformfieldgroupEncrypted", "eEzsignformfieldgroupTextvalidation", "sEzsignformfieldgroupRegexp", "sEzsignformfieldgroupTextvalidationcustommessage", "tEzsignformfieldgroupTooltip", "eEzsignformfieldgroupTooltipposition", "dtEzsignformfieldgroupCompleted", "a_objEzsignformfield", "a_objDropdownElement", "a_objEzsignformfieldgroupsigner"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignformfieldgroupResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignformfieldgroupResponseCompound is not found in the empty JSON string", EzsignformfieldgroupResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignformfieldgroupResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignformfieldgroupResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
