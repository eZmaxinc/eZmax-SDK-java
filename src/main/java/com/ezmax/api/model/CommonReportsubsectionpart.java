  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonReportsubsectionpart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CommonReportsubsectionpart is not found in the empty JSON string", CommonReportsubsectionpart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonReportsubsectionpart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonReportsubsectionpart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("eReportsubsectionpartType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `eReportsubsectionpartType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eReportsubsectionpartType").toString()));
      }
      ...
      if (!jsonObj.get("a_objReportrow").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objReportrow` to be an array in the JSON string but got `%s`", jsonObj.get("a_objReportrow").toString()));
      }
