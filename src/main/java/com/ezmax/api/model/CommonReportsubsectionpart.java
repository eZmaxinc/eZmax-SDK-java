...
public class CommonReportsubsectionpart {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eReportsubsectionpartType", "a_objReportrow", "a_sVariableobjectProperty"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eReportsubsectionpartType", "a_objReportrow", "a_sVariableobjectProperty"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonReportsubsectionpart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonReportsubsectionpart is not found in the empty JSON string", CommonReportsubsectionpart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonReportsubsectionpart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonReportsubsectionpart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("eReportsubsectionpartType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eReportsubsectionpartType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eReportsubsectionpartType").toString()));
      }
