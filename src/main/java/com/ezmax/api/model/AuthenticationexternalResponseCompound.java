  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationexternalResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AuthenticationexternalResponseCompound is not found in the empty JSON string", AuthenticationexternalResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationexternalResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthenticationexternalResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sAuthenticationexternalAuthorizationurl") != null && !jsonObj.get("sAuthenticationexternalAuthorizationurl").isJsonNull()) && !jsonObj.get("sAuthenticationexternalAuthorizationurl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sAuthenticationexternalAuthorizationurl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sAuthenticationexternalAuthorizationurl").toString()));
      }
