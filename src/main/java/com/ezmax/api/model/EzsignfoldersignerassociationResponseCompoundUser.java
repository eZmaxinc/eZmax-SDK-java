...
public class EzsignfoldersignerassociationResponseCompoundUser {
  ...
  public EzsignfoldersignerassociationResponseCompoundUser eUserType(@javax.annotation.Nonnull FieldEUserType eUserType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUserID, ezsignfoldersignerassociationResponseCompoundUser.pkiUserID) &&
        ...
        Objects.equals(this.eUserType, ezsignfoldersignerassociationResponseCompoundUser.eUserType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiUserID, fkiLanguageID, sUserFirstname, sUserLastname, sEmailAddress, eUserType);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiUserID", "fkiLanguageID", "sUserFirstname", "sUserLastname", "sEmailAddress", "eUserType"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiUserID", "fkiLanguageID", "sUserFirstname", "sUserLastname", "sEmailAddress", "eUserType"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldersignerassociationResponseCompoundUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignfoldersignerassociationResponseCompoundUser is not found in the empty JSON string", EzsignfoldersignerassociationResponseCompoundUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldersignerassociationResponseCompoundUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfoldersignerassociationResponseCompoundUser` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
