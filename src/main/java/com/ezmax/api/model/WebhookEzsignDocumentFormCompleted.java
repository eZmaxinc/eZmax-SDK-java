  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEzsignDocumentFormCompleted.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookEzsignDocumentFormCompleted is not found in the empty JSON string", WebhookEzsignDocumentFormCompleted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookEzsignDocumentFormCompleted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookEzsignDocumentFormCompleted` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
