...
public class PaymenttermRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "46", value = "The unique ID of the Paymentterm")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiPaymenttermID, sPaymenttermCode, objPaymenttermDescription, bPaymenttermIsactive);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymenttermRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymenttermRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymenttermRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymenttermRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
