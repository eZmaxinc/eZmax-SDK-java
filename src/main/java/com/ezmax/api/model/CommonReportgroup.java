...
public class CommonReportgroup {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("a_objReport", "a_objReportcellstyleCustom", "a_objReportgroupParameter", "sReportgroupFilename"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("a_objReport", "a_objReportcellstyleCustom", "a_objReportgroupParameter", "sReportgroupFilename"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonReportgroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CommonReportgroup is not found in the empty JSON string", CommonReportgroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonReportgroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonReportgroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("a_objReport").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objReport` to be an array in the JSON string but got `%s`", jsonObj.get("a_objReport").toString()));
      }
      ...
      if (!jsonObj.get("a_objReportcellstyleCustom").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objReportcellstyleCustom` to be an array in the JSON string but got `%s`", jsonObj.get("a_objReportcellstyleCustom").toString()));
      }
      ...
      if (!jsonObj.get("a_objReportgroupParameter").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objReportgroupParameter` to be an array in the JSON string but got `%s`", jsonObj.get("a_objReportgroupParameter").toString()));
      }
      ...
      if (!jsonObj.get("sReportgroupFilename").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sReportgroupFilename` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sReportgroupFilename").toString()));
      }
  }
