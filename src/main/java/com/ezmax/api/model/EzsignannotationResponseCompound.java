...
public class EzsignannotationResponseCompound {
  ...
  public EzsignannotationResponseCompound() {
  }

  public EzsignannotationResponseCompound pkiEzsignannotationID(@javax.annotation.Nonnull Integer pkiEzsignannotationID) {
  ...
  public EzsignannotationResponseCompound fkiEzsigndocumentID(@javax.annotation.Nonnull Integer fkiEzsigndocumentID) {
  ...
  public EzsignannotationResponseCompound eEzsignannotationHorizontalalignment(@javax.annotation.Nullable EnumHorizontalalignment eEzsignannotationHorizontalalignment) {
  ...
  public EzsignannotationResponseCompound eEzsignannotationVerticalalignment(@javax.annotation.Nullable EnumVerticalalignment eEzsignannotationVerticalalignment) {
  ...
  public EzsignannotationResponseCompound eEzsignannotationType(@javax.annotation.Nonnull FieldEEzsignannotationType eEzsignannotationType) {
  ...
  public EzsignannotationResponseCompound iEzsignannotationX(@javax.annotation.Nonnull Integer iEzsignannotationX) {
  ...
  public EzsignannotationResponseCompound iEzsignannotationY(@javax.annotation.Nonnull Integer iEzsignannotationY) {
  ...
  public EzsignannotationResponseCompound iEzsignannotationWidth(@javax.annotation.Nullable Integer iEzsignannotationWidth) {
  ...
  public EzsignannotationResponseCompound iEzsignannotationHeight(@javax.annotation.Nullable Integer iEzsignannotationHeight) {
  ...
  public EzsignannotationResponseCompound sEzsignannotationText(@javax.annotation.Nullable String sEzsignannotationText) {
  ...
  public EzsignannotationResponseCompound iEzsignpagePagenumber(@javax.annotation.Nonnull Integer iEzsignpagePagenumber) {
  ...
  public EzsignannotationResponseCompound objTextstylestatic(@javax.annotation.Nullable TextstylestaticResponseCompound objTextstylestatic) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignannotationID, ezsignannotationResponseCompound.pkiEzsignannotationID) &&
        Objects.equals(this.fkiEzsigndocumentID, ezsignannotationResponseCompound.fkiEzsigndocumentID) &&
        Objects.equals(this.eEzsignannotationHorizontalalignment, ezsignannotationResponseCompound.eEzsignannotationHorizontalalignment) &&
        Objects.equals(this.eEzsignannotationVerticalalignment, ezsignannotationResponseCompound.eEzsignannotationVerticalalignment) &&
        Objects.equals(this.eEzsignannotationType, ezsignannotationResponseCompound.eEzsignannotationType) &&
        Objects.equals(this.iEzsignannotationX, ezsignannotationResponseCompound.iEzsignannotationX) &&
        Objects.equals(this.iEzsignannotationY, ezsignannotationResponseCompound.iEzsignannotationY) &&
        Objects.equals(this.iEzsignannotationWidth, ezsignannotationResponseCompound.iEzsignannotationWidth) &&
        Objects.equals(this.iEzsignannotationHeight, ezsignannotationResponseCompound.iEzsignannotationHeight) &&
        Objects.equals(this.sEzsignannotationText, ezsignannotationResponseCompound.sEzsignannotationText) &&
        Objects.equals(this.iEzsignpagePagenumber, ezsignannotationResponseCompound.iEzsignpagePagenumber) &&
        Objects.equals(this.objTextstylestatic, ezsignannotationResponseCompound.objTextstylestatic);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignannotationID", "fkiEzsigndocumentID", "eEzsignannotationType", "iEzsignannotationX", "iEzsignannotationY", "iEzsignpagePagenumber"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignannotationResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignannotationResponseCompound is not found in the empty JSON string", EzsignannotationResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignannotationResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignannotationResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignannotationResponseCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignannotationResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignannotationResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignannotationResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignannotationResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignannotationResponseCompound>() {
           @Override
           public void write(JsonWriter out, EzsignannotationResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignannotationResponseCompound read(JsonReader in) throws IOException {
