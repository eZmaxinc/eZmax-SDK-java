...
public class SignatureResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiSignatureID, signatureResponse.pkiSignatureID) &&
        Objects.equals(this.fkiFontID, signatureResponse.fkiFontID) &&
        Objects.equals(this.sSignatureUrl, signatureResponse.sSignatureUrl) &&
        Objects.equals(this.sSignatureUrlinitials, signatureResponse.sSignatureUrlinitials);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiSignatureID", "fkiFontID", "sSignatureUrl", "sSignatureUrlinitials"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiSignatureID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignatureResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SignatureResponse is not found in the empty JSON string", SignatureResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignatureResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignatureResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sSignatureUrl") != null && !jsonObj.get("sSignatureUrl").isJsonNull()) && !jsonObj.get("sSignatureUrl").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sSignatureUrl` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sSignatureUrl").toString()));
      }
      if ((jsonObj.get("sSignatureUrlinitials") != null && !jsonObj.get("sSignatureUrlinitials").isJsonNull()) && !jsonObj.get("sSignatureUrlinitials").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sSignatureUrlinitials` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sSignatureUrlinitials").toString()));
      }
  }
