...
public class EzsigntemplatedocumentpagerecognitionRequestCompound {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound pkiEzsigntemplatedocumentpagerecognitionID(@javax.annotation.Nullable Integer pkiEzsigntemplatedocumentpagerecognitionID) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound fkiEzsigntemplatedocumentpageID(@javax.annotation.Nonnull Integer fkiEzsigntemplatedocumentpageID) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound eEzsigntemplatedocumentpagerecognitionOperator(@javax.annotation.Nonnull FieldEEzsigntemplatedocumentpagerecognitionOperator eEzsigntemplatedocumentpagerecognitionOperator) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound eEzsigntemplatedocumentpagerecognitionSection(@javax.annotation.Nonnull FieldEEzsigntemplatedocumentpagerecognitionSection eEzsigntemplatedocumentpagerecognitionSection) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound iEzsigntemplatedocumentpagerecognitionSimilarpercentage(@javax.annotation.Nullable Integer iEzsigntemplatedocumentpagerecognitionSimilarpercentage) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound iEzsigntemplatedocumentpagerecognitionX(@javax.annotation.Nullable Integer iEzsigntemplatedocumentpagerecognitionX) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound iEzsigntemplatedocumentpagerecognitionY(@javax.annotation.Nullable Integer iEzsigntemplatedocumentpagerecognitionY) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound iEzsigntemplatedocumentpagerecognitionWidth(@javax.annotation.Nullable Integer iEzsigntemplatedocumentpagerecognitionWidth) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound iEzsigntemplatedocumentpagerecognitionHeight(@javax.annotation.Nullable Integer iEzsigntemplatedocumentpagerecognitionHeight) {
  ...
  public EzsigntemplatedocumentpagerecognitionRequestCompound tEzsigntemplatedocumentpagerecognitionText(@javax.annotation.Nonnull String tEzsigntemplatedocumentpagerecognitionText) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplatedocumentpagerecognitionID, ezsigntemplatedocumentpagerecognitionRequestCompound.pkiEzsigntemplatedocumentpagerecognitionID) &&
        Objects.equals(this.fkiEzsigntemplatedocumentpageID, ezsigntemplatedocumentpagerecognitionRequestCompound.fkiEzsigntemplatedocumentpageID) &&
        Objects.equals(this.eEzsigntemplatedocumentpagerecognitionOperator, ezsigntemplatedocumentpagerecognitionRequestCompound.eEzsigntemplatedocumentpagerecognitionOperator) &&
        Objects.equals(this.eEzsigntemplatedocumentpagerecognitionSection, ezsigntemplatedocumentpagerecognitionRequestCompound.eEzsigntemplatedocumentpagerecognitionSection) &&
        Objects.equals(this.iEzsigntemplatedocumentpagerecognitionSimilarpercentage, ezsigntemplatedocumentpagerecognitionRequestCompound.iEzsigntemplatedocumentpagerecognitionSimilarpercentage) &&
        Objects.equals(this.iEzsigntemplatedocumentpagerecognitionX, ezsigntemplatedocumentpagerecognitionRequestCompound.iEzsigntemplatedocumentpagerecognitionX) &&
        Objects.equals(this.iEzsigntemplatedocumentpagerecognitionY, ezsigntemplatedocumentpagerecognitionRequestCompound.iEzsigntemplatedocumentpagerecognitionY) &&
        Objects.equals(this.iEzsigntemplatedocumentpagerecognitionWidth, ezsigntemplatedocumentpagerecognitionRequestCompound.iEzsigntemplatedocumentpagerecognitionWidth) &&
        Objects.equals(this.iEzsigntemplatedocumentpagerecognitionHeight, ezsigntemplatedocumentpagerecognitionRequestCompound.iEzsigntemplatedocumentpagerecognitionHeight) &&
        Objects.equals(this.tEzsigntemplatedocumentpagerecognitionText, ezsigntemplatedocumentpagerecognitionRequestCompound.tEzsigntemplatedocumentpagerecognitionText);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatedocumentpagerecognitionID", "fkiEzsigntemplatedocumentpageID", "eEzsigntemplatedocumentpagerecognitionOperator", "eEzsigntemplatedocumentpagerecognitionSection", "iEzsigntemplatedocumentpagerecognitionSimilarpercentage", "iEzsigntemplatedocumentpagerecognitionX", "iEzsigntemplatedocumentpagerecognitionY", "iEzsigntemplatedocumentpagerecognitionWidth", "iEzsigntemplatedocumentpagerecognitionHeight", "tEzsigntemplatedocumentpagerecognitionText"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiEzsigntemplatedocumentpageID", "eEzsigntemplatedocumentpagerecognitionOperator", "eEzsigntemplatedocumentpagerecognitionSection", "tEzsigntemplatedocumentpagerecognitionText"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatedocumentpagerecognitionRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatedocumentpagerecognitionRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatedocumentpagerecognitionRequestCompound is not found in the empty JSON string", EzsigntemplatedocumentpagerecognitionRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatedocumentpagerecognitionRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatedocumentpagerecognitionRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplatedocumentpagerecognitionRequestCompound.openapiRequiredFields) {
      ...
      if (!jsonObj.get("tEzsigntemplatedocumentpagerecognitionText").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tEzsigntemplatedocumentpagerecognitionText` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tEzsigntemplatedocumentpagerecognitionText").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatedocumentpagerecognitionRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatedocumentpagerecognitionRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatedocumentpagerecognitionRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatedocumentpagerecognitionRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatedocumentpagerecognitionRequestCompound>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatedocumentpagerecognitionRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplatedocumentpagerecognitionRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplatedocumentpagerecognitionRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplatedocumentpagerecognitionRequestCompound
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplatedocumentpagerecognitionRequestCompound
   */
  public static EzsigntemplatedocumentpagerecognitionRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplatedocumentpagerecognitionRequestCompound.class);
  }

  /**
   * Convert an instance of EzsigntemplatedocumentpagerecognitionRequestCompound to an JSON string
   *
   * @return JSON string
   */
