...
public class EzsignsignerRequest {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fkiTaxassignmentID, ezsignsignerRequest.fkiTaxassignmentID) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to EzsignsignerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EzsignsignerRequest.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignsignerRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
