...
import com.ezmax.api.model.CustomEzsignfoldersignerassociationstatusResponseV3;
...
public class EzsigndocumentResponseCompoundV3 {
  ...
  public static final String SERIALIZED_NAME_B_EZSIGNDOCUMENT_SENDTOGED = "bEzsigndocumentSendtoged";
  @SerializedName(SERIALIZED_NAME_B_EZSIGNDOCUMENT_SENDTOGED)
  @javax.annotation.Nullable
  private Boolean bEzsigndocumentSendtoged;
  ...
  public static final String SERIALIZED_NAME_I_EZSIGNDOCUMENT_STEPTOTAL = "iEzsigndocumentSteptotal";
  @SerializedName(SERIALIZED_NAME_I_EZSIGNDOCUMENT_STEPTOTAL)
  @javax.annotation.Nonnull
  private Integer iEzsigndocumentSteptotal;

  public static final String SERIALIZED_NAME_I_EZSIGNDOCUMENT_STEPCURRENT = "iEzsigndocumentStepcurrent";
  @SerializedName(SERIALIZED_NAME_I_EZSIGNDOCUMENT_STEPCURRENT)
  @javax.annotation.Nonnull
  private Integer iEzsigndocumentStepcurrent;
  ...
  @javax.annotation.Nonnull
  private List<CustomEzsignfoldersignerassociationstatusResponseV3> aObjEzsignfoldersignerassociationstatus = new ArrayList<>();
  ...
  public EzsigndocumentResponseCompoundV3() {
  }

  public EzsigndocumentResponseCompoundV3 pkiEzsigndocumentID(@javax.annotation.Nonnull Integer pkiEzsigndocumentID) {
  ...
  public EzsigndocumentResponseCompoundV3 fkiEzsignfolderID(@javax.annotation.Nonnull Integer fkiEzsignfolderID) {
  ...
  public EzsigndocumentResponseCompoundV3 fkiEzsignfoldersignerassociationIDDeclinedtosign(@javax.annotation.Nullable Integer fkiEzsignfoldersignerassociationIDDeclinedtosign) {
  ...
  public EzsigndocumentResponseCompoundV3 dtEzsigndocumentDuedate(@javax.annotation.Nonnull String dtEzsigndocumentDuedate) {
  ...
  public EzsigndocumentResponseCompoundV3 dtEzsignformCompleted(@javax.annotation.Nullable String dtEzsignformCompleted) {
  ...
  public EzsigndocumentResponseCompoundV3 fkiLanguageID(@javax.annotation.Nullable Integer fkiLanguageID) {
  ...
  public EzsigndocumentResponseCompoundV3 sEzsigndocumentName(@javax.annotation.Nonnull String sEzsigndocumentName) {
  ...
  public EzsigndocumentResponseCompoundV3 eEzsigndocumentStep(@javax.annotation.Nonnull FieldEEzsigndocumentStep eEzsigndocumentStep) {
  ...
  public EzsigndocumentResponseCompoundV3 dtEzsigndocumentFirstsend(@javax.annotation.Nullable String dtEzsigndocumentFirstsend) {
  ...
  public EzsigndocumentResponseCompoundV3 dtEzsigndocumentLastsend(@javax.annotation.Nullable String dtEzsigndocumentLastsend) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentOrder(@javax.annotation.Nonnull Integer iEzsigndocumentOrder) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentPagetotal(@javax.annotation.Nonnull Integer iEzsigndocumentPagetotal) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentSignaturesigned(@javax.annotation.Nonnull Integer iEzsigndocumentSignaturesigned) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentSignaturetotal(@javax.annotation.Nonnull Integer iEzsigndocumentSignaturetotal) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentFormfieldtotal(@javax.annotation.Nonnull Integer iEzsigndocumentFormfieldtotal) {
  ...
  public EzsigndocumentResponseCompoundV3 sEzsigndocumentMD5initial(@javax.annotation.Nullable String sEzsigndocumentMD5initial) {
  ...
  public EzsigndocumentResponseCompoundV3 tEzsigndocumentDeclinedtosignreason(@javax.annotation.Nullable String tEzsigndocumentDeclinedtosignreason) {
  ...
  public EzsigndocumentResponseCompoundV3 sEzsigndocumentMD5signed(@javax.annotation.Nullable String sEzsigndocumentMD5signed) {
  ...
  public EzsigndocumentResponseCompoundV3 bEzsigndocumentEzsignform(@javax.annotation.Nullable Boolean bEzsigndocumentEzsignform) {
  ...
  public EzsigndocumentResponseCompoundV3 bEzsigndocumentHassignedsignatures(@javax.annotation.Nullable Boolean bEzsigndocumentHassignedsignatures) {
  ...
  public EzsigndocumentResponseCompoundV3 bEzsigndocumentSendtoged(@javax.annotation.Nullable Boolean bEzsigndocumentSendtoged) {
  ...
  public void setbEzsigndocumentSendtoged(@javax.annotation.Nullable Boolean bEzsigndocumentSendtoged) {
    this.bEzsigndocumentSendtoged = bEzsigndocumentSendtoged;
  }


  public EzsigndocumentResponseCompoundV3 objAudit(@javax.annotation.Nullable CommonAudit objAudit) {
  ...
  public EzsigndocumentResponseCompoundV3 sEzsigndocumentExternalid(@javax.annotation.Nullable String sEzsigndocumentExternalid) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentEzsignsignatureattachmenttotal(@javax.annotation.Nonnull Integer iEzsigndocumentEzsignsignatureattachmenttotal) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentEzsigndiscussiontotal(@javax.annotation.Nonnull Integer iEzsigndocumentEzsigndiscussiontotal) {
  ...
  public EzsigndocumentResponseCompoundV3 iEzsigndocumentSteptotal(@javax.annotation.Nonnull Integer iEzsigndocumentSteptotal) {
  ...
  public void setiEzsigndocumentSteptotal(@javax.annotation.Nonnull Integer iEzsigndocumentSteptotal) {
    this.iEzsigndocumentSteptotal = iEzsigndocumentSteptotal;
  }


  public EzsigndocumentResponseCompoundV3 iEzsigndocumentStepcurrent(@javax.annotation.Nonnull Integer iEzsigndocumentStepcurrent) {
  ...
  public void setiEzsigndocumentStepcurrent(@javax.annotation.Nonnull Integer iEzsigndocumentStepcurrent) {
    this.iEzsigndocumentStepcurrent = iEzsigndocumentStepcurrent;
  }


  public EzsigndocumentResponseCompoundV3 aObjEzsignfoldersignerassociationstatus(@javax.annotation.Nonnull List<CustomEzsignfoldersignerassociationstatusResponseV3> aObjEzsignfoldersignerassociationstatus) {
    this.aObjEzsignfoldersignerassociationstatus = aObjEzsignfoldersignerassociationstatus;
    return this;
  }

  public EzsigndocumentResponseCompoundV3 addAObjEzsignfoldersignerassociationstatusItem(CustomEzsignfoldersignerassociationstatusResponseV3 aObjEzsignfoldersignerassociationstatusItem) {
  ...
  public void setaObjEzsignfoldersignerassociationstatus(@javax.annotation.Nonnull List<CustomEzsignfoldersignerassociationstatusResponseV3> aObjEzsignfoldersignerassociationstatus) {
    this.aObjEzsignfoldersignerassociationstatus = aObjEzsignfoldersignerassociationstatus;
  }


  public EzsigndocumentResponseCompoundV3 aObjEzsigndocumentdependency(@javax.annotation.Nullable List<EzsigndocumentdependencyResponse> aObjEzsigndocumentdependency) {
    this.aObjEzsigndocumentdependency = aObjEzsigndocumentdependency;
    return this;
  }

  public EzsigndocumentResponseCompoundV3 addAObjEzsigndocumentdependencyItem(EzsigndocumentdependencyResponse aObjEzsigndocumentdependencyItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigndocumentID, ezsigndocumentResponseCompoundV3.pkiEzsigndocumentID) &&
        Objects.equals(this.fkiEzsignfolderID, ezsigndocumentResponseCompoundV3.fkiEzsignfolderID) &&
        Objects.equals(this.fkiEzsignfoldersignerassociationIDDeclinedtosign, ezsigndocumentResponseCompoundV3.fkiEzsignfoldersignerassociationIDDeclinedtosign) &&
        Objects.equals(this.dtEzsigndocumentDuedate, ezsigndocumentResponseCompoundV3.dtEzsigndocumentDuedate) &&
        Objects.equals(this.dtEzsignformCompleted, ezsigndocumentResponseCompoundV3.dtEzsignformCompleted) &&
        Objects.equals(this.fkiLanguageID, ezsigndocumentResponseCompoundV3.fkiLanguageID) &&
        Objects.equals(this.sEzsigndocumentName, ezsigndocumentResponseCompoundV3.sEzsigndocumentName) &&
        Objects.equals(this.eEzsigndocumentStep, ezsigndocumentResponseCompoundV3.eEzsigndocumentStep) &&
        Objects.equals(this.dtEzsigndocumentFirstsend, ezsigndocumentResponseCompoundV3.dtEzsigndocumentFirstsend) &&
        Objects.equals(this.dtEzsigndocumentLastsend, ezsigndocumentResponseCompoundV3.dtEzsigndocumentLastsend) &&
        Objects.equals(this.iEzsigndocumentOrder, ezsigndocumentResponseCompoundV3.iEzsigndocumentOrder) &&
        Objects.equals(this.iEzsigndocumentPagetotal, ezsigndocumentResponseCompoundV3.iEzsigndocumentPagetotal) &&
        Objects.equals(this.iEzsigndocumentSignaturesigned, ezsigndocumentResponseCompoundV3.iEzsigndocumentSignaturesigned) &&
        Objects.equals(this.iEzsigndocumentSignaturetotal, ezsigndocumentResponseCompoundV3.iEzsigndocumentSignaturetotal) &&
        Objects.equals(this.iEzsigndocumentFormfieldtotal, ezsigndocumentResponseCompoundV3.iEzsigndocumentFormfieldtotal) &&
        Objects.equals(this.sEzsigndocumentMD5initial, ezsigndocumentResponseCompoundV3.sEzsigndocumentMD5initial) &&
        Objects.equals(this.tEzsigndocumentDeclinedtosignreason, ezsigndocumentResponseCompoundV3.tEzsigndocumentDeclinedtosignreason) &&
        Objects.equals(this.sEzsigndocumentMD5signed, ezsigndocumentResponseCompoundV3.sEzsigndocumentMD5signed) &&
        Objects.equals(this.bEzsigndocumentEzsignform, ezsigndocumentResponseCompoundV3.bEzsigndocumentEzsignform) &&
        Objects.equals(this.bEzsigndocumentHassignedsignatures, ezsigndocumentResponseCompoundV3.bEzsigndocumentHassignedsignatures) &&
        Objects.equals(this.bEzsigndocumentSendtoged, ezsigndocumentResponseCompoundV3.bEzsigndocumentSendtoged) &&
        Objects.equals(this.objAudit, ezsigndocumentResponseCompoundV3.objAudit) &&
        Objects.equals(this.sEzsigndocumentExternalid, ezsigndocumentResponseCompoundV3.sEzsigndocumentExternalid) &&
        Objects.equals(this.iEzsigndocumentEzsignsignatureattachmenttotal, ezsigndocumentResponseCompoundV3.iEzsigndocumentEzsignsignatureattachmenttotal) &&
        Objects.equals(this.iEzsigndocumentEzsigndiscussiontotal, ezsigndocumentResponseCompoundV3.iEzsigndocumentEzsigndiscussiontotal) &&
        Objects.equals(this.iEzsigndocumentSteptotal, ezsigndocumentResponseCompoundV3.iEzsigndocumentSteptotal) &&
        Objects.equals(this.iEzsigndocumentStepcurrent, ezsigndocumentResponseCompoundV3.iEzsigndocumentStepcurrent) &&
        Objects.equals(this.aObjEzsignfoldersignerassociationstatus, ezsigndocumentResponseCompoundV3.aObjEzsignfoldersignerassociationstatus) &&
        Objects.equals(this.aObjEzsigndocumentdependency, ezsigndocumentResponseCompoundV3.aObjEzsigndocumentdependency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsigndocumentID, fkiEzsignfolderID, fkiEzsignfoldersignerassociationIDDeclinedtosign, dtEzsigndocumentDuedate, dtEzsignformCompleted, fkiLanguageID, sEzsigndocumentName, eEzsigndocumentStep, dtEzsigndocumentFirstsend, dtEzsigndocumentLastsend, iEzsigndocumentOrder, iEzsigndocumentPagetotal, iEzsigndocumentSignaturesigned, iEzsigndocumentSignaturetotal, iEzsigndocumentFormfieldtotal, sEzsigndocumentMD5initial, tEzsigndocumentDeclinedtosignreason, sEzsigndocumentMD5signed, bEzsigndocumentEzsignform, bEzsigndocumentHassignedsignatures, bEzsigndocumentSendtoged, objAudit, sEzsigndocumentExternalid, iEzsigndocumentEzsignsignatureattachmenttotal, iEzsigndocumentEzsigndiscussiontotal, iEzsigndocumentSteptotal, iEzsigndocumentStepcurrent, aObjEzsignfoldersignerassociationstatus, aObjEzsigndocumentdependency);
  }
  ...
  public String toString() {
    ...
    sb.append("    bEzsigndocumentSendtoged: ").append(toIndentedString(bEzsigndocumentSendtoged)).append("\n");
    ...
    sb.append("    iEzsigndocumentSteptotal: ").append(toIndentedString(iEzsigndocumentSteptotal)).append("\n");
    sb.append("    iEzsigndocumentStepcurrent: ").append(toIndentedString(iEzsigndocumentStepcurrent)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigndocumentID", "fkiEzsignfolderID", "fkiEzsignfoldersignerassociationIDDeclinedtosign", "dtEzsigndocumentDuedate", "dtEzsignformCompleted", "fkiLanguageID", "sEzsigndocumentName", "eEzsigndocumentStep", "dtEzsigndocumentFirstsend", "dtEzsigndocumentLastsend", "iEzsigndocumentOrder", "iEzsigndocumentPagetotal", "iEzsigndocumentSignaturesigned", "iEzsigndocumentSignaturetotal", "iEzsigndocumentFormfieldtotal", "sEzsigndocumentMD5initial", "tEzsigndocumentDeclinedtosignreason", "sEzsigndocumentMD5signed", "bEzsigndocumentEzsignform", "bEzsigndocumentHassignedsignatures", "bEzsigndocumentSendtoged", "objAudit", "sEzsigndocumentExternalid", "iEzsigndocumentEzsignsignatureattachmenttotal", "iEzsigndocumentEzsigndiscussiontotal", "iEzsigndocumentSteptotal", "iEzsigndocumentStepcurrent", "a_objEzsignfoldersignerassociationstatus", "a_objEzsigndocumentdependency"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsigndocumentID", "fkiEzsignfolderID", "dtEzsigndocumentDuedate", "sEzsigndocumentName", "eEzsigndocumentStep", "iEzsigndocumentOrder", "iEzsigndocumentPagetotal", "iEzsigndocumentSignaturesigned", "iEzsigndocumentSignaturetotal", "iEzsigndocumentFormfieldtotal", "iEzsigndocumentEzsignsignatureattachmenttotal", "iEzsigndocumentEzsigndiscussiontotal", "iEzsigndocumentSteptotal", "iEzsigndocumentStepcurrent", "a_objEzsignfoldersignerassociationstatus"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigndocumentResponseCompoundV3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigndocumentResponseCompoundV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsigndocumentResponseCompoundV3 is not found in the empty JSON string", EzsigndocumentResponseCompoundV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigndocumentResponseCompoundV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigndocumentResponseCompoundV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigndocumentResponseCompoundV3.openapiRequiredFields) {
      ...
      if ((jsonObj.get("dtEzsignformCompleted") != null && !jsonObj.get("dtEzsignformCompleted").isJsonNull()) && !jsonObj.get("dtEzsignformCompleted").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtEzsignformCompleted` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzsignformCompleted").toString()));
      }
      if (!jsonObj.get("sEzsigndocumentName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentName").toString()));
      }
      ...
      if ((jsonObj.get("dtEzsigndocumentFirstsend") != null && !jsonObj.get("dtEzsigndocumentFirstsend").isJsonNull()) && !jsonObj.get("dtEzsigndocumentFirstsend").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtEzsigndocumentFirstsend` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzsigndocumentFirstsend").toString()));
      }
      if ((jsonObj.get("dtEzsigndocumentLastsend") != null && !jsonObj.get("dtEzsigndocumentLastsend").isJsonNull()) && !jsonObj.get("dtEzsigndocumentLastsend").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtEzsigndocumentLastsend` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzsigndocumentLastsend").toString()));
      }
      if ((jsonObj.get("sEzsigndocumentMD5initial") != null && !jsonObj.get("sEzsigndocumentMD5initial").isJsonNull()) && !jsonObj.get("sEzsigndocumentMD5initial").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentMD5initial` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentMD5initial").toString()));
      }
      if ((jsonObj.get("tEzsigndocumentDeclinedtosignreason") != null && !jsonObj.get("tEzsigndocumentDeclinedtosignreason").isJsonNull()) && !jsonObj.get("tEzsigndocumentDeclinedtosignreason").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `tEzsigndocumentDeclinedtosignreason` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tEzsigndocumentDeclinedtosignreason").toString()));
      }
      if ((jsonObj.get("sEzsigndocumentMD5signed") != null && !jsonObj.get("sEzsigndocumentMD5signed").isJsonNull()) && !jsonObj.get("sEzsigndocumentMD5signed").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentMD5signed` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentMD5signed").toString()));
      }
      ...
      if ((jsonObj.get("sEzsigndocumentExternalid") != null && !jsonObj.get("sEzsigndocumentExternalid").isJsonNull()) && !jsonObj.get("sEzsigndocumentExternalid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigndocumentExternalid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigndocumentExternalid").toString()));
      }
      // ensure the json data is an array
      if (!jsonObj.get("a_objEzsignfoldersignerassociationstatus").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objEzsignfoldersignerassociationstatus` to be an array in the JSON string but got `%s`", jsonObj.get("a_objEzsignfoldersignerassociationstatus").toString()));
      }
      ...
      if (jsonObj.get("a_objEzsigndocumentdependency") != null && !jsonObj.get("a_objEzsigndocumentdependency").isJsonNull()) {
        ...
        if (jsonArrayaObjEzsigndocumentdependency != null) {
          ...
          if (!jsonObj.get("a_objEzsigndocumentdependency").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objEzsigndocumentdependency` to be an array in the JSON string but got `%s`", jsonObj.get("a_objEzsigndocumentdependency").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigndocumentResponseCompoundV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigndocumentResponseCompoundV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigndocumentResponseCompoundV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigndocumentResponseCompoundV3.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigndocumentResponseCompoundV3>() {
           @Override
           public void write(JsonWriter out, EzsigndocumentResponseCompoundV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigndocumentResponseCompoundV3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigndocumentResponseCompoundV3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigndocumentResponseCompoundV3
   * @throws IOException if the JSON string is invalid with respect to EzsigndocumentResponseCompoundV3
   */
  public static EzsigndocumentResponseCompoundV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigndocumentResponseCompoundV3.class);
  }

  /**
   * Convert an instance of EzsigndocumentResponseCompoundV3 to an JSON string
   *
   * @return JSON string
   */
