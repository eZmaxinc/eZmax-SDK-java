...
public class BrandingRequestCompound {
  ...
  public BrandingRequestCompound() {
  }

  public BrandingRequestCompound pkiBrandingID(Integer pkiBrandingID) {
  ...
  **/
  ...
  public BrandingRequestCompound objBrandingDescription(MultilingualBrandingDescription objBrandingDescription) {
  ...
  **/
  ...
  public BrandingRequestCompound eBrandingLogo(FieldEBrandingLogo eBrandingLogo) {
  ...
  **/
  ...
  public BrandingRequestCompound sBrandingBase64(byte[] sBrandingBase64) {
  ...
  **/
  ...
  public BrandingRequestCompound iBrandingColortext(Integer iBrandingColortext) {
  ...
  **/
  ...
  public BrandingRequestCompound iBrandingColortextlinkbox(Integer iBrandingColortextlinkbox) {
  ...
  **/
  ...
  public BrandingRequestCompound iBrandingColortextbutton(Integer iBrandingColortextbutton) {
  ...
  **/
  ...
  public BrandingRequestCompound iBrandingColorbackground(Integer iBrandingColorbackground) {
  ...
  **/
  ...
  public BrandingRequestCompound iBrandingColorbackgroundbutton(Integer iBrandingColorbackgroundbutton) {
  ...
  **/
  ...
  public BrandingRequestCompound iBrandingColorbackgroundsmallbox(Integer iBrandingColorbackgroundsmallbox) {
  ...
  **/
  ...
  public BrandingRequestCompound bBrandingIsactive(Boolean bBrandingIsactive) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BrandingRequestCompound brandingRequestCompound = (BrandingRequestCompound) o;
    return Objects.equals(this.pkiBrandingID, brandingRequestCompound.pkiBrandingID) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to BrandingRequestCompound
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BrandingRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrandingRequestCompound is not found in the empty JSON string", BrandingRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BrandingRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BrandingRequestCompound` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BrandingRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BrandingRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BrandingRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BrandingRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BrandingRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<BrandingRequestCompound>() {
           @Override
           public void write(JsonWriter out, BrandingRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BrandingRequestCompound read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of BrandingRequestCompound given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BrandingRequestCompound
  * @throws IOException if the JSON string is invalid with respect to BrandingRequestCompound
  */
  public static BrandingRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BrandingRequestCompound.class);
  }

 /**
  * Convert an instance of BrandingRequestCompound to an JSON string
  *
  * @return JSON string
  */
