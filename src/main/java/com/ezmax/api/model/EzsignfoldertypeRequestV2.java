...
public class EzsignfoldertypeRequestV2 {
  ...
  public EzsignfoldertypeRequestV2 pkiEzsignfoldertypeID(Integer pkiEzsignfoldertypeID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 objEzsignfoldertypeName(MultilingualEzsignfoldertypeName objEzsignfoldertypeName) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 fkiBrandingID(Integer fkiBrandingID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 fkiBillingentityinternalID(Integer fkiBillingentityinternalID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 fkiEzsigntsarequirementID(Integer fkiEzsigntsarequirementID) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 aFkiUserlogintypeID(List<Integer> aFkiUserlogintypeID) {
    this.aFkiUserlogintypeID = aFkiUserlogintypeID;
    return this;
  }

  public EzsignfoldertypeRequestV2 addAFkiUserlogintypeIDItem(Integer aFkiUserlogintypeIDItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 aFkiUsergroupIDAll(List<Integer> aFkiUsergroupIDAll) {
    this.aFkiUsergroupIDAll = aFkiUsergroupIDAll;
    return this;
  }

  public EzsignfoldertypeRequestV2 addAFkiUsergroupIDAllItem(Integer aFkiUsergroupIDAllItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 aFkiUsergroupIDRestricted(List<Integer> aFkiUsergroupIDRestricted) {
    this.aFkiUsergroupIDRestricted = aFkiUsergroupIDRestricted;
    return this;
  }

  public EzsignfoldertypeRequestV2 addAFkiUsergroupIDRestrictedItem(Integer aFkiUsergroupIDRestrictedItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 aFkiUsergroupIDTemplate(List<Integer> aFkiUsergroupIDTemplate) {
    this.aFkiUsergroupIDTemplate = aFkiUsergroupIDTemplate;
    return this;
  }

  public EzsignfoldertypeRequestV2 addAFkiUsergroupIDTemplateItem(Integer aFkiUsergroupIDTemplateItem) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 sEmailAddressSigned(String sEmailAddressSigned) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 sEmailAddressSummary(String sEmailAddressSummary) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 eEzsignfoldertypePrivacylevel(FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 eEzsignfoldertypeSendreminderfrequency(FieldEEzsignfoldertypeSendreminderfrequency eEzsignfoldertypeSendreminderfrequency) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 iEzsignfoldertypeArchivaldays(Integer iEzsignfoldertypeArchivaldays) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 eEzsignfoldertypeDisposal(FieldEEzsignfoldertypeDisposal eEzsignfoldertypeDisposal) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 eEzsignfoldertypeCompletion(FieldEEzsignfoldertypeCompletion eEzsignfoldertypeCompletion) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 iEzsignfoldertypeDisposaldays(Integer iEzsignfoldertypeDisposaldays) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 iEzsignfoldertypeDeadlinedays(Integer iEzsignfoldertypeDeadlinedays) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeDelegate(Boolean bEzsignfoldertypeDelegate) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeDiscussion(Boolean bEzsignfoldertypeDiscussion) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeReassignezsignsigner(Boolean bEzsignfoldertypeReassignezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeReassignuser(Boolean bEzsignfoldertypeReassignuser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtoezsignsigner(Boolean bEzsignfoldertypeSendsignedtoezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtouser(Boolean bEzsignfoldertypeSendsignedtouser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendattachmentezsignsigner(Boolean bEzsignfoldertypeSendattachmentezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendproofezsignsigner(Boolean bEzsignfoldertypeSendproofezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendattachmentuser(Boolean bEzsignfoldertypeSendattachmentuser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendproofuser(Boolean bEzsignfoldertypeSendproofuser) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendproofemail(Boolean bEzsignfoldertypeSendproofemail) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeAllowdownloadattachmentezsignsigner(Boolean bEzsignfoldertypeAllowdownloadattachmentezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeAllowdownloadproofezsignsigner(Boolean bEzsignfoldertypeAllowdownloadproofezsignsigner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendproofreceivealldocument(Boolean bEzsignfoldertypeSendproofreceivealldocument) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtodocumentowner(Boolean bEzsignfoldertypeSendsignedtodocumentowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtofolderowner(Boolean bEzsignfoldertypeSendsignedtofolderowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtofullgroup(Boolean bEzsignfoldertypeSendsignedtofullgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtolimitedgroup(Boolean bEzsignfoldertypeSendsignedtolimitedgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsignedtocolleague(Boolean bEzsignfoldertypeSendsignedtocolleague) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsummarytodocumentowner(Boolean bEzsignfoldertypeSendsummarytodocumentowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsummarytofolderowner(Boolean bEzsignfoldertypeSendsummarytofolderowner) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsummarytofullgroup(Boolean bEzsignfoldertypeSendsummarytofullgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsummarytolimitedgroup(Boolean bEzsignfoldertypeSendsummarytolimitedgroup) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeSendsummarytocolleague(Boolean bEzsignfoldertypeSendsummarytocolleague) {
  ...
  **/
  ...
  public EzsignfoldertypeRequestV2 bEzsignfoldertypeIsactive(Boolean bEzsignfoldertypeIsactive) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfoldertypeID, ezsignfoldertypeRequestV2.pkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertypeName, ezsignfoldertypeRequestV2.objEzsignfoldertypeName) &&
        Objects.equals(this.fkiBrandingID, ezsignfoldertypeRequestV2.fkiBrandingID) &&
        Objects.equals(this.fkiBillingentityinternalID, ezsignfoldertypeRequestV2.fkiBillingentityinternalID) &&
        Objects.equals(this.fkiEzsigntsarequirementID, ezsignfoldertypeRequestV2.fkiEzsigntsarequirementID) &&
        Objects.equals(this.aFkiUserlogintypeID, ezsignfoldertypeRequestV2.aFkiUserlogintypeID) &&
        Objects.equals(this.aFkiUsergroupIDAll, ezsignfoldertypeRequestV2.aFkiUsergroupIDAll) &&
        Objects.equals(this.aFkiUsergroupIDRestricted, ezsignfoldertypeRequestV2.aFkiUsergroupIDRestricted) &&
        Objects.equals(this.aFkiUsergroupIDTemplate, ezsignfoldertypeRequestV2.aFkiUsergroupIDTemplate) &&
        Objects.equals(this.sEmailAddressSigned, ezsignfoldertypeRequestV2.sEmailAddressSigned) &&
        Objects.equals(this.sEmailAddressSummary, ezsignfoldertypeRequestV2.sEmailAddressSummary) &&
        Objects.equals(this.eEzsignfoldertypePrivacylevel, ezsignfoldertypeRequestV2.eEzsignfoldertypePrivacylevel) &&
        Objects.equals(this.eEzsignfoldertypeSendreminderfrequency, ezsignfoldertypeRequestV2.eEzsignfoldertypeSendreminderfrequency) &&
        Objects.equals(this.iEzsignfoldertypeArchivaldays, ezsignfoldertypeRequestV2.iEzsignfoldertypeArchivaldays) &&
        Objects.equals(this.eEzsignfoldertypeDisposal, ezsignfoldertypeRequestV2.eEzsignfoldertypeDisposal) &&
        Objects.equals(this.eEzsignfoldertypeCompletion, ezsignfoldertypeRequestV2.eEzsignfoldertypeCompletion) &&
        Objects.equals(this.iEzsignfoldertypeDisposaldays, ezsignfoldertypeRequestV2.iEzsignfoldertypeDisposaldays) &&
        Objects.equals(this.iEzsignfoldertypeDeadlinedays, ezsignfoldertypeRequestV2.iEzsignfoldertypeDeadlinedays) &&
        Objects.equals(this.bEzsignfoldertypeDelegate, ezsignfoldertypeRequestV2.bEzsignfoldertypeDelegate) &&
        Objects.equals(this.bEzsignfoldertypeDiscussion, ezsignfoldertypeRequestV2.bEzsignfoldertypeDiscussion) &&
        Objects.equals(this.bEzsignfoldertypeReassignezsignsigner, ezsignfoldertypeRequestV2.bEzsignfoldertypeReassignezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeReassignuser, ezsignfoldertypeRequestV2.bEzsignfoldertypeReassignuser) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtoezsignsigner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtoezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtouser, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtouser) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentezsignsigner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofezsignsigner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentuser, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendattachmentuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofuser, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendproofuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofemail, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendproofemail) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadattachmentezsignsigner, ezsignfoldertypeRequestV2.bEzsignfoldertypeAllowdownloadattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadproofezsignsigner, ezsignfoldertypeRequestV2.bEzsignfoldertypeAllowdownloadproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofreceivealldocument, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendproofreceivealldocument) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtodocumentowner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofolderowner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofullgroup, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtolimitedgroup, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtocolleague, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsignedtocolleague) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytodocumentowner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsummarytodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofolderowner, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsummarytofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofullgroup, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsummarytofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytolimitedgroup, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsummarytolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytocolleague, ezsignfoldertypeRequestV2.bEzsignfoldertypeSendsummarytocolleague) &&
        Objects.equals(this.bEzsignfoldertypeIsactive, ezsignfoldertypeRequestV2.bEzsignfoldertypeIsactive);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EzsignfoldertypeRequestV2
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeRequestV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignfoldertypeRequestV2 is not found in the empty JSON string", EzsignfoldertypeRequestV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeRequestV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignfoldertypeRequestV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignfoldertypeRequestV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignfoldertypeRequestV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignfoldertypeRequestV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignfoldertypeRequestV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignfoldertypeRequestV2.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignfoldertypeRequestV2>() {
           @Override
           public void write(JsonWriter out, EzsignfoldertypeRequestV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignfoldertypeRequestV2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EzsignfoldertypeRequestV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EzsignfoldertypeRequestV2
  * @throws IOException if the JSON string is invalid with respect to EzsignfoldertypeRequestV2
  */
  public static EzsignfoldertypeRequestV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignfoldertypeRequestV2.class);
  }

 /**
  * Convert an instance of EzsignfoldertypeRequestV2 to an JSON string
  *
  * @return JSON string
  */
