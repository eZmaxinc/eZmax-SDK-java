...
public class UsergroupResponseCompound {
  ...
  public UsergroupResponseCompound pkiUsergroupID(Integer pkiUsergroupID) {
  ...
  **/
  ...
  public UsergroupResponseCompound objUsergroupName(MultilingualUsergroupName objUsergroupName) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsergroupResponseCompound
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsergroupResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UsergroupResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsergroupResponseCompound` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
