...
public class SsprValidateTokenV1Request {
  ...
  public SsprValidateTokenV1Request() { 
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SsprValidateTokenV1Request
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SsprValidateTokenV1Request.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SsprValidateTokenV1Request is not found in the empty JSON string", SsprValidateTokenV1Request.openapiRequiredFields.toString()));
        }
      }
      Set<Entry<String, JsonElement>> entries = jsonObj.entrySet();
      // check to see if the JSON string contains additional fields
      for (Entry<String, JsonElement> entry : entries) {
        if (!SsprValidateTokenV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SsprValidateTokenV1Request` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SsprValidateTokenV1Request.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SsprValidateTokenV1Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SsprValidateTokenV1Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SsprValidateTokenV1Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SsprValidateTokenV1Request.class));

       return (TypeAdapter<T>) new TypeAdapter<SsprValidateTokenV1Request>() {
           @Override
           public void write(JsonWriter out, SsprValidateTokenV1Request value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SsprValidateTokenV1Request read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SsprValidateTokenV1Request given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SsprValidateTokenV1Request
  * @throws IOException if the JSON string is invalid with respect to SsprValidateTokenV1Request
  */
  public static SsprValidateTokenV1Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SsprValidateTokenV1Request.class);
  }

 /**
  * Convert an instance of SsprValidateTokenV1Request to an JSON string
  *
  * @return JSON string
  */
