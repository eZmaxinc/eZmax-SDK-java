...
public class ApikeyRequestCompound {
  ...
  public ApikeyRequestCompound pkiApikeyID(@javax.annotation.Nullable Integer pkiApikeyID) {
  ...
  public ApikeyRequestCompound fkiUserID(@javax.annotation.Nonnull Integer fkiUserID) {
  ...
  public ApikeyRequestCompound objApikeyDescription(@javax.annotation.Nonnull MultilingualApikeyDescription objApikeyDescription) {
  ...
  public ApikeyRequestCompound bApikeyIsactive(@javax.annotation.Nullable Boolean bApikeyIsactive) {
  ...
  public ApikeyRequestCompound bApikeyIssigned(@javax.annotation.Nullable Boolean bApikeyIssigned) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiApikeyID", "fkiUserID", "objApikeyDescription", "bApikeyIsactive", "bApikeyIssigned"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiUserID", "objApikeyDescription"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApikeyRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApikeyRequestCompound is not found in the empty JSON string", ApikeyRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApikeyRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApikeyRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
