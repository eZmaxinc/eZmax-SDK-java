...
import com.ezmax.api.model.FieldEWebhookEzmaxpartnerevent;
...
public class WebhookResponseCompound {
  ...
  public static final String SERIALIZED_NAME_E_WEBHOOK_EZMAXPARTNEREVENT = "eWebhookEzmaxpartnerevent";
  @SerializedName(SERIALIZED_NAME_E_WEBHOOK_EZMAXPARTNEREVENT)
  @javax.annotation.Nullable
  private FieldEWebhookEzmaxpartnerevent eWebhookEzmaxpartnerevent;
  ...
  public static final String SERIALIZED_NAME_S_WEBHOOK_AUTHENTIFICATIONEXTERNALERROR = "sWebhookAuthentificationexternalerror";
  @SerializedName(SERIALIZED_NAME_S_WEBHOOK_AUTHENTIFICATIONEXTERNALERROR)
  @javax.annotation.Nullable
  private String sWebhookAuthentificationexternalerror;
  ...
  public WebhookResponseCompound pkiWebhookID(@javax.annotation.Nullable Integer pkiWebhookID) {
  ...
  public WebhookResponseCompound fkiAuthenticationexternalID(@javax.annotation.Nullable Integer fkiAuthenticationexternalID) {
  ...
  public WebhookResponseCompound sWebhookDescription(@javax.annotation.Nonnull String sWebhookDescription) {
  ...
  public WebhookResponseCompound fkiEzsignfoldertypeID(@javax.annotation.Nullable Integer fkiEzsignfoldertypeID) {
  ...
  public WebhookResponseCompound sEzsignfoldertypeNameX(@javax.annotation.Nullable String sEzsignfoldertypeNameX) {
  ...
  public WebhookResponseCompound eWebhookModule(@javax.annotation.Nonnull FieldEWebhookModule eWebhookModule) {
  ...
  public WebhookResponseCompound eWebhookEzmaxpartnerevent(@javax.annotation.Nullable FieldEWebhookEzmaxpartnerevent eWebhookEzmaxpartnerevent) {
    this.eWebhookEzmaxpartnerevent = eWebhookEzmaxpartnerevent;
    return this;
  }

  /**
   * Get eWebhookEzmaxpartnerevent
   * @return eWebhookEzmaxpartnerevent
   */
  @javax.annotation.Nullable
  public FieldEWebhookEzmaxpartnerevent geteWebhookEzmaxpartnerevent() {
    return eWebhookEzmaxpartnerevent;
  }

  public void seteWebhookEzmaxpartnerevent(@javax.annotation.Nullable FieldEWebhookEzmaxpartnerevent eWebhookEzmaxpartnerevent) {
    this.eWebhookEzmaxpartnerevent = eWebhookEzmaxpartnerevent;
  }


  public WebhookResponseCompound eWebhookEzsignevent(@javax.annotation.Nullable FieldEWebhookEzsignevent eWebhookEzsignevent) {
  ...
  public WebhookResponseCompound eWebhookManagementevent(@javax.annotation.Nullable FieldEWebhookManagementevent eWebhookManagementevent) {
  ...
  public WebhookResponseCompound eWebhookRealestateevent(@javax.annotation.Nullable FieldEWebhookRealestateevent eWebhookRealestateevent) {
  ...
  public WebhookResponseCompound sWebhookUrl(@javax.annotation.Nonnull String sWebhookUrl) {
  ...
  public WebhookResponseCompound sWebhookEmailfailed(@javax.annotation.Nonnull String sWebhookEmailfailed) {
  ...
  public WebhookResponseCompound sWebhookApikey(@javax.annotation.Nullable String sWebhookApikey) {
  ...
  public WebhookResponseCompound sWebhookSecret(@javax.annotation.Nullable String sWebhookSecret) {
  ...
  public WebhookResponseCompound bWebhookIsactive(@javax.annotation.Nonnull Boolean bWebhookIsactive) {
  ...
  public WebhookResponseCompound bWebhookIssigned(@javax.annotation.Nonnull Boolean bWebhookIssigned) {
  ...
  public WebhookResponseCompound bWebhookSkipsslvalidation(@javax.annotation.Nonnull Boolean bWebhookSkipsslvalidation) {
  ...
  public WebhookResponseCompound sAuthenticationexternalDescription(@javax.annotation.Nullable String sAuthenticationexternalDescription) {
  ...
  public WebhookResponseCompound objAudit(@javax.annotation.Nullable CommonAudit objAudit) {
  ...
  public WebhookResponseCompound sWebhookEvent(@javax.annotation.Nullable String sWebhookEvent) {
  ...
  public WebhookResponseCompound sWebhookAuthentificationexternalerror(@javax.annotation.Nullable String sWebhookAuthentificationexternalerror) {
   ...
   * @return sWebhookAuthentificationexternalerror
   */
  @javax.annotation.Nullable
  public String getsWebhookAuthentificationexternalerror() {
    return sWebhookAuthentificationexternalerror;
  }

  public void setsWebhookAuthentificationexternalerror(@javax.annotation.Nullable String sWebhookAuthentificationexternalerror) {
    this.sWebhookAuthentificationexternalerror = sWebhookAuthentificationexternalerror;
  }


  public WebhookResponseCompound aObjWebhookheader(@javax.annotation.Nullable List<WebhookheaderResponseCompound> aObjWebhookheader) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiWebhookID, webhookResponseCompound.pkiWebhookID) &&
        ...
        Objects.equals(this.eWebhookEzmaxpartnerevent, webhookResponseCompound.eWebhookEzmaxpartnerevent) &&
        ...
        Objects.equals(this.eWebhookRealestateevent, webhookResponseCompound.eWebhookRealestateevent) &&
        ...
        Objects.equals(this.sWebhookAuthentificationexternalerror, webhookResponseCompound.sWebhookAuthentificationexternalerror) &&
        Objects.equals(this.aObjWebhookheader, webhookResponseCompound.aObjWebhookheader);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiWebhookID, fkiAuthenticationexternalID, sWebhookDescription, fkiEzsignfoldertypeID, sEzsignfoldertypeNameX, eWebhookModule, eWebhookEzmaxpartnerevent, eWebhookEzsignevent, eWebhookManagementevent, eWebhookRealestateevent, sWebhookUrl, sWebhookEmailfailed, sWebhookApikey, sWebhookSecret, bWebhookIsactive, bWebhookIssigned, bWebhookSkipsslvalidation, sAuthenticationexternalDescription, objAudit, sWebhookEvent, sWebhookAuthentificationexternalerror, aObjWebhookheader);
  }
  ...
  public String toString() {
    ...
    sb.append("    sWebhookAuthentificationexternalerror: ").append(toIndentedString(sWebhookAuthentificationexternalerror)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiWebhookID", "fkiAuthenticationexternalID", "sWebhookDescription", "fkiEzsignfoldertypeID", "sEzsignfoldertypeNameX", "eWebhookModule", "eWebhookEzmaxpartnerevent", "eWebhookEzsignevent", "eWebhookManagementevent", "eWebhookRealestateevent", "sWebhookUrl", "sWebhookEmailfailed", "sWebhookApikey", "sWebhookSecret", "bWebhookIsactive", "bWebhookIssigned", "bWebhookSkipsslvalidation", "sAuthenticationexternalDescription", "objAudit", "sWebhookEvent", "sWebhookAuthentificationexternalerror", "a_objWebhookheader"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookResponseCompound is not found in the empty JSON string", WebhookResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `eWebhookEzmaxpartnerevent`
      if (jsonObj.get("eWebhookEzmaxpartnerevent") != null && !jsonObj.get("eWebhookEzmaxpartnerevent").isJsonNull()) {
        FieldEWebhookEzmaxpartnerevent.validateJsonElement(jsonObj.get("eWebhookEzmaxpartnerevent"));
      }
