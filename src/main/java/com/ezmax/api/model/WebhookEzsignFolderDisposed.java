...
public class WebhookEzsignFolderDisposed {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookEzsignFolderDisposed
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEzsignFolderDisposed.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookEzsignFolderDisposed is not found in the empty JSON string", WebhookEzsignFolderDisposed.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookEzsignFolderDisposed.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookEzsignFolderDisposed` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookEzsignFolderDisposed.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookEzsignFolderDisposed.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookEzsignFolderDisposed' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookEzsignFolderDisposed> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookEzsignFolderDisposed.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookEzsignFolderDisposed>() {
           @Override
           public void write(JsonWriter out, WebhookEzsignFolderDisposed value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookEzsignFolderDisposed read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookEzsignFolderDisposed given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookEzsignFolderDisposed
   * @throws IOException if the JSON string is invalid with respect to WebhookEzsignFolderDisposed
   */
  public static WebhookEzsignFolderDisposed fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookEzsignFolderDisposed.class);
  }

  /**
   * Convert an instance of WebhookEzsignFolderDisposed to an JSON string
   *
   * @return JSON string
   */
