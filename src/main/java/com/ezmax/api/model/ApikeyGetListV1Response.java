...
public class ApikeyGetListV1Response {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mPayload, apikeyGetListV1Response.mPayload) &&
        Objects.equals(this.objDebugPayload, apikeyGetListV1Response.objDebugPayload) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to ApikeyGetListV1Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ApikeyGetListV1Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ApikeyGetListV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApikeyGetListV1Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
