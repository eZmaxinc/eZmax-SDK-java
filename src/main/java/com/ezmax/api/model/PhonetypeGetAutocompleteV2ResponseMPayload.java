...
public class PhonetypeGetAutocompleteV2ResponseMPayload {
  ...
  public PhonetypeGetAutocompleteV2ResponseMPayload aObjPhonetype(@javax.annotation.Nonnull List<PhonetypeAutocompleteElementResponse> aObjPhonetype) {
  ...
  public void setaObjPhonetype(@javax.annotation.Nonnull List<PhonetypeAutocompleteElementResponse> aObjPhonetype) {
    this.aObjPhonetype = aObjPhonetype;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("a_objPhonetype"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("a_objPhonetype"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PhonetypeGetAutocompleteV2ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PhonetypeGetAutocompleteV2ResponseMPayload is not found in the empty JSON string", PhonetypeGetAutocompleteV2ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PhonetypeGetAutocompleteV2ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PhonetypeGetAutocompleteV2ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("a_objPhonetype") != null) {
        if (!jsonObj.get("a_objPhonetype").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `a_objPhonetype` to be an array in the JSON string but got `%s`", jsonObj.get("a_objPhonetype").toString()));
        }
