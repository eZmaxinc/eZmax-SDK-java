...
public class CustomerRequest {
  ...
  public CustomerRequest sCustomerNote(@javax.annotation.Nullable String sCustomerNote) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiCustomerID, customerRequest.pkiCustomerID) &&
        Objects.equals(this.fkiCompanyID, customerRequest.fkiCompanyID) &&
        Objects.equals(this.fkiCustomergroupID, customerRequest.fkiCustomergroupID) &&
        Objects.equals(this.sCustomerName, customerRequest.sCustomerName) &&
        Objects.equals(this.sCustomerNote, customerRequest.sCustomerNote) &&
        Objects.equals(this.fkiContactinformationsID, customerRequest.fkiContactinformationsID) &&
        Objects.equals(this.fkiContactcontainerID, customerRequest.fkiContactcontainerID) &&
        Objects.equals(this.fkiImageID, customerRequest.fkiImageID) &&
        Objects.equals(this.fkiGlaccountcontainerID, customerRequest.fkiGlaccountcontainerID) &&
        Objects.equals(this.fkiLanguageID, customerRequest.fkiLanguageID) &&
        Objects.equals(this.fkiDepartmentID, customerRequest.fkiDepartmentID) &&
        Objects.equals(this.fkiPaymentmethodID, customerRequest.fkiPaymentmethodID) &&
        Objects.equals(this.fkiElectronicfundstransferbankaccountID, customerRequest.fkiElectronicfundstransferbankaccountID) &&
        Objects.equals(this.fkiElectronicfundstransferbankaccountIDDirectdebit, customerRequest.fkiElectronicfundstransferbankaccountIDDirectdebit) &&
        Objects.equals(this.fkiSendingmethodID, customerRequest.fkiSendingmethodID) &&
        Objects.equals(this.fkiTaxassignmentID, customerRequest.fkiTaxassignmentID) &&
        Objects.equals(this.fkiAttendancestatusID, customerRequest.fkiAttendancestatusID) &&
        Objects.equals(this.fkiAgentIDVariableexpensechargeto, customerRequest.fkiAgentIDVariableexpensechargeto) &&
        Objects.equals(this.fkiBrokerIDVariableexpensechargeto, customerRequest.fkiBrokerIDVariableexpensechargeto) &&
        Objects.equals(this.fkiCustomerIDVariableexpensechargeto, customerRequest.fkiCustomerIDVariableexpensechargeto) &&
        Objects.equals(this.fkiGlaccountcontainerIDVariableexpensechargeto, customerRequest.fkiGlaccountcontainerIDVariableexpensechargeto) &&
        Objects.equals(this.fkiAgentIDSupplychargechargeto, customerRequest.fkiAgentIDSupplychargechargeto) &&
        Objects.equals(this.fkiBrokerIDSupplychargechargeto, customerRequest.fkiBrokerIDSupplychargechargeto) &&
        Objects.equals(this.fkiCustomerIDSupplychargechargeto, customerRequest.fkiCustomerIDSupplychargechargeto) &&
        Objects.equals(this.fkiGlaccountcontainerIDSupplychargechargeto, customerRequest.fkiGlaccountcontainerIDSupplychargechargeto) &&
        Objects.equals(this.fkiInvoicealternatelogoID, customerRequest.fkiInvoicealternatelogoID) &&
        Objects.equals(this.fkiSynchronizationlinkserverID, customerRequest.fkiSynchronizationlinkserverID) &&
        Objects.equals(this.efkiUserID, customerRequest.efkiUserID) &&
        Objects.equals(this.efksCustomerCode, customerRequest.efksCustomerCode) &&
        Objects.equals(this.sCustomerCode, customerRequest.sCustomerCode) &&
        Objects.equals(this.dCustomerFulltimeequivalent, customerRequest.dCustomerFulltimeequivalent) &&
        Objects.equals(this.iCustomerPhotocopiercode, customerRequest.iCustomerPhotocopiercode) &&
        Objects.equals(this.iCustomerLongdistancecode, customerRequest.iCustomerLongdistancecode) &&
        Objects.equals(this.iCustomerTimewindowstart, customerRequest.iCustomerTimewindowstart) &&
        Objects.equals(this.iCustomerTimewindowend, customerRequest.iCustomerTimewindowend) &&
        Objects.equals(this.dCustomerMinimumchargeableinterests, customerRequest.dCustomerMinimumchargeableinterests) &&
        Objects.equals(this.dtCustomerBirthdate, customerRequest.dtCustomerBirthdate) &&
        Objects.equals(this.dtCustomerTransfer, customerRequest.dtCustomerTransfer) &&
        Objects.equals(this.dtCustomerTransferappointment, customerRequest.dtCustomerTransferappointment) &&
        Objects.equals(this.dtCustomerTransfersurvey, customerRequest.dtCustomerTransfersurvey) &&
        Objects.equals(this.bCustomerIsactive, customerRequest.bCustomerIsactive) &&
        Objects.equals(this.bCustomerVariableexpensefinanced, customerRequest.bCustomerVariableexpensefinanced) &&
        Objects.equals(this.bCustomerVariableexpensefinancedtaxes, customerRequest.bCustomerVariableexpensefinancedtaxes) &&
        Objects.equals(this.bCustomerSupplychargefinanced, customerRequest.bCustomerSupplychargefinanced) &&
        Objects.equals(this.bCustomerSupplychargefinancedtaxes, customerRequest.bCustomerSupplychargefinancedtaxes) &&
        Objects.equals(this.bCustomerAttendance, customerRequest.bCustomerAttendance) &&
        Objects.equals(this.eCustomerType, customerRequest.eCustomerType) &&
        Objects.equals(this.eCustomerMarketingcorrespondence, customerRequest.eCustomerMarketingcorrespondence) &&
        Objects.equals(this.bCustomerBlackcopycarbon, customerRequest.bCustomerBlackcopycarbon) &&
        Objects.equals(this.bCustomerUnsubscribeinfo, customerRequest.bCustomerUnsubscribeinfo) &&
        Objects.equals(this.tCustomerComment, customerRequest.tCustomerComment) &&
        Objects.equals(this.IMPORTID, customerRequest.IMPORTID);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomerRequest is not found in the empty JSON string", CustomerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
