...
public class SystemconfigurationRequestCompoundV2 {
  ...
  public SystemconfigurationRequestCompoundV2() {
  }

  public SystemconfigurationRequestCompoundV2 pkiSystemconfigurationID(@javax.annotation.Nullable Integer pkiSystemconfigurationID) {
  ...
  public SystemconfigurationRequestCompoundV2 fkiBrandingID(@javax.annotation.Nullable Integer fkiBrandingID) {
  ...
  public SystemconfigurationRequestCompoundV2 eSystemconfigurationNewexternaluseraction(@javax.annotation.Nonnull FieldESystemconfigurationNewexternaluseraction eSystemconfigurationNewexternaluseraction) {
  ...
  public SystemconfigurationRequestCompoundV2 eSystemconfigurationLanguage1(@javax.annotation.Nonnull FieldESystemconfigurationLanguage1 eSystemconfigurationLanguage1) {
  ...
  public SystemconfigurationRequestCompoundV2 eSystemconfigurationLanguage2(@javax.annotation.Nonnull FieldESystemconfigurationLanguage2 eSystemconfigurationLanguage2) {
  ...
  public SystemconfigurationRequestCompoundV2 eSystemconfigurationEzsignofficeplan(@javax.annotation.Nullable FieldESystemconfigurationEzsignofficeplan eSystemconfigurationEzsignofficeplan) {
  ...
  public SystemconfigurationRequestCompoundV2 bSystemconfigurationEzsignpaidbyoffice(@javax.annotation.Nullable Boolean bSystemconfigurationEzsignpaidbyoffice) {
  ...
  public SystemconfigurationRequestCompoundV2 bSystemconfigurationEzsignpersonnal(@javax.annotation.Nonnull Boolean bSystemconfigurationEzsignpersonnal) {
  ...
  public SystemconfigurationRequestCompoundV2 bSystemconfigurationSspr(@javax.annotation.Nonnull Boolean bSystemconfigurationSspr) {
  ...
  public SystemconfigurationRequestCompoundV2 dtSystemconfigurationReadonlyexpirationstart(@javax.annotation.Nullable String dtSystemconfigurationReadonlyexpirationstart) {
  ...
  public SystemconfigurationRequestCompoundV2 dtSystemconfigurationReadonlyexpirationend(@javax.annotation.Nullable String dtSystemconfigurationReadonlyexpirationend) {
  ...
  public SystemconfigurationRequestCompoundV2 iSystemconfigurationEzsignreminderhoursend(@javax.annotation.Nonnull Integer iSystemconfigurationEzsignreminderhoursend) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiSystemconfigurationID, systemconfigurationRequestCompoundV2.pkiSystemconfigurationID) &&
        Objects.equals(this.fkiBrandingID, systemconfigurationRequestCompoundV2.fkiBrandingID) &&
        Objects.equals(this.eSystemconfigurationNewexternaluseraction, systemconfigurationRequestCompoundV2.eSystemconfigurationNewexternaluseraction) &&
        Objects.equals(this.eSystemconfigurationLanguage1, systemconfigurationRequestCompoundV2.eSystemconfigurationLanguage1) &&
        Objects.equals(this.eSystemconfigurationLanguage2, systemconfigurationRequestCompoundV2.eSystemconfigurationLanguage2) &&
        Objects.equals(this.eSystemconfigurationEzsignofficeplan, systemconfigurationRequestCompoundV2.eSystemconfigurationEzsignofficeplan) &&
        Objects.equals(this.bSystemconfigurationEzsignpaidbyoffice, systemconfigurationRequestCompoundV2.bSystemconfigurationEzsignpaidbyoffice) &&
        Objects.equals(this.bSystemconfigurationEzsignpersonnal, systemconfigurationRequestCompoundV2.bSystemconfigurationEzsignpersonnal) &&
        Objects.equals(this.bSystemconfigurationSspr, systemconfigurationRequestCompoundV2.bSystemconfigurationSspr) &&
        Objects.equals(this.dtSystemconfigurationReadonlyexpirationstart, systemconfigurationRequestCompoundV2.dtSystemconfigurationReadonlyexpirationstart) &&
        Objects.equals(this.dtSystemconfigurationReadonlyexpirationend, systemconfigurationRequestCompoundV2.dtSystemconfigurationReadonlyexpirationend) &&
        Objects.equals(this.iSystemconfigurationEzsignreminderhoursend, systemconfigurationRequestCompoundV2.iSystemconfigurationEzsignreminderhoursend);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SystemconfigurationRequestCompoundV2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SystemconfigurationRequestCompoundV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SystemconfigurationRequestCompoundV2 is not found in the empty JSON string", SystemconfigurationRequestCompoundV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SystemconfigurationRequestCompoundV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SystemconfigurationRequestCompoundV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SystemconfigurationRequestCompoundV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SystemconfigurationRequestCompoundV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SystemconfigurationRequestCompoundV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SystemconfigurationRequestCompoundV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SystemconfigurationRequestCompoundV2.class));

       return (TypeAdapter<T>) new TypeAdapter<SystemconfigurationRequestCompoundV2>() {
           @Override
           public void write(JsonWriter out, SystemconfigurationRequestCompoundV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SystemconfigurationRequestCompoundV2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SystemconfigurationRequestCompoundV2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SystemconfigurationRequestCompoundV2
   * @throws IOException if the JSON string is invalid with respect to SystemconfigurationRequestCompoundV2
   */
  public static SystemconfigurationRequestCompoundV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SystemconfigurationRequestCompoundV2.class);
  }

  /**
   * Convert an instance of SystemconfigurationRequestCompoundV2 to an JSON string
   *
   * @return JSON string
   */
