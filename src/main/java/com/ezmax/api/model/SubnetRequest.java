...
public class SubnetRequest {
  ...
  **/
  ...
  public SubnetRequest iSubnetNetwork(Integer iSubnetNetwork) {
  ...
  **/
  ...
  public SubnetRequest iSubnetMask(Integer iSubnetMask) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubnetRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubnetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SubnetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SubnetRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
