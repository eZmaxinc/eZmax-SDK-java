...
public class EzsigntemplatepublicCreateEzsignfolderV1Request {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pksEzmaxcustomerCode", "sEzsigntemplatepublicReferenceid", "a_sEzsigntemplatesignerDescription", "a_objEzsignsigner"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pksEzmaxcustomerCode", "sEzsigntemplatepublicReferenceid", "a_sEzsigntemplatesignerDescription", "a_objEzsignsigner"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("a_objEzsignsigner") != null) {
