...
public class WebhookEzmaxpartnerproductUnsubscribe {
  ...
  public WebhookEzmaxpartnerproductUnsubscribe objWebhook(@javax.annotation.Nonnull CustomWebhookResponse objWebhook) {
  ...
  public WebhookEzmaxpartnerproductUnsubscribe aObjAttempt(@javax.annotation.Nonnull List<AttemptResponseCompound> aObjAttempt) {
    this.aObjAttempt = aObjAttempt;
    return this;
  }

  public WebhookEzmaxpartnerproductUnsubscribe addAObjAttemptItem(AttemptResponseCompound aObjAttemptItem) {
  ...
  public WebhookEzmaxpartnerproductUnsubscribe objEzmaxpartnerproduct(@javax.annotation.Nonnull CustomEzmaxpartnerproductSubscribe objEzmaxpartnerproduct) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookEzmaxpartnerproductUnsubscribe
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEzmaxpartnerproductUnsubscribe.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookEzmaxpartnerproductUnsubscribe is not found in the empty JSON string", WebhookEzmaxpartnerproductUnsubscribe.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookEzmaxpartnerproductUnsubscribe.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookEzmaxpartnerproductUnsubscribe` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : WebhookEzmaxpartnerproductUnsubscribe.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookEzmaxpartnerproductUnsubscribe.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookEzmaxpartnerproductUnsubscribe' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookEzmaxpartnerproductUnsubscribe> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookEzmaxpartnerproductUnsubscribe.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookEzmaxpartnerproductUnsubscribe>() {
           @Override
           public void write(JsonWriter out, WebhookEzmaxpartnerproductUnsubscribe value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookEzmaxpartnerproductUnsubscribe read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WebhookEzmaxpartnerproductUnsubscribe given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WebhookEzmaxpartnerproductUnsubscribe
   * @throws IOException if the JSON string is invalid with respect to WebhookEzmaxpartnerproductUnsubscribe
   */
  public static WebhookEzmaxpartnerproductUnsubscribe fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WebhookEzmaxpartnerproductUnsubscribe.class);
  }

  /**
   * Convert an instance of WebhookEzmaxpartnerproductUnsubscribe to an JSON string
   *
   * @return JSON string
   */
