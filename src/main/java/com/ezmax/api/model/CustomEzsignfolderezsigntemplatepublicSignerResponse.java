...
public class CustomEzsignfolderezsigntemplatepublicSignerResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiUserID", "fkiEzsignsignergroupID", "sContactFirstname", "sContactLastname", "sEzsignsignergroupDescriptionX"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzsignfolderezsigntemplatepublicSignerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzsignfolderezsigntemplatepublicSignerResponse is not found in the empty JSON string", CustomEzsignfolderezsigntemplatepublicSignerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignfolderezsigntemplatepublicSignerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzsignfolderezsigntemplatepublicSignerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
