...
public class VariableexpenseResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariableexpenseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableexpenseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariableexpenseResponse is not found in the empty JSON string", VariableexpenseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariableexpenseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VariableexpenseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
