...
public class PhoneResponseCompound {
  ...
  public static final String SERIALIZED_NAME_I_PHONE_NUMBER = "iPhoneNumber";
  @SerializedName(SERIALIZED_NAME_I_PHONE_NUMBER)
  ...
  **/
  ...
  public PhoneResponseCompound sPhoneRegion(String sPhoneRegion) {
  ...
  **/
  ...
  public PhoneResponseCompound sPhoneExchange(String sPhoneExchange) {
  ...
  **/
  ...
  public PhoneResponseCompound iPhoneNumber(String iPhoneNumber) {
  ...
  **/
  ...
  public PhoneResponseCompound sPhoneInternational(String sPhoneInternational) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "15149901516", value = "The international phone number.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiPhoneID, phoneResponseCompound.pkiPhoneID) &&
        ...
        Objects.equals(this.sPhoneRegion, phoneResponseCompound.sPhoneRegion) &&
        Objects.equals(this.sPhoneExchange, phoneResponseCompound.sPhoneExchange) &&
        Objects.equals(this.iPhoneNumber, phoneResponseCompound.iPhoneNumber) &&
        Objects.equals(this.sPhoneExtension, phoneResponseCompound.sPhoneExtension) &&
        Objects.equals(this.sPhoneInternational, phoneResponseCompound.sPhoneInternational);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiPhoneID, fkiPhonetypeID, ePhoneType, sPhoneRegion, sPhoneExchange, iPhoneNumber, sPhoneExtension, sPhoneInternational);
  }
  ...
  public String toString() {
    ...
    sb.append("    iPhoneNumber: ").append(toIndentedString(iPhoneNumber)).append("\n");
  ...
  static {
    ...
    openapiFields.add("iPhoneNumber");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PhoneResponseCompound
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PhoneResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PhoneResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PhoneResponseCompound` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("iPhoneNumber") != null && !jsonObj.get("iPhoneNumber").isJsonNull()) && !jsonObj.get("iPhoneNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `iPhoneNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("iPhoneNumber").toString()));
      }
