...
public class UserlogintypeResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUserlogintypeID, userlogintypeResponse.pkiUserlogintypeID) &&
        Objects.equals(this.objUserlogintypeDescription, userlogintypeResponse.objUserlogintypeDescription) &&
        Objects.equals(this.sUserlogintypeDescriptionX, userlogintypeResponse.sUserlogintypeDescriptionX);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiUserlogintypeID, objUserlogintypeDescription, sUserlogintypeDescriptionX);
  }
  ...
  public String toString() {
    ...
    sb.append("    objUserlogintypeDescription: ").append(toIndentedString(objUserlogintypeDescription)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiUserlogintypeID", "objUserlogintypeDescription", "sUserlogintypeDescriptionX"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiUserlogintypeID", "objUserlogintypeDescription", "sUserlogintypeDescriptionX"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserlogintypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserlogintypeResponse is not found in the empty JSON string", UserlogintypeResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserlogintypeResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserlogintypeResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserlogintypeResponse.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `objUserlogintypeDescription`
      MultilingualUserlogintypeDescription.validateJsonElement(jsonObj.get("objUserlogintypeDescription"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserlogintypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserlogintypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserlogintypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserlogintypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UserlogintypeResponse>() {
           @Override
           public void write(JsonWriter out, UserlogintypeResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserlogintypeResponse read(JsonReader in) throws IOException {
