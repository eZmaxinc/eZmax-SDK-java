...
public class DomainResponseCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiDomainID", "sDomainName", "bDomainValiddkim", "bDomainValidmailfrom", "bDomainValidcustomer", "objAudit", "a_objDnsrecord"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiDomainID", "sDomainName", "bDomainValiddkim", "bDomainValidmailfrom", "bDomainValidcustomer", "objAudit", "a_objDnsrecord"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DomainResponseCompound is not found in the empty JSON string", DomainResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DomainResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
