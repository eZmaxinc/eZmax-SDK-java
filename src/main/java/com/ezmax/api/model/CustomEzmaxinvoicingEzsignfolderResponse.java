...
public class CustomEzmaxinvoicingEzsignfolderResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fkiEzsignfolderID, fkiBillingentityinternalID, sEzsignfolderDescription, bEzsigntsarequirementBillable, bEzsignfolderMfaused, bEzsignfolderAllowed);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiEzsignfolderID", "fkiBillingentityinternalID", "sEzsignfolderDescription", "bEzsigntsarequirementBillable", "bEzsignfolderMfaused", "bEzsignfolderAllowed"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiEzsignfolderID", "sEzsignfolderDescription", "bEzsigntsarequirementBillable", "bEzsignfolderMfaused", "bEzsignfolderAllowed"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzmaxinvoicingEzsignfolderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzmaxinvoicingEzsignfolderResponse is not found in the empty JSON string", CustomEzmaxinvoicingEzsignfolderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzmaxinvoicingEzsignfolderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzmaxinvoicingEzsignfolderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
