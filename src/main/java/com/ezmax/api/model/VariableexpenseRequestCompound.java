...
public class VariableexpenseRequestCompound {
  ...
  public VariableexpenseRequestCompound pkiVariableexpenseID(@javax.annotation.Nullable Integer pkiVariableexpenseID) {
  ...
  public VariableexpenseRequestCompound sVariableexpenseCode(@javax.annotation.Nonnull String sVariableexpenseCode) {
  ...
  public VariableexpenseRequestCompound objVariableexpenseDescription(@javax.annotation.Nonnull MultilingualVariableexpenseDescription objVariableexpenseDescription) {
  ...
  public VariableexpenseRequestCompound eVariableexpenseTaxable(@javax.annotation.Nonnull FieldEVariableexpenseTaxable eVariableexpenseTaxable) {
  ...
  public VariableexpenseRequestCompound bVariableexpenseIsactive(@javax.annotation.Nonnull Boolean bVariableexpenseIsactive) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiVariableexpenseID", "sVariableexpenseCode", "objVariableexpenseDescription", "eVariableexpenseTaxable", "bVariableexpenseIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sVariableexpenseCode", "objVariableexpenseDescription", "eVariableexpenseTaxable", "bVariableexpenseIsactive"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VariableexpenseRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableexpenseRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariableexpenseRequestCompound is not found in the empty JSON string", VariableexpenseRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariableexpenseRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VariableexpenseRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VariableexpenseRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariableexpenseRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariableexpenseRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariableexpenseRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariableexpenseRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<VariableexpenseRequestCompound>() {
           @Override
           public void write(JsonWriter out, VariableexpenseRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VariableexpenseRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VariableexpenseRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VariableexpenseRequestCompound
   * @throws IOException if the JSON string is invalid with respect to VariableexpenseRequestCompound
   */
  public static VariableexpenseRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VariableexpenseRequestCompound.class);
  }

  /**
   * Convert an instance of VariableexpenseRequestCompound to an JSON string
   *
   * @return JSON string
   */
