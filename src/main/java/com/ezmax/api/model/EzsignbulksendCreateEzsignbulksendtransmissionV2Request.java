...
public class EzsignbulksendCreateEzsignbulksendtransmissionV2Request {
  ...
  public EzsignbulksendCreateEzsignbulksendtransmissionV2Request fkiSecretquestionID(@javax.annotation.Nullable Integer fkiSecretquestionID) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fkiUserlogintypeID, ezsignbulksendCreateEzsignbulksendtransmissionV2Request.fkiUserlogintypeID) &&
        Objects.equals(this.fkiSecretquestionID, ezsignbulksendCreateEzsignbulksendtransmissionV2Request.fkiSecretquestionID) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fkiUserlogintypeID, fkiSecretquestionID, fkiEzsigntsarequirementID, sEzsignbulksendtransmissionDescription, dtEzsigndocumentDuedate, iEzsignfolderSendreminderfirstdays, iEzsignfolderSendreminderotherdays, tExtraMessage, Arrays.hashCode(sCsvBase64));
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiUserlogintypeID", "fkiSecretquestionID", "fkiEzsigntsarequirementID", "sEzsignbulksendtransmissionDescription", "dtEzsigndocumentDuedate", "iEzsignfolderSendreminderfirstdays", "iEzsignfolderSendreminderotherdays", "tExtraMessage", "sCsvBase64"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiUserlogintypeID", "sEzsignbulksendtransmissionDescription", "dtEzsigndocumentDuedate", "iEzsignfolderSendreminderfirstdays", "iEzsignfolderSendreminderotherdays", "tExtraMessage", "sCsvBase64"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksendCreateEzsignbulksendtransmissionV2Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsignbulksendCreateEzsignbulksendtransmissionV2Request is not found in the empty JSON string", EzsignbulksendCreateEzsignbulksendtransmissionV2Request.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksendCreateEzsignbulksendtransmissionV2Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignbulksendCreateEzsignbulksendtransmissionV2Request` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("tExtraMessage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `tExtraMessage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tExtraMessage").toString()));
      }
  }
