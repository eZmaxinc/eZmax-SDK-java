...
public class SignatureResponseCompoundV3 {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiSignatureID", "fkiFontID", "eSignaturePreference", "bSignatureSvg", "bSignatureSvginitials"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiSignatureID", "fkiFontID", "eSignaturePreference", "bSignatureSvg", "bSignatureSvginitials"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignatureResponseCompoundV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SignatureResponseCompoundV3 is not found in the empty JSON string", SignatureResponseCompoundV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignatureResponseCompoundV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignatureResponseCompoundV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
