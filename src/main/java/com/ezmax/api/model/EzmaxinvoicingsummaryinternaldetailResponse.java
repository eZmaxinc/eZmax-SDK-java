...
public class EzmaxinvoicingsummaryinternaldetailResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzmaxinvoicingsummaryinternaldetailID", "fkiEzmaxinvoicingsummaryinternalID", "fkiEzmaxproductID", "sEzmaxproductDescriptionX", "fkiBillingentityexternalID", "sBillingentityexternalDescription", "dEzmaxinvoicingsummaryinternaldetailCountreal", "dEzmaxinvoicingsummaryinternaldetailSubtotal", "dEzmaxinvoicingsummaryinternaldetailRebate", "dEzmaxinvoicingsummaryinternaldetailTotal", "bEzmaxinvoicingsummaryinternaldetailAdjustment", "tEzmaxproductHelpX"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzmaxinvoicingsummaryinternaldetailResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzmaxinvoicingsummaryinternaldetailResponse is not found in the empty JSON string", EzmaxinvoicingsummaryinternaldetailResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzmaxinvoicingsummaryinternaldetailResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzmaxinvoicingsummaryinternaldetailResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sBillingentityexternalDescription").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sBillingentityexternalDescription` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sBillingentityexternalDescription").toString()));
      }
      if (!jsonObj.get("dEzmaxinvoicingsummaryinternaldetailCountreal").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dEzmaxinvoicingsummaryinternaldetailCountreal` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dEzmaxinvoicingsummaryinternaldetailCountreal").toString()));
      }
      if (!jsonObj.get("dEzmaxinvoicingsummaryinternaldetailSubtotal").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dEzmaxinvoicingsummaryinternaldetailSubtotal` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dEzmaxinvoicingsummaryinternaldetailSubtotal").toString()));
      }
      if (!jsonObj.get("dEzmaxinvoicingsummaryinternaldetailRebate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dEzmaxinvoicingsummaryinternaldetailRebate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dEzmaxinvoicingsummaryinternaldetailRebate").toString()));
      }
      if (!jsonObj.get("dEzmaxinvoicingsummaryinternaldetailTotal").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dEzmaxinvoicingsummaryinternaldetailTotal` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dEzmaxinvoicingsummaryinternaldetailTotal").toString()));
      }
