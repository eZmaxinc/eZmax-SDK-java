...
public class ContactinformationsResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiContactinformationsID", "fkiAddressIDDefault", "fkiPhoneIDDefault", "fkiEmailIDDefault", "fkiWebsiteIDDefault", "eContactinformationsType", "sContactinformationsUrl", "objAddressDefault", "objPhoneDefault", "objEmailDefault", "objWebsiteDefault"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiContactinformationsID", "eContactinformationsType"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactinformationsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContactinformationsResponse is not found in the empty JSON string", ContactinformationsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactinformationsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContactinformationsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
