...
public class EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response {
  ...
  public EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response objDebugPayload(@javax.annotation.Nonnull CommonResponseObjDebugPayload objDebugPayload) {
  ...
  public EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response objDebug(@javax.annotation.Nullable CommonResponseObjDebug objDebug) {
  ...
  public EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response mPayload(@javax.annotation.Nonnull EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1ResponseMPayload mPayload) {
  ...
  public void setmPayload(@javax.annotation.Nonnull EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1ResponseMPayload mPayload) {
    this.mPayload = mPayload;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response is not found in the empty JSON string", EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response value) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response
   */
  public static EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.class);
  }

  /**
   * Convert an instance of EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response to an JSON string
   *
   * @return JSON string
   */
