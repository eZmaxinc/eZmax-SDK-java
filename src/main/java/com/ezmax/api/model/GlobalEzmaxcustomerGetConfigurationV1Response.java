...
public class GlobalEzmaxcustomerGetConfigurationV1Response {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sInfrastructureregionCode", "sInfrastructureregionCodeWeb", "sInfrastructureenvironmenttypeDescription", "sCognitoClientIDExternal", "sCognitoClientIDEzmaxpublic"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sInfrastructureregionCode", "sInfrastructureregionCodeWeb", "sInfrastructureenvironmenttypeDescription", "sCognitoClientIDEzmaxpublic"));
  }
