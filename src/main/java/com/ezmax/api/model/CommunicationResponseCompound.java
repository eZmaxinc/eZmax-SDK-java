...
public class CommunicationResponseCompound {
  ...
  **/
  ...
  public CommunicationResponseCompound bCommunicationPrivate(Boolean bCommunicationPrivate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiCommunicationID, communicationResponseCompound.pkiCommunicationID) &&
        ...
        Objects.equals(this.bCommunicationPrivate, communicationResponseCompound.bCommunicationPrivate) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiCommunicationID, eCommunicationImportance, eCommunicationType, sCommunicationSubject, sCommunicationBodyurl, eCommunicationDirection, iCommunicationrecipientCount, bCommunicationPrivate, objDescriptionstaticSender, objEmailstaticSender, objPhonestaticSender, objAudit, aObjCommunicationattachment, aObjCommunicationrecipient, aObjCommunicationexternalrecipient);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CommunicationResponseCompound
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommunicationResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommunicationResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArrayaObjCommunicationattachment.size(); i++) {
        CommunicationattachmentResponseCompound.validateJsonElement(jsonArrayaObjCommunicationattachment.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayaObjCommunicationrecipient.size(); i++) {
        CommunicationrecipientResponseCompound.validateJsonElement(jsonArrayaObjCommunicationrecipient.get(i));
      };
      // ensure the json data is an array
      ...
      for (int i = 0; i < jsonArrayaObjCommunicationexternalrecipient.size(); i++) {
        CommunicationexternalrecipientResponseCompound.validateJsonElement(jsonArrayaObjCommunicationexternalrecipient.get(i));
      };
  }
