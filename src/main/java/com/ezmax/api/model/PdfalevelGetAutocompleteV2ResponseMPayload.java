...
public class PdfalevelGetAutocompleteV2ResponseMPayload {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("a_objPdfalevel"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("a_objPdfalevel"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PdfalevelGetAutocompleteV2ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PdfalevelGetAutocompleteV2ResponseMPayload is not found in the empty JSON string", PdfalevelGetAutocompleteV2ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PdfalevelGetAutocompleteV2ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PdfalevelGetAutocompleteV2ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("a_objPdfalevel") != null) {
        if (!jsonObj.get("a_objPdfalevel").isJsonArray()) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `a_objPdfalevel` to be an array in the JSON string but got `%s`", jsonObj.get("a_objPdfalevel").toString()));
        }
