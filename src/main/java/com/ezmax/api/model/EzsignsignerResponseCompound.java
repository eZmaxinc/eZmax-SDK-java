...
public class EzsignsignerResponseCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignsignerID", "fkiTaxassignmentID", "fkiSecretquestionID", "fkiUserlogintypeID", "sUserlogintypeDescriptionX", "objContact"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignsignerID", "fkiTaxassignmentID", "fkiUserlogintypeID", "sUserlogintypeDescriptionX", "objContact"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignerResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignerResponseCompound is not found in the empty JSON string", EzsignsignerResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignerResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignerResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
