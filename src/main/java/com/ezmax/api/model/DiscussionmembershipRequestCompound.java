...
public class DiscussionmembershipRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiDiscussionmembershipID", "fkiDiscussionID", "fkiUserID", "fkiUsergroupID", "fkiModulesectionID", "dtDiscussionmembershipJoined"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiDiscussionID", "dtDiscussionmembershipJoined"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiscussionmembershipRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiscussionmembershipRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DiscussionmembershipRequestCompound is not found in the empty JSON string", DiscussionmembershipRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiscussionmembershipRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DiscussionmembershipRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DiscussionmembershipRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiscussionmembershipRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiscussionmembershipRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiscussionmembershipRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiscussionmembershipRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<DiscussionmembershipRequestCompound>() {
           @Override
           public void write(JsonWriter out, DiscussionmembershipRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiscussionmembershipRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiscussionmembershipRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiscussionmembershipRequestCompound
   * @throws IOException if the JSON string is invalid with respect to DiscussionmembershipRequestCompound
   */
  public static DiscussionmembershipRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiscussionmembershipRequestCompound.class);
  }

  /**
   * Convert an instance of DiscussionmembershipRequestCompound to an JSON string
   *
   * @return JSON string
   */
