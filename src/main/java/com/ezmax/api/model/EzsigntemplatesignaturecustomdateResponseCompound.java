...
public class EzsigntemplatesignaturecustomdateResponseCompound {
  ...
  public EzsigntemplatesignaturecustomdateResponseCompound pkiEzsigntemplatesignaturecustomdateID(@javax.annotation.Nonnull Integer pkiEzsigntemplatesignaturecustomdateID) {
  ...
  @Deprecated
  public EzsigntemplatesignaturecustomdateResponseCompound iEzsigntemplatesignaturecustomdateX(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateX) {
  ...
  @Deprecated
  public EzsigntemplatesignaturecustomdateResponseCompound iEzsigntemplatesignaturecustomdateY(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateY) {
  ...
  public EzsigntemplatesignaturecustomdateResponseCompound iEzsigntemplatesignaturecustomdateOffsetx(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateOffsetx) {
  ...
  public EzsigntemplatesignaturecustomdateResponseCompound iEzsigntemplatesignaturecustomdateOffsety(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateOffsety) {
  ...
  public EzsigntemplatesignaturecustomdateResponseCompound sEzsigntemplatesignaturecustomdateFormat(@javax.annotation.Nonnull String sEzsigntemplatesignaturecustomdateFormat) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplatesignaturecustomdateID, ezsigntemplatesignaturecustomdateResponseCompound.pkiEzsigntemplatesignaturecustomdateID) &&
        ...
        Objects.equals(this.iEzsigntemplatesignaturecustomdateOffsetx, ezsigntemplatesignaturecustomdateResponseCompound.iEzsigntemplatesignaturecustomdateOffsetx) &&
        Objects.equals(this.iEzsigntemplatesignaturecustomdateOffsety, ezsigntemplatesignaturecustomdateResponseCompound.iEzsigntemplatesignaturecustomdateOffsety) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatesignaturecustomdateID", "iEzsigntemplatesignaturecustomdateX", "iEzsigntemplatesignaturecustomdateY", "iEzsigntemplatesignaturecustomdateOffsetx", "iEzsigntemplatesignaturecustomdateOffsety", "sEzsigntemplatesignaturecustomdateFormat"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatesignaturecustomdateID", "sEzsigntemplatesignaturecustomdateFormat"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatesignaturecustomdateResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatesignaturecustomdateResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatesignaturecustomdateResponseCompound is not found in the empty JSON string", EzsigntemplatesignaturecustomdateResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatesignaturecustomdateResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatesignaturecustomdateResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sEzsigntemplatesignaturecustomdateFormat").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsigntemplatesignaturecustomdateFormat` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplatesignaturecustomdateFormat").toString()));
      }
  }
