...
public class EzsigntemplatesignatureResponseCompoundV3 {
  ...
  public EzsigntemplatesignatureResponseCompoundV3 fkiPaymentgatewayID(@javax.annotation.Nullable Integer fkiPaymentgatewayID) {
  ...
  public EzsigntemplatesignatureResponseCompoundV3 sEzsigntemplatesignatureCreditcardamountdescription(@javax.annotation.Nullable String sEzsigntemplatesignatureCreditcardamountdescription) {
  ...
  public EzsigntemplatesignatureResponseCompoundV3 dEzsigntemplatesignatureCreditcardamount(@javax.annotation.Nullable String dEzsigntemplatesignatureCreditcardamount) {
  ...
  public EzsigntemplatesignatureResponseCompoundV3 aObjEzsigntemplatesignaturepaymentdetail(@javax.annotation.Nullable List<EzsigntemplatesignaturepaymentdetailResponseCompound> aObjEzsigntemplatesignaturepaymentdetail) {
    this.aObjEzsigntemplatesignaturepaymentdetail = aObjEzsigntemplatesignaturepaymentdetail;
    return this;
  }

  public EzsigntemplatesignatureResponseCompoundV3 addAObjEzsigntemplatesignaturepaymentdetailItem(EzsigntemplatesignaturepaymentdetailResponseCompound aObjEzsigntemplatesignaturepaymentdetailItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplatesignatureID, ezsigntemplatesignatureResponseCompoundV3.pkiEzsigntemplatesignatureID) &&
        ...
        Objects.equals(this.fkiPaymentgatewayID, ezsigntemplatesignatureResponseCompoundV3.fkiPaymentgatewayID) &&
        ...
        Objects.equals(this.sEzsigntemplatesignatureCreditcardamountdescription, ezsigntemplatesignatureResponseCompoundV3.sEzsigntemplatesignatureCreditcardamountdescription) &&
        Objects.equals(this.dEzsigntemplatesignatureCreditcardamount, ezsigntemplatesignatureResponseCompoundV3.dEzsigntemplatesignatureCreditcardamount) &&
        ...
        Objects.equals(this.aObjEzsigntemplatesignaturepaymentdetail, ezsigntemplatesignatureResponseCompoundV3.aObjEzsigntemplatesignaturepaymentdetail);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatesignatureResponseCompoundV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsigntemplatesignatureResponseCompoundV3 is not found in the empty JSON string", EzsigntemplatesignatureResponseCompoundV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatesignatureResponseCompoundV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatesignatureResponseCompoundV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
