...
public class EzsignformfieldgroupResponse {
  ...
  public static final String SERIALIZED_NAME_DT_EZSIGNFORMFIELDGROUP_COMPLETED = "dtEzsignformfieldgroupCompleted";
  @SerializedName(SERIALIZED_NAME_DT_EZSIGNFORMFIELDGROUP_COMPLETED)
  @javax.annotation.Nullable
  private String dtEzsignformfieldgroupCompleted;
  ...
  public EzsignformfieldgroupResponse dtEzsignformfieldgroupCompleted(@javax.annotation.Nullable String dtEzsignformfieldgroupCompleted) {
   ...
   * @return dtEzsignformfieldgroupCompleted
   */
  @javax.annotation.Nullable
  public String getDtEzsignformfieldgroupCompleted() {
    return dtEzsignformfieldgroupCompleted;
  }

  public void setDtEzsignformfieldgroupCompleted(@javax.annotation.Nullable String dtEzsignformfieldgroupCompleted) {
    this.dtEzsignformfieldgroupCompleted = dtEzsignformfieldgroupCompleted;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignformfieldgroupID, ezsignformfieldgroupResponse.pkiEzsignformfieldgroupID) &&
        ...
        Objects.equals(this.dtEzsignformfieldgroupCompleted, ezsignformfieldgroupResponse.dtEzsignformfieldgroupCompleted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignformfieldgroupID, fkiEzsigndocumentID, eEzsignformfieldgroupType, eEzsignformfieldgroupSignerrequirement, sEzsignformfieldgroupLabel, iEzsignformfieldgroupStep, sEzsignformfieldgroupDefaultvalue, iEzsignformfieldgroupFilledmin, iEzsignformfieldgroupFilledmax, bEzsignformfieldgroupReadonly, iEzsignformfieldgroupMaxlength, bEzsignformfieldgroupEncrypted, eEzsignformfieldgroupTextvalidation, sEzsignformfieldgroupRegexp, sEzsignformfieldgroupTextvalidationcustommessage, tEzsignformfieldgroupTooltip, eEzsignformfieldgroupTooltipposition, dtEzsignformfieldgroupCompleted);
  }
  ...
  public String toString() {
    ...
    sb.append("    dtEzsignformfieldgroupCompleted: ").append(toIndentedString(dtEzsignformfieldgroupCompleted)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignformfieldgroupID", "fkiEzsigndocumentID", "eEzsignformfieldgroupType", "sEzsignformfieldgroupLabel", "iEzsignformfieldgroupStep", "iEzsignformfieldgroupFilledmin", "iEzsignformfieldgroupFilledmax", "bEzsignformfieldgroupReadonly"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignformfieldgroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignformfieldgroupResponse is not found in the empty JSON string", EzsignformfieldgroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignformfieldgroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignformfieldgroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("dtEzsignformfieldgroupCompleted") != null && !jsonObj.get("dtEzsignformfieldgroupCompleted").isJsonNull()) && !jsonObj.get("dtEzsignformfieldgroupCompleted").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtEzsignformfieldgroupCompleted` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzsignformfieldgroupCompleted").toString()));
      }
  }
