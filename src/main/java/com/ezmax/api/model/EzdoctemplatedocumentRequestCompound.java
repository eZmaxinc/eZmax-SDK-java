...
public class EzdoctemplatedocumentRequestCompound {
  ...
  public EzdoctemplatedocumentRequestCompound fkiEzdoctemplatefieldtypecategoryID(@javax.annotation.Nullable Integer fkiEzdoctemplatefieldtypecategoryID) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzdoctemplatedocumentRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzdoctemplatedocumentRequestCompound is not found in the empty JSON string", EzdoctemplatedocumentRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzdoctemplatedocumentRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzdoctemplatedocumentRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
