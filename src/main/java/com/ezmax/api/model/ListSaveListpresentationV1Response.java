...
public class ListSaveListpresentationV1Response {
  ...
  public ListSaveListpresentationV1Response() { 
  }
  ...
  **/
  ...
  public ListSaveListpresentationV1Response objDebug(CommonResponseObjDebug objDebug) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListSaveListpresentationV1Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListSaveListpresentationV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListSaveListpresentationV1Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListSaveListpresentationV1Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListSaveListpresentationV1Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListSaveListpresentationV1Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListSaveListpresentationV1Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListSaveListpresentationV1Response>() {
           @Override
           public void write(JsonWriter out, ListSaveListpresentationV1Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListSaveListpresentationV1Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListSaveListpresentationV1Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListSaveListpresentationV1Response
  * @throws IOException if the JSON string is invalid with respect to ListSaveListpresentationV1Response
  */
  public static ListSaveListpresentationV1Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSaveListpresentationV1Response.class);
  }

 /**
  * Convert an instance of ListSaveListpresentationV1Response to an JSON string
  *
  * @return JSON string
  */
