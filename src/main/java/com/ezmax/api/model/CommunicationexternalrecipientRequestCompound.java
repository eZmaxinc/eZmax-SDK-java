...
public class CommunicationexternalrecipientRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiCommunicationexternalrecipientID", "sEmailAddress", "sPhoneE164", "eCommunicationexternalrecipientType", "sCommunicationexternalrecipientName"));
