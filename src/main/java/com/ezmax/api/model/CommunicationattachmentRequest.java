...
public class CommunicationattachmentRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiCommunicationattachmentID", "fkiAttachmentID", "fkiInvoiceID", "fkiSalarypreparationID"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationattachmentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommunicationattachmentRequest is not found in the empty JSON string", CommunicationattachmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommunicationattachmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommunicationattachmentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
