...
public class EzsigntemplatedocumentGetWordsPositionsV1Request {
  ...
  public EzsigntemplatedocumentGetWordsPositionsV1Request eGet(@javax.annotation.Nonnull EGetEnum eGet) {
    this.eGet = eGet;
    return this;
  }
  ...
  public EzsigntemplatedocumentGetWordsPositionsV1Request bWordCaseSensitive(@javax.annotation.Nonnull Boolean bWordCaseSensitive) {
  ...
  public EzsigntemplatedocumentGetWordsPositionsV1Request aSWord(@javax.annotation.Nullable List<String> aSWord) {
    this.aSWord = aSWord;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eGet", "bWordCaseSensitive", "a_sWord"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eGet", "bWordCaseSensitive"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatedocumentGetWordsPositionsV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatedocumentGetWordsPositionsV1Request is not found in the empty JSON string", EzsigntemplatedocumentGetWordsPositionsV1Request.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatedocumentGetWordsPositionsV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatedocumentGetWordsPositionsV1Request` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("eGet").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eGet` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eGet").toString()));
      }
      ...
      if (jsonObj.get("a_sWord") != null && !jsonObj.get("a_sWord").isJsonNull() && !jsonObj.get("a_sWord").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `a_sWord` to be an array in the JSON string but got `%s`", jsonObj.get("a_sWord").toString()));
      }
  }
