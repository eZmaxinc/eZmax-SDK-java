...
public class EzsigntemplatedocumentGetWordsPositionsV1Response {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objDebugPayload, ezsigntemplatedocumentGetWordsPositionsV1Response.objDebugPayload) &&
        Objects.equals(this.objDebug, ezsigntemplatedocumentGetWordsPositionsV1Response.objDebug) &&
        Objects.equals(this.mPayload, ezsigntemplatedocumentGetWordsPositionsV1Response.mPayload);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatedocumentGetWordsPositionsV1Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatedocumentGetWordsPositionsV1Response is not found in the empty JSON string", EzsigntemplatedocumentGetWordsPositionsV1Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatedocumentGetWordsPositionsV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatedocumentGetWordsPositionsV1Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplatedocumentGetWordsPositionsV1Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatedocumentGetWordsPositionsV1Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatedocumentGetWordsPositionsV1Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatedocumentGetWordsPositionsV1Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatedocumentGetWordsPositionsV1Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatedocumentGetWordsPositionsV1Response>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatedocumentGetWordsPositionsV1Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplatedocumentGetWordsPositionsV1Response read(JsonReader in) throws IOException {
