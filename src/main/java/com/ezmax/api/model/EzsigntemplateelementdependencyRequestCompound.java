...
public class EzsigntemplateelementdependencyRequestCompound {
  ...
  public EzsigntemplateelementdependencyRequestCompound() {
  }

  public EzsigntemplateelementdependencyRequestCompound pkiEzsigntemplateelementdependencyID(@javax.annotation.Nullable Integer pkiEzsigntemplateelementdependencyID) {
  ...
  public EzsigntemplateelementdependencyRequestCompound fkiEzsigntemplateformfieldIDValidation(@javax.annotation.Nullable Integer fkiEzsigntemplateformfieldIDValidation) {
  ...
  public EzsigntemplateelementdependencyRequestCompound fkiEzsigntemplateformfieldgroupIDValidation(@javax.annotation.Nullable Integer fkiEzsigntemplateformfieldgroupIDValidation) {
  ...
  public EzsigntemplateelementdependencyRequestCompound sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel(@javax.annotation.Nullable String sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel) {
  ...
  public EzsigntemplateelementdependencyRequestCompound sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel(@javax.annotation.Nullable String sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel) {
  ...
  public EzsigntemplateelementdependencyRequestCompound eEzsigntemplateelementdependencyValidation(@javax.annotation.Nonnull FieldEEzsigntemplateelementdependencyValidation eEzsigntemplateelementdependencyValidation) {
  ...
  public EzsigntemplateelementdependencyRequestCompound bEzsigntemplateelementdependencySelected(@javax.annotation.Nullable Boolean bEzsigntemplateelementdependencySelected) {
  ...
  public EzsigntemplateelementdependencyRequestCompound eEzsigntemplateelementdependencyOperator(@javax.annotation.Nullable FieldEEzsigntemplateelementdependencyOperator eEzsigntemplateelementdependencyOperator) {
  ...
  public EzsigntemplateelementdependencyRequestCompound sEzsigntemplateelementdependencyValue(@javax.annotation.Nullable String sEzsigntemplateelementdependencyValue) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplateelementdependencyID, ezsigntemplateelementdependencyRequestCompound.pkiEzsigntemplateelementdependencyID) &&
        Objects.equals(this.fkiEzsigntemplateformfieldIDValidation, ezsigntemplateelementdependencyRequestCompound.fkiEzsigntemplateformfieldIDValidation) &&
        Objects.equals(this.fkiEzsigntemplateformfieldgroupIDValidation, ezsigntemplateelementdependencyRequestCompound.fkiEzsigntemplateformfieldgroupIDValidation) &&
        Objects.equals(this.sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel, ezsigntemplateelementdependencyRequestCompound.sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel) &&
        Objects.equals(this.sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel, ezsigntemplateelementdependencyRequestCompound.sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel) &&
        Objects.equals(this.eEzsigntemplateelementdependencyValidation, ezsigntemplateelementdependencyRequestCompound.eEzsigntemplateelementdependencyValidation) &&
        Objects.equals(this.bEzsigntemplateelementdependencySelected, ezsigntemplateelementdependencyRequestCompound.bEzsigntemplateelementdependencySelected) &&
        Objects.equals(this.eEzsigntemplateelementdependencyOperator, ezsigntemplateelementdependencyRequestCompound.eEzsigntemplateelementdependencyOperator) &&
        Objects.equals(this.sEzsigntemplateelementdependencyValue, ezsigntemplateelementdependencyRequestCompound.sEzsigntemplateelementdependencyValue);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplateelementdependencyRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateelementdependencyRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsigntemplateelementdependencyRequestCompound is not found in the empty JSON string", EzsigntemplateelementdependencyRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateelementdependencyRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsigntemplateelementdependencyRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplateelementdependencyRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplateelementdependencyRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplateelementdependencyRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplateelementdependencyRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplateelementdependencyRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplateelementdependencyRequestCompound>() {
           @Override
           public void write(JsonWriter out, EzsigntemplateelementdependencyRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplateelementdependencyRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplateelementdependencyRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplateelementdependencyRequestCompound
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplateelementdependencyRequestCompound
   */
  public static EzsigntemplateelementdependencyRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplateelementdependencyRequestCompound.class);
  }

  /**
   * Convert an instance of EzsigntemplateelementdependencyRequestCompound to an JSON string
   *
   * @return JSON string
   */
