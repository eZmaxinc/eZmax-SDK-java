...
public class EzsigntemplateelementdependencyRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplateelementdependencyID", "fkiEzsigntemplateformfieldIDValidation", "fkiEzsigntemplateformfieldgroupIDValidation", "sEzsigntemplateelementdependencyEzsigntemplateformfieldgrouplabel", "sEzsigntemplateelementdependencyEzsigntemplateformfieldlabel", "eEzsigntemplateelementdependencyValidation", "bEzsigntemplateelementdependencySelected", "eEzsigntemplateelementdependencyOperator", "sEzsigntemplateelementdependencyValue"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eEzsigntemplateelementdependencyValidation"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateelementdependencyRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplateelementdependencyRequestCompound is not found in the empty JSON string", EzsigntemplateelementdependencyRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateelementdependencyRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateelementdependencyRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
