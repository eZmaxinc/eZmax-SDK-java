...
public class CommonWebhook {
  ...
  public CommonWebhook objWebhook(@javax.annotation.Nonnull CustomWebhookResponse objWebhook) {
  ...
  public CommonWebhook aObjAttempt(@javax.annotation.Nonnull List<AttemptResponseCompound> aObjAttempt) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("objWebhook", "a_objAttempt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("objWebhook", "a_objAttempt"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonWebhook is not found in the empty JSON string", CommonWebhook.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonWebhook.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonWebhook` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
