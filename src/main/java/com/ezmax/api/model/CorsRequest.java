...
public class CorsRequest {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiCorsID, corsRequest.pkiCorsID) &&
        Objects.equals(this.fkiApikeyID, corsRequest.fkiApikeyID) &&
        Objects.equals(this.sCorsEntryurl, corsRequest.sCorsEntryurl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CorsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CorsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CorsRequest is not found in the empty JSON string", CorsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CorsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CorsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @return An instance of CorsRequest
   * @throws IOException if the JSON string is invalid with respect to CorsRequest
   */
  public static CorsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CorsRequest.class);
  }

  /**
   * Convert an instance of CorsRequest to an JSON string
   *
   * @return JSON string
   */
