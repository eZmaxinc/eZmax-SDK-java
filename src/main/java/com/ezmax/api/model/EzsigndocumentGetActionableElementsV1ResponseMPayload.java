...
public class EzsigndocumentGetActionableElementsV1ResponseMPayload {
  ...
  public EzsigndocumentGetActionableElementsV1ResponseMPayload aObjEzsignsignature(@javax.annotation.Nonnull List<EzsignsignatureResponseCompound> aObjEzsignsignature) {
  ...
  public EzsigndocumentGetActionableElementsV1ResponseMPayload aObjEzsignformfieldgroup(@javax.annotation.Nonnull List<EzsignformfieldgroupResponseCompound> aObjEzsignformfieldgroup) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigndocumentGetActionableElementsV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigndocumentGetActionableElementsV1ResponseMPayload is not found in the empty JSON string", EzsigndocumentGetActionableElementsV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigndocumentGetActionableElementsV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigndocumentGetActionableElementsV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
