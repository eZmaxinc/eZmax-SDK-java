...
public class SsprResetPasswordRequestV1Request {
  ...
  public SsprResetPasswordRequestV1Request() { 
  }

  public SsprResetPasswordRequestV1Request pksCustomerCode(String pksCustomerCode) {
  ...
  **/
  ...
  public SsprResetPasswordRequestV1Request fkiLanguageID(Integer fkiLanguageID) {
  ...
  **/
  ...
  public SsprResetPasswordRequestV1Request eUserTypeSSPR(FieldEUserTypeSSPR eUserTypeSSPR) {
  ...
  **/
  ...
  public SsprResetPasswordRequestV1Request sEmailAddress(String sEmailAddress) {
  ...
  **/
  ...
  public SsprResetPasswordRequestV1Request sUserLoginname(String sUserLoginname) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pksCustomerCode, ssprResetPasswordRequestV1Request.pksCustomerCode) &&
        Objects.equals(this.fkiLanguageID, ssprResetPasswordRequestV1Request.fkiLanguageID) &&
        Objects.equals(this.eUserTypeSSPR, ssprResetPasswordRequestV1Request.eUserTypeSSPR) &&
        Objects.equals(this.sEmailAddress, ssprResetPasswordRequestV1Request.sEmailAddress) &&
        Objects.equals(this.sUserLoginname, ssprResetPasswordRequestV1Request.sUserLoginname);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SsprResetPasswordRequestV1Request
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SsprResetPasswordRequestV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SsprResetPasswordRequestV1Request` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SsprResetPasswordRequestV1Request.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SsprResetPasswordRequestV1Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SsprResetPasswordRequestV1Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SsprResetPasswordRequestV1Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SsprResetPasswordRequestV1Request.class));

       return (TypeAdapter<T>) new TypeAdapter<SsprResetPasswordRequestV1Request>() {
           @Override
           public void write(JsonWriter out, SsprResetPasswordRequestV1Request value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SsprResetPasswordRequestV1Request read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SsprResetPasswordRequestV1Request given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SsprResetPasswordRequestV1Request
  * @throws IOException if the JSON string is invalid with respect to SsprResetPasswordRequestV1Request
  */
  public static SsprResetPasswordRequestV1Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SsprResetPasswordRequestV1Request.class);
  }

 /**
  * Convert an instance of SsprResetPasswordRequestV1Request to an JSON string
  *
  * @return JSON string
  */
