...
public class EzsignsignerResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignsignerID", "fkiTaxassignmentID", "fkiSecretquestionID", "fkiUserlogintypeID", "sUserlogintypeDescriptionX"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignsignerID", "fkiTaxassignmentID", "fkiUserlogintypeID", "sUserlogintypeDescriptionX"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignerResponse is not found in the empty JSON string", EzsignsignerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
