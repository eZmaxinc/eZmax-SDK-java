...
public class EzsigntemplatepackagesignerRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatepackagesignerID", "fkiEzsigntemplatepackageID", "fkiEzdoctemplatedocumentID", "fkiUserID", "fkiUsergroupID", "bEzsigntemplatepackagesignerReceivecopy", "eEzsigntemplatepackagesignerMapping", "sEzsigntemplatepackagesignerDescription"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatepackagesignerRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatepackagesignerRequestCompound is not found in the empty JSON string", EzsigntemplatepackagesignerRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatepackagesignerRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatepackagesignerRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
