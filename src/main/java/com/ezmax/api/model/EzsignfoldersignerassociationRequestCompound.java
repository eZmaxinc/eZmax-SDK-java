...
public class EzsignfoldersignerassociationRequestCompound {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignfoldersignerassociationID, fkiUserID, fkiEzsignfolderID, bEzsignfoldersignerassociationReceivecopy, tEzsignfoldersignerassociationMessage, objEzsignsigner);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EzsignfoldersignerassociationRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
