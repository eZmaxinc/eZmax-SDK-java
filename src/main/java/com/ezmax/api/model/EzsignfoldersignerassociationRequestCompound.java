...
public class EzsignfoldersignerassociationRequestCompound {
  ...
  public EzsignfoldersignerassociationRequestCompound pkiEzsignfoldersignerassociationID(@javax.annotation.Nullable Integer pkiEzsignfoldersignerassociationID) {
  ...
  public EzsignfoldersignerassociationRequestCompound fkiUserID(@javax.annotation.Nullable Integer fkiUserID) {
  ...
  public EzsignfoldersignerassociationRequestCompound fkiEzsignsignergroupID(@javax.annotation.Nullable Integer fkiEzsignsignergroupID) {
  ...
  public EzsignfoldersignerassociationRequestCompound fkiEzsignfolderID(@javax.annotation.Nonnull Integer fkiEzsignfolderID) {
  ...
  public EzsignfoldersignerassociationRequestCompound bEzsignfoldersignerassociationReceivecopy(@javax.annotation.Nullable Boolean bEzsignfoldersignerassociationReceivecopy) {
  ...
  public EzsignfoldersignerassociationRequestCompound tEzsignfoldersignerassociationMessage(@javax.annotation.Nullable String tEzsignfoldersignerassociationMessage) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignfoldersignerassociationID", "fkiUserID", "fkiEzsignsignergroupID", "fkiEzsignfolderID", "bEzsignfoldersignerassociationReceivecopy", "tEzsignfoldersignerassociationMessage", "objEzsignsigner"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldersignerassociationRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignfoldersignerassociationRequestCompound is not found in the empty JSON string", EzsignfoldersignerassociationRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldersignerassociationRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfoldersignerassociationRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
