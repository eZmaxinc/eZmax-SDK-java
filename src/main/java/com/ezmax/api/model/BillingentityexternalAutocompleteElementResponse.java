...
public class BillingentityexternalAutocompleteElementResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiBillingentityexternalID", "sBillingentityexternalDescription", "bBillingentityexternalIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiBillingentityexternalID", "sBillingentityexternalDescription", "bBillingentityexternalIsactive"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillingentityexternalAutocompleteElementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BillingentityexternalAutocompleteElementResponse is not found in the empty JSON string", BillingentityexternalAutocompleteElementResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BillingentityexternalAutocompleteElementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BillingentityexternalAutocompleteElementResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
