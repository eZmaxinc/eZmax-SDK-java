  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserstagedResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserstagedResponseCompound is not found in the empty JSON string", UserstagedResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserstagedResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserstagedResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sUserstagedFirstname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sUserstagedFirstname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserstagedFirstname").toString()));
      }
      if (!jsonObj.get("sUserstagedLastname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sUserstagedLastname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserstagedLastname").toString()));
      }
      if (!jsonObj.get("sUserstagedExternalid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sUserstagedExternalid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserstagedExternalid").toString()));
      }
  }
