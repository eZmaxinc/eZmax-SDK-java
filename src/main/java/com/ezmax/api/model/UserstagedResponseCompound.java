...
public class UserstagedResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUserstagedID, userstagedResponseCompound.pkiUserstagedID) &&
        Objects.equals(this.fkiEmailID, userstagedResponseCompound.fkiEmailID) &&
        Objects.equals(this.sEmailAddress, userstagedResponseCompound.sEmailAddress) &&
        Objects.equals(this.sUserstagedFirstname, userstagedResponseCompound.sUserstagedFirstname) &&
        Objects.equals(this.sUserstagedLastname, userstagedResponseCompound.sUserstagedLastname) &&
        Objects.equals(this.sUserstagedExternalid, userstagedResponseCompound.sUserstagedExternalid);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiUserstagedID", "fkiEmailID", "sEmailAddress", "sUserstagedFirstname", "sUserstagedLastname", "sUserstagedExternalid"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiUserstagedID", "fkiEmailID", "sEmailAddress", "sUserstagedFirstname", "sUserstagedLastname", "sUserstagedExternalid"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UserstagedResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserstagedResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UserstagedResponseCompound is not found in the empty JSON string", UserstagedResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserstagedResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserstagedResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserstagedResponseCompound.openapiRequiredFields) {
      ...
      if (!jsonObj.get("sUserstagedFirstname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserstagedFirstname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserstagedFirstname").toString()));
      }
      if (!jsonObj.get("sUserstagedLastname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserstagedLastname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserstagedLastname").toString()));
      }
      if (!jsonObj.get("sUserstagedExternalid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sUserstagedExternalid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sUserstagedExternalid").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserstagedResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserstagedResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserstagedResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserstagedResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<UserstagedResponseCompound>() {
           @Override
           public void write(JsonWriter out, UserstagedResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserstagedResponseCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UserstagedResponseCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UserstagedResponseCompound
   * @throws IOException if the JSON string is invalid with respect to UserstagedResponseCompound
   */
  public static UserstagedResponseCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserstagedResponseCompound.class);
  }

  /**
   * Convert an instance of UserstagedResponseCompound to an JSON string
   *
   * @return JSON string
   */
