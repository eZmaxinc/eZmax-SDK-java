...
public class WebhookEzsignDocumentCompleted {
  ...
  public WebhookEzsignDocumentCompleted objWebhook(@javax.annotation.Nonnull CustomWebhookResponse objWebhook) {
  ...
  public WebhookEzsignDocumentCompleted aObjAttempt(@javax.annotation.Nonnull List<AttemptResponseCompound> aObjAttempt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objWebhook, webhookEzsignDocumentCompleted.objWebhook) &&
        Objects.equals(this.aObjAttempt, webhookEzsignDocumentCompleted.aObjAttempt) &&
        Objects.equals(this.objEzsigndocument, webhookEzsignDocumentCompleted.objEzsigndocument);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookEzsignDocumentCompleted.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookEzsignDocumentCompleted is not found in the empty JSON string", WebhookEzsignDocumentCompleted.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookEzsignDocumentCompleted.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookEzsignDocumentCompleted` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
