...
public class EzsignsignatureSignV1Response {
  ...
  public EzsignsignatureSignV1Response objDebugPayload(@javax.annotation.Nonnull CommonResponseObjDebugPayload objDebugPayload) {
  ...
  public EzsignsignatureSignV1Response objDebug(@javax.annotation.Nullable CommonResponseObjDebug objDebug) {
  ...
  public EzsignsignatureSignV1Response mPayload(@javax.annotation.Nonnull EzsignsignatureSignV1ResponseMPayload mPayload) {
  ...
  public void setmPayload(@javax.annotation.Nonnull EzsignsignatureSignV1ResponseMPayload mPayload) {
    this.mPayload = mPayload;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignatureSignV1Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignatureSignV1Response is not found in the empty JSON string", EzsignsignatureSignV1Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignatureSignV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignatureSignV1Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignsignatureSignV1Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignsignatureSignV1Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignsignatureSignV1Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignsignatureSignV1Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignsignatureSignV1Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignsignatureSignV1Response>() {
           @Override
           public void write(JsonWriter out, EzsignsignatureSignV1Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignsignatureSignV1Response read(JsonReader in) throws IOException {
