...
public class ListGetListpresentationV1Response {
  ...
  public ListGetListpresentationV1Response() { 
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListGetListpresentationV1Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListGetListpresentationV1Response.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has reuqired fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListGetListpresentationV1Response is not found in the empty JSON string", ListGetListpresentationV1Response.openapiRequiredFields.toString()));
        }
      }
      Set<Entry<String, JsonElement>> entries = jsonObj.entrySet();
      // check to see if the JSON string contains additional fields
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListGetListpresentationV1Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListGetListpresentationV1Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListGetListpresentationV1Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListGetListpresentationV1Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListGetListpresentationV1Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListGetListpresentationV1Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListGetListpresentationV1Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListGetListpresentationV1Response>() {
           @Override
           public void write(JsonWriter out, ListGetListpresentationV1Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListGetListpresentationV1Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListGetListpresentationV1Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListGetListpresentationV1Response
  * @throws IOException if the JSON string is invalid with respect to ListGetListpresentationV1Response
  */
  public static ListGetListpresentationV1Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListGetListpresentationV1Response.class);
  }

 /**
  * Convert an instance of ListGetListpresentationV1Response to an JSON string
  *
  * @return JSON string
  */
