...
public class CustomFormsDataFolderResponse {
  ...
  public CustomFormsDataFolderResponse pkiEzsignfolderID(@javax.annotation.Nonnull Integer pkiEzsignfolderID) {
  ...
  public CustomFormsDataFolderResponse sEzsignfolderDescription(@javax.annotation.Nonnull String sEzsignfolderDescription) {
  ...
  public CustomFormsDataFolderResponse aObjFormDataDocument(@javax.annotation.Nonnull List<CustomFormDataDocumentResponse> aObjFormDataDocument) {
  ...
  public void setaObjFormDataDocument(@javax.annotation.Nonnull List<CustomFormDataDocumentResponse> aObjFormDataDocument) {
    this.aObjFormDataDocument = aObjFormDataDocument;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignfolderID", "sEzsignfolderDescription", "a_objFormDataDocument"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignfolderID", "sEzsignfolderDescription", "a_objFormDataDocument"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFormsDataFolderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomFormsDataFolderResponse is not found in the empty JSON string", CustomFormsDataFolderResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomFormsDataFolderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomFormsDataFolderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("a_objFormDataDocument").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objFormDataDocument` to be an array in the JSON string but got `%s`", jsonObj.get("a_objFormDataDocument").toString()));
      }
