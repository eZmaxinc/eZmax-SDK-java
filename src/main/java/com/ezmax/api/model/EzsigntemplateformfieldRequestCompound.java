...
public class EzsigntemplateformfieldRequestCompound {
  ...
  public EzsigntemplateformfieldRequestCompound pkiEzsigntemplateformfieldID(@javax.annotation.Nullable Integer pkiEzsigntemplateformfieldID) {
  ...
  public EzsigntemplateformfieldRequestCompound eEzsigntemplateformfieldPositioning(@javax.annotation.Nullable FieldEEzsigntemplateformfieldPositioning eEzsigntemplateformfieldPositioning) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplatedocumentpagePagenumber(@javax.annotation.Nonnull Integer iEzsigntemplatedocumentpagePagenumber) {
  ...
  public EzsigntemplateformfieldRequestCompound sEzsigntemplateformfieldLabel(@javax.annotation.Nonnull String sEzsigntemplateformfieldLabel) {
  ...
  public EzsigntemplateformfieldRequestCompound sEzsigntemplateformfieldValue(@javax.annotation.Nullable String sEzsigntemplateformfieldValue) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplateformfieldX(@javax.annotation.Nullable Integer iEzsigntemplateformfieldX) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplateformfieldY(@javax.annotation.Nullable Integer iEzsigntemplateformfieldY) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplateformfieldWidth(@javax.annotation.Nonnull Integer iEzsigntemplateformfieldWidth) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplateformfieldHeight(@javax.annotation.Nonnull Integer iEzsigntemplateformfieldHeight) {
  ...
  public EzsigntemplateformfieldRequestCompound bEzsigntemplateformfieldAutocomplete(@javax.annotation.Nullable Boolean bEzsigntemplateformfieldAutocomplete) {
  ...
  public EzsigntemplateformfieldRequestCompound bEzsigntemplateformfieldSelected(@javax.annotation.Nullable Boolean bEzsigntemplateformfieldSelected) {
  ...
  public EzsigntemplateformfieldRequestCompound eEzsigntemplateformfieldDependencyrequirement(@javax.annotation.Nullable FieldEEzsigntemplateformfieldDependencyrequirement eEzsigntemplateformfieldDependencyrequirement) {
  ...
  public EzsigntemplateformfieldRequestCompound sEzsigntemplateformfieldPositioningpattern(@javax.annotation.Nullable String sEzsigntemplateformfieldPositioningpattern) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplateformfieldPositioningoffsetx(@javax.annotation.Nullable Integer iEzsigntemplateformfieldPositioningoffsetx) {
  ...
  public EzsigntemplateformfieldRequestCompound iEzsigntemplateformfieldPositioningoffsety(@javax.annotation.Nullable Integer iEzsigntemplateformfieldPositioningoffsety) {
  ...
  public EzsigntemplateformfieldRequestCompound eEzsigntemplateformfieldPositioningoccurence(@javax.annotation.Nullable FieldEEzsigntemplateformfieldPositioningoccurence eEzsigntemplateformfieldPositioningoccurence) {
  ...
  public EzsigntemplateformfieldRequestCompound eEzsigntemplateformfieldHorizontalalignment(@javax.annotation.Nullable EnumHorizontalalignment eEzsigntemplateformfieldHorizontalalignment) {
  ...
  public EzsigntemplateformfieldRequestCompound objTextstylestatic(@javax.annotation.Nullable TextstylestaticRequestCompound objTextstylestatic) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplateformfieldID, ezsigntemplateformfieldRequestCompound.pkiEzsigntemplateformfieldID) &&
        Objects.equals(this.eEzsigntemplateformfieldPositioning, ezsigntemplateformfieldRequestCompound.eEzsigntemplateformfieldPositioning) &&
        ...
        Objects.equals(this.eEzsigntemplateformfieldDependencyrequirement, ezsigntemplateformfieldRequestCompound.eEzsigntemplateformfieldDependencyrequirement) &&
        Objects.equals(this.sEzsigntemplateformfieldPositioningpattern, ezsigntemplateformfieldRequestCompound.sEzsigntemplateformfieldPositioningpattern) &&
        Objects.equals(this.iEzsigntemplateformfieldPositioningoffsetx, ezsigntemplateformfieldRequestCompound.iEzsigntemplateformfieldPositioningoffsetx) &&
        Objects.equals(this.iEzsigntemplateformfieldPositioningoffsety, ezsigntemplateformfieldRequestCompound.iEzsigntemplateformfieldPositioningoffsety) &&
        Objects.equals(this.eEzsigntemplateformfieldPositioningoccurence, ezsigntemplateformfieldRequestCompound.eEzsigntemplateformfieldPositioningoccurence) &&
        Objects.equals(this.eEzsigntemplateformfieldHorizontalalignment, ezsigntemplateformfieldRequestCompound.eEzsigntemplateformfieldHorizontalalignment) &&
        Objects.equals(this.objTextstylestatic, ezsigntemplateformfieldRequestCompound.objTextstylestatic) &&
        Objects.equals(this.aObjEzsigntemplateelementdependency, ezsigntemplateformfieldRequestCompound.aObjEzsigntemplateelementdependency);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplateformfieldID", "eEzsigntemplateformfieldPositioning", "iEzsigntemplatedocumentpagePagenumber", "sEzsigntemplateformfieldLabel", "sEzsigntemplateformfieldValue", "iEzsigntemplateformfieldX", "iEzsigntemplateformfieldY", "iEzsigntemplateformfieldWidth", "iEzsigntemplateformfieldHeight", "bEzsigntemplateformfieldAutocomplete", "bEzsigntemplateformfieldSelected", "eEzsigntemplateformfieldDependencyrequirement", "sEzsigntemplateformfieldPositioningpattern", "iEzsigntemplateformfieldPositioningoffsetx", "iEzsigntemplateformfieldPositioningoffsety", "eEzsigntemplateformfieldPositioningoccurence", "eEzsigntemplateformfieldHorizontalalignment", "objTextstylestatic", "a_objEzsigntemplateelementdependency"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iEzsigntemplatedocumentpagePagenumber", "sEzsigntemplateformfieldLabel", "iEzsigntemplateformfieldWidth", "iEzsigntemplateformfieldHeight"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateformfieldRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplateformfieldRequestCompound is not found in the empty JSON string", EzsigntemplateformfieldRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateformfieldRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateformfieldRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sEzsigntemplateformfieldLabel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsigntemplateformfieldLabel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateformfieldLabel").toString()));
      }
      if ((jsonObj.get("sEzsigntemplateformfieldValue") != null && !jsonObj.get("sEzsigntemplateformfieldValue").isJsonNull()) && !jsonObj.get("sEzsigntemplateformfieldValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsigntemplateformfieldValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateformfieldValue").toString()));
      }
      ...
      if ((jsonObj.get("sEzsigntemplateformfieldPositioningpattern") != null && !jsonObj.get("sEzsigntemplateformfieldPositioningpattern").isJsonNull()) && !jsonObj.get("sEzsigntemplateformfieldPositioningpattern").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsigntemplateformfieldPositioningpattern` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateformfieldPositioningpattern").toString()));
      }
