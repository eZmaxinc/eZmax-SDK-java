  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateformfieldRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in EzsigntemplateformfieldRequestCompound is not found in the empty JSON string", EzsigntemplateformfieldRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateformfieldRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplateformfieldRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sEzsigntemplateformfieldLabel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigntemplateformfieldLabel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateformfieldLabel").toString()));
      }
      if ((jsonObj.get("sEzsigntemplateformfieldValue") != null && !jsonObj.get("sEzsigntemplateformfieldValue").isJsonNull()) && !jsonObj.get("sEzsigntemplateformfieldValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigntemplateformfieldValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateformfieldValue").toString()));
      }
      ...
      if ((jsonObj.get("sEzsigntemplateformfieldPositioningpattern") != null && !jsonObj.get("sEzsigntemplateformfieldPositioningpattern").isJsonNull()) && !jsonObj.get("sEzsigntemplateformfieldPositioningpattern").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sEzsigntemplateformfieldPositioningpattern` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsigntemplateformfieldPositioningpattern").toString()));
      }
