...
public class PermissionRequest {
  ...
  public PermissionRequest pkiPermissionID(Integer pkiPermissionID) {
  ...
  **/
  ...
  public PermissionRequest fkiUserID(Integer fkiUserID) {
  ...
  **/
  ...
  public PermissionRequest fkiApikeyID(Integer fkiApikeyID) {
  ...
  **/
  ...
  public PermissionRequest fkiUsergroupID(Integer fkiUsergroupID) {
  ...
  **/
  ...
  public PermissionRequest fkiCompanyID(Integer fkiCompanyID) {
  ...
  **/
  ...
  public PermissionRequest fkiModulesectionID(Integer fkiModulesectionID) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PermissionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PermissionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PermissionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PermissionRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
