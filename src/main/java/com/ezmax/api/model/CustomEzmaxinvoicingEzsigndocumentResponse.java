...
public class CustomEzmaxinvoicingEzsigndocumentResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiEzsignfolderID", "fkiBillingentityinternalID", "sName", "sEzsignfolderDescription", "sEzsigndocumentName", "bEzsignfolderAllowed"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiEzsignfolderID", "sName", "sEzsignfolderDescription", "sEzsigndocumentName", "bEzsignfolderAllowed"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzmaxinvoicingEzsigndocumentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzmaxinvoicingEzsigndocumentResponse is not found in the empty JSON string", CustomEzmaxinvoicingEzsigndocumentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzmaxinvoicingEzsigndocumentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzmaxinvoicingEzsigndocumentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sName").toString()));
      }
