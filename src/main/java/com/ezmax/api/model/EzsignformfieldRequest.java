...
public class EzsignformfieldRequest {
  ...
  public EzsignformfieldRequest pkiEzsignformfieldID(@javax.annotation.Nullable Integer pkiEzsignformfieldID) {
  ...
  public EzsignformfieldRequest iEzsignpagePagenumber(@javax.annotation.Nonnull Integer iEzsignpagePagenumber) {
  ...
  public EzsignformfieldRequest sEzsignformfieldLabel(@javax.annotation.Nonnull String sEzsignformfieldLabel) {
  ...
  public EzsignformfieldRequest sEzsignformfieldValue(@javax.annotation.Nullable String sEzsignformfieldValue) {
  ...
  public EzsignformfieldRequest iEzsignformfieldX(@javax.annotation.Nonnull Integer iEzsignformfieldX) {
  ...
  public EzsignformfieldRequest iEzsignformfieldY(@javax.annotation.Nonnull Integer iEzsignformfieldY) {
  ...
  public EzsignformfieldRequest iEzsignformfieldWidth(@javax.annotation.Nonnull Integer iEzsignformfieldWidth) {
  ...
  public EzsignformfieldRequest iEzsignformfieldHeight(@javax.annotation.Nonnull Integer iEzsignformfieldHeight) {
  ...
  public EzsignformfieldRequest bEzsignformfieldAutocomplete(@javax.annotation.Nullable Boolean bEzsignformfieldAutocomplete) {
  ...
  public EzsignformfieldRequest bEzsignformfieldSelected(@javax.annotation.Nullable Boolean bEzsignformfieldSelected) {
  ...
  public EzsignformfieldRequest sEzsignformfieldEnteredvalue(@javax.annotation.Nullable String sEzsignformfieldEnteredvalue) {
  ...
  public EzsignformfieldRequest eEzsignformfieldDependencyrequirement(@javax.annotation.Nullable FieldEEzsignformfieldDependencyrequirement eEzsignformfieldDependencyrequirement) {
  ...
  public EzsignformfieldRequest eEzsignformfieldHorizontalalignment(@javax.annotation.Nullable EnumHorizontalalignment eEzsignformfieldHorizontalalignment) {
  ...
  public EzsignformfieldRequest objTextstylestatic(@javax.annotation.Nullable TextstylestaticRequestCompound objTextstylestatic) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignformfieldID, ezsignformfieldRequest.pkiEzsignformfieldID) &&
        ...
        Objects.equals(this.bEzsignformfieldAutocomplete, ezsignformfieldRequest.bEzsignformfieldAutocomplete) &&
        ...
        Objects.equals(this.eEzsignformfieldDependencyrequirement, ezsignformfieldRequest.eEzsignformfieldDependencyrequirement) &&
        Objects.equals(this.eEzsignformfieldHorizontalalignment, ezsignformfieldRequest.eEzsignformfieldHorizontalalignment) &&
        Objects.equals(this.objTextstylestatic, ezsignformfieldRequest.objTextstylestatic);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignformfieldID", "iEzsignpagePagenumber", "sEzsignformfieldLabel", "sEzsignformfieldValue", "iEzsignformfieldX", "iEzsignformfieldY", "iEzsignformfieldWidth", "iEzsignformfieldHeight", "bEzsignformfieldAutocomplete", "bEzsignformfieldSelected", "sEzsignformfieldEnteredvalue", "eEzsignformfieldDependencyrequirement", "eEzsignformfieldHorizontalalignment", "objTextstylestatic"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iEzsignpagePagenumber", "sEzsignformfieldLabel", "iEzsignformfieldX", "iEzsignformfieldY", "iEzsignformfieldWidth", "iEzsignformfieldHeight"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignformfieldRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignformfieldRequest is not found in the empty JSON string", EzsignformfieldRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignformfieldRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignformfieldRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("sEzsignformfieldValue") != null && !jsonObj.get("sEzsignformfieldValue").isJsonNull()) && !jsonObj.get("sEzsignformfieldValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignformfieldValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignformfieldValue").toString()));
      }
      if ((jsonObj.get("sEzsignformfieldEnteredvalue") != null && !jsonObj.get("sEzsignformfieldEnteredvalue").isJsonNull()) && !jsonObj.get("sEzsignformfieldEnteredvalue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignformfieldEnteredvalue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignformfieldEnteredvalue").toString()));
      }
