...
public class CustomEzsignformfieldRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomEzsignformfieldRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomEzsignformfieldRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignformfieldRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomEzsignformfieldRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
