...
public class DiscussionResponseCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiDiscussionID", "sDiscussionDescription", "bDiscussionClosed", "dtDiscussionLastread", "iDiscussionmessageCount", "iDiscussionmessageCountunread", "objDiscussionconfiguration", "a_objDiscussionmembership", "a_objDiscussionmessage"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiDiscussionID", "sDiscussionDescription", "bDiscussionClosed", "iDiscussionmessageCount", "iDiscussionmessageCountunread", "a_objDiscussionmembership", "a_objDiscussionmessage"));
  }
