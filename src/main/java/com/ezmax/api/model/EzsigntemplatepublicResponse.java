...
public class EzsigntemplatepublicResponse {
  ...
  public EzsigntemplatepublicResponse() {
  }

  public EzsigntemplatepublicResponse pkiEzsigntemplatepublicID(@javax.annotation.Nonnull Integer pkiEzsigntemplatepublicID) {
  ...
  public EzsigntemplatepublicResponse fkiEzsignfoldertypeID(@javax.annotation.Nonnull Integer fkiEzsignfoldertypeID) {
  ...
  public EzsigntemplatepublicResponse sEzsignfoldertypeNameX(@javax.annotation.Nonnull String sEzsignfoldertypeNameX) {
  ...
  public EzsigntemplatepublicResponse fkiUserlogintypeID(@javax.annotation.Nonnull Integer fkiUserlogintypeID) {
  ...
  public EzsigntemplatepublicResponse sUserlogintypeDescriptionX(@javax.annotation.Nonnull String sUserlogintypeDescriptionX) {
  ...
  public EzsigntemplatepublicResponse fkiEzsigntemplateID(@javax.annotation.Nullable Integer fkiEzsigntemplateID) {
  ...
  public EzsigntemplatepublicResponse fkiEzsigntemplatepackageID(@javax.annotation.Nullable Integer fkiEzsigntemplatepackageID) {
  ...
  public EzsigntemplatepublicResponse sEzsigntemplatepublicDescription(@javax.annotation.Nonnull String sEzsigntemplatepublicDescription) {
  ...
  public EzsigntemplatepublicResponse sEzsigntemplatepublicReferenceid(@javax.annotation.Nonnull String sEzsigntemplatepublicReferenceid) {
  ...
  public EzsigntemplatepublicResponse bEzsigntemplatepublicIsactive(@javax.annotation.Nonnull Boolean bEzsigntemplatepublicIsactive) {
  ...
  public EzsigntemplatepublicResponse tEzsigntemplatepublicNote(@javax.annotation.Nonnull String tEzsigntemplatepublicNote) {
  ...
  public EzsigntemplatepublicResponse eEzsigntemplatepublicLimittype(@javax.annotation.Nonnull FieldEEzsigntemplatepublicLimittype eEzsigntemplatepublicLimittype) {
  ...
  public EzsigntemplatepublicResponse iEzsigntemplatepublicLimit(@javax.annotation.Nonnull Integer iEzsigntemplatepublicLimit) {
  ...
  public EzsigntemplatepublicResponse iEzsigntemplatepublicLimitexceeded(@javax.annotation.Nonnull Integer iEzsigntemplatepublicLimitexceeded) {
  ...
  public EzsigntemplatepublicResponse dtEzsigntemplatepublicLimitexceededsince(@javax.annotation.Nonnull String dtEzsigntemplatepublicLimitexceededsince) {
  ...
  public EzsigntemplatepublicResponse sEzsigntemplatepublicUrl(@javax.annotation.Nonnull String sEzsigntemplatepublicUrl) {
  ...
  public void setsEzsigntemplatepublicUrl(@javax.annotation.Nonnull String sEzsigntemplatepublicUrl) {
    this.sEzsigntemplatepublicUrl = sEzsigntemplatepublicUrl;
  }


  public EzsigntemplatepublicResponse sEzsigntemplatepublicEzsigntemplatedescription(@javax.annotation.Nonnull String sEzsigntemplatepublicEzsigntemplatedescription) {
  ...
  public EzsigntemplatepublicResponse objAudit(@javax.annotation.Nullable CommonAudit objAudit) {
  ...
  public boolean equals(Object o) {
    ...
    EzsigntemplatepublicResponse ezsigntemplatepublicResponse = (EzsigntemplatepublicResponse) o;
    return Objects.equals(this.pkiEzsigntemplatepublicID, ezsigntemplatepublicResponse.pkiEzsigntemplatepublicID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsigntemplatepublicResponse.fkiEzsignfoldertypeID) &&
        Objects.equals(this.sEzsignfoldertypeNameX, ezsigntemplatepublicResponse.sEzsignfoldertypeNameX) &&
        Objects.equals(this.fkiUserlogintypeID, ezsigntemplatepublicResponse.fkiUserlogintypeID) &&
        Objects.equals(this.sUserlogintypeDescriptionX, ezsigntemplatepublicResponse.sUserlogintypeDescriptionX) &&
        Objects.equals(this.fkiEzsigntemplateID, ezsigntemplatepublicResponse.fkiEzsigntemplateID) &&
        Objects.equals(this.fkiEzsigntemplatepackageID, ezsigntemplatepublicResponse.fkiEzsigntemplatepackageID) &&
        Objects.equals(this.sEzsigntemplatepublicDescription, ezsigntemplatepublicResponse.sEzsigntemplatepublicDescription) &&
        Objects.equals(this.sEzsigntemplatepublicReferenceid, ezsigntemplatepublicResponse.sEzsigntemplatepublicReferenceid) &&
        Objects.equals(this.bEzsigntemplatepublicIsactive, ezsigntemplatepublicResponse.bEzsigntemplatepublicIsactive) &&
        Objects.equals(this.tEzsigntemplatepublicNote, ezsigntemplatepublicResponse.tEzsigntemplatepublicNote) &&
        Objects.equals(this.eEzsigntemplatepublicLimittype, ezsigntemplatepublicResponse.eEzsigntemplatepublicLimittype) &&
        Objects.equals(this.iEzsigntemplatepublicLimit, ezsigntemplatepublicResponse.iEzsigntemplatepublicLimit) &&
        Objects.equals(this.iEzsigntemplatepublicLimitexceeded, ezsigntemplatepublicResponse.iEzsigntemplatepublicLimitexceeded) &&
        Objects.equals(this.dtEzsigntemplatepublicLimitexceededsince, ezsigntemplatepublicResponse.dtEzsigntemplatepublicLimitexceededsince) &&
        Objects.equals(this.sEzsigntemplatepublicUrl, ezsigntemplatepublicResponse.sEzsigntemplatepublicUrl) &&
        Objects.equals(this.sEzsigntemplatepublicEzsigntemplatedescription, ezsigntemplatepublicResponse.sEzsigntemplatepublicEzsigntemplatedescription) &&
        Objects.equals(this.objAudit, ezsigntemplatepublicResponse.objAudit);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatepublicID", "fkiEzsignfoldertypeID", "sEzsignfoldertypeNameX", "fkiUserlogintypeID", "sUserlogintypeDescriptionX", "fkiEzsigntemplateID", "fkiEzsigntemplatepackageID", "sEzsigntemplatepublicDescription", "sEzsigntemplatepublicReferenceid", "bEzsigntemplatepublicIsactive", "tEzsigntemplatepublicNote", "eEzsigntemplatepublicLimittype", "iEzsigntemplatepublicLimit", "iEzsigntemplatepublicLimitexceeded", "dtEzsigntemplatepublicLimitexceededsince", "sEzsigntemplatepublicUrl", "sEzsigntemplatepublicEzsigntemplatedescription", "objAudit"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatepublicID", "fkiEzsignfoldertypeID", "sEzsignfoldertypeNameX", "fkiUserlogintypeID", "sUserlogintypeDescriptionX", "sEzsigntemplatepublicDescription", "sEzsigntemplatepublicReferenceid", "bEzsigntemplatepublicIsactive", "tEzsigntemplatepublicNote", "eEzsigntemplatepublicLimittype", "iEzsigntemplatepublicLimit", "iEzsigntemplatepublicLimitexceeded", "dtEzsigntemplatepublicLimitexceededsince", "sEzsigntemplatepublicUrl", "sEzsigntemplatepublicEzsigntemplatedescription"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatepublicResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatepublicResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatepublicResponse is not found in the empty JSON string", EzsigntemplatepublicResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatepublicResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatepublicResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplatepublicResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplatepublicResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplatepublicResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplatepublicResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplatepublicResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplatepublicResponse>() {
           @Override
           public void write(JsonWriter out, EzsigntemplatepublicResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplatepublicResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsigntemplatepublicResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsigntemplatepublicResponse
   * @throws IOException if the JSON string is invalid with respect to EzsigntemplatepublicResponse
   */
  public static EzsigntemplatepublicResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplatepublicResponse.class);
  }

  /**
   * Convert an instance of EzsigntemplatepublicResponse to an JSON string
   *
   * @return JSON string
   */
