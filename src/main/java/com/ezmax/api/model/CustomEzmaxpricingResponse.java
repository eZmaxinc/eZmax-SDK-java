  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzmaxpricingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomEzmaxpricingResponse is not found in the empty JSON string", CustomEzmaxpricingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzmaxpricingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzmaxpricingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("dEzmaxpricingRebateezsignallagents").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dEzmaxpricingRebateezsignallagents` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dEzmaxpricingRebateezsignallagents").toString()));
      }
      if (!jsonObj.get("dtEzmaxpricingStart").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtEzmaxpricingStart` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzmaxpricingStart").toString()));
      }
      if ((jsonObj.get("dtEzmaxpricingEnd") != null && !jsonObj.get("dtEzmaxpricingEnd").isJsonNull()) && !jsonObj.get("dtEzmaxpricingEnd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtEzmaxpricingEnd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzmaxpricingEnd").toString()));
      }
  }
