...
public class EzsignbulksenddocumentmappingRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignbulksenddocumentmappingID", "fkiEzsignbulksendID", "fkiEzsigntemplatepackageID", "fkiEzsigntemplateID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiEzsignbulksendID"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignbulksenddocumentmappingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignbulksenddocumentmappingRequest is not found in the empty JSON string", EzsignbulksenddocumentmappingRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignbulksenddocumentmappingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignbulksenddocumentmappingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
