...
public class EzsignsignaturecustomdateResponseCompound {
  ...
  public EzsignsignaturecustomdateResponseCompound pkiEzsignsignaturecustomdateID(@javax.annotation.Nonnull Integer pkiEzsignsignaturecustomdateID) {
  ...
  public EzsignsignaturecustomdateResponseCompound iEzsignsignaturecustomdateX(@javax.annotation.Nullable Integer iEzsignsignaturecustomdateX) {
  ...
  public EzsignsignaturecustomdateResponseCompound iEzsignsignaturecustomdateY(@javax.annotation.Nullable Integer iEzsignsignaturecustomdateY) {
  ...
  public EzsignsignaturecustomdateResponseCompound iEzsignsignaturecustomdateOffsetx(@javax.annotation.Nullable Integer iEzsignsignaturecustomdateOffsetx) {
  ...
  public EzsignsignaturecustomdateResponseCompound iEzsignsignaturecustomdateOffsety(@javax.annotation.Nullable Integer iEzsignsignaturecustomdateOffsety) {
  ...
  public EzsignsignaturecustomdateResponseCompound sEzsignsignaturecustomdateFormat(@javax.annotation.Nonnull String sEzsignsignaturecustomdateFormat) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignsignaturecustomdateID, ezsignsignaturecustomdateResponseCompound.pkiEzsignsignaturecustomdateID) &&
        ...
        Objects.equals(this.iEzsignsignaturecustomdateOffsetx, ezsignsignaturecustomdateResponseCompound.iEzsignsignaturecustomdateOffsetx) &&
        Objects.equals(this.iEzsignsignaturecustomdateOffsety, ezsignsignaturecustomdateResponseCompound.iEzsignsignaturecustomdateOffsety) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignsignaturecustomdateResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignaturecustomdateResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignaturecustomdateResponseCompound is not found in the empty JSON string", EzsignsignaturecustomdateResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignaturecustomdateResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignaturecustomdateResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
