...
public class SignatureRequestCompound {
  ...
  public SignatureRequestCompound pkiSignatureID(Integer pkiSignatureID) {
  ...
  public SignatureRequestCompound fkiFontID(Integer fkiFontID) {
  ...
  public SignatureRequestCompound eSignaturePreference(FieldESignaturePreference eSignaturePreference) {
  ...
  public SignatureRequestCompound tSignatureSvg(String tSignatureSvg) {
  ...
  public SignatureRequestCompound tSignatureSvginitials(String tSignatureSvginitials) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SignatureRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignatureRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignatureRequestCompound is not found in the empty JSON string", SignatureRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignatureRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SignatureRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SignatureRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignatureRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignatureRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignatureRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignatureRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<SignatureRequestCompound>() {
           @Override
           public void write(JsonWriter out, SignatureRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SignatureRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SignatureRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SignatureRequestCompound
   * @throws IOException if the JSON string is invalid with respect to SignatureRequestCompound
   */
  public static SignatureRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignatureRequestCompound.class);
  }

  /**
   * Convert an instance of SignatureRequestCompound to an JSON string
   *
   * @return JSON string
   */
