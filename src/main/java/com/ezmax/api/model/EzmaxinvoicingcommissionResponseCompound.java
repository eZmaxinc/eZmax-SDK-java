...
public class EzmaxinvoicingcommissionResponseCompound {
  ...
  public EzmaxinvoicingcommissionResponseCompound pkiEzmaxinvoicingcommissionID(@javax.annotation.Nullable Integer pkiEzmaxinvoicingcommissionID) {
  ...
  public EzmaxinvoicingcommissionResponseCompound fkiEzmaxinvoicingsummaryglobalID(@javax.annotation.Nullable Integer fkiEzmaxinvoicingsummaryglobalID) {
  ...
  public EzmaxinvoicingcommissionResponseCompound fkiEzmaxpartnerID(@javax.annotation.Nullable Integer fkiEzmaxpartnerID) {
  ...
  public EzmaxinvoicingcommissionResponseCompound fkiEzmaxrepresentativeID(@javax.annotation.Nullable Integer fkiEzmaxrepresentativeID) {
  ...
  public EzmaxinvoicingcommissionResponseCompound dtEzmaxinvoicingcommissionStart(@javax.annotation.Nonnull String dtEzmaxinvoicingcommissionStart) {
  ...
  public EzmaxinvoicingcommissionResponseCompound dtEzmaxinvoicingcommissionEnd(@javax.annotation.Nonnull String dtEzmaxinvoicingcommissionEnd) {
  ...
  public EzmaxinvoicingcommissionResponseCompound iEzmaxinvoicingcommissionDays(@javax.annotation.Nonnull Integer iEzmaxinvoicingcommissionDays) {
  ...
  public EzmaxinvoicingcommissionResponseCompound dEzmaxinvoicingcommissionAmount(@javax.annotation.Nonnull String dEzmaxinvoicingcommissionAmount) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzmaxinvoicingcommissionID", "fkiEzmaxinvoicingsummaryglobalID", "fkiEzmaxpartnerID", "fkiEzmaxrepresentativeID", "dtEzmaxinvoicingcommissionStart", "dtEzmaxinvoicingcommissionEnd", "iEzmaxinvoicingcommissionDays", "dEzmaxinvoicingcommissionAmount", "objContactName"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("dtEzmaxinvoicingcommissionStart", "dtEzmaxinvoicingcommissionEnd", "iEzmaxinvoicingcommissionDays", "dEzmaxinvoicingcommissionAmount"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzmaxinvoicingcommissionResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzmaxinvoicingcommissionResponseCompound is not found in the empty JSON string", EzmaxinvoicingcommissionResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzmaxinvoicingcommissionResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzmaxinvoicingcommissionResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("dtEzmaxinvoicingcommissionStart").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtEzmaxinvoicingcommissionStart` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzmaxinvoicingcommissionStart").toString()));
      }
      if (!jsonObj.get("dtEzmaxinvoicingcommissionEnd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dtEzmaxinvoicingcommissionEnd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtEzmaxinvoicingcommissionEnd").toString()));
      }
      if (!jsonObj.get("dEzmaxinvoicingcommissionAmount").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `dEzmaxinvoicingcommissionAmount` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dEzmaxinvoicingcommissionAmount").toString()));
      }
