...
public class CreditcarddetailResponseCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiCreditcarddetailID", "fkiCreditcardtypeID", "iCreditcarddetailLastdigits", "iCreditcarddetailExpirationmonth", "iCreditcarddetailExpirationyear", "sCreditcarddetailCivic", "sCreditcarddetailStreet", "sCreditcarddetailZip"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiCreditcarddetailID", "fkiCreditcardtypeID", "iCreditcarddetailLastdigits", "iCreditcarddetailExpirationmonth", "iCreditcarddetailExpirationyear", "sCreditcarddetailCivic", "sCreditcarddetailStreet", "sCreditcarddetailZip"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreditcarddetailResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreditcarddetailResponseCompound is not found in the empty JSON string", CreditcarddetailResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreditcarddetailResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreditcarddetailResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sCreditcarddetailCivic").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sCreditcarddetailCivic` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCreditcarddetailCivic").toString()));
      }
      if (!jsonObj.get("sCreditcarddetailStreet").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sCreditcarddetailStreet` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCreditcarddetailStreet").toString()));
      }
      if (!jsonObj.get("sCreditcarddetailZip").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sCreditcarddetailZip` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCreditcarddetailZip").toString()));
      }
  }
