...
public class CustomEzsignsignatureEzsignsignaturesAutomaticResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignsignatureID, customEzsignsignatureEzsignsignaturesAutomaticResponse.pkiEzsignsignatureID) &&
        Objects.equals(this.eEzsignsignatureType, customEzsignsignatureEzsignsignaturesAutomaticResponse.eEzsignsignatureType) &&
        Objects.equals(this.iEzsignpagePagenumber, customEzsignsignatureEzsignsignaturesAutomaticResponse.iEzsignpagePagenumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignsignatureID, eEzsignsignatureType, iEzsignpagePagenumber);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignsignatureID", "eEzsignsignatureType", "iEzsignpagePagenumber"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiEzsignsignatureID", "eEzsignsignatureType", "iEzsignpagePagenumber"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzsignsignatureEzsignsignaturesAutomaticResponse is not found in the empty JSON string", CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzsignsignatureEzsignsignaturesAutomaticResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomEzsignsignatureEzsignsignaturesAutomaticResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomEzsignsignatureEzsignsignaturesAutomaticResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomEzsignsignatureEzsignsignaturesAutomaticResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomEzsignsignatureEzsignsignaturesAutomaticResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomEzsignsignatureEzsignsignaturesAutomaticResponse>() {
           @Override
           public void write(JsonWriter out, CustomEzsignsignatureEzsignsignaturesAutomaticResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomEzsignsignatureEzsignsignaturesAutomaticResponse read(JsonReader in) throws IOException {
