...
public class CustomEzsignsignatureEzsignsignaturesAutomaticResponse {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomEzsignsignatureEzsignsignaturesAutomaticResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomEzsignsignatureEzsignsignaturesAutomaticResponse is not found in the empty JSON string", CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignsignatureEzsignsignaturesAutomaticResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomEzsignsignatureEzsignsignaturesAutomaticResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
