...
public class EzsignsignatureSignV1Request {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EzsignsignatureSignV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("a_objFile") != null && !jsonObj.get("a_objFile").isJsonNull()) {
        ...
        if (jsonArrayaObjFile != null) {
          ...
          for (int i = 0; i < jsonArrayaObjFile.size(); i++) {
            CommonFile.validateJsonObject(jsonArrayaObjFile.get(i).getAsJsonObject());
          };
        }
      }
  }
