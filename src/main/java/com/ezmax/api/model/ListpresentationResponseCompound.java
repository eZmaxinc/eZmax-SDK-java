...
public class ListpresentationResponseCompound {
  ...
  public ListpresentationResponseCompound() { 
  }

  public ListpresentationResponseCompound sListpresentationDescription(String sListpresentationDescription) {
  ...
  **/
  ...
  public ListpresentationResponseCompound sListpresentationFilter(String sListpresentationFilter) {
  ...
  **/
  ...
  public ListpresentationResponseCompound sListpresentationOrderby(String sListpresentationOrderby) {
  ...
  **/
  ...
  public ListpresentationResponseCompound aSColumnName(List<String> aSColumnName) {
    
    this.aSColumnName = aSColumnName;
    return this;
  }

  public ListpresentationResponseCompound addASColumnNameItem(String aSColumnNameItem) {
  ...
  **/
  ...
  public ListpresentationResponseCompound iListpresentationRowMax(Integer iListpresentationRowMax) {
  ...
  **/
  ...
  public ListpresentationResponseCompound iListpresentationRowOffset(Integer iListpresentationRowOffset) {
  ...
  **/
  ...
  public ListpresentationResponseCompound bListpresentationDefault(Boolean bListpresentationDefault) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sListpresentationDescription, listpresentationResponseCompound.sListpresentationDescription) &&
        Objects.equals(this.sListpresentationFilter, listpresentationResponseCompound.sListpresentationFilter) &&
        Objects.equals(this.sListpresentationOrderby, listpresentationResponseCompound.sListpresentationOrderby) &&
        Objects.equals(this.aSColumnName, listpresentationResponseCompound.aSColumnName) &&
        Objects.equals(this.iListpresentationRowMax, listpresentationResponseCompound.iListpresentationRowMax) &&
        Objects.equals(this.iListpresentationRowOffset, listpresentationResponseCompound.iListpresentationRowOffset) &&
        Objects.equals(this.bListpresentationDefault, listpresentationResponseCompound.bListpresentationDefault);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListpresentationResponseCompound
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ListpresentationResponseCompound.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListpresentationResponseCompound is not found in the empty JSON string", ListpresentationResponseCompound.openapiRequiredFields.toString()));
        }
      }
      Set<Entry<String, JsonElement>> entries = jsonObj.entrySet();
      // check to see if the JSON string contains additional fields
      for (Entry<String, JsonElement> entry : entries) {
        if (!ListpresentationResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListpresentationResponseCompound` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListpresentationResponseCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListpresentationResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListpresentationResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListpresentationResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListpresentationResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<ListpresentationResponseCompound>() {
           @Override
           public void write(JsonWriter out, ListpresentationResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListpresentationResponseCompound read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ListpresentationResponseCompound given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListpresentationResponseCompound
  * @throws IOException if the JSON string is invalid with respect to ListpresentationResponseCompound
  */
  public static ListpresentationResponseCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListpresentationResponseCompound.class);
  }

 /**
  * Convert an instance of ListpresentationResponseCompound to an JSON string
  *
  * @return JSON string
  */
