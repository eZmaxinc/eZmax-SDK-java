...
public class EzsignsignaturepaymentdetailRequest {
  ...
  public EzsignsignaturepaymentdetailRequest fkiGlaccountcontainerID(@javax.annotation.Nullable Integer fkiGlaccountcontainerID) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignaturepaymentdetailRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignsignaturepaymentdetailRequest is not found in the empty JSON string", EzsignsignaturepaymentdetailRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignaturepaymentdetailRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignsignaturepaymentdetailRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
