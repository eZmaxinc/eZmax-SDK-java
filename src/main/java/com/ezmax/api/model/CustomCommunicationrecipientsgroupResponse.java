...
public class CustomCommunicationrecipientsgroupResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sCommunicationrecipientsgroupLabel", "a_objCommunicationrecipientsrecipient"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sCommunicationrecipientsgroupLabel", "a_objCommunicationrecipientsrecipient"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomCommunicationrecipientsgroupResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomCommunicationrecipientsgroupResponse is not found in the empty JSON string", CustomCommunicationrecipientsgroupResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomCommunicationrecipientsgroupResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomCommunicationrecipientsgroupResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sCommunicationrecipientsgroupLabel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sCommunicationrecipientsgroupLabel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCommunicationrecipientsgroupLabel").toString()));
      }
      // ensure the json data is an array
      if (!jsonObj.get("a_objCommunicationrecipientsrecipient").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objCommunicationrecipientsrecipient` to be an array in the JSON string but got `%s`", jsonObj.get("a_objCommunicationrecipientsrecipient").toString()));
      }
