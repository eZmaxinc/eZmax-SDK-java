...
public class WebhookSendWebhookV1Request {
  ...
  public WebhookSendWebhookV1Request eWebhookRealestateevent(@javax.annotation.Nullable FieldEWebhookRealestateevent eWebhookRealestateevent) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eWebhookModule, webhookSendWebhookV1Request.eWebhookModule) &&
        ...
        Objects.equals(this.eWebhookRealestateevent, webhookSendWebhookV1Request.eWebhookRealestateevent) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eWebhookModule, eWebhookEzsignevent, eWebhookManagementevent, eWebhookRealestateevent, fkiEzsignfolderID, fkiEzsigndocumentID, fkiEzsignsignerID, fkiUserID, fkiUserstagedID);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eWebhookModule", "eWebhookEzsignevent", "eWebhookManagementevent", "eWebhookRealestateevent", "fkiEzsignfolderID", "fkiEzsigndocumentID", "fkiEzsignsignerID", "fkiUserID", "fkiUserstagedID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eWebhookModule"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSendWebhookV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookSendWebhookV1Request is not found in the empty JSON string", WebhookSendWebhookV1Request.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSendWebhookV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookSendWebhookV1Request` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
