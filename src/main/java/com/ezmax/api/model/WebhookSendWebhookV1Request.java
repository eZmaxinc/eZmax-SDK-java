...
public class WebhookSendWebhookV1Request {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eWebhookModule", "eWebhookEzsignevent", "eWebhookManagementevent", "fkiEzsignfolderID", "fkiEzsigndocumentID", "fkiEzsignsignerID", "fkiUserID", "fkiUserstagedID"));
