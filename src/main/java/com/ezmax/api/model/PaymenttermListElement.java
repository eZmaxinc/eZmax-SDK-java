...
public class PaymenttermListElement {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiPaymenttermID, sPaymenttermCode, sPaymenttermDescriptionX, bPaymenttermIsactive);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PaymenttermListElement
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PaymenttermListElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PaymenttermListElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PaymenttermListElement` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
