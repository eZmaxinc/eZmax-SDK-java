...
public class PaymenttermListElement {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiPaymenttermID", "sPaymenttermCode", "ePaymenttermType", "iPaymenttermDay", "sPaymenttermDescriptionX", "bPaymenttermIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiPaymenttermID", "sPaymenttermCode", "ePaymenttermType", "iPaymenttermDay", "sPaymenttermDescriptionX", "bPaymenttermIsactive"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymenttermListElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaymenttermListElement is not found in the empty JSON string", PaymenttermListElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymenttermListElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PaymenttermListElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
