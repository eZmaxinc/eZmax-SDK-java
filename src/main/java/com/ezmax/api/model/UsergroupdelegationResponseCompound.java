...
public class UsergroupdelegationResponseCompound {
  ...
  public UsergroupdelegationResponseCompound pkiUsergroupdelegationID(@javax.annotation.Nonnull Integer pkiUsergroupdelegationID) {
  ...
  public UsergroupdelegationResponseCompound fkiUsergroupID(@javax.annotation.Nonnull Integer fkiUsergroupID) {
  ...
  public UsergroupdelegationResponseCompound fkiUserID(@javax.annotation.Nonnull Integer fkiUserID) {
  ...
  public UsergroupdelegationResponseCompound sUserFirstname(@javax.annotation.Nonnull String sUserFirstname) {
  ...
  public UsergroupdelegationResponseCompound sUserLastname(@javax.annotation.Nonnull String sUserLastname) {
  ...
  public UsergroupdelegationResponseCompound sUserLoginname(@javax.annotation.Nonnull String sUserLoginname) {
  ...
  public UsergroupdelegationResponseCompound sEmailAddress(@javax.annotation.Nullable String sEmailAddress) {
  ...
  public UsergroupdelegationResponseCompound bUserIsactive(@javax.annotation.Nonnull Boolean bUserIsactive) {
  ...
  public UsergroupdelegationResponseCompound sUsergroupNameX(@javax.annotation.Nonnull String sUsergroupNameX) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiUsergroupdelegationID, usergroupdelegationResponseCompound.pkiUsergroupdelegationID) &&
        ...
        Objects.equals(this.bUserIsactive, usergroupdelegationResponseCompound.bUserIsactive) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UsergroupdelegationResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UsergroupdelegationResponseCompound is not found in the empty JSON string", UsergroupdelegationResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UsergroupdelegationResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UsergroupdelegationResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
