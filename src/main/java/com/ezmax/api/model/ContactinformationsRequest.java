...
public class ContactinformationsRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("iAddressDefault", "iPhoneDefault", "iEmailDefault", "iWebsiteDefault"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("iAddressDefault", "iPhoneDefault", "iEmailDefault", "iWebsiteDefault"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactinformationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ContactinformationsRequest is not found in the empty JSON string", ContactinformationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactinformationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ContactinformationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
