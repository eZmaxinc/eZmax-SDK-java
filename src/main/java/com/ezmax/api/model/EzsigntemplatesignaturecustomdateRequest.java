...
public class EzsigntemplatesignaturecustomdateRequest {
  ...
  public EzsigntemplatesignaturecustomdateRequest pkiEzsigntemplatesignaturecustomdateID(@javax.annotation.Nullable Integer pkiEzsigntemplatesignaturecustomdateID) {
  ...
  @Deprecated
  public EzsigntemplatesignaturecustomdateRequest iEzsigntemplatesignaturecustomdateX(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateX) {
  ...
  @Deprecated
  public EzsigntemplatesignaturecustomdateRequest iEzsigntemplatesignaturecustomdateY(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateY) {
  ...
  public EzsigntemplatesignaturecustomdateRequest iEzsigntemplatesignaturecustomdateOffsetx(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateOffsetx) {
  ...
  public EzsigntemplatesignaturecustomdateRequest iEzsigntemplatesignaturecustomdateOffsety(@javax.annotation.Nullable Integer iEzsigntemplatesignaturecustomdateOffsety) {
  ...
  public EzsigntemplatesignaturecustomdateRequest sEzsigntemplatesignaturecustomdateFormat(@javax.annotation.Nonnull String sEzsigntemplatesignaturecustomdateFormat) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplatesignaturecustomdateID, ezsigntemplatesignaturecustomdateRequest.pkiEzsigntemplatesignaturecustomdateID) &&
        ...
        Objects.equals(this.iEzsigntemplatesignaturecustomdateOffsetx, ezsigntemplatesignaturecustomdateRequest.iEzsigntemplatesignaturecustomdateOffsetx) &&
        Objects.equals(this.iEzsigntemplatesignaturecustomdateOffsety, ezsigntemplatesignaturecustomdateRequest.iEzsigntemplatesignaturecustomdateOffsety) &&
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sEzsigntemplatesignaturecustomdateFormat"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatesignaturecustomdateRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatesignaturecustomdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatesignaturecustomdateRequest is not found in the empty JSON string", EzsigntemplatesignaturecustomdateRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatesignaturecustomdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatesignaturecustomdateRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
