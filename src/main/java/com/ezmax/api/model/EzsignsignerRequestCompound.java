...
public class EzsignsignerRequestCompound {
  ...
  public EzsignsignerRequestCompound fkiUserlogintypeID(@javax.annotation.Nullable Integer fkiUserlogintypeID) {
  ...
  public EzsignsignerRequestCompound fkiTaxassignmentID(@javax.annotation.Nonnull Integer fkiTaxassignmentID) {
  ...
  public EzsignsignerRequestCompound fkiSecretquestionID(@javax.annotation.Nullable Integer fkiSecretquestionID) {
  ...
  @Deprecated
  public EzsignsignerRequestCompound eEzsignsignerLogintype(@javax.annotation.Nullable EEzsignsignerLogintypeEnum eEzsignsignerLogintype) {
  ...
  public EzsignsignerRequestCompound sEzsignsignerSecretanswer(@javax.annotation.Nullable String sEzsignsignerSecretanswer) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiUserlogintypeID", "fkiTaxassignmentID", "fkiSecretquestionID", "eEzsignsignerLogintype", "sEzsignsignerSecretanswer", "objContact"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiTaxassignmentID", "objContact"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignsignerRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignerRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignerRequestCompound is not found in the empty JSON string", EzsignsignerRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignerRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignerRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignsignerRequestCompound.openapiRequiredFields) {
      ...
      if ((jsonObj.get("eEzsignsignerLogintype") != null && !jsonObj.get("eEzsignsignerLogintype").isJsonNull()) && !jsonObj.get("eEzsignsignerLogintype").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eEzsignsignerLogintype` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eEzsignsignerLogintype").toString()));
      }
      ...
      if ((jsonObj.get("sEzsignsignerSecretanswer") != null && !jsonObj.get("sEzsignsignerSecretanswer").isJsonNull()) && !jsonObj.get("sEzsignsignerSecretanswer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignsignerSecretanswer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignsignerSecretanswer").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignsignerRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignsignerRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignsignerRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignsignerRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignsignerRequestCompound>() {
           @Override
           public void write(JsonWriter out, EzsignsignerRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignsignerRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsignsignerRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignsignerRequestCompound
   * @throws IOException if the JSON string is invalid with respect to EzsignsignerRequestCompound
   */
  public static EzsignsignerRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignsignerRequestCompound.class);
  }

  /**
   * Convert an instance of EzsignsignerRequestCompound to an JSON string
   *
   * @return JSON string
   */
