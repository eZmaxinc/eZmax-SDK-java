 ...
 */
@JsonAdapter(FieldEAttachmentDocumenttype.Adapter.class)
public enum FieldEAttachmentDocumenttype {
  ...
  FieldEAttachmentDocumenttype(String value) {
    this.value = value;
  }
  ...
  public static FieldEAttachmentDocumenttype fromValue(String value) {
    for (FieldEAttachmentDocumenttype b : FieldEAttachmentDocumenttype.values()) {
  ...
  public static class Adapter extends TypeAdapter<FieldEAttachmentDocumenttype> {
    @Override
    public void write(final JsonWriter jsonWriter, final FieldEAttachmentDocumenttype enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FieldEAttachmentDocumenttype read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FieldEAttachmentDocumenttype.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FieldEAttachmentDocumenttype.fromValue(value);
  }
}
