...
public class BillingentityinternalResponseCompound {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiBillingentityinternalID", "objBillingentityinternalDescription", "a_objBillingentityinternalproduct"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BillingentityinternalResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BillingentityinternalResponseCompound is not found in the empty JSON string", BillingentityinternalResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BillingentityinternalResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BillingentityinternalResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
