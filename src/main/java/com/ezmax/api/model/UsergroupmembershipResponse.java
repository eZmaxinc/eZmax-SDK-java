...
public class UsergroupmembershipResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pkiUsergroupmembershipID, fkiUsergroupID, fkiUserID, sUserFirstname, sUserLastname, sUserLoginname, sEmailAddress, sUsergroupNameX);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UsergroupmembershipResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UsergroupmembershipResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UsergroupmembershipResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UsergroupmembershipResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
