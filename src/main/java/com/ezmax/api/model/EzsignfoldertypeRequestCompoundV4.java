...
public class EzsignfoldertypeRequestCompoundV4 {
  ...
  public EzsignfoldertypeRequestCompoundV4() {
  }

  public EzsignfoldertypeRequestCompoundV4 pkiEzsignfoldertypeID(@javax.annotation.Nullable Integer pkiEzsignfoldertypeID) {
  ...
  public void setPkiEzsignfoldertypeID(@javax.annotation.Nullable Integer pkiEzsignfoldertypeID) {
    this.pkiEzsignfoldertypeID = pkiEzsignfoldertypeID;
  }


  public EzsignfoldertypeRequestCompoundV4 objEzsignfoldertypeName(@javax.annotation.Nonnull MultilingualEzsignfoldertypeName objEzsignfoldertypeName) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiBrandingID(@javax.annotation.Nonnull Integer fkiBrandingID) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiBillingentityinternalID(@javax.annotation.Nullable Integer fkiBillingentityinternalID) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiEzsigntsarequirementID(@javax.annotation.Nullable Integer fkiEzsigntsarequirementID) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiFontIDAnnotation(@javax.annotation.Nullable Integer fkiFontIDAnnotation) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiFontIDFormfield(@javax.annotation.Nullable Integer fkiFontIDFormfield) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiFontIDSignature(@javax.annotation.Nullable Integer fkiFontIDSignature) {
  ...
  public EzsignfoldertypeRequestCompoundV4 fkiPdfalevelIDConvert(@javax.annotation.Nullable Integer fkiPdfalevelIDConvert) {
  ...
  public EzsignfoldertypeRequestCompoundV4 aFkiPdfalevelID(@javax.annotation.Nullable List<Integer> aFkiPdfalevelID) {
    this.aFkiPdfalevelID = aFkiPdfalevelID;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiPdfalevelIDItem(Integer aFkiPdfalevelIDItem) {
  ...
  public EzsignfoldertypeRequestCompoundV4 aFkiUserlogintypeID(@javax.annotation.Nonnull List<Integer> aFkiUserlogintypeID) {
    this.aFkiUserlogintypeID = aFkiUserlogintypeID;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiUserlogintypeIDItem(Integer aFkiUserlogintypeIDItem) {
  ...
  public void setaFkiUserlogintypeID(@javax.annotation.Nonnull List<Integer> aFkiUserlogintypeID) {
    this.aFkiUserlogintypeID = aFkiUserlogintypeID;
  }


  public EzsignfoldertypeRequestCompoundV4 aFkiUsergroupIDAll(@javax.annotation.Nullable List<Integer> aFkiUsergroupIDAll) {
    this.aFkiUsergroupIDAll = aFkiUsergroupIDAll;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiUsergroupIDAllItem(Integer aFkiUsergroupIDAllItem) {
  ...
  public void setaFkiUsergroupIDAll(@javax.annotation.Nullable List<Integer> aFkiUsergroupIDAll) {
    this.aFkiUsergroupIDAll = aFkiUsergroupIDAll;
  }


  public EzsignfoldertypeRequestCompoundV4 aFkiUsergroupIDRestricted(@javax.annotation.Nullable List<Integer> aFkiUsergroupIDRestricted) {
    this.aFkiUsergroupIDRestricted = aFkiUsergroupIDRestricted;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiUsergroupIDRestrictedItem(Integer aFkiUsergroupIDRestrictedItem) {
  ...
  public void setaFkiUsergroupIDRestricted(@javax.annotation.Nullable List<Integer> aFkiUsergroupIDRestricted) {
    this.aFkiUsergroupIDRestricted = aFkiUsergroupIDRestricted;
  }


  public EzsignfoldertypeRequestCompoundV4 aFkiUsergroupIDTemplate(@javax.annotation.Nullable List<Integer> aFkiUsergroupIDTemplate) {
    this.aFkiUsergroupIDTemplate = aFkiUsergroupIDTemplate;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiUsergroupIDTemplateItem(Integer aFkiUsergroupIDTemplateItem) {
  ...
  public void setaFkiUsergroupIDTemplate(@javax.annotation.Nullable List<Integer> aFkiUsergroupIDTemplate) {
    this.aFkiUsergroupIDTemplate = aFkiUsergroupIDTemplate;
  }


  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypeSignaturedatedisplay(@javax.annotation.Nonnull FieldEEzsignfoldertypeSignaturedatedisplay eEzsignfoldertypeSignaturedatedisplay) {
  ...
  public EzsignfoldertypeRequestCompoundV4 sEzsignfoldertypeSignaturedatecustomformat(@javax.annotation.Nullable String sEzsignfoldertypeSignaturedatecustomformat) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypeDocumentdependency(@javax.annotation.Nullable FieldEEzsignfoldertypeDocumentdependency eEzsignfoldertypeDocumentdependency) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypeDocumentmerge(@javax.annotation.Nullable FieldEEzsignfoldertypeDocumentmerge eEzsignfoldertypeDocumentmerge) {
  ...
  public EzsignfoldertypeRequestCompoundV4 sEmailAddressSigned(@javax.annotation.Nullable String sEmailAddressSigned) {
  ...
  public EzsignfoldertypeRequestCompoundV4 sEmailAddressSummary(@javax.annotation.Nullable String sEmailAddressSummary) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypePdfarequirement(@javax.annotation.Nullable FieldEEzsignfoldertypePdfarequirement eEzsignfoldertypePdfarequirement) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypePdfanoncompliantaction(@javax.annotation.Nullable FieldEEzsignfoldertypePdfanoncompliantaction eEzsignfoldertypePdfanoncompliantaction) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypePrivacylevel(@javax.annotation.Nonnull FieldEEzsignfoldertypePrivacylevel eEzsignfoldertypePrivacylevel) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeFontsizeannotation(@javax.annotation.Nullable Integer iEzsignfoldertypeFontsizeannotation) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeFontsizeformfield(@javax.annotation.Nullable Integer iEzsignfoldertypeFontsizeformfield) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeSendreminderfirstdays(@javax.annotation.Nullable Integer iEzsignfoldertypeSendreminderfirstdays) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeSendreminderotherdays(@javax.annotation.Nullable Integer iEzsignfoldertypeSendreminderotherdays) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeArchivaldays(@javax.annotation.Nonnull Integer iEzsignfoldertypeArchivaldays) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypeDisposal(@javax.annotation.Nonnull FieldEEzsignfoldertypeDisposal eEzsignfoldertypeDisposal) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypeCompletion(@javax.annotation.Nonnull FieldEEzsignfoldertypeCompletion eEzsignfoldertypeCompletion) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeDisposaldays(@javax.annotation.Nullable Integer iEzsignfoldertypeDisposaldays) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypeDeadlinedays(@javax.annotation.Nonnull Integer iEzsignfoldertypeDeadlinedays) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypePrematurelyendautomatically(@javax.annotation.Nullable Boolean bEzsignfoldertypePrematurelyendautomatically) {
  ...
  public EzsignfoldertypeRequestCompoundV4 iEzsignfoldertypePrematurelyendautomaticallydays(@javax.annotation.Nullable Integer iEzsignfoldertypePrematurelyendautomaticallydays) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeAutomaticsignature(@javax.annotation.Nullable Boolean bEzsignfoldertypeAutomaticsignature) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeDelegate(@javax.annotation.Nullable Boolean bEzsignfoldertypeDelegate) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeDiscussion(@javax.annotation.Nullable Boolean bEzsignfoldertypeDiscussion) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeLogrecipientinproof(@javax.annotation.Nullable Boolean bEzsignfoldertypeLogrecipientinproof) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeReassignezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeReassignezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeReassignuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeReassignuser) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeReassigngroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeReassigngroup) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSenddocumentmergetoemail(@javax.annotation.Nullable Boolean bEzsignfoldertypeSenddocumentmergetoemail) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSenddocumentmergetoezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSenddocumentmergetoezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSenddocumentmergetoreceivealldocument(@javax.annotation.Nullable Boolean bEzsignfoldertypeSenddocumentmergetoreceivealldocument) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSenddocumentmergetouser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSenddocumentmergetouser) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtoezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtoezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtouser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtouser) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendattachmentezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendattachmentezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignatureattachmentezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignatureattachmentezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignatureattachment(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignatureattachment) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendproofezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendattachmentuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendattachmentuser) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignatureattachmentuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignatureattachmentuser) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendproofuser(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofuser) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendproofemail(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofemail) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeAllowdownloadattachmentezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeAllowdownloadattachmentezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeAllowdownloadproofezsignsigner(@javax.annotation.Nullable Boolean bEzsignfoldertypeAllowdownloadproofezsignsigner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendproofreceivealldocument(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendproofreceivealldocument) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignatureattachmentreceivealldocument(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignatureattachmentreceivealldocument) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtodocumentowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsignedtodocumentowner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtofolderowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsignedtofolderowner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtofullgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtofullgroup) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtolimitedgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsignedtolimitedgroup) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsignedtocolleague(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsignedtocolleague) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsummarytodocumentowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsummarytodocumentowner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsummarytofolderowner(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsummarytofolderowner) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsummarytofullgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsummarytofullgroup) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsummarytolimitedgroup(@javax.annotation.Nullable Boolean bEzsignfoldertypeSendsummarytolimitedgroup) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeSendsummarytocolleague(@javax.annotation.Nonnull Boolean bEzsignfoldertypeSendsummarytocolleague) {
  ...
  public EzsignfoldertypeRequestCompoundV4 eEzsignfoldertypeSigneraccess(@javax.annotation.Nullable FieldEEzsignfoldertypeSigneraccess eEzsignfoldertypeSigneraccess) {
  ...
  public EzsignfoldertypeRequestCompoundV4 bEzsignfoldertypeIsactive(@javax.annotation.Nonnull Boolean bEzsignfoldertypeIsactive) {
  ...
  public EzsignfoldertypeRequestCompoundV4 aFkiUserIDSigned(@javax.annotation.Nullable List<Integer> aFkiUserIDSigned) {
    this.aFkiUserIDSigned = aFkiUserIDSigned;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiUserIDSignedItem(Integer aFkiUserIDSignedItem) {
  ...
  public EzsignfoldertypeRequestCompoundV4 aFkiUserIDSummary(@javax.annotation.Nullable List<Integer> aFkiUserIDSummary) {
    this.aFkiUserIDSummary = aFkiUserIDSummary;
    return this;
  }

  public EzsignfoldertypeRequestCompoundV4 addAFkiUserIDSummaryItem(Integer aFkiUserIDSummaryItem) {
  ...
  public boolean equals(Object o) {
    ...
    EzsignfoldertypeRequestCompoundV4 ezsignfoldertypeRequestCompoundV4 = (EzsignfoldertypeRequestCompoundV4) o;
    return Objects.equals(this.pkiEzsignfoldertypeID, ezsignfoldertypeRequestCompoundV4.pkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertypeName, ezsignfoldertypeRequestCompoundV4.objEzsignfoldertypeName) &&
        Objects.equals(this.fkiBrandingID, ezsignfoldertypeRequestCompoundV4.fkiBrandingID) &&
        Objects.equals(this.fkiBillingentityinternalID, ezsignfoldertypeRequestCompoundV4.fkiBillingentityinternalID) &&
        Objects.equals(this.fkiEzsigntsarequirementID, ezsignfoldertypeRequestCompoundV4.fkiEzsigntsarequirementID) &&
        Objects.equals(this.fkiFontIDAnnotation, ezsignfoldertypeRequestCompoundV4.fkiFontIDAnnotation) &&
        Objects.equals(this.fkiFontIDFormfield, ezsignfoldertypeRequestCompoundV4.fkiFontIDFormfield) &&
        Objects.equals(this.fkiFontIDSignature, ezsignfoldertypeRequestCompoundV4.fkiFontIDSignature) &&
        Objects.equals(this.fkiPdfalevelIDConvert, ezsignfoldertypeRequestCompoundV4.fkiPdfalevelIDConvert) &&
        Objects.equals(this.aFkiPdfalevelID, ezsignfoldertypeRequestCompoundV4.aFkiPdfalevelID) &&
        Objects.equals(this.aFkiUserlogintypeID, ezsignfoldertypeRequestCompoundV4.aFkiUserlogintypeID) &&
        Objects.equals(this.aFkiUsergroupIDAll, ezsignfoldertypeRequestCompoundV4.aFkiUsergroupIDAll) &&
        Objects.equals(this.aFkiUsergroupIDRestricted, ezsignfoldertypeRequestCompoundV4.aFkiUsergroupIDRestricted) &&
        Objects.equals(this.aFkiUsergroupIDTemplate, ezsignfoldertypeRequestCompoundV4.aFkiUsergroupIDTemplate) &&
        Objects.equals(this.eEzsignfoldertypeSignaturedatedisplay, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypeSignaturedatedisplay) &&
        Objects.equals(this.sEzsignfoldertypeSignaturedatecustomformat, ezsignfoldertypeRequestCompoundV4.sEzsignfoldertypeSignaturedatecustomformat) &&
        Objects.equals(this.eEzsignfoldertypeDocumentdependency, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypeDocumentdependency) &&
        Objects.equals(this.eEzsignfoldertypeDocumentmerge, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypeDocumentmerge) &&
        Objects.equals(this.sEmailAddressSigned, ezsignfoldertypeRequestCompoundV4.sEmailAddressSigned) &&
        Objects.equals(this.sEmailAddressSummary, ezsignfoldertypeRequestCompoundV4.sEmailAddressSummary) &&
        Objects.equals(this.eEzsignfoldertypePdfarequirement, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypePdfarequirement) &&
        Objects.equals(this.eEzsignfoldertypePdfanoncompliantaction, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypePdfanoncompliantaction) &&
        Objects.equals(this.eEzsignfoldertypePrivacylevel, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypePrivacylevel) &&
        Objects.equals(this.iEzsignfoldertypeFontsizeannotation, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeFontsizeannotation) &&
        Objects.equals(this.iEzsignfoldertypeFontsizeformfield, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeFontsizeformfield) &&
        Objects.equals(this.iEzsignfoldertypeSendreminderfirstdays, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeSendreminderfirstdays) &&
        Objects.equals(this.iEzsignfoldertypeSendreminderotherdays, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeSendreminderotherdays) &&
        Objects.equals(this.iEzsignfoldertypeArchivaldays, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeArchivaldays) &&
        Objects.equals(this.eEzsignfoldertypeDisposal, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypeDisposal) &&
        Objects.equals(this.eEzsignfoldertypeCompletion, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypeCompletion) &&
        Objects.equals(this.iEzsignfoldertypeDisposaldays, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeDisposaldays) &&
        Objects.equals(this.iEzsignfoldertypeDeadlinedays, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypeDeadlinedays) &&
        Objects.equals(this.bEzsignfoldertypePrematurelyendautomatically, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypePrematurelyendautomatically) &&
        Objects.equals(this.iEzsignfoldertypePrematurelyendautomaticallydays, ezsignfoldertypeRequestCompoundV4.iEzsignfoldertypePrematurelyendautomaticallydays) &&
        Objects.equals(this.bEzsignfoldertypeAutomaticsignature, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeAutomaticsignature) &&
        Objects.equals(this.bEzsignfoldertypeDelegate, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeDelegate) &&
        Objects.equals(this.bEzsignfoldertypeDiscussion, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeDiscussion) &&
        Objects.equals(this.bEzsignfoldertypeLogrecipientinproof, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeLogrecipientinproof) &&
        Objects.equals(this.bEzsignfoldertypeReassignezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeReassignezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeReassignuser, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeReassignuser) &&
        Objects.equals(this.bEzsignfoldertypeReassigngroup, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeReassigngroup) &&
        Objects.equals(this.bEzsignfoldertypeSenddocumentmergetoemail, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSenddocumentmergetoemail) &&
        Objects.equals(this.bEzsignfoldertypeSenddocumentmergetoezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSenddocumentmergetoezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSenddocumentmergetoreceivealldocument, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSenddocumentmergetoreceivealldocument) &&
        Objects.equals(this.bEzsignfoldertypeSenddocumentmergetouser, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSenddocumentmergetouser) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtoezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtoezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtouser, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtouser) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignatureattachmentezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignatureattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignatureattachment, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignatureattachment) &&
        Objects.equals(this.bEzsignfoldertypeSendproofezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendattachmentuser, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendattachmentuser) &&
        Objects.equals(this.bEzsignfoldertypeSendsignatureattachmentuser, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignatureattachmentuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofuser, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendproofuser) &&
        Objects.equals(this.bEzsignfoldertypeSendproofemail, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendproofemail) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadattachmentezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeAllowdownloadattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeAllowdownloadproofezsignsigner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeAllowdownloadproofezsignsigner) &&
        Objects.equals(this.bEzsignfoldertypeSendproofreceivealldocument, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendproofreceivealldocument) &&
        Objects.equals(this.bEzsignfoldertypeSendsignatureattachmentreceivealldocument, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignatureattachmentreceivealldocument) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtodocumentowner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofolderowner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtofullgroup, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtolimitedgroup, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsignedtocolleague, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsignedtocolleague) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytodocumentowner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsummarytodocumentowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofolderowner, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsummarytofolderowner) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytofullgroup, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsummarytofullgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytolimitedgroup, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsummarytolimitedgroup) &&
        Objects.equals(this.bEzsignfoldertypeSendsummarytocolleague, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeSendsummarytocolleague) &&
        Objects.equals(this.eEzsignfoldertypeSigneraccess, ezsignfoldertypeRequestCompoundV4.eEzsignfoldertypeSigneraccess) &&
        Objects.equals(this.bEzsignfoldertypeIsactive, ezsignfoldertypeRequestCompoundV4.bEzsignfoldertypeIsactive) &&
        Objects.equals(this.aFkiUserIDSigned, ezsignfoldertypeRequestCompoundV4.aFkiUserIDSigned) &&
        Objects.equals(this.aFkiUserIDSummary, ezsignfoldertypeRequestCompoundV4.aFkiUserIDSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiEzsignfoldertypeID, objEzsignfoldertypeName, fkiBrandingID, fkiBillingentityinternalID, fkiEzsigntsarequirementID, fkiFontIDAnnotation, fkiFontIDFormfield, fkiFontIDSignature, fkiPdfalevelIDConvert, aFkiPdfalevelID, aFkiUserlogintypeID, aFkiUsergroupIDAll, aFkiUsergroupIDRestricted, aFkiUsergroupIDTemplate, eEzsignfoldertypeSignaturedatedisplay, sEzsignfoldertypeSignaturedatecustomformat, eEzsignfoldertypeDocumentdependency, eEzsignfoldertypeDocumentmerge, sEmailAddressSigned, sEmailAddressSummary, eEzsignfoldertypePdfarequirement, eEzsignfoldertypePdfanoncompliantaction, eEzsignfoldertypePrivacylevel, iEzsignfoldertypeFontsizeannotation, iEzsignfoldertypeFontsizeformfield, iEzsignfoldertypeSendreminderfirstdays, iEzsignfoldertypeSendreminderotherdays, iEzsignfoldertypeArchivaldays, eEzsignfoldertypeDisposal, eEzsignfoldertypeCompletion, iEzsignfoldertypeDisposaldays, iEzsignfoldertypeDeadlinedays, bEzsignfoldertypePrematurelyendautomatically, iEzsignfoldertypePrematurelyendautomaticallydays, bEzsignfoldertypeAutomaticsignature, bEzsignfoldertypeDelegate, bEzsignfoldertypeDiscussion, bEzsignfoldertypeLogrecipientinproof, bEzsignfoldertypeReassignezsignsigner, bEzsignfoldertypeReassignuser, bEzsignfoldertypeReassigngroup, bEzsignfoldertypeSenddocumentmergetoemail, bEzsignfoldertypeSenddocumentmergetoezsignsigner, bEzsignfoldertypeSenddocumentmergetoreceivealldocument, bEzsignfoldertypeSenddocumentmergetouser, bEzsignfoldertypeSendsignedtoezsignsigner, bEzsignfoldertypeSendsignedtouser, bEzsignfoldertypeSendattachmentezsignsigner, bEzsignfoldertypeSendsignatureattachmentezsignsigner, bEzsignfoldertypeSendsignatureattachment, bEzsignfoldertypeSendproofezsignsigner, bEzsignfoldertypeSendattachmentuser, bEzsignfoldertypeSendsignatureattachmentuser, bEzsignfoldertypeSendproofuser, bEzsignfoldertypeSendproofemail, bEzsignfoldertypeAllowdownloadattachmentezsignsigner, bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner, bEzsignfoldertypeAllowdownloadproofezsignsigner, bEzsignfoldertypeSendproofreceivealldocument, bEzsignfoldertypeSendsignatureattachmentreceivealldocument, bEzsignfoldertypeSendsignedtodocumentowner, bEzsignfoldertypeSendsignedtofolderowner, bEzsignfoldertypeSendsignedtofullgroup, bEzsignfoldertypeSendsignedtolimitedgroup, bEzsignfoldertypeSendsignedtocolleague, bEzsignfoldertypeSendsummarytodocumentowner, bEzsignfoldertypeSendsummarytofolderowner, bEzsignfoldertypeSendsummarytofullgroup, bEzsignfoldertypeSendsummarytolimitedgroup, bEzsignfoldertypeSendsummarytocolleague, eEzsignfoldertypeSigneraccess, bEzsignfoldertypeIsactive, aFkiUserIDSigned, aFkiUserIDSummary);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignfoldertypeRequestCompoundV4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfoldertypeRequestCompoundV4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignfoldertypeRequestCompoundV4 is not found in the empty JSON string", EzsignfoldertypeRequestCompoundV4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfoldertypeRequestCompoundV4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignfoldertypeRequestCompoundV4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignfoldertypeRequestCompoundV4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignfoldertypeRequestCompoundV4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignfoldertypeRequestCompoundV4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignfoldertypeRequestCompoundV4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignfoldertypeRequestCompoundV4.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignfoldertypeRequestCompoundV4>() {
           @Override
           public void write(JsonWriter out, EzsignfoldertypeRequestCompoundV4 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignfoldertypeRequestCompoundV4 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsignfoldertypeRequestCompoundV4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignfoldertypeRequestCompoundV4
   * @throws IOException if the JSON string is invalid with respect to EzsignfoldertypeRequestCompoundV4
   */
  public static EzsignfoldertypeRequestCompoundV4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignfoldertypeRequestCompoundV4.class);
  }

  /**
   * Convert an instance of EzsignfoldertypeRequestCompoundV4 to an JSON string
   *
   * @return JSON string
   */
