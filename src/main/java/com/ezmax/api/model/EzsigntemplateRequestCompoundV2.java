...
public class EzsigntemplateRequestCompoundV2 {
  ...
  public EzsigntemplateRequestCompoundV2() {
  }

  public EzsigntemplateRequestCompoundV2 pkiEzsigntemplateID(Integer pkiEzsigntemplateID) {
  ...
  **/
  ...
  public EzsigntemplateRequestCompoundV2 fkiEzsignfoldertypeID(Integer fkiEzsignfoldertypeID) {
  ...
  **/
  ...
  public EzsigntemplateRequestCompoundV2 fkiLanguageID(Integer fkiLanguageID) {
  ...
  **/
  ...
  public EzsigntemplateRequestCompoundV2 sEzsigntemplateDescription(String sEzsigntemplateDescription) {
  ...
  **/
  ...
  public EzsigntemplateRequestCompoundV2 sEzsigntemplateFilenamepattern(String sEzsigntemplateFilenamepattern) {
  ...
  **/
  ...
  public EzsigntemplateRequestCompoundV2 bEzsigntemplateAdminonly(Boolean bEzsigntemplateAdminonly) {
  ...
  **/
  ...
  public EzsigntemplateRequestCompoundV2 eEzsigntemplateType(FieldEEzsigntemplateType eEzsigntemplateType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsigntemplateID, ezsigntemplateRequestCompoundV2.pkiEzsigntemplateID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsigntemplateRequestCompoundV2.fkiEzsignfoldertypeID) &&
        Objects.equals(this.fkiLanguageID, ezsigntemplateRequestCompoundV2.fkiLanguageID) &&
        Objects.equals(this.sEzsigntemplateDescription, ezsigntemplateRequestCompoundV2.sEzsigntemplateDescription) &&
        Objects.equals(this.sEzsigntemplateFilenamepattern, ezsigntemplateRequestCompoundV2.sEzsigntemplateFilenamepattern) &&
        Objects.equals(this.bEzsigntemplateAdminonly, ezsigntemplateRequestCompoundV2.bEzsigntemplateAdminonly) &&
        Objects.equals(this.eEzsigntemplateType, ezsigntemplateRequestCompoundV2.eEzsigntemplateType);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EzsigntemplateRequestCompoundV2
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplateRequestCompoundV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsigntemplateRequestCompoundV2 is not found in the empty JSON string", EzsigntemplateRequestCompoundV2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplateRequestCompoundV2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsigntemplateRequestCompoundV2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsigntemplateRequestCompoundV2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsigntemplateRequestCompoundV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsigntemplateRequestCompoundV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsigntemplateRequestCompoundV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsigntemplateRequestCompoundV2.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsigntemplateRequestCompoundV2>() {
           @Override
           public void write(JsonWriter out, EzsigntemplateRequestCompoundV2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsigntemplateRequestCompoundV2 read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EzsigntemplateRequestCompoundV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EzsigntemplateRequestCompoundV2
  * @throws IOException if the JSON string is invalid with respect to EzsigntemplateRequestCompoundV2
  */
  public static EzsigntemplateRequestCompoundV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsigntemplateRequestCompoundV2.class);
  }

 /**
  * Convert an instance of EzsigntemplateRequestCompoundV2 to an JSON string
  *
  * @return JSON string
  */
