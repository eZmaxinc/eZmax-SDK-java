...
public class MultilingualApikeyDescription {
  ...
  **/
  ...
  static {
    ...
    openapiFields.add("sApikeyDescription1");
    openapiFields.add("sApikeyDescription2");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MultilingualApikeyDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MultilingualApikeyDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
