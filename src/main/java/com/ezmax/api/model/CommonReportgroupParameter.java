  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonReportgroupParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CommonReportgroupParameter is not found in the empty JSON string", CommonReportgroupParameter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonReportgroupParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonReportgroupParameter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sReportgroupParameterName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sReportgroupParameterName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sReportgroupParameterName").toString()));
      }
      if ((jsonObj.get("sReportgroupParameterValue") != null && !jsonObj.get("sReportgroupParameterValue").isJsonNull()) && !jsonObj.get("sReportgroupParameterValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sReportgroupParameterValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sReportgroupParameterValue").toString()));
      }
      ...
      if (jsonObj.get("a_sReportgroupParameterValue") != null && !jsonObj.get("a_sReportgroupParameterValue").isJsonNull() && !jsonObj.get("a_sReportgroupParameterValue").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_sReportgroupParameterValue` to be an array in the JSON string but got `%s`", jsonObj.get("a_sReportgroupParameterValue").toString()));
      }
  }
