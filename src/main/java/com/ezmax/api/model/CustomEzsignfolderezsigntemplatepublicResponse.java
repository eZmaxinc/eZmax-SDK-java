  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzsignfolderezsigntemplatepublicResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomEzsignfolderezsigntemplatepublicResponse is not found in the empty JSON string", CustomEzsignfolderezsigntemplatepublicResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignfolderezsigntemplatepublicResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzsignfolderezsigntemplatepublicResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("a_objEzsignfolderezsigntemplatepublicSigner") != null && !jsonObj.get("a_objEzsignfolderezsigntemplatepublicSigner").isJsonNull()) {
        ...
        if (jsonArrayaObjEzsignfolderezsigntemplatepublicSigner != null) {
          ...
          if (!jsonObj.get("a_objEzsignfolderezsigntemplatepublicSigner").isJsonArray()) {
            throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_objEzsignfolderezsigntemplatepublicSigner` to be an array in the JSON string but got `%s`", jsonObj.get("a_objEzsignfolderezsigntemplatepublicSigner").toString()));
          }
