...
public class WebsiteRequest {
  ...
  public WebsiteRequest pkiWebsiteID(@javax.annotation.Nullable Integer pkiWebsiteID) {
  ...
  public WebsiteRequest fkiWebsitetypeID(@javax.annotation.Nonnull Integer fkiWebsitetypeID) {
  ...
  public WebsiteRequest sWebsiteAddress(@javax.annotation.Nonnull String sWebsiteAddress) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebsiteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebsiteRequest is not found in the empty JSON string", WebsiteRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebsiteRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebsiteRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
