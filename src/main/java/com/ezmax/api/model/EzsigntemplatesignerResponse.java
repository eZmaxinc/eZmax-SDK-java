...
public class EzsigntemplatesignerResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsigntemplatesignerID", "fkiEzsigntemplateID", "fkiUserID", "fkiUsergroupID", "fkiEzdoctemplatedocumentID", "bEzsigntemplatesignerReceivecopy", "eEzsigntemplatesignerMapping", "sEzsigntemplatesignerDescription", "sUserName", "sUsergroupNameX"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatesignerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatesignerResponse is not found in the empty JSON string", EzsigntemplatesignerResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatesignerResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatesignerResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
