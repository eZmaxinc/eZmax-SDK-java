...
public class EzsignfolderResponseV3 {
  ...
  public EzsignfolderResponseV3() {
  }

  public EzsignfolderResponseV3 pkiEzsignfolderID(@javax.annotation.Nonnull Integer pkiEzsignfolderID) {
  ...
  public EzsignfolderResponseV3 fkiEzsignfoldertypeID(@javax.annotation.Nullable Integer fkiEzsignfoldertypeID) {
  ...
  public EzsignfolderResponseV3 fkiTimezoneID(@javax.annotation.Nullable Integer fkiTimezoneID) {
  ...
  public EzsignfolderResponseV3 eEzsignfolderCompletion(@javax.annotation.Nonnull FieldEEzsignfolderCompletion eEzsignfolderCompletion) {
  ...
  public EzsignfolderResponseV3 eEzsignfolderDocumentdependency(@javax.annotation.Nullable FieldEEzsignfolderDocumentdependency eEzsignfolderDocumentdependency) {
  ...
  @Deprecated
  public EzsignfolderResponseV3 sEzsignfoldertypeNameX(@javax.annotation.Nullable String sEzsignfoldertypeNameX) {
  ...
  public EzsignfolderResponseV3 fkiBillingentityinternalID(@javax.annotation.Nullable Integer fkiBillingentityinternalID) {
  ...
  public EzsignfolderResponseV3 sBillingentityinternalDescriptionX(@javax.annotation.Nullable String sBillingentityinternalDescriptionX) {
  ...
  public EzsignfolderResponseV3 fkiEzsigntsarequirementID(@javax.annotation.Nullable Integer fkiEzsigntsarequirementID) {
  ...
  public EzsignfolderResponseV3 sEzsigntsarequirementDescriptionX(@javax.annotation.Nullable String sEzsigntsarequirementDescriptionX) {
  ...
  public EzsignfolderResponseV3 sEzsignfolderDescription(@javax.annotation.Nonnull String sEzsignfolderDescription) {
  ...
  public EzsignfolderResponseV3 tEzsignfolderNote(@javax.annotation.Nullable String tEzsignfolderNote) {
  ...
  public EzsignfolderResponseV3 bEzsignfolderIsdisposable(@javax.annotation.Nullable Boolean bEzsignfolderIsdisposable) {
  ...
  public EzsignfolderResponseV3 iEzsignfolderSendreminderfirstdays(@javax.annotation.Nullable Integer iEzsignfolderSendreminderfirstdays) {
  ...
  public EzsignfolderResponseV3 iEzsignfolderSendreminderotherdays(@javax.annotation.Nullable Integer iEzsignfolderSendreminderotherdays) {
  ...
  public EzsignfolderResponseV3 dtEzsignfolderDelayedsenddate(@javax.annotation.Nullable String dtEzsignfolderDelayedsenddate) {
  ...
  public EzsignfolderResponseV3 dtEzsignfolderDuedate(@javax.annotation.Nullable String dtEzsignfolderDuedate) {
  ...
  public EzsignfolderResponseV3 dtEzsignfolderSentdate(@javax.annotation.Nullable String dtEzsignfolderSentdate) {
  ...
  public EzsignfolderResponseV3 dtEzsignfolderScheduledarchive(@javax.annotation.Nullable String dtEzsignfolderScheduledarchive) {
  ...
  public EzsignfolderResponseV3 dtEzsignfolderScheduleddispose(@javax.annotation.Nullable String dtEzsignfolderScheduleddispose) {
  ...
  public EzsignfolderResponseV3 eEzsignfolderStep(@javax.annotation.Nullable FieldEEzsignfolderStep eEzsignfolderStep) {
  ...
  public EzsignfolderResponseV3 dtEzsignfolderClose(@javax.annotation.Nullable String dtEzsignfolderClose) {
  ...
  public EzsignfolderResponseV3 sEzsignfolderExternalid(@javax.annotation.Nullable String sEzsignfolderExternalid) {
  ...
  public EzsignfolderResponseV3 eEzsignfolderAccess(@javax.annotation.Nullable ComputedEEzsignfolderAccess eEzsignfolderAccess) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzsignfolderID, ezsignfolderResponseV3.pkiEzsignfolderID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezsignfolderResponseV3.fkiEzsignfoldertypeID) &&
        Objects.equals(this.objEzsignfoldertype, ezsignfolderResponseV3.objEzsignfoldertype) &&
        Objects.equals(this.fkiTimezoneID, ezsignfolderResponseV3.fkiTimezoneID) &&
        Objects.equals(this.eEzsignfolderCompletion, ezsignfolderResponseV3.eEzsignfolderCompletion) &&
        Objects.equals(this.eEzsignfolderDocumentdependency, ezsignfolderResponseV3.eEzsignfolderDocumentdependency) &&
        Objects.equals(this.sEzsignfoldertypeNameX, ezsignfolderResponseV3.sEzsignfoldertypeNameX) &&
        Objects.equals(this.fkiBillingentityinternalID, ezsignfolderResponseV3.fkiBillingentityinternalID) &&
        Objects.equals(this.sBillingentityinternalDescriptionX, ezsignfolderResponseV3.sBillingentityinternalDescriptionX) &&
        Objects.equals(this.fkiEzsigntsarequirementID, ezsignfolderResponseV3.fkiEzsigntsarequirementID) &&
        Objects.equals(this.sEzsigntsarequirementDescriptionX, ezsignfolderResponseV3.sEzsigntsarequirementDescriptionX) &&
        Objects.equals(this.sEzsignfolderDescription, ezsignfolderResponseV3.sEzsignfolderDescription) &&
        Objects.equals(this.tEzsignfolderNote, ezsignfolderResponseV3.tEzsignfolderNote) &&
        Objects.equals(this.bEzsignfolderIsdisposable, ezsignfolderResponseV3.bEzsignfolderIsdisposable) &&
        Objects.equals(this.iEzsignfolderSendreminderfirstdays, ezsignfolderResponseV3.iEzsignfolderSendreminderfirstdays) &&
        Objects.equals(this.iEzsignfolderSendreminderotherdays, ezsignfolderResponseV3.iEzsignfolderSendreminderotherdays) &&
        Objects.equals(this.dtEzsignfolderDelayedsenddate, ezsignfolderResponseV3.dtEzsignfolderDelayedsenddate) &&
        Objects.equals(this.dtEzsignfolderDuedate, ezsignfolderResponseV3.dtEzsignfolderDuedate) &&
        Objects.equals(this.dtEzsignfolderSentdate, ezsignfolderResponseV3.dtEzsignfolderSentdate) &&
        Objects.equals(this.dtEzsignfolderScheduledarchive, ezsignfolderResponseV3.dtEzsignfolderScheduledarchive) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignfolderResponseV3
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignfolderResponseV3.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EzsignfolderResponseV3 is not found in the empty JSON string", EzsignfolderResponseV3.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignfolderResponseV3.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignfolderResponseV3` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignfolderResponseV3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignfolderResponseV3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignfolderResponseV3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignfolderResponseV3.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignfolderResponseV3>() {
           @Override
           public void write(JsonWriter out, EzsignfolderResponseV3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignfolderResponseV3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsignfolderResponseV3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignfolderResponseV3
   * @throws IOException if the JSON string is invalid with respect to EzsignfolderResponseV3
   */
  public static EzsignfolderResponseV3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignfolderResponseV3.class);
  }

  /**
   * Convert an instance of EzsignfolderResponseV3 to an JSON string
   *
   * @return JSON string
   */
