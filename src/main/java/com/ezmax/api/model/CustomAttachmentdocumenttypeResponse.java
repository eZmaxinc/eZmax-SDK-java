...
public class CustomAttachmentdocumenttypeResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("eAttachmentDocumenttype", "a_objAttachment"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eAttachmentDocumenttype", "a_objAttachment"));
  }
