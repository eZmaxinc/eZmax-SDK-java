...
public class CommonResponseErrorWrongFranchiseoffice {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sErrorMessage", "eErrorCode", "a_sErrorMessagedetail", "fkiFranchiseagenceID", "sFranchiseagenceName", "fkiFranchiseofficeID", "iFranchiseofficeCode"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sErrorMessage", "eErrorCode", "fkiFranchiseagenceID", "sFranchiseagenceName", "fkiFranchiseofficeID", "iFranchiseofficeCode"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonResponseErrorWrongFranchiseoffice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonResponseErrorWrongFranchiseoffice is not found in the empty JSON string", CommonResponseErrorWrongFranchiseoffice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonResponseErrorWrongFranchiseoffice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonResponseErrorWrongFranchiseoffice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sErrorMessage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sErrorMessage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sErrorMessage").toString()));
      }
      ...
      if (jsonObj.get("a_sErrorMessagedetail") != null && !jsonObj.get("a_sErrorMessagedetail").isJsonNull() && !jsonObj.get("a_sErrorMessagedetail").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `a_sErrorMessagedetail` to be an array in the JSON string but got `%s`", jsonObj.get("a_sErrorMessagedetail").toString()));
      }
      if (!jsonObj.get("sFranchiseagenceName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sFranchiseagenceName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sFranchiseagenceName").toString()));
      }
      if (!jsonObj.get("iFranchiseofficeCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `iFranchiseofficeCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("iFranchiseofficeCode").toString()));
      }
  }
