...
public class CustomEzsignformfielderrortestResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sEzsignformfielderrortestName", "sEzsignformfielderrortestDetail"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sEzsignformfielderrortestName", "sEzsignformfielderrortestDetail"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomEzsignformfielderrortestResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CustomEzsignformfielderrortestResponse is not found in the empty JSON string", CustomEzsignformfielderrortestResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomEzsignformfielderrortestResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomEzsignformfielderrortestResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sEzsignformfielderrortestName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignformfielderrortestName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignformfielderrortestName").toString()));
      }
      if (!jsonObj.get("sEzsignformfielderrortestDetail").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignformfielderrortestDetail` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignformfielderrortestDetail").toString()));
      }
  }
