...
public class EzsignelementdependencyRequest {
  ...
  public EzsignelementdependencyRequest pkiEzsignelementdependencyID(@javax.annotation.Nullable Integer pkiEzsignelementdependencyID) {
  ...
  public EzsignelementdependencyRequest fkiEzsignformfieldIDValidation(@javax.annotation.Nullable Integer fkiEzsignformfieldIDValidation) {
  ...
  public EzsignelementdependencyRequest fkiEzsignformfieldgroupIDValidation(@javax.annotation.Nullable Integer fkiEzsignformfieldgroupIDValidation) {
  ...
  public EzsignelementdependencyRequest sEzsignelementdependencyEzsignformfieldgrouplabel(@javax.annotation.Nullable String sEzsignelementdependencyEzsignformfieldgrouplabel) {
  ...
  public EzsignelementdependencyRequest sEzsignelementdependencyEzsignformfieldlabel(@javax.annotation.Nullable String sEzsignelementdependencyEzsignformfieldlabel) {
  ...
  public EzsignelementdependencyRequest eEzsignelementdependencyValidation(@javax.annotation.Nonnull FieldEEzsignelementdependencyValidation eEzsignelementdependencyValidation) {
  ...
  public EzsignelementdependencyRequest bEzsignelementdependencySelected(@javax.annotation.Nullable Boolean bEzsignelementdependencySelected) {
  ...
  public EzsignelementdependencyRequest eEzsignelementdependencyOperator(@javax.annotation.Nullable FieldEEzsignelementdependencyOperator eEzsignelementdependencyOperator) {
  ...
  public EzsignelementdependencyRequest sEzsignelementdependencyValue(@javax.annotation.Nullable String sEzsignelementdependencyValue) {
  ...
  public boolean equals(Object o) {
    ...
    EzsignelementdependencyRequest ezsignelementdependencyRequest = (EzsignelementdependencyRequest) o;
    return Objects.equals(this.pkiEzsignelementdependencyID, ezsignelementdependencyRequest.pkiEzsignelementdependencyID) &&
        Objects.equals(this.fkiEzsignformfieldIDValidation, ezsignelementdependencyRequest.fkiEzsignformfieldIDValidation) &&
        Objects.equals(this.fkiEzsignformfieldgroupIDValidation, ezsignelementdependencyRequest.fkiEzsignformfieldgroupIDValidation) &&
        Objects.equals(this.sEzsignelementdependencyEzsignformfieldgrouplabel, ezsignelementdependencyRequest.sEzsignelementdependencyEzsignformfieldgrouplabel) &&
        Objects.equals(this.sEzsignelementdependencyEzsignformfieldlabel, ezsignelementdependencyRequest.sEzsignelementdependencyEzsignformfieldlabel) &&
        Objects.equals(this.eEzsignelementdependencyValidation, ezsignelementdependencyRequest.eEzsignelementdependencyValidation) &&
        Objects.equals(this.bEzsignelementdependencySelected, ezsignelementdependencyRequest.bEzsignelementdependencySelected) &&
        Objects.equals(this.eEzsignelementdependencyOperator, ezsignelementdependencyRequest.eEzsignelementdependencyOperator) &&
        Objects.equals(this.sEzsignelementdependencyValue, ezsignelementdependencyRequest.sEzsignelementdependencyValue);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzsignelementdependencyID", "fkiEzsignformfieldIDValidation", "fkiEzsignformfieldgroupIDValidation", "sEzsignelementdependencyEzsignformfieldgrouplabel", "sEzsignelementdependencyEzsignformfieldlabel", "eEzsignelementdependencyValidation", "bEzsignelementdependencySelected", "eEzsignelementdependencyOperator", "sEzsignelementdependencyValue"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eEzsignelementdependencyValidation"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsignelementdependencyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignelementdependencyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignelementdependencyRequest is not found in the empty JSON string", EzsignelementdependencyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignelementdependencyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignelementdependencyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzsignelementdependencyRequest.openapiRequiredFields) {
      ...
      if ((jsonObj.get("sEzsignelementdependencyEzsignformfieldgrouplabel") != null && !jsonObj.get("sEzsignelementdependencyEzsignformfieldgrouplabel").isJsonNull()) && !jsonObj.get("sEzsignelementdependencyEzsignformfieldgrouplabel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignelementdependencyEzsignformfieldgrouplabel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignelementdependencyEzsignformfieldgrouplabel").toString()));
      }
      if ((jsonObj.get("sEzsignelementdependencyEzsignformfieldlabel") != null && !jsonObj.get("sEzsignelementdependencyEzsignformfieldlabel").isJsonNull()) && !jsonObj.get("sEzsignelementdependencyEzsignformfieldlabel").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignelementdependencyEzsignformfieldlabel` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignelementdependencyEzsignformfieldlabel").toString()));
      }
      ...
      if ((jsonObj.get("sEzsignelementdependencyValue") != null && !jsonObj.get("sEzsignelementdependencyValue").isJsonNull()) && !jsonObj.get("sEzsignelementdependencyValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sEzsignelementdependencyValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sEzsignelementdependencyValue").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignelementdependencyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignelementdependencyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignelementdependencyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignelementdependencyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignelementdependencyRequest>() {
           @Override
           public void write(JsonWriter out, EzsignelementdependencyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzsignelementdependencyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzsignelementdependencyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignelementdependencyRequest
   * @throws IOException if the JSON string is invalid with respect to EzsignelementdependencyRequest
   */
  public static EzsignelementdependencyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignelementdependencyRequest.class);
  }

  /**
   * Convert an instance of EzsignelementdependencyRequest to an JSON string
   *
   * @return JSON string
   */
