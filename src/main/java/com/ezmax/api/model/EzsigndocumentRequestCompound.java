...
public class EzsigndocumentRequestCompound {
  ...
  public EzsigndocumentRequestCompound pkiEzsigndocumentID(Integer pkiEzsigndocumentID) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[B@773cbf4f", value = "The Base64 encoded binary content of the document.  This field is Required when eEzsigndocumentSource = Base64.")
  ...
  public EzsigndocumentRequestCompound sEzsigndocumentUrl(String sEzsigndocumentUrl) {
  ...
  **/
  ...
  public EzsigndocumentRequestCompound bEzsigndocumentForcerepair(Boolean bEzsigndocumentForcerepair) {
  ...
  **/
  ...
  public EzsigndocumentRequestCompound sEzsigndocumentPassword(String sEzsigndocumentPassword) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EzsigndocumentRequestCompound
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EzsigndocumentRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EzsigndocumentRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsigndocumentRequestCompound` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
