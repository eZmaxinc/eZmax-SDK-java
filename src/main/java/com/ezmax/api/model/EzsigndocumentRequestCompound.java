...
public class EzsigndocumentRequestCompound {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eEzsigndocumentSource, eEzsigndocumentFormat, Arrays.hashCode(sEzsigndocumentBase64), sEzsigndocumentPassword, fkiEzsignfolderID, dtEzsigndocumentDuedate, fkiLanguageID, sEzsigndocumentName);
  }
