...
public class EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload is not found in the empty JSON string", EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
