...
public class CreditcardmerchantResponseCompound {
  ...
  public CreditcardmerchantResponseCompound fkiBankaccountID(@javax.annotation.Nonnull Integer fkiBankaccountID) {
  ...
  public CreditcardmerchantResponseCompound fkiLanguageID(@javax.annotation.Nullable Integer fkiLanguageID) {
  ...
  public CreditcardmerchantResponseCompound sLanguageNameX(@javax.annotation.Nullable String sLanguageNameX) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreditcardmerchantResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreditcardmerchantResponseCompound is not found in the empty JSON string", CreditcardmerchantResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreditcardmerchantResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreditcardmerchantResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
