...
public class TextstylestaticRequestCompound {
  ...
  public TextstylestaticRequestCompound fkiFontID(@javax.annotation.Nonnull Integer fkiFontID) {
  ...
  public TextstylestaticRequestCompound bTextstylestaticBold(@javax.annotation.Nonnull Boolean bTextstylestaticBold) {
  ...
  public TextstylestaticRequestCompound bTextstylestaticUnderline(@javax.annotation.Nonnull Boolean bTextstylestaticUnderline) {
  ...
  public TextstylestaticRequestCompound bTextstylestaticItalic(@javax.annotation.Nonnull Boolean bTextstylestaticItalic) {
  ...
  public TextstylestaticRequestCompound bTextstylestaticStrikethrough(@javax.annotation.Nonnull Boolean bTextstylestaticStrikethrough) {
  ...
  public TextstylestaticRequestCompound iTextstylestaticFontcolor(@javax.annotation.Nonnull Integer iTextstylestaticFontcolor) {
  ...
  public TextstylestaticRequestCompound iTextstylestaticSize(@javax.annotation.Nonnull Integer iTextstylestaticSize) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fkiFontID", "bTextstylestaticBold", "bTextstylestaticUnderline", "bTextstylestaticItalic", "bTextstylestaticStrikethrough", "iTextstylestaticFontcolor", "iTextstylestaticSize"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiFontID", "bTextstylestaticBold", "bTextstylestaticUnderline", "bTextstylestaticItalic", "bTextstylestaticStrikethrough", "iTextstylestaticFontcolor", "iTextstylestaticSize"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TextstylestaticRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextstylestaticRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TextstylestaticRequestCompound is not found in the empty JSON string", TextstylestaticRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TextstylestaticRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TextstylestaticRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TextstylestaticRequestCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TextstylestaticRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TextstylestaticRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TextstylestaticRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TextstylestaticRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<TextstylestaticRequestCompound>() {
           @Override
           public void write(JsonWriter out, TextstylestaticRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TextstylestaticRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TextstylestaticRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TextstylestaticRequestCompound
   * @throws IOException if the JSON string is invalid with respect to TextstylestaticRequestCompound
   */
  public static TextstylestaticRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TextstylestaticRequestCompound.class);
  }

  /**
   * Convert an instance of TextstylestaticRequestCompound to an JSON string
   *
   * @return JSON string
   */
