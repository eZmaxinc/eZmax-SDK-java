...
public class PaymenttermGetAutocompleteV2ResponseMPayload {
  ...
  public PaymenttermGetAutocompleteV2ResponseMPayload aObjPaymentterm(@javax.annotation.Nonnull List<PaymenttermAutocompleteElementResponse> aObjPaymentterm) {
  ...
  public void setaObjPaymentterm(@javax.annotation.Nonnull List<PaymenttermAutocompleteElementResponse> aObjPaymentterm) {
    this.aObjPaymentterm = aObjPaymentterm;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymenttermGetAutocompleteV2ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaymenttermGetAutocompleteV2ResponseMPayload is not found in the empty JSON string", PaymenttermGetAutocompleteV2ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymenttermGetAutocompleteV2ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PaymenttermGetAutocompleteV2ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
