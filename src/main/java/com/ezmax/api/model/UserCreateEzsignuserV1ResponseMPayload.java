  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserCreateEzsignuserV1ResponseMPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in UserCreateEzsignuserV1ResponseMPayload is not found in the empty JSON string", UserCreateEzsignuserV1ResponseMPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UserCreateEzsignuserV1ResponseMPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UserCreateEzsignuserV1ResponseMPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("a_sEmailAddressSuccess") == null) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_sEmailAddressSuccess` to be an array in the JSON string but got `%s`", jsonObj.get("a_sEmailAddressSuccess").toString()));
      }
      // ensure the required json array is present
      if (jsonObj.get("a_sEmailAddressFailure") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("a_sEmailAddressFailure").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `a_sEmailAddressFailure` to be an array in the JSON string but got `%s`", jsonObj.get("a_sEmailAddressFailure").toString()));
      }
  }
