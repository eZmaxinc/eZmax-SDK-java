...
public class EzsignsignaturecustomdateRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EzsignsignaturecustomdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (EzsignsignaturecustomdateRequest.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignaturecustomdateRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EzsignsignaturecustomdateRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
