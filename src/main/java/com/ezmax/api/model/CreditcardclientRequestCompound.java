...
public class CreditcardclientRequestCompound {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiCreditcardclientID", "fksCreditcardtokenID", "bCreditcardclientrelationIsdefault", "sCreditcardclientDescription", "bCreditcardclientAllowedcompanypayment", "bCreditcardclientAllowedezsign", "bCreditcardclientAllowedtranquillit", "objCreditcarddetail", "sCreditcardclientCVV"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("bCreditcardclientrelationIsdefault", "sCreditcardclientDescription", "bCreditcardclientAllowedcompanypayment", "bCreditcardclientAllowedezsign", "bCreditcardclientAllowedtranquillit", "objCreditcarddetail", "sCreditcardclientCVV"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreditcardclientRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreditcardclientRequestCompound is not found in the empty JSON string", CreditcardclientRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreditcardclientRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreditcardclientRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("sCreditcardclientCVV").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sCreditcardclientCVV` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCreditcardclientCVV").toString()));
      }
  }
