...
public class CommonResponseGetList {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objDebugPayload, commonResponseGetList.objDebugPayload) &&
        Objects.equals(this.objDebug, commonResponseGetList.objDebug);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommonResponseGetList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommonResponseGetList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CommonResponseGetList is not found in the empty JSON string", CommonResponseGetList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CommonResponseGetList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CommonResponseGetList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
   ...
   * @return An instance of CommonResponseGetList
   * @throws IOException if the JSON string is invalid with respect to CommonResponseGetList
   */
  public static CommonResponseGetList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonResponseGetList.class);
  }

  /**
   * Convert an instance of CommonResponseGetList to an JSON string
   *
   * @return JSON string
   */
