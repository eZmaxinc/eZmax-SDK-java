...
public class PaymenttermResponseCompound {
  ...
  public PaymenttermResponseCompound pkiPaymenttermID(@javax.annotation.Nonnull Integer pkiPaymenttermID) {
  ...
  public PaymenttermResponseCompound sPaymenttermCode(@javax.annotation.Nonnull String sPaymenttermCode) {
  ...
  public PaymenttermResponseCompound ePaymenttermType(@javax.annotation.Nonnull FieldEPaymenttermType ePaymenttermType) {
  ...
  public PaymenttermResponseCompound iPaymenttermDay(@javax.annotation.Nonnull Integer iPaymenttermDay) {
  ...
  public PaymenttermResponseCompound objPaymenttermDescription(@javax.annotation.Nonnull MultilingualPaymenttermDescription objPaymenttermDescription) {
  ...
  public PaymenttermResponseCompound bPaymenttermIsactive(@javax.annotation.Nonnull Boolean bPaymenttermIsactive) {
  ...
  public PaymenttermResponseCompound objAudit(@javax.annotation.Nonnull CommonAudit objAudit) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiPaymenttermID", "sPaymenttermCode", "ePaymenttermType", "iPaymenttermDay", "objPaymenttermDescription", "bPaymenttermIsactive", "objAudit"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiPaymenttermID", "sPaymenttermCode", "ePaymenttermType", "iPaymenttermDay", "objPaymenttermDescription", "bPaymenttermIsactive", "objAudit"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PaymenttermResponseCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PaymenttermResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PaymenttermResponseCompound is not found in the empty JSON string", PaymenttermResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PaymenttermResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PaymenttermResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PaymenttermResponseCompound.openapiRequiredFields) {
      ...
      if (!jsonObj.get("sPaymenttermCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `sPaymenttermCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sPaymenttermCode").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PaymenttermResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PaymenttermResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PaymenttermResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PaymenttermResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<PaymenttermResponseCompound>() {
           @Override
           public void write(JsonWriter out, PaymenttermResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PaymenttermResponseCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PaymenttermResponseCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PaymenttermResponseCompound
   * @throws IOException if the JSON string is invalid with respect to PaymenttermResponseCompound
   */
  public static PaymenttermResponseCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PaymenttermResponseCompound.class);
  }

  /**
   * Convert an instance of PaymenttermResponseCompound to an JSON string
   *
   * @return JSON string
   */
