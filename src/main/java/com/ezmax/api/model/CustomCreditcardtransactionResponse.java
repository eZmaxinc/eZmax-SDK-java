...
public class CustomCreditcardtransactionResponse {
  public static final String SERIALIZED_NAME_S_CREDITCARDTYPE_CODENAME = "sCreditcardtypeCodename";
  @SerializedName(SERIALIZED_NAME_S_CREDITCARDTYPE_CODENAME)
  private String sCreditcardtypeCodename;
  ...
  public CustomCreditcardtransactionResponse sCreditcardtypeCodename(String sCreditcardtypeCodename) {
   ...
   * @return sCreditcardtypeCodename
  **/
  @javax.annotation.Nonnull
  public String getsCreditcardtypeCodename() {
    return sCreditcardtypeCodename;
  }


  public void setsCreditcardtypeCodename(String sCreditcardtypeCodename) {
    this.sCreditcardtypeCodename = sCreditcardtypeCodename;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sCreditcardtypeCodename, customCreditcardtransactionResponse.sCreditcardtypeCodename) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sCreditcardtypeCodename, dCreditcardtransactionAmount, sCreditcardtransactionPartiallydecryptednumber, sCreditcardtransactionReferencenumber);
  }
  ...
  public String toString() {
    ...
    sb.append("    sCreditcardtypeCodename: ").append(toIndentedString(sCreditcardtypeCodename)).append("\n");
  ...
  static {
    ...
    openapiFields.add("sCreditcardtypeCodename");
    ...
    openapiRequiredFields.add("sCreditcardtypeCodename");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomCreditcardtransactionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomCreditcardtransactionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomCreditcardtransactionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomCreditcardtransactionResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (!jsonObj.get("sCreditcardtypeCodename").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `sCreditcardtypeCodename` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sCreditcardtypeCodename").toString()));
      }
