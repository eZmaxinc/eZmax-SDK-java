  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AddressResponse is not found in the empty JSON string", AddressResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddressResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("fAddressLongitude") != null && !jsonObj.get("fAddressLongitude").isJsonNull()) && !jsonObj.get("fAddressLongitude").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `fAddressLongitude` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fAddressLongitude").toString()));
      }
      if ((jsonObj.get("fAddressLatitude") != null && !jsonObj.get("fAddressLatitude").isJsonNull()) && !jsonObj.get("fAddressLatitude").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `fAddressLatitude` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fAddressLatitude").toString()));
      }
  }
