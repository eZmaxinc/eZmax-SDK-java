...
public class AddressResponse {
  ...
  public AddressResponse pkiAddressID(@javax.annotation.Nonnull Integer pkiAddressID) {
  ...
  public AddressResponse fkiAddresstypeID(@javax.annotation.Nonnull Integer fkiAddresstypeID) {
  ...
  public AddressResponse sAddressCivic(@javax.annotation.Nonnull String sAddressCivic) {
  ...
  public AddressResponse sAddressStreet(@javax.annotation.Nonnull String sAddressStreet) {
  ...
  public AddressResponse sAddressSuite(@javax.annotation.Nullable String sAddressSuite) {
  ...
  public AddressResponse sAddressCity(@javax.annotation.Nonnull String sAddressCity) {
  ...
  public AddressResponse fkiProvinceID(@javax.annotation.Nonnull Integer fkiProvinceID) {
  ...
  public AddressResponse sProvinceNameX(@javax.annotation.Nonnull String sProvinceNameX) {
  ...
  public AddressResponse fkiCountryID(@javax.annotation.Nonnull Integer fkiCountryID) {
  ...
  public AddressResponse sCountryNameX(@javax.annotation.Nonnull String sCountryNameX) {
  ...
  public AddressResponse sAddressZip(@javax.annotation.Nonnull String sAddressZip) {
  ...
  public AddressResponse fAddressLongitude(@javax.annotation.Nullable String fAddressLongitude) {
  ...
  public AddressResponse fAddressLatitude(@javax.annotation.Nullable String fAddressLatitude) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiAddressID", "fkiAddresstypeID", "sAddressCivic", "sAddressStreet", "sAddressSuite", "sAddressCity", "fkiProvinceID", "sProvinceNameX", "fkiCountryID", "sCountryNameX", "sAddressZip", "fAddressLongitude", "fAddressLatitude"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiAddressID", "fkiAddresstypeID", "sAddressCivic", "sAddressStreet", "sAddressCity", "fkiProvinceID", "sProvinceNameX", "fkiCountryID", "sCountryNameX", "sAddressZip"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddressResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddressResponse is not found in the empty JSON string", AddressResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddressResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddressResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("fAddressLongitude") != null && !jsonObj.get("fAddressLongitude").isJsonNull()) && !jsonObj.get("fAddressLongitude").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `fAddressLongitude` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fAddressLongitude").toString()));
      }
      if ((jsonObj.get("fAddressLatitude") != null && !jsonObj.get("fAddressLatitude").isJsonNull()) && !jsonObj.get("fAddressLatitude").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `fAddressLatitude` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fAddressLatitude").toString()));
      }
  }
