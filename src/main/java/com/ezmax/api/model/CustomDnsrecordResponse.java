  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomDnsrecordResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomDnsrecordResponse is not found in the empty JSON string", CustomDnsrecordResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomDnsrecordResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomDnsrecordResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("eDnsrecordType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `eDnsrecordType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eDnsrecordType").toString()));
      }
      ...
      if (!jsonObj.get("eDnsrecordValidation").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `eDnsrecordValidation` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eDnsrecordValidation").toString()));
      }
      ...
      if (!jsonObj.get("sDnsrecordName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sDnsrecordName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sDnsrecordName").toString()));
      }
      if ((jsonObj.get("sDnsrecordValue") != null && !jsonObj.get("sDnsrecordValue").isJsonNull()) && !jsonObj.get("sDnsrecordValue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sDnsrecordValue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sDnsrecordValue").toString()));
      }
      if ((jsonObj.get("sDnsrecordExpectedvalue") != null && !jsonObj.get("sDnsrecordExpectedvalue").isJsonNull()) && !jsonObj.get("sDnsrecordExpectedvalue").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `sDnsrecordExpectedvalue` to be a primitive type in the JSON string but got `%s`", jsonObj.get("sDnsrecordExpectedvalue").toString()));
      }
  }
