...
public class EzsignsignergroupEditObjectV1Request {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzsignsignergroupEditObjectV1Request.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzsignsignergroupEditObjectV1Request is not found in the empty JSON string", EzsignsignergroupEditObjectV1Request.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzsignsignergroupEditObjectV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzsignsignergroupEditObjectV1Request` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzsignsignergroupEditObjectV1Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzsignsignergroupEditObjectV1Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzsignsignergroupEditObjectV1Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzsignsignergroupEditObjectV1Request.class));

       return (TypeAdapter<T>) new TypeAdapter<EzsignsignergroupEditObjectV1Request>() {
           @Override
           public void write(JsonWriter out, EzsignsignergroupEditObjectV1Request value) throws IOException {
  ...
  /**
   * Create an instance of EzsignsignergroupEditObjectV1Request given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzsignsignergroupEditObjectV1Request
   * @throws IOException if the JSON string is invalid with respect to EzsignsignergroupEditObjectV1Request
   */
  public static EzsignsignergroupEditObjectV1Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzsignsignergroupEditObjectV1Request.class);
  }

  /**
   * Convert an instance of EzsignsignergroupEditObjectV1Request to an JSON string
   *
   * @return JSON string
   */
