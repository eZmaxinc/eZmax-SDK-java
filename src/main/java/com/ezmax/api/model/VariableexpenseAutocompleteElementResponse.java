...
public class VariableexpenseAutocompleteElementResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sVariableexpenseDescriptionX", "pkiVariableexpenseID", "bVariableexpenseIsactive"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("sVariableexpenseDescriptionX", "pkiVariableexpenseID", "bVariableexpenseIsactive"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableexpenseAutocompleteElementResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariableexpenseAutocompleteElementResponse is not found in the empty JSON string", VariableexpenseAutocompleteElementResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariableexpenseAutocompleteElementResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VariableexpenseAutocompleteElementResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
