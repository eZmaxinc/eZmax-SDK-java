...
public class AuthenticationexternalListElement {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiAuthenticationexternalID", "sAuthenticationexternalDescription", "eAuthenticationexternalType", "bAuthenticationexternalConnected"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiAuthenticationexternalID", "sAuthenticationexternalDescription", "eAuthenticationexternalType", "bAuthenticationexternalConnected"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationexternalListElement.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthenticationexternalListElement is not found in the empty JSON string", AuthenticationexternalListElement.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticationexternalListElement.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthenticationexternalListElement` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
