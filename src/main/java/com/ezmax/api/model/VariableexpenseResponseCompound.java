...
public class VariableexpenseResponseCompound {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiVariableexpenseID, variableexpenseResponseCompound.pkiVariableexpenseID) &&
        Objects.equals(this.sVariableexpenseCode, variableexpenseResponseCompound.sVariableexpenseCode) &&
        Objects.equals(this.objVariableexpenseDescription, variableexpenseResponseCompound.objVariableexpenseDescription) &&
        Objects.equals(this.eVariableexpenseTaxable, variableexpenseResponseCompound.eVariableexpenseTaxable) &&
        Objects.equals(this.bVariableexpenseIsactive, variableexpenseResponseCompound.bVariableexpenseIsactive);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("pkiVariableexpenseID", "objVariableexpenseDescription"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableexpenseResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VariableexpenseResponseCompound is not found in the empty JSON string", VariableexpenseResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VariableexpenseResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VariableexpenseResponseCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VariableexpenseResponseCompound.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariableexpenseResponseCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariableexpenseResponseCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VariableexpenseResponseCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VariableexpenseResponseCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<VariableexpenseResponseCompound>() {
           @Override
           public void write(JsonWriter out, VariableexpenseResponseCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VariableexpenseResponseCompound read(JsonReader in) throws IOException {
