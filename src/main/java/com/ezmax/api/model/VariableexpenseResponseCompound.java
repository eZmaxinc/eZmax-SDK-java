...
public class VariableexpenseResponseCompound {
  ...
  * @throws IOException if the JSON Object is invalid with respect to VariableexpenseResponseCompound
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VariableexpenseResponseCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariableexpenseResponseCompound is not found in the empty JSON string", VariableexpenseResponseCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!VariableexpenseResponseCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VariableexpenseResponseCompound` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
