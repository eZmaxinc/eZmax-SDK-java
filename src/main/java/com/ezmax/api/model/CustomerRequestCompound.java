...
public class CustomerRequestCompound {
  ...
  public CustomerRequestCompound() {
  }

  public CustomerRequestCompound pkiCustomerID(@javax.annotation.Nullable Integer pkiCustomerID) {
  ...
  public CustomerRequestCompound fkiCompanyID(@javax.annotation.Nonnull Integer fkiCompanyID) {
  ...
  public CustomerRequestCompound fkiCustomergroupID(@javax.annotation.Nonnull Integer fkiCustomergroupID) {
  ...
  public CustomerRequestCompound sCustomerName(@javax.annotation.Nonnull String sCustomerName) {
  ...
  public CustomerRequestCompound sCustomerNote(@javax.annotation.Nullable String sCustomerNote) {
  ...
  public CustomerRequestCompound fkiContactinformationsID(@javax.annotation.Nonnull Integer fkiContactinformationsID) {
  ...
  public CustomerRequestCompound fkiContactcontainerID(@javax.annotation.Nonnull Integer fkiContactcontainerID) {
  ...
  public CustomerRequestCompound fkiImageID(@javax.annotation.Nonnull Integer fkiImageID) {
  ...
  public CustomerRequestCompound fkiGlaccountcontainerID(@javax.annotation.Nonnull Integer fkiGlaccountcontainerID) {
  ...
  public CustomerRequestCompound fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public CustomerRequestCompound fkiDepartmentID(@javax.annotation.Nonnull Integer fkiDepartmentID) {
  ...
  public CustomerRequestCompound fkiPaymentmethodID(@javax.annotation.Nonnull Integer fkiPaymentmethodID) {
  ...
  public CustomerRequestCompound fkiElectronicfundstransferbankaccountID(@javax.annotation.Nonnull Integer fkiElectronicfundstransferbankaccountID) {
  ...
  public CustomerRequestCompound fkiElectronicfundstransferbankaccountIDDirectdebit(@javax.annotation.Nonnull Integer fkiElectronicfundstransferbankaccountIDDirectdebit) {
  ...
  public CustomerRequestCompound fkiSendingmethodID(@javax.annotation.Nonnull Integer fkiSendingmethodID) {
  ...
  public CustomerRequestCompound fkiTaxassignmentID(@javax.annotation.Nonnull Integer fkiTaxassignmentID) {
  ...
  public CustomerRequestCompound fkiAttendancestatusID(@javax.annotation.Nonnull Integer fkiAttendancestatusID) {
  ...
  public CustomerRequestCompound fkiAgentIDVariableexpensechargeto(@javax.annotation.Nonnull Integer fkiAgentIDVariableexpensechargeto) {
  ...
  public CustomerRequestCompound fkiBrokerIDVariableexpensechargeto(@javax.annotation.Nonnull Integer fkiBrokerIDVariableexpensechargeto) {
  ...
  public CustomerRequestCompound fkiCustomerIDVariableexpensechargeto(@javax.annotation.Nonnull Integer fkiCustomerIDVariableexpensechargeto) {
  ...
  public CustomerRequestCompound fkiGlaccountcontainerIDVariableexpensechargeto(@javax.annotation.Nonnull Integer fkiGlaccountcontainerIDVariableexpensechargeto) {
  ...
  public CustomerRequestCompound fkiAgentIDSupplychargechargeto(@javax.annotation.Nonnull Integer fkiAgentIDSupplychargechargeto) {
  ...
  public CustomerRequestCompound fkiBrokerIDSupplychargechargeto(@javax.annotation.Nonnull Integer fkiBrokerIDSupplychargechargeto) {
  ...
  public CustomerRequestCompound fkiCustomerIDSupplychargechargeto(@javax.annotation.Nonnull Integer fkiCustomerIDSupplychargechargeto) {
  ...
  public CustomerRequestCompound fkiGlaccountcontainerIDSupplychargechargeto(@javax.annotation.Nonnull Integer fkiGlaccountcontainerIDSupplychargechargeto) {
  ...
  public CustomerRequestCompound fkiInvoicealternatelogoID(@javax.annotation.Nonnull Integer fkiInvoicealternatelogoID) {
  ...
  public CustomerRequestCompound fkiSynchronizationlinkserverID(@javax.annotation.Nonnull Integer fkiSynchronizationlinkserverID) {
  ...
  public CustomerRequestCompound efkiUserID(@javax.annotation.Nullable Integer efkiUserID) {
  ...
  public CustomerRequestCompound efksCustomerCode(@javax.annotation.Nullable String efksCustomerCode) {
  ...
  public CustomerRequestCompound sCustomerCode(@javax.annotation.Nonnull String sCustomerCode) {
  ...
  public CustomerRequestCompound dCustomerFulltimeequivalent(@javax.annotation.Nonnull String dCustomerFulltimeequivalent) {
  ...
  public CustomerRequestCompound iCustomerPhotocopiercode(@javax.annotation.Nonnull Integer iCustomerPhotocopiercode) {
  ...
  public CustomerRequestCompound iCustomerLongdistancecode(@javax.annotation.Nonnull Integer iCustomerLongdistancecode) {
  ...
  public CustomerRequestCompound iCustomerTimewindowstart(@javax.annotation.Nonnull Integer iCustomerTimewindowstart) {
  ...
  public CustomerRequestCompound iCustomerTimewindowend(@javax.annotation.Nonnull Integer iCustomerTimewindowend) {
  ...
  public CustomerRequestCompound dCustomerMinimumchargeableinterests(@javax.annotation.Nonnull String dCustomerMinimumchargeableinterests) {
  ...
  public CustomerRequestCompound dtCustomerBirthdate(@javax.annotation.Nonnull String dtCustomerBirthdate) {
  ...
  public CustomerRequestCompound dtCustomerTransfer(@javax.annotation.Nonnull String dtCustomerTransfer) {
  ...
  public CustomerRequestCompound dtCustomerTransferappointment(@javax.annotation.Nonnull String dtCustomerTransferappointment) {
  ...
  public CustomerRequestCompound dtCustomerTransfersurvey(@javax.annotation.Nonnull String dtCustomerTransfersurvey) {
  ...
  public CustomerRequestCompound bCustomerIsactive(@javax.annotation.Nonnull Boolean bCustomerIsactive) {
  ...
  public CustomerRequestCompound bCustomerVariableexpensefinanced(@javax.annotation.Nonnull Boolean bCustomerVariableexpensefinanced) {
  ...
  public CustomerRequestCompound bCustomerVariableexpensefinancedtaxes(@javax.annotation.Nonnull Boolean bCustomerVariableexpensefinancedtaxes) {
  ...
  public CustomerRequestCompound bCustomerSupplychargefinanced(@javax.annotation.Nonnull Boolean bCustomerSupplychargefinanced) {
  ...
  public CustomerRequestCompound bCustomerSupplychargefinancedtaxes(@javax.annotation.Nonnull Boolean bCustomerSupplychargefinancedtaxes) {
  ...
  public CustomerRequestCompound bCustomerAttendance(@javax.annotation.Nonnull Boolean bCustomerAttendance) {
  ...
  public CustomerRequestCompound eCustomerType(@javax.annotation.Nonnull FieldECustomerType eCustomerType) {
  ...
  public CustomerRequestCompound eCustomerMarketingcorrespondence(@javax.annotation.Nonnull FieldECustomerMarketingcorrespondence eCustomerMarketingcorrespondence) {
  ...
  public CustomerRequestCompound bCustomerBlackcopycarbon(@javax.annotation.Nonnull Boolean bCustomerBlackcopycarbon) {
  ...
  public CustomerRequestCompound bCustomerUnsubscribeinfo(@javax.annotation.Nonnull Boolean bCustomerUnsubscribeinfo) {
  ...
  public CustomerRequestCompound tCustomerComment(@javax.annotation.Nonnull String tCustomerComment) {
  ...
  public CustomerRequestCompound IMPORTID(@javax.annotation.Nullable String IMPORTID) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiCustomerID, customerRequestCompound.pkiCustomerID) &&
        Objects.equals(this.fkiCompanyID, customerRequestCompound.fkiCompanyID) &&
        Objects.equals(this.fkiCustomergroupID, customerRequestCompound.fkiCustomergroupID) &&
        Objects.equals(this.sCustomerName, customerRequestCompound.sCustomerName) &&
        Objects.equals(this.sCustomerNote, customerRequestCompound.sCustomerNote) &&
        Objects.equals(this.fkiContactinformationsID, customerRequestCompound.fkiContactinformationsID) &&
        Objects.equals(this.fkiContactcontainerID, customerRequestCompound.fkiContactcontainerID) &&
        Objects.equals(this.fkiImageID, customerRequestCompound.fkiImageID) &&
        Objects.equals(this.fkiGlaccountcontainerID, customerRequestCompound.fkiGlaccountcontainerID) &&
        Objects.equals(this.fkiLanguageID, customerRequestCompound.fkiLanguageID) &&
        Objects.equals(this.fkiDepartmentID, customerRequestCompound.fkiDepartmentID) &&
        Objects.equals(this.fkiPaymentmethodID, customerRequestCompound.fkiPaymentmethodID) &&
        Objects.equals(this.fkiElectronicfundstransferbankaccountID, customerRequestCompound.fkiElectronicfundstransferbankaccountID) &&
        Objects.equals(this.fkiElectronicfundstransferbankaccountIDDirectdebit, customerRequestCompound.fkiElectronicfundstransferbankaccountIDDirectdebit) &&
        Objects.equals(this.fkiSendingmethodID, customerRequestCompound.fkiSendingmethodID) &&
        Objects.equals(this.fkiTaxassignmentID, customerRequestCompound.fkiTaxassignmentID) &&
        Objects.equals(this.fkiAttendancestatusID, customerRequestCompound.fkiAttendancestatusID) &&
        Objects.equals(this.fkiAgentIDVariableexpensechargeto, customerRequestCompound.fkiAgentIDVariableexpensechargeto) &&
        Objects.equals(this.fkiBrokerIDVariableexpensechargeto, customerRequestCompound.fkiBrokerIDVariableexpensechargeto) &&
        Objects.equals(this.fkiCustomerIDVariableexpensechargeto, customerRequestCompound.fkiCustomerIDVariableexpensechargeto) &&
        Objects.equals(this.fkiGlaccountcontainerIDVariableexpensechargeto, customerRequestCompound.fkiGlaccountcontainerIDVariableexpensechargeto) &&
        Objects.equals(this.fkiAgentIDSupplychargechargeto, customerRequestCompound.fkiAgentIDSupplychargechargeto) &&
        Objects.equals(this.fkiBrokerIDSupplychargechargeto, customerRequestCompound.fkiBrokerIDSupplychargechargeto) &&
        Objects.equals(this.fkiCustomerIDSupplychargechargeto, customerRequestCompound.fkiCustomerIDSupplychargechargeto) &&
        Objects.equals(this.fkiGlaccountcontainerIDSupplychargechargeto, customerRequestCompound.fkiGlaccountcontainerIDSupplychargechargeto) &&
        Objects.equals(this.fkiInvoicealternatelogoID, customerRequestCompound.fkiInvoicealternatelogoID) &&
        Objects.equals(this.fkiSynchronizationlinkserverID, customerRequestCompound.fkiSynchronizationlinkserverID) &&
        Objects.equals(this.efkiUserID, customerRequestCompound.efkiUserID) &&
        Objects.equals(this.efksCustomerCode, customerRequestCompound.efksCustomerCode) &&
        Objects.equals(this.sCustomerCode, customerRequestCompound.sCustomerCode) &&
        Objects.equals(this.dCustomerFulltimeequivalent, customerRequestCompound.dCustomerFulltimeequivalent) &&
        Objects.equals(this.iCustomerPhotocopiercode, customerRequestCompound.iCustomerPhotocopiercode) &&
        Objects.equals(this.iCustomerLongdistancecode, customerRequestCompound.iCustomerLongdistancecode) &&
        Objects.equals(this.iCustomerTimewindowstart, customerRequestCompound.iCustomerTimewindowstart) &&
        Objects.equals(this.iCustomerTimewindowend, customerRequestCompound.iCustomerTimewindowend) &&
        Objects.equals(this.dCustomerMinimumchargeableinterests, customerRequestCompound.dCustomerMinimumchargeableinterests) &&
        Objects.equals(this.dtCustomerBirthdate, customerRequestCompound.dtCustomerBirthdate) &&
        Objects.equals(this.dtCustomerTransfer, customerRequestCompound.dtCustomerTransfer) &&
        Objects.equals(this.dtCustomerTransferappointment, customerRequestCompound.dtCustomerTransferappointment) &&
        Objects.equals(this.dtCustomerTransfersurvey, customerRequestCompound.dtCustomerTransfersurvey) &&
        Objects.equals(this.bCustomerIsactive, customerRequestCompound.bCustomerIsactive) &&
        Objects.equals(this.bCustomerVariableexpensefinanced, customerRequestCompound.bCustomerVariableexpensefinanced) &&
        Objects.equals(this.bCustomerVariableexpensefinancedtaxes, customerRequestCompound.bCustomerVariableexpensefinancedtaxes) &&
        Objects.equals(this.bCustomerSupplychargefinanced, customerRequestCompound.bCustomerSupplychargefinanced) &&
        Objects.equals(this.bCustomerSupplychargefinancedtaxes, customerRequestCompound.bCustomerSupplychargefinancedtaxes) &&
        Objects.equals(this.bCustomerAttendance, customerRequestCompound.bCustomerAttendance) &&
        Objects.equals(this.eCustomerType, customerRequestCompound.eCustomerType) &&
        Objects.equals(this.eCustomerMarketingcorrespondence, customerRequestCompound.eCustomerMarketingcorrespondence) &&
        Objects.equals(this.bCustomerBlackcopycarbon, customerRequestCompound.bCustomerBlackcopycarbon) &&
        Objects.equals(this.bCustomerUnsubscribeinfo, customerRequestCompound.bCustomerUnsubscribeinfo) &&
        Objects.equals(this.tCustomerComment, customerRequestCompound.tCustomerComment) &&
        Objects.equals(this.IMPORTID, customerRequestCompound.IMPORTID);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkiCustomerID, fkiCompanyID, fkiCustomergroupID, sCustomerName, sCustomerNote, fkiContactinformationsID, fkiContactcontainerID, fkiImageID, fkiGlaccountcontainerID, fkiLanguageID, fkiDepartmentID, fkiPaymentmethodID, fkiElectronicfundstransferbankaccountID, fkiElectronicfundstransferbankaccountIDDirectdebit, fkiSendingmethodID, fkiTaxassignmentID, fkiAttendancestatusID, fkiAgentIDVariableexpensechargeto, fkiBrokerIDVariableexpensechargeto, fkiCustomerIDVariableexpensechargeto, fkiGlaccountcontainerIDVariableexpensechargeto, fkiAgentIDSupplychargechargeto, fkiBrokerIDSupplychargechargeto, fkiCustomerIDSupplychargechargeto, fkiGlaccountcontainerIDSupplychargechargeto, fkiInvoicealternatelogoID, fkiSynchronizationlinkserverID, efkiUserID, efksCustomerCode, sCustomerCode, dCustomerFulltimeequivalent, iCustomerPhotocopiercode, iCustomerLongdistancecode, iCustomerTimewindowstart, iCustomerTimewindowend, dCustomerMinimumchargeableinterests, dtCustomerBirthdate, dtCustomerTransfer, dtCustomerTransferappointment, dtCustomerTransfersurvey, bCustomerIsactive, bCustomerVariableexpensefinanced, bCustomerVariableexpensefinancedtaxes, bCustomerSupplychargefinanced, bCustomerSupplychargefinancedtaxes, bCustomerAttendance, eCustomerType, eCustomerMarketingcorrespondence, bCustomerBlackcopycarbon, bCustomerUnsubscribeinfo, tCustomerComment, IMPORTID);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiCustomerID", "fkiCompanyID", "fkiCustomergroupID", "sCustomerName", "sCustomerNote", "fkiContactinformationsID", "fkiContactcontainerID", "fkiImageID", "fkiGlaccountcontainerID", "fkiLanguageID", "fkiDepartmentID", "fkiPaymentmethodID", "fkiElectronicfundstransferbankaccountID", "fkiElectronicfundstransferbankaccountIDDirectdebit", "fkiSendingmethodID", "fkiTaxassignmentID", "fkiAttendancestatusID", "fkiAgentIDVariableexpensechargeto", "fkiBrokerIDVariableexpensechargeto", "fkiCustomerIDVariableexpensechargeto", "fkiGlaccountcontainerIDVariableexpensechargeto", "fkiAgentIDSupplychargechargeto", "fkiBrokerIDSupplychargechargeto", "fkiCustomerIDSupplychargechargeto", "fkiGlaccountcontainerIDSupplychargechargeto", "fkiInvoicealternatelogoID", "fkiSynchronizationlinkserverID", "efkiUserID", "efksCustomerCode", "sCustomerCode", "dCustomerFulltimeequivalent", "iCustomerPhotocopiercode", "iCustomerLongdistancecode", "iCustomerTimewindowstart", "iCustomerTimewindowend", "dCustomerMinimumchargeableinterests", "dtCustomerBirthdate", "dtCustomerTransfer", "dtCustomerTransferappointment", "dtCustomerTransfersurvey", "bCustomerIsactive", "bCustomerVariableexpensefinanced", "bCustomerVariableexpensefinancedtaxes", "bCustomerSupplychargefinanced", "bCustomerSupplychargefinancedtaxes", "bCustomerAttendance", "eCustomerType", "eCustomerMarketingcorrespondence", "bCustomerBlackcopycarbon", "bCustomerUnsubscribeinfo", "tCustomerComment", "IMPORTID"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiCompanyID", "fkiCustomergroupID", "sCustomerName", "fkiContactinformationsID", "fkiContactcontainerID", "fkiImageID", "fkiGlaccountcontainerID", "fkiLanguageID", "fkiDepartmentID", "fkiPaymentmethodID", "fkiElectronicfundstransferbankaccountID", "fkiElectronicfundstransferbankaccountIDDirectdebit", "fkiSendingmethodID", "fkiTaxassignmentID", "fkiAttendancestatusID", "fkiAgentIDVariableexpensechargeto", "fkiBrokerIDVariableexpensechargeto", "fkiCustomerIDVariableexpensechargeto", "fkiGlaccountcontainerIDVariableexpensechargeto", "fkiAgentIDSupplychargechargeto", "fkiBrokerIDSupplychargechargeto", "fkiCustomerIDSupplychargechargeto", "fkiGlaccountcontainerIDSupplychargechargeto", "fkiInvoicealternatelogoID", "fkiSynchronizationlinkserverID", "sCustomerCode", "dCustomerFulltimeequivalent", "iCustomerPhotocopiercode", "iCustomerLongdistancecode", "iCustomerTimewindowstart", "iCustomerTimewindowend", "dCustomerMinimumchargeableinterests", "dtCustomerBirthdate", "dtCustomerTransfer", "dtCustomerTransferappointment", "dtCustomerTransfersurvey", "bCustomerIsactive", "bCustomerVariableexpensefinanced", "bCustomerVariableexpensefinancedtaxes", "bCustomerSupplychargefinanced", "bCustomerSupplychargefinancedtaxes", "bCustomerAttendance", "eCustomerType", "eCustomerMarketingcorrespondence", "bCustomerBlackcopycarbon", "bCustomerUnsubscribeinfo", "tCustomerComment"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomerRequestCompound
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomerRequestCompound.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CustomerRequestCompound is not found in the empty JSON string", CustomerRequestCompound.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomerRequestCompound.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CustomerRequestCompound` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomerRequestCompound.openapiRequiredFields) {
      ...
      if ((jsonObj.get("efksCustomerCode") != null && !jsonObj.get("efksCustomerCode").isJsonNull()) && !jsonObj.get("efksCustomerCode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `efksCustomerCode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("efksCustomerCode").toString()));
      }
      ...
      if (!jsonObj.get("dCustomerFulltimeequivalent").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dCustomerFulltimeequivalent` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dCustomerFulltimeequivalent").toString()));
      }
      if (!jsonObj.get("dCustomerMinimumchargeableinterests").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dCustomerMinimumchargeableinterests` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dCustomerMinimumchargeableinterests").toString()));
      }
      if (!jsonObj.get("dtCustomerBirthdate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtCustomerBirthdate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtCustomerBirthdate").toString()));
      }
      if (!jsonObj.get("dtCustomerTransfer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtCustomerTransfer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtCustomerTransfer").toString()));
      }
      if (!jsonObj.get("dtCustomerTransferappointment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtCustomerTransferappointment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtCustomerTransferappointment").toString()));
      }
      if (!jsonObj.get("dtCustomerTransfersurvey").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `dtCustomerTransfersurvey` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dtCustomerTransfersurvey").toString()));
      }
      ...
      if (!jsonObj.get("tCustomerComment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `tCustomerComment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tCustomerComment").toString()));
      }
      if ((jsonObj.get("IMPORTID") != null && !jsonObj.get("IMPORTID").isJsonNull()) && !jsonObj.get("IMPORTID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `IMPORTID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("IMPORTID").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomerRequestCompound.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomerRequestCompound' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomerRequestCompound> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomerRequestCompound.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomerRequestCompound>() {
           @Override
           public void write(JsonWriter out, CustomerRequestCompound value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomerRequestCompound read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomerRequestCompound given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomerRequestCompound
   * @throws IOException if the JSON string is invalid with respect to CustomerRequestCompound
   */
  public static CustomerRequestCompound fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomerRequestCompound.class);
  }

  /**
   * Convert an instance of CustomerRequestCompound to an JSON string
   *
   * @return JSON string
   */
