...
public class EzdoctemplatedocumentRequest {
  ...
  public EzdoctemplatedocumentRequest() {
  }

  public EzdoctemplatedocumentRequest pkiEzdoctemplatedocumentID(@javax.annotation.Nullable Integer pkiEzdoctemplatedocumentID) {
  ...
  public EzdoctemplatedocumentRequest fkiLanguageID(@javax.annotation.Nonnull Integer fkiLanguageID) {
  ...
  public EzdoctemplatedocumentRequest fkiEzsignfoldertypeID(@javax.annotation.Nullable Integer fkiEzsignfoldertypeID) {
  ...
  public EzdoctemplatedocumentRequest fkiEzdoctemplatetypeID(@javax.annotation.Nonnull Integer fkiEzdoctemplatetypeID) {
  ...
  public EzdoctemplatedocumentRequest fkiEzdoctemplatefieldtypecategoryID(@javax.annotation.Nullable Integer fkiEzdoctemplatefieldtypecategoryID) {
  ...
  public EzdoctemplatedocumentRequest eEzdoctemplatedocumentPrivacylevel(@javax.annotation.Nullable FieldEEzdoctemplatedocumentPrivacylevel eEzdoctemplatedocumentPrivacylevel) {
  ...
  public EzdoctemplatedocumentRequest bEzdoctemplatedocumentIsactive(@javax.annotation.Nonnull Boolean bEzdoctemplatedocumentIsactive) {
  ...
  public EzdoctemplatedocumentRequest objEzdoctemplatedocumentName(@javax.annotation.Nonnull MultilingualEzdoctemplatedocumentName objEzdoctemplatedocumentName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pkiEzdoctemplatedocumentID, ezdoctemplatedocumentRequest.pkiEzdoctemplatedocumentID) &&
        Objects.equals(this.fkiLanguageID, ezdoctemplatedocumentRequest.fkiLanguageID) &&
        Objects.equals(this.fkiEzsignfoldertypeID, ezdoctemplatedocumentRequest.fkiEzsignfoldertypeID) &&
        Objects.equals(this.fkiEzdoctemplatetypeID, ezdoctemplatedocumentRequest.fkiEzdoctemplatetypeID) &&
        Objects.equals(this.fkiEzdoctemplatefieldtypecategoryID, ezdoctemplatedocumentRequest.fkiEzdoctemplatefieldtypecategoryID) &&
        Objects.equals(this.eEzdoctemplatedocumentPrivacylevel, ezdoctemplatedocumentRequest.eEzdoctemplatedocumentPrivacylevel) &&
        Objects.equals(this.bEzdoctemplatedocumentIsactive, ezdoctemplatedocumentRequest.bEzdoctemplatedocumentIsactive) &&
        Objects.equals(this.objEzdoctemplatedocumentName, ezdoctemplatedocumentRequest.objEzdoctemplatedocumentName);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("pkiEzdoctemplatedocumentID", "fkiLanguageID", "fkiEzsignfoldertypeID", "fkiEzdoctemplatetypeID", "fkiEzdoctemplatefieldtypecategoryID", "eEzdoctemplatedocumentPrivacylevel", "bEzdoctemplatedocumentIsactive", "objEzdoctemplatedocumentName"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fkiLanguageID", "fkiEzdoctemplatetypeID", "bEzdoctemplatedocumentIsactive", "objEzdoctemplatedocumentName"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EzdoctemplatedocumentRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EzdoctemplatedocumentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EzdoctemplatedocumentRequest is not found in the empty JSON string", EzdoctemplatedocumentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EzdoctemplatedocumentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EzdoctemplatedocumentRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EzdoctemplatedocumentRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EzdoctemplatedocumentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EzdoctemplatedocumentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EzdoctemplatedocumentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EzdoctemplatedocumentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EzdoctemplatedocumentRequest>() {
           @Override
           public void write(JsonWriter out, EzdoctemplatedocumentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EzdoctemplatedocumentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EzdoctemplatedocumentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EzdoctemplatedocumentRequest
   * @throws IOException if the JSON string is invalid with respect to EzdoctemplatedocumentRequest
   */
  public static EzdoctemplatedocumentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EzdoctemplatedocumentRequest.class);
  }

  /**
   * Convert an instance of EzdoctemplatedocumentRequest to an JSON string
   *
   * @return JSON string
   */
