...
public class SsprUnlockAccountRequestV1Request {
  ...
  public SsprUnlockAccountRequestV1Request() { 
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SsprUnlockAccountRequestV1Request
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SsprUnlockAccountRequestV1Request.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in SsprUnlockAccountRequestV1Request is not found in the empty JSON string", SsprUnlockAccountRequestV1Request.openapiRequiredFields.toString()));
        }
      }
      Set<Entry<String, JsonElement>> entries = jsonObj.entrySet();
      // check to see if the JSON string contains additional fields
      for (Entry<String, JsonElement> entry : entries) {
        if (!SsprUnlockAccountRequestV1Request.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SsprUnlockAccountRequestV1Request` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SsprUnlockAccountRequestV1Request.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SsprUnlockAccountRequestV1Request.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SsprUnlockAccountRequestV1Request' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SsprUnlockAccountRequestV1Request> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SsprUnlockAccountRequestV1Request.class));

       return (TypeAdapter<T>) new TypeAdapter<SsprUnlockAccountRequestV1Request>() {
           @Override
           public void write(JsonWriter out, SsprUnlockAccountRequestV1Request value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SsprUnlockAccountRequestV1Request read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SsprUnlockAccountRequestV1Request given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SsprUnlockAccountRequestV1Request
  * @throws IOException if the JSON string is invalid with respect to SsprUnlockAccountRequestV1Request
  */
  public static SsprUnlockAccountRequestV1Request fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SsprUnlockAccountRequestV1Request.class);
  }

 /**
  * Convert an instance of SsprUnlockAccountRequestV1Request to an JSON string
  *
  * @return JSON string
  */
