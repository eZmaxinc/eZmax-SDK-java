...
public class ObjectDiscussionmembershipApi {
     ...
     */
    public okhttp3.Call discussionmembershipCreateObjectV1Call(@javax.annotation.Nonnull DiscussionmembershipCreateObjectV1Request discussionmembershipCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call discussionmembershipCreateObjectV1ValidateBeforeCall(@javax.annotation.Nonnull DiscussionmembershipCreateObjectV1Request discussionmembershipCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DiscussionmembershipCreateObjectV1Response discussionmembershipCreateObjectV1(@javax.annotation.Nonnull DiscussionmembershipCreateObjectV1Request discussionmembershipCreateObjectV1Request) throws ApiException {
     ...
     */
    public ApiResponse<DiscussionmembershipCreateObjectV1Response> discussionmembershipCreateObjectV1WithHttpInfo(@javax.annotation.Nonnull DiscussionmembershipCreateObjectV1Request discussionmembershipCreateObjectV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call discussionmembershipCreateObjectV1Async(@javax.annotation.Nonnull DiscussionmembershipCreateObjectV1Request discussionmembershipCreateObjectV1Request, final ApiCallback<DiscussionmembershipCreateObjectV1Response> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call discussionmembershipDeleteObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiDiscussionmembershipID, final ApiCallback _callback) throws ApiException {
