...
public class ObjectEzsigntemplateformfieldgroupApi {
    ...
    private okhttp3.Call ezsigntemplateformfieldgroupCreateObjectV1ValidateBeforeCall(EzsigntemplateformfieldgroupCreateObjectV1Request ezsigntemplateformfieldgroupCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupCreateObjectV1Call(ezsigntemplateformfieldgroupCreateObjectV1Request, _callback);
        return localVarCall;
    ...
    public okhttp3.Call ezsigntemplateformfieldgroupDeleteObjectV1Call(Integer pkiEzsigntemplateformfieldgroupID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1/object/ezsigntemplateformfieldgroup/{pkiEzsigntemplateformfieldgroupID}"
            .replaceAll("\\{" + "pkiEzsigntemplateformfieldgroupID" + "\\}", localVarApiClient.escapeString(pkiEzsigntemplateformfieldgroupID.toString()));
    ...
    private okhttp3.Call ezsigntemplateformfieldgroupDeleteObjectV1ValidateBeforeCall(Integer pkiEzsigntemplateformfieldgroupID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupDeleteObjectV1Call(pkiEzsigntemplateformfieldgroupID, _callback);
        return localVarCall;
    ...
    private okhttp3.Call ezsigntemplateformfieldgroupEditObjectV1ValidateBeforeCall(Integer pkiEzsigntemplateformfieldgroupID, EzsigntemplateformfieldgroupEditObjectV1Request ezsigntemplateformfieldgroupEditObjectV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupEditObjectV1Call(pkiEzsigntemplateformfieldgroupID, ezsigntemplateformfieldgroupEditObjectV1Request, _callback);
        return localVarCall;
    ...
    /**
     * Build call for ezsigntemplateformfieldgroupGetObjectV1
     * @param pkiEzsigntemplateformfieldgroupID  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    @Deprecated
    public okhttp3.Call ezsigntemplateformfieldgroupGetObjectV1Call(Integer pkiEzsigntemplateformfieldgroupID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsigntemplateformfieldgroupGetObjectV1ValidateBeforeCall(Integer pkiEzsigntemplateformfieldgroupID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiEzsigntemplateformfieldgroupID' is set
        if (pkiEzsigntemplateformfieldgroupID == null) {
            throw new ApiException("Missing the required parameter 'pkiEzsigntemplateformfieldgroupID' when calling ezsigntemplateformfieldgroupGetObjectV1(Async)");
        }
        

        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupGetObjectV1Call(pkiEzsigntemplateformfieldgroupID, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public EzsigntemplateformfieldgroupGetObjectV1Response ezsigntemplateformfieldgroupGetObjectV1(Integer pkiEzsigntemplateformfieldgroupID) throws ApiException {
        ApiResponse<EzsigntemplateformfieldgroupGetObjectV1Response> localVarResp = ezsigntemplateformfieldgroupGetObjectV1WithHttpInfo(pkiEzsigntemplateformfieldgroupID);
        return localVarResp.getData();
    }
     ...
     * 
     * @param pkiEzsigntemplateformfieldgroupID  (required)
     * @return ApiResponse&lt;EzsigntemplateformfieldgroupGetObjectV1Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    @Deprecated
    public ApiResponse<EzsigntemplateformfieldgroupGetObjectV1Response> ezsigntemplateformfieldgroupGetObjectV1WithHttpInfo(Integer pkiEzsigntemplateformfieldgroupID) throws ApiException {
        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupGetObjectV1ValidateBeforeCall(pkiEzsigntemplateformfieldgroupID, null);
        Type localVarReturnType = new TypeToken<EzsigntemplateformfieldgroupGetObjectV1Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    @Deprecated
    public okhttp3.Call ezsigntemplateformfieldgroupGetObjectV1Async(Integer pkiEzsigntemplateformfieldgroupID, final ApiCallback<EzsigntemplateformfieldgroupGetObjectV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupGetObjectV1ValidateBeforeCall(pkiEzsigntemplateformfieldgroupID, _callback);
        Type localVarReturnType = new TypeToken<EzsigntemplateformfieldgroupGetObjectV1Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call ezsigntemplateformfieldgroupGetObjectV2ValidateBeforeCall(Integer pkiEzsigntemplateformfieldgroupID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateformfieldgroupGetObjectV2Call(pkiEzsigntemplateformfieldgroupID, _callback);
        return localVarCall;
