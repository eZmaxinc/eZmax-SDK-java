...
public class ObjectEzsigndocumentApi {
     ...
     */
    public okhttp3.Call ezsigndocumentGetChildrenV1Call(Integer pkiEzsigndocumentID, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsigndocumentGetChildrenV1ValidateBeforeCall(Integer pkiEzsigndocumentID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiEzsigndocumentID' is set
        if (pkiEzsigndocumentID == null) {
            throw new ApiException("Missing the required parameter 'pkiEzsigndocumentID' when calling ezsigndocumentGetChildrenV1(Async)");
        }
        

        okhttp3.Call localVarCall = ezsigndocumentGetChildrenV1Call(pkiEzsigndocumentID, _callback);
        return localVarCall;
     ...
     */
    public void ezsigndocumentGetChildrenV1(Integer pkiEzsigndocumentID) throws ApiException {
     ...
     */
    public ApiResponse<Void> ezsigndocumentGetChildrenV1WithHttpInfo(Integer pkiEzsigndocumentID) throws ApiException {
        okhttp3.Call localVarCall = ezsigndocumentGetChildrenV1ValidateBeforeCall(pkiEzsigndocumentID, null);
     ...
     */
    public okhttp3.Call ezsigndocumentGetChildrenV1Async(Integer pkiEzsigndocumentID, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = ezsigndocumentGetChildrenV1ValidateBeforeCall(pkiEzsigndocumentID, _callback);
     ...
     */
    public File ezsigndocumentGetFormDataV1(Integer pkiEzsigndocumentID) throws ApiException {
        ApiResponse<File> localVarResp = ezsigndocumentGetFormDataV1WithHttpInfo(pkiEzsigndocumentID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> ezsigndocumentGetFormDataV1WithHttpInfo(Integer pkiEzsigndocumentID) throws ApiException {
     ...
     */
    public okhttp3.Call ezsigndocumentGetFormDataV1Async(Integer pkiEzsigndocumentID, final ApiCallback<File> _callback) throws ApiException {
