...
public class ObjectElectronicfundstransferApi {
    ...
    private okhttp3.Call electronicfundstransferGetCommunicationCountV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call electronicfundstransferGetCommunicationListV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiElectronicfundstransferID' is set
        if (pkiElectronicfundstransferID == null) {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call electronicfundstransferGetCommunicationrecipientsV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiElectronicfundstransferID' is set
        if (pkiElectronicfundstransferID == null) {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call electronicfundstransferGetCommunicationsendersV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiElectronicfundstransferID' is set
        if (pkiElectronicfundstransferID == null) {
    ...
    /**
     * Build call for electronicfundstransferImportIntoEDMV1
     * @param pkiElectronicfundstransferID  (required)
     * @param electronicfundstransferImportIntoEDMV1Request  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call electronicfundstransferImportIntoEDMV1Call(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, @javax.annotation.Nonnull ElectronicfundstransferImportIntoEDMV1Request electronicfundstransferImportIntoEDMV1Request, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = electronicfundstransferImportIntoEDMV1Request;

        // create path and map variables
        String localVarPath = "/1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/importIntoEDM"
            .replace("{" + "pkiElectronicfundstransferID" + "}", localVarApiClient.escapeString(pkiElectronicfundstransferID.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call electronicfundstransferImportIntoEDMV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, @javax.annotation.Nonnull ElectronicfundstransferImportIntoEDMV1Request electronicfundstransferImportIntoEDMV1Request, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiElectronicfundstransferID' is set
        if (pkiElectronicfundstransferID == null) {
            throw new ApiException("Missing the required parameter 'pkiElectronicfundstransferID' when calling electronicfundstransferImportIntoEDMV1(Async)");
        }
        ...
        if (electronicfundstransferImportIntoEDMV1Request == null) {
            throw new ApiException("Missing the required parameter 'electronicfundstransferImportIntoEDMV1Request' when calling electronicfundstransferImportIntoEDMV1(Async)");
        }

        return electronicfundstransferImportIntoEDMV1Call(pkiElectronicfundstransferID, electronicfundstransferImportIntoEDMV1Request, _callback);
    ...
    public ElectronicfundstransferImportIntoEDMV1Response electronicfundstransferImportIntoEDMV1(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, @javax.annotation.Nonnull ElectronicfundstransferImportIntoEDMV1Request electronicfundstransferImportIntoEDMV1Request) throws ApiException {
        ApiResponse<ElectronicfundstransferImportIntoEDMV1Response> localVarResp = electronicfundstransferImportIntoEDMV1WithHttpInfo(pkiElectronicfundstransferID, electronicfundstransferImportIntoEDMV1Request);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<ElectronicfundstransferImportIntoEDMV1Response> electronicfundstransferImportIntoEDMV1WithHttpInfo(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, @javax.annotation.Nonnull ElectronicfundstransferImportIntoEDMV1Request electronicfundstransferImportIntoEDMV1Request) throws ApiException {
        okhttp3.Call localVarCall = electronicfundstransferImportIntoEDMV1ValidateBeforeCall(pkiElectronicfundstransferID, electronicfundstransferImportIntoEDMV1Request, null);
        Type localVarReturnType = new TypeToken<ElectronicfundstransferImportIntoEDMV1Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Import attachments into the Electronicfundstransfer (asynchronously)
     * 
     * @param pkiElectronicfundstransferID  (required)
     * @param electronicfundstransferImportIntoEDMV1Request  (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    public okhttp3.Call electronicfundstransferImportIntoEDMV1Async(@javax.annotation.Nonnull Integer pkiElectronicfundstransferID, @javax.annotation.Nonnull ElectronicfundstransferImportIntoEDMV1Request electronicfundstransferImportIntoEDMV1Request, final ApiCallback<ElectronicfundstransferImportIntoEDMV1Response> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = electronicfundstransferImportIntoEDMV1ValidateBeforeCall(pkiElectronicfundstransferID, electronicfundstransferImportIntoEDMV1Request, _callback);
        Type localVarReturnType = new TypeToken<ElectronicfundstransferImportIntoEDMV1Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
