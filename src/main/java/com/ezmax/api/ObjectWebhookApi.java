...
public class ObjectWebhookApi {
    ...
    private okhttp3.Call webhookCreateObjectV1ValidateBeforeCall(WebhookCreateObjectV1Request webhookCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = webhookCreateObjectV1Call(webhookCreateObjectV1Request, _callback);
        return localVarCall;
    ...
    public okhttp3.Call webhookDeleteObjectV1Call(Integer pkiWebhookID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1/object/webhook/{pkiWebhookID}"
            .replaceAll("\\{" + "pkiWebhookID" + "\\}", localVarApiClient.escapeString(pkiWebhookID.toString()));
    ...
    private okhttp3.Call webhookDeleteObjectV1ValidateBeforeCall(Integer pkiWebhookID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = webhookDeleteObjectV1Call(pkiWebhookID, _callback);
        return localVarCall;
    ...
    private okhttp3.Call webhookEditObjectV1ValidateBeforeCall(Integer pkiWebhookID, WebhookEditObjectV1Request webhookEditObjectV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = webhookEditObjectV1Call(pkiWebhookID, webhookEditObjectV1Request, _callback);
        return localVarCall;
    ...
    private okhttp3.Call webhookGetHistoryV1ValidateBeforeCall(Integer pkiWebhookID, String eWebhookHistoryinterval, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = webhookGetHistoryV1Call(pkiWebhookID, eWebhookHistoryinterval, _callback);
        return localVarCall;
    ...
    private okhttp3.Call webhookGetListV1ValidateBeforeCall(String eOrderBy, Integer iRowMax, Integer iRowOffset, HeaderAcceptLanguage acceptLanguage, String sFilter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = webhookGetListV1Call(eOrderBy, iRowMax, iRowOffset, acceptLanguage, sFilter, _callback);
        return localVarCall;
    ...
    /**
     * Build call for webhookGetObjectV1
     * @param pkiWebhookID  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call webhookGetObjectV1Call(Integer pkiWebhookID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call webhookGetObjectV1ValidateBeforeCall(Integer pkiWebhookID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiWebhookID' is set
        if (pkiWebhookID == null) {
            throw new ApiException("Missing the required parameter 'pkiWebhookID' when calling webhookGetObjectV1(Async)");
        }
        

        okhttp3.Call localVarCall = webhookGetObjectV1Call(pkiWebhookID, _callback);
        return localVarCall;
     ...
     */
    public WebhookGetObjectV1Response webhookGetObjectV1(Integer pkiWebhookID) throws ApiException {
        ApiResponse<WebhookGetObjectV1Response> localVarResp = webhookGetObjectV1WithHttpInfo(pkiWebhookID);
        return localVarResp.getData();
    }
     ...
     * 
     * @param pkiWebhookID  (required)
     * @return ApiResponse&lt;WebhookGetObjectV1Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WebhookGetObjectV1Response> webhookGetObjectV1WithHttpInfo(Integer pkiWebhookID) throws ApiException {
        okhttp3.Call localVarCall = webhookGetObjectV1ValidateBeforeCall(pkiWebhookID, null);
        Type localVarReturnType = new TypeToken<WebhookGetObjectV1Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call webhookGetObjectV1Async(Integer pkiWebhookID, final ApiCallback<WebhookGetObjectV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = webhookGetObjectV1ValidateBeforeCall(pkiWebhookID, _callback);
        Type localVarReturnType = new TypeToken<WebhookGetObjectV1Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for webhookTestUrlV1
     * @param pkiWebhookID  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call webhookTestUrlV1Call(Integer pkiWebhookID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call webhookTestUrlV1ValidateBeforeCall(Integer pkiWebhookID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiWebhookID' is set
        if (pkiWebhookID == null) {
            throw new ApiException("Missing the required parameter 'pkiWebhookID' when calling webhookTestUrlV1(Async)");
        }
        

        okhttp3.Call localVarCall = webhookTestUrlV1Call(pkiWebhookID, _callback);
        return localVarCall;
     ...
     */
    public WebhookTestV1Response webhookTestUrlV1(Integer pkiWebhookID) throws ApiException {
        ApiResponse<WebhookTestV1Response> localVarResp = webhookTestUrlV1WithHttpInfo(pkiWebhookID);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<WebhookTestV1Response> webhookTestUrlV1WithHttpInfo(Integer pkiWebhookID) throws ApiException {
        okhttp3.Call localVarCall = webhookTestUrlV1ValidateBeforeCall(pkiWebhookID, null);
     ...
     */
    public okhttp3.Call webhookTestUrlV1Async(Integer pkiWebhookID, final ApiCallback<WebhookTestV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = webhookTestUrlV1ValidateBeforeCall(pkiWebhookID, _callback);
        Type localVarReturnType = new TypeToken<WebhookTestV1Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
