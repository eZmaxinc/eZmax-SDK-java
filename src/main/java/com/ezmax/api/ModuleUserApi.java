...
public class ModuleUserApi {
     ...
     */
    public okhttp3.Call userCreateEzsignuserV1Call(@javax.annotation.Nonnull List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call userCreateEzsignuserV1ValidateBeforeCall(@javax.annotation.Nonnull List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public UserCreateEzsignuserV1Response userCreateEzsignuserV1(@javax.annotation.Nonnull List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request) throws ApiException {
     ...
     */
    public ApiResponse<UserCreateEzsignuserV1Response> userCreateEzsignuserV1WithHttpInfo(@javax.annotation.Nonnull List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call userCreateEzsignuserV1Async(@javax.annotation.Nonnull List<UserCreateEzsignuserV1Request> userCreateEzsignuserV1Request, final ApiCallback<UserCreateEzsignuserV1Response> _callback) throws ApiException {
