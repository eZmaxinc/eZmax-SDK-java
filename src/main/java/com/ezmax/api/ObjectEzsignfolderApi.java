...
public class ObjectEzsignfolderApi {
    ...
    /**
     * Build call for ezsignfolderGetObjectGetChildrenV1
     * @param pkiEzsignfolderID The unique ID of the Ezsignfolder (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call ezsignfolderGetObjectGetChildrenV1Call(Integer pkiEzsignfolderID, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignfolderGetObjectGetChildrenV1ValidateBeforeCall(Integer pkiEzsignfolderID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiEzsignfolderID' is set
        if (pkiEzsignfolderID == null) {
            throw new ApiException("Missing the required parameter 'pkiEzsignfolderID' when calling ezsignfolderGetObjectGetChildrenV1(Async)");
        }
        

        okhttp3.Call localVarCall = ezsignfolderGetObjectGetChildrenV1Call(pkiEzsignfolderID, _callback);
        return localVarCall;
     ...
     */
    public void ezsignfolderGetObjectGetChildrenV1(Integer pkiEzsignfolderID) throws ApiException {
     ...
     */
    public ApiResponse<Void> ezsignfolderGetObjectGetChildrenV1WithHttpInfo(Integer pkiEzsignfolderID) throws ApiException {
        okhttp3.Call localVarCall = ezsignfolderGetObjectGetChildrenV1ValidateBeforeCall(pkiEzsignfolderID, null);
     ...
     */
    public okhttp3.Call ezsignfolderGetObjectGetChildrenV1Async(Integer pkiEzsignfolderID, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = ezsignfolderGetObjectGetChildrenV1ValidateBeforeCall(pkiEzsignfolderID, _callback);
