...
public class ObjectEzsignformfieldgroupApi {
     ...
     */
    public okhttp3.Call ezsignformfieldgroupCreateObjectV1Call(@javax.annotation.Nonnull EzsignformfieldgroupCreateObjectV1Request ezsignformfieldgroupCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ezsignformfieldgroupCreateObjectV1ValidateBeforeCall(@javax.annotation.Nonnull EzsignformfieldgroupCreateObjectV1Request ezsignformfieldgroupCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzsignformfieldgroupCreateObjectV1Response ezsignformfieldgroupCreateObjectV1(@javax.annotation.Nonnull EzsignformfieldgroupCreateObjectV1Request ezsignformfieldgroupCreateObjectV1Request) throws ApiException {
     ...
     */
    public ApiResponse<EzsignformfieldgroupCreateObjectV1Response> ezsignformfieldgroupCreateObjectV1WithHttpInfo(@javax.annotation.Nonnull EzsignformfieldgroupCreateObjectV1Request ezsignformfieldgroupCreateObjectV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call ezsignformfieldgroupCreateObjectV1Async(@javax.annotation.Nonnull EzsignformfieldgroupCreateObjectV1Request ezsignformfieldgroupCreateObjectV1Request, final ApiCallback<EzsignformfieldgroupCreateObjectV1Response> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignformfieldgroupDeleteObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignformfieldgroupEditObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignformfieldgroupID, @javax.annotation.Nonnull EzsignformfieldgroupEditObjectV1Request ezsignformfieldgroupEditObjectV1Request, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsignformfieldgroupID' is set
        if (pkiEzsignformfieldgroupID == null) {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignformfieldgroupGetObjectV2ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsignformfieldgroupID' is set
        if (pkiEzsignformfieldgroupID == null) {
