...
public class ObjectEzsignformfieldgroupApi {
    ...
    private okhttp3.Call ezsignformfieldgroupCreateObjectV1ValidateBeforeCall(EzsignformfieldgroupCreateObjectV1Request ezsignformfieldgroupCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsignformfieldgroupCreateObjectV1Call(ezsignformfieldgroupCreateObjectV1Request, _callback);
        return localVarCall;
    ...
    public okhttp3.Call ezsignformfieldgroupDeleteObjectV1Call(Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}"
            .replaceAll("\\{" + "pkiEzsignformfieldgroupID" + "\\}", localVarApiClient.escapeString(pkiEzsignformfieldgroupID.toString()));
    ...
    private okhttp3.Call ezsignformfieldgroupDeleteObjectV1ValidateBeforeCall(Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsignformfieldgroupDeleteObjectV1Call(pkiEzsignformfieldgroupID, _callback);
        return localVarCall;
    ...
    private okhttp3.Call ezsignformfieldgroupEditObjectV1ValidateBeforeCall(Integer pkiEzsignformfieldgroupID, EzsignformfieldgroupEditObjectV1Request ezsignformfieldgroupEditObjectV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsignformfieldgroupEditObjectV1Call(pkiEzsignformfieldgroupID, ezsignformfieldgroupEditObjectV1Request, _callback);
        return localVarCall;
    ...
    /**
     * Build call for ezsignformfieldgroupGetObjectV1
     * @param pkiEzsignformfieldgroupID  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    @Deprecated
    public okhttp3.Call ezsignformfieldgroupGetObjectV1Call(Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignformfieldgroupGetObjectV1ValidateBeforeCall(Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiEzsignformfieldgroupID' is set
        if (pkiEzsignformfieldgroupID == null) {
            throw new ApiException("Missing the required parameter 'pkiEzsignformfieldgroupID' when calling ezsignformfieldgroupGetObjectV1(Async)");
        }
        

        okhttp3.Call localVarCall = ezsignformfieldgroupGetObjectV1Call(pkiEzsignformfieldgroupID, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public EzsignformfieldgroupGetObjectV1Response ezsignformfieldgroupGetObjectV1(Integer pkiEzsignformfieldgroupID) throws ApiException {
        ApiResponse<EzsignformfieldgroupGetObjectV1Response> localVarResp = ezsignformfieldgroupGetObjectV1WithHttpInfo(pkiEzsignformfieldgroupID);
        return localVarResp.getData();
    }
     ...
     * 
     * @param pkiEzsignformfieldgroupID  (required)
     * @return ApiResponse&lt;EzsignformfieldgroupGetObjectV1Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    @Deprecated
    public okhttp3.Call ezsignformfieldgroupGetObjectV1Async(Integer pkiEzsignformfieldgroupID, final ApiCallback<EzsignformfieldgroupGetObjectV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = ezsignformfieldgroupGetObjectV1ValidateBeforeCall(pkiEzsignformfieldgroupID, _callback);
        Type localVarReturnType = new TypeToken<EzsignformfieldgroupGetObjectV1Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call ezsignformfieldgroupGetObjectV2ValidateBeforeCall(Integer pkiEzsignformfieldgroupID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsignformfieldgroupGetObjectV2Call(pkiEzsignformfieldgroupID, _callback);
        return localVarCall;
