...
public class ObjectEzmaxinvoicingApi {
     ...
     */
    public okhttp3.Call ezmaxinvoicingGetAutocompleteV2Call(@javax.annotation.Nonnull String sSelector, @javax.annotation.Nullable String eFilterActive, @javax.annotation.Nullable String sQuery, @javax.annotation.Nullable HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ezmaxinvoicingGetAutocompleteV2ValidateBeforeCall(@javax.annotation.Nonnull String sSelector, @javax.annotation.Nullable String eFilterActive, @javax.annotation.Nullable String sQuery, @javax.annotation.Nullable HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzmaxinvoicingGetAutocompleteV2Response ezmaxinvoicingGetAutocompleteV2(@javax.annotation.Nonnull String sSelector, @javax.annotation.Nullable String eFilterActive, @javax.annotation.Nullable String sQuery, @javax.annotation.Nullable HeaderAcceptLanguage acceptLanguage) throws ApiException {
     ...
     */
    public okhttp3.Call ezmaxinvoicingGetAutocompleteV2Async(@javax.annotation.Nonnull String sSelector, @javax.annotation.Nullable String eFilterActive, @javax.annotation.Nullable String sQuery, @javax.annotation.Nullable HeaderAcceptLanguage acceptLanguage, final ApiCallback<EzmaxinvoicingGetAutocompleteV2Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call ezmaxinvoicingGetObjectV2Call(@javax.annotation.Nonnull Integer pkiEzmaxinvoicingID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezmaxinvoicingGetObjectV2ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzmaxinvoicingID, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzmaxinvoicingGetObjectV2Response ezmaxinvoicingGetObjectV2(@javax.annotation.Nonnull Integer pkiEzmaxinvoicingID) throws ApiException {
     ...
     */
    public ApiResponse<EzmaxinvoicingGetObjectV2Response> ezmaxinvoicingGetObjectV2WithHttpInfo(@javax.annotation.Nonnull Integer pkiEzmaxinvoicingID) throws ApiException {
     ...
     */
    public okhttp3.Call ezmaxinvoicingGetObjectV2Async(@javax.annotation.Nonnull Integer pkiEzmaxinvoicingID, final ApiCallback<EzmaxinvoicingGetObjectV2Response> _callback) throws ApiException {
