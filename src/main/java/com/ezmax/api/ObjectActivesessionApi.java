...
public class ObjectActivesessionApi {
    ...
    /**
     * Build call for activesessionGenerateFederationTokenV1
     * @param activesessionGenerateFederationTokenV1Request  (required)
     ...
     */
    public okhttp3.Call activesessionGenerateFederationTokenV1Call(ActivesessionGenerateFederationTokenV1Request activesessionGenerateFederationTokenV1Request, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = activesessionGenerateFederationTokenV1Request;

        // create path and map variables
        String localVarPath = "/1/object/activesession/generateFederationToken";
    ...
    private okhttp3.Call activesessionGenerateFederationTokenV1ValidateBeforeCall(ActivesessionGenerateFederationTokenV1Request activesessionGenerateFederationTokenV1Request, final ApiCallback _callback) throws ApiException {
        ...
        if (activesessionGenerateFederationTokenV1Request == null) {
            throw new ApiException("Missing the required parameter 'activesessionGenerateFederationTokenV1Request' when calling activesessionGenerateFederationTokenV1(Async)");
        }

        return activesessionGenerateFederationTokenV1Call(activesessionGenerateFederationTokenV1Request, _callback);
     ...
     */
    public ActivesessionGenerateFederationTokenV1Response activesessionGenerateFederationTokenV1(ActivesessionGenerateFederationTokenV1Request activesessionGenerateFederationTokenV1Request) throws ApiException {
        ApiResponse<ActivesessionGenerateFederationTokenV1Response> localVarResp = activesessionGenerateFederationTokenV1WithHttpInfo(activesessionGenerateFederationTokenV1Request);
     ...
     */
    public ApiResponse<ActivesessionGenerateFederationTokenV1Response> activesessionGenerateFederationTokenV1WithHttpInfo(ActivesessionGenerateFederationTokenV1Request activesessionGenerateFederationTokenV1Request) throws ApiException {
        okhttp3.Call localVarCall = activesessionGenerateFederationTokenV1ValidateBeforeCall(activesessionGenerateFederationTokenV1Request, null);
        Type localVarReturnType = new TypeToken<ActivesessionGenerateFederationTokenV1Response>(){}.getType();
     ...
     */
    public okhttp3.Call activesessionGenerateFederationTokenV1Async(ActivesessionGenerateFederationTokenV1Request activesessionGenerateFederationTokenV1Request, final ApiCallback<ActivesessionGenerateFederationTokenV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = activesessionGenerateFederationTokenV1ValidateBeforeCall(activesessionGenerateFederationTokenV1Request, _callback);
        Type localVarReturnType = new TypeToken<ActivesessionGenerateFederationTokenV1Response>(){}.getType();
