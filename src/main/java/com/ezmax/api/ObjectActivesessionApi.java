...
public class ObjectActivesessionApi {
    ...
    private okhttp3.Call activesessionGenerateFederationTokenV1ValidateBeforeCall(@javax.annotation.Nonnull ActivesessionGenerateFederationTokenV1Request activesessionGenerateFederationTokenV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiResponse<ActivesessionGetListV1Response> activesessionGetListV1WithHttpInfo(@javax.annotation.Nullable String eOrderBy, @javax.annotation.Nullable Integer iRowMax, @javax.annotation.Nullable Integer iRowOffset, @javax.annotation.Nullable HeaderAcceptLanguage acceptLanguage, @javax.annotation.Nullable String sFilter) throws ApiException {
     ...
     */
    public okhttp3.Call activesessionGetListV1Async(@javax.annotation.Nullable String eOrderBy, @javax.annotation.Nullable Integer iRowMax, @javax.annotation.Nullable Integer iRowOffset, @javax.annotation.Nullable HeaderAcceptLanguage acceptLanguage, @javax.annotation.Nullable String sFilter, final ApiCallback<ActivesessionGetListV1Response> _callback) throws ApiException {
