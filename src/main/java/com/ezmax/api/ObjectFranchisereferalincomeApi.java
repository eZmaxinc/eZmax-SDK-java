...
public class ObjectFranchisereferalincomeApi {
     ...
     */
    public okhttp3.Call franchisereferalincomeCreateObjectV2Call(@javax.annotation.Nonnull FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call franchisereferalincomeCreateObjectV2ValidateBeforeCall(@javax.annotation.Nonnull FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public FranchisereferalincomeCreateObjectV2Response franchisereferalincomeCreateObjectV2(@javax.annotation.Nonnull FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request) throws ApiException {
     ...
     */
    public ApiResponse<FranchisereferalincomeCreateObjectV2Response> franchisereferalincomeCreateObjectV2WithHttpInfo(@javax.annotation.Nonnull FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request) throws ApiException {
     ...
     */
    public okhttp3.Call franchisereferalincomeCreateObjectV2Async(@javax.annotation.Nonnull FranchisereferalincomeCreateObjectV2Request franchisereferalincomeCreateObjectV2Request, final ApiCallback<FranchisereferalincomeCreateObjectV2Response> _callback) throws ApiException {
