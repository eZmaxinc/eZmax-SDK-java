...
public class ObjectEzsigndiscussionApi {
     ...
     */
    public okhttp3.Call ezsigndiscussionCreateObjectV1Call(@javax.annotation.Nonnull EzsigndiscussionCreateObjectV1Request ezsigndiscussionCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ezsigndiscussionCreateObjectV1ValidateBeforeCall(@javax.annotation.Nonnull EzsigndiscussionCreateObjectV1Request ezsigndiscussionCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzsigndiscussionCreateObjectV1Response ezsigndiscussionCreateObjectV1(@javax.annotation.Nonnull EzsigndiscussionCreateObjectV1Request ezsigndiscussionCreateObjectV1Request) throws ApiException {
     ...
     */
    public ApiResponse<EzsigndiscussionCreateObjectV1Response> ezsigndiscussionCreateObjectV1WithHttpInfo(@javax.annotation.Nonnull EzsigndiscussionCreateObjectV1Request ezsigndiscussionCreateObjectV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call ezsigndiscussionCreateObjectV1Async(@javax.annotation.Nonnull EzsigndiscussionCreateObjectV1Request ezsigndiscussionCreateObjectV1Request, final ApiCallback<EzsigndiscussionCreateObjectV1Response> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsigndiscussionDeleteObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsigndiscussionID, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsigndiscussionGetObjectV2ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsigndiscussionID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsigndiscussionID' is set
        if (pkiEzsigndiscussionID == null) {
