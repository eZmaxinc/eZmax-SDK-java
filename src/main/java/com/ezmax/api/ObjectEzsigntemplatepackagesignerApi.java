...
public class ObjectEzsigntemplatepackagesignerApi {
     ...
     */
    public CommonResponse ezsigntemplatepackagesignerEditObjectV1(Integer pkiEzsigntemplatepackagesignerID, EzsigntemplatepackagesignerEditObjectV1Request ezsigntemplatepackagesignerEditObjectV1Request) throws ApiException {
        ApiResponse<CommonResponse> localVarResp = ezsigntemplatepackagesignerEditObjectV1WithHttpInfo(pkiEzsigntemplatepackagesignerID, ezsigntemplatepackagesignerEditObjectV1Request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CommonResponse> ezsigntemplatepackagesignerEditObjectV1WithHttpInfo(Integer pkiEzsigntemplatepackagesignerID, EzsigntemplatepackagesignerEditObjectV1Request ezsigntemplatepackagesignerEditObjectV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call ezsigntemplatepackagesignerEditObjectV1Async(Integer pkiEzsigntemplatepackagesignerID, EzsigntemplatepackagesignerEditObjectV1Request ezsigntemplatepackagesignerEditObjectV1Request, final ApiCallback<CommonResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call ezsigntemplatepackagesignerGetObjectV2Call(Integer pkiEzsigntemplatepackagesignerID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsigntemplatepackagesignerGetObjectV2ValidateBeforeCall(Integer pkiEzsigntemplatepackagesignerID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsigntemplatepackagesignerID' is set
        if (pkiEzsigntemplatepackagesignerID == null) {
     ...
     */
    public EzsigntemplatepackagesignerGetObjectV2Response ezsigntemplatepackagesignerGetObjectV2(Integer pkiEzsigntemplatepackagesignerID) throws ApiException {
     ...
     */
    public ApiResponse<EzsigntemplatepackagesignerGetObjectV2Response> ezsigntemplatepackagesignerGetObjectV2WithHttpInfo(Integer pkiEzsigntemplatepackagesignerID) throws ApiException {
     ...
     */
    public okhttp3.Call ezsigntemplatepackagesignerGetObjectV2Async(Integer pkiEzsigntemplatepackagesignerID, final ApiCallback<EzsigntemplatepackagesignerGetObjectV2Response> _callback) throws ApiException {
