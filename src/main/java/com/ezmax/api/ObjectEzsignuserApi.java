...
public class ObjectEzsignuserApi {
     ...
     */
    public okhttp3.Call ezsignuserEditObjectV1Call(@javax.annotation.Nonnull Integer pkiEzsignuserID, @javax.annotation.Nonnull EzsignuserEditObjectV1Request ezsignuserEditObjectV1Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ezsignuserEditObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignuserID, @javax.annotation.Nonnull EzsignuserEditObjectV1Request ezsignuserEditObjectV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzsignuserEditObjectV1Response ezsignuserEditObjectV1(@javax.annotation.Nonnull Integer pkiEzsignuserID, @javax.annotation.Nonnull EzsignuserEditObjectV1Request ezsignuserEditObjectV1Request) throws ApiException {
     ...
     */
    public ApiResponse<EzsignuserEditObjectV1Response> ezsignuserEditObjectV1WithHttpInfo(@javax.annotation.Nonnull Integer pkiEzsignuserID, @javax.annotation.Nonnull EzsignuserEditObjectV1Request ezsignuserEditObjectV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call ezsignuserEditObjectV1Async(@javax.annotation.Nonnull Integer pkiEzsignuserID, @javax.annotation.Nonnull EzsignuserEditObjectV1Request ezsignuserEditObjectV1Request, final ApiCallback<EzsignuserEditObjectV1Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call ezsignuserGetObjectV2Call(@javax.annotation.Nonnull Integer pkiEzsignuserID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignuserGetObjectV2ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignuserID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsignuserID' is set
        if (pkiEzsignuserID == null) {
     ...
     */
    public EzsignuserGetObjectV2Response ezsignuserGetObjectV2(@javax.annotation.Nonnull Integer pkiEzsignuserID) throws ApiException {
     ...
     */
    public ApiResponse<EzsignuserGetObjectV2Response> ezsignuserGetObjectV2WithHttpInfo(@javax.annotation.Nonnull Integer pkiEzsignuserID) throws ApiException {
     ...
     */
    public okhttp3.Call ezsignuserGetObjectV2Async(@javax.annotation.Nonnull Integer pkiEzsignuserID, final ApiCallback<EzsignuserGetObjectV2Response> _callback) throws ApiException {
