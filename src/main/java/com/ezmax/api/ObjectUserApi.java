...
public class ObjectUserApi {
    ...
    /**
     * Build call for userGetAutocompleteV1
     ...
     */
    @Deprecated
    public okhttp3.Call userGetAutocompleteV1Call(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/1/object/user/getAutocomplete/{sSelector}"
    ...
    private okhttp3.Call userGetAutocompleteV1ValidateBeforeCall(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'sSelector' is set
        if (sSelector == null) {
            throw new ApiException("Missing the required parameter 'sSelector' when calling userGetAutocompleteV1(Async)");
        }
        

        okhttp3.Call localVarCall = userGetAutocompleteV1Call(sSelector, eFilterActive, sQuery, acceptLanguage, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public CommonGetAutocompleteV1Response userGetAutocompleteV1(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage) throws ApiException {
        ApiResponse<CommonGetAutocompleteV1Response> localVarResp = userGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
     ...
     */
    @Deprecated
    public ApiResponse<CommonGetAutocompleteV1Response> userGetAutocompleteV1WithHttpInfo(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = userGetAutocompleteV1ValidateBeforeCall(sSelector, eFilterActive, sQuery, acceptLanguage, null);
     ...
     */
    @Deprecated
    public okhttp3.Call userGetAutocompleteV1Async(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback<CommonGetAutocompleteV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = userGetAutocompleteV1ValidateBeforeCall(sSelector, eFilterActive, sQuery, acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<CommonGetAutocompleteV1Response>(){}.getType();
    ...
    private okhttp3.Call userGetAutocompleteV2ValidateBeforeCall(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = userGetAutocompleteV2Call(sSelector, eFilterActive, sQuery, acceptLanguage, _callback);
        return localVarCall;
