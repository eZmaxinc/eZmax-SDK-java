...
public class ObjectAttachmentApi {
    ...
    private okhttp3.Call attachmentDownloadV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiAttachmentID, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call attachmentGetAttachmentlogsV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiAttachmentID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiAttachmentID' is set
        if (pkiAttachmentID == null) {
