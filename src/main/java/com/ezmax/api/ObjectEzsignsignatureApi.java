...
public class ObjectEzsignsignatureApi {
    ...
    /**
     * Modify an existing Ezsignsignature (asynchronously)
     * 
     * @param pkiEzsignsignatureID The unique ID of the Ezsignsignature (required)
     * @param ezsignsignatureEditObjectV1Request  (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Build call for ezsignsignatureGetObjectGetChildrenV1
     * @param pkiEzsignsignatureID The unique ID of the Ezsignsignature (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call ezsignsignatureGetObjectGetChildrenV1Call(Integer pkiEzsignsignatureID, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignsignatureGetObjectGetChildrenV1ValidateBeforeCall(Integer pkiEzsignsignatureID, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'pkiEzsignsignatureID' is set
        if (pkiEzsignsignatureID == null) {
            throw new ApiException("Missing the required parameter 'pkiEzsignsignatureID' when calling ezsignsignatureGetObjectGetChildrenV1(Async)");
        }
        

        okhttp3.Call localVarCall = ezsignsignatureGetObjectGetChildrenV1Call(pkiEzsignsignatureID, _callback);
        return localVarCall;
     ...
     */
    public void ezsignsignatureGetObjectGetChildrenV1(Integer pkiEzsignsignatureID) throws ApiException {
     ...
     */
    public ApiResponse<Void> ezsignsignatureGetObjectGetChildrenV1WithHttpInfo(Integer pkiEzsignsignatureID) throws ApiException {
        okhttp3.Call localVarCall = ezsignsignatureGetObjectGetChildrenV1ValidateBeforeCall(pkiEzsignsignatureID, null);
     ...
     */
    public okhttp3.Call ezsignsignatureGetObjectGetChildrenV1Async(Integer pkiEzsignsignatureID, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = ezsignsignatureGetObjectGetChildrenV1ValidateBeforeCall(pkiEzsignsignatureID, _callback);
