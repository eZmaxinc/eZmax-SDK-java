...
public class ObjectEzsigntemplateApi {
    ...
    private okhttp3.Call ezsigntemplateCopyV1ValidateBeforeCall(Integer pkiEzsigntemplateID, EzsigntemplateCopyV1Request ezsigntemplateCopyV1Request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateCopyV1Call(pkiEzsigntemplateID, ezsigntemplateCopyV1Request, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public okhttp3.Call ezsigntemplateGetAutocompleteV1Call(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsigntemplateGetAutocompleteV1ValidateBeforeCall(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateGetAutocompleteV1Call(sSelector, eFilterActive, sQuery, acceptLanguage, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public CommonGetAutocompleteV1Response ezsigntemplateGetAutocompleteV1(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage) throws ApiException {
        ApiResponse<CommonGetAutocompleteV1Response> localVarResp = ezsigntemplateGetAutocompleteV1WithHttpInfo(sSelector, eFilterActive, sQuery, acceptLanguage);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<CommonGetAutocompleteV1Response> ezsigntemplateGetAutocompleteV1WithHttpInfo(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage) throws ApiException {
        okhttp3.Call localVarCall = ezsigntemplateGetAutocompleteV1ValidateBeforeCall(sSelector, eFilterActive, sQuery, acceptLanguage, null);
     ...
     */
    @Deprecated
    public okhttp3.Call ezsigntemplateGetAutocompleteV1Async(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback<CommonGetAutocompleteV1Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = ezsigntemplateGetAutocompleteV1ValidateBeforeCall(sSelector, eFilterActive, sQuery, acceptLanguage, _callback);
        Type localVarReturnType = new TypeToken<CommonGetAutocompleteV1Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call ezsigntemplateGetAutocompleteV2ValidateBeforeCall(String sSelector, String eFilterActive, String sQuery, HeaderAcceptLanguage acceptLanguage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateGetAutocompleteV2Call(sSelector, eFilterActive, sQuery, acceptLanguage, _callback);
        return localVarCall;
    ...
    private okhttp3.Call ezsigntemplateGetObjectV2ValidateBeforeCall(Integer pkiEzsigntemplateID, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = ezsigntemplateGetObjectV2Call(pkiEzsigntemplateID, _callback);
        return localVarCall;
