...
public class ObjectEzsignpageApi {
     ...
     */
    public okhttp3.Call ezsignpageConsultV1Call(@javax.annotation.Nonnull Integer pkiEzsignpageID, @javax.annotation.Nonnull Object body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ezsignpageConsultV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignpageID, @javax.annotation.Nonnull Object body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzsignpageConsultV1Response ezsignpageConsultV1(@javax.annotation.Nonnull Integer pkiEzsignpageID, @javax.annotation.Nonnull Object body) throws ApiException {
     ...
     */
    public ApiResponse<EzsignpageConsultV1Response> ezsignpageConsultV1WithHttpInfo(@javax.annotation.Nonnull Integer pkiEzsignpageID, @javax.annotation.Nonnull Object body) throws ApiException {
     ...
     */
    public okhttp3.Call ezsignpageConsultV1Async(@javax.annotation.Nonnull Integer pkiEzsignpageID, @javax.annotation.Nonnull Object body, final ApiCallback<EzsignpageConsultV1Response> _callback) throws ApiException {
