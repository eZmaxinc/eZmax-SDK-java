...
public class ObjectEzsignannotationApi {
     ...
     */
    public okhttp3.Call ezsignannotationCreateObjectV1Call(@javax.annotation.Nonnull EzsignannotationCreateObjectV1Request ezsignannotationCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call ezsignannotationCreateObjectV1ValidateBeforeCall(@javax.annotation.Nonnull EzsignannotationCreateObjectV1Request ezsignannotationCreateObjectV1Request, final ApiCallback _callback) throws ApiException {
     ...
     */
    public EzsignannotationCreateObjectV1Response ezsignannotationCreateObjectV1(@javax.annotation.Nonnull EzsignannotationCreateObjectV1Request ezsignannotationCreateObjectV1Request) throws ApiException {
     ...
     */
    public ApiResponse<EzsignannotationCreateObjectV1Response> ezsignannotationCreateObjectV1WithHttpInfo(@javax.annotation.Nonnull EzsignannotationCreateObjectV1Request ezsignannotationCreateObjectV1Request) throws ApiException {
     ...
     */
    public okhttp3.Call ezsignannotationCreateObjectV1Async(@javax.annotation.Nonnull EzsignannotationCreateObjectV1Request ezsignannotationCreateObjectV1Request, final ApiCallback<EzsignannotationCreateObjectV1Response> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignannotationDeleteObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignannotationID, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignannotationEditObjectV1ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignannotationID, @javax.annotation.Nonnull EzsignannotationEditObjectV1Request ezsignannotationEditObjectV1Request, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsignannotationID' is set
        if (pkiEzsignannotationID == null) {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call ezsignannotationGetObjectV2ValidateBeforeCall(@javax.annotation.Nonnull Integer pkiEzsignannotationID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'pkiEzsignannotationID' is set
        if (pkiEzsignannotationID == null) {
