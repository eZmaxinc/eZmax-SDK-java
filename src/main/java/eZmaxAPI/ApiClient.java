...
import eZmaxAPI.auth.Authentication;
import eZmaxAPI.auth.HttpBasicAuth;
import eZmaxAPI.auth.HttpBearerAuth;
import eZmaxAPI.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://prod.api.appcluster01.ca-central-1.ezmax.com/rest";
    ...
    new ServerConfiguration(
      ...
      new HashMap<String, ServerVariable>() {{
        put("sInfrastructureenvironmenttypeDescription", new ServerVariable(
          "The environment on on which to call the API. Should always be \"prod\" unless instructed otherwise by support.",
          "prod",
          new HashSet<String>(
            Arrays.asList(
              "iso",
        ...
        put("sInfrastructureregionCode", new ServerVariable(
          "The region where your services are hosted.",
          "ca-central-1",
          new HashSet<String>(
            Arrays.asList(
              "ca-central-1"
    ...
    public ApiClient() {
        ...
        authentications.put("Presigned", new ApiKeyAuth("query", "sAuthorization"));
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.3.3/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://prod.api.appcluster01.ca-central-1.ezmax.com/rest)
     ...
     * @return a {@link eZmaxAPI.ApiClient} object
     */
    ...
    */
     ...
     * @throws eZmaxAPI.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws eZmaxAPI.ApiException If fail to serialize the given object
     */
     ...
     * @throws eZmaxAPI.ApiException If fail to read file content from response and write to disk
     ...
     * @throws eZmaxAPI.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws eZmaxAPI.ApiException If the response has an unsuccessful status code or
     ...
     * @throws eZmaxAPI.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws eZmaxAPI.ApiException If fails to update the parameters
     */
     ...
     * @throws eZmaxAPI.ApiException If fail to serialize the request body object into a string
     */
