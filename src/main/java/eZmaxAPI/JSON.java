...
public class JSON {
...

    {
        gson = createGson()
            ...
            .registerTypeAdapterFactory(new com.ezmax.api.model.ListpresentationRequestCompound.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.ezmax.api.model.ListpresentationResponseCompound.CustomTypeAdapterFactory())
